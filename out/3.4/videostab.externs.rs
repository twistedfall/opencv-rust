...
pub fn cv_videostab_DeblurerBase_deblur_int_MatR(instance: *mut c_void, idx: i32, frame: *mut c_void, ocvrs_return: *mut Result<()>);
...
pub fn cv_videostab_GaussianMotionFilter_stabilize_int_const_vectorLMatGR_pairLint__intG(instance: *mut c_void, idx: i32, motions: *const c_void, range: *mut c_void, ocvrs_return: *mut Result<*mut c_void>);
...
pub fn cv_videostab_IMotionStabilizer_stabilize_int_const_vectorLMatGR_pairLint__intG_MatX(instance: *mut c_void, size: i32, motions: *const c_void, range: *mut c_void, stabilization_motions: *mut c_void, ocvrs_return: *mut Result<()>);
...
pub fn cv_videostab_LpMotionStabilizer_stabilize_int_const_vectorLMatGR_pairLint__intG_MatX(instance: *mut c_void, size: i32, motions: *const c_void, range: *mut c_void, stabilization_motions: *mut c_void, ocvrs_return: *mut Result<()>);
...
pub fn cv_videostab_MotionFilterBase_stabilize_int_const_vectorLMatGR_pairLint__intG(instance: *mut c_void, idx: i32, motions: *const c_void, range: *mut c_void, ocvrs_return: *mut Result<*mut c_void>);
...
pub fn cv_videostab_MotionFilterBase_stabilize_int_const_vectorLMatGR_pairLint__intG_MatX(instance: *mut c_void, size: i32, motions: *const c_void, range: *mut c_void, stabilization_motions: *mut c_void, ocvrs_return: *mut Result<()>);
...
pub fn cv_videostab_MotionStabilizationPipeline_stabilize_int_const_vectorLMatGR_pairLint__intG_MatX(instance: *mut c_void, size: i32, motions: *const c_void, range: *mut c_void, stabilization_motions: *mut c_void, ocvrs_return: *mut Result<()>);
...
pub fn cv_videostab_NullDeblurer_deblur_int_MatR(instance: *mut c_void, unnamed: i32, unnamed_1: *mut c_void, ocvrs_return: *mut Result<()>);
...
pub fn cv_videostab_WeightingDeblurer_deblur_int_MatR(instance: *mut c_void, idx: i32, frame: *mut c_void, ocvrs_return: *mut Result<()>);
