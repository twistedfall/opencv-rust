...
pub fn cv_flann_IndexParams_getAll_const_vectorLStringGR_vectorLintGR_vectorLStringGR_vectorLdoubleGR(instance: *const c_void, names: *mut c_void, types: *mut c_void, str_values: *mut c_void, num_values: *mut c_void, ocvrs_return: *mut Result<()>);
