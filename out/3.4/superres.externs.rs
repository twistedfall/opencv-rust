...
pub fn cv_superres_SuperResolution_getLabmda_const(instance: *const c_void, ocvrs_return: *mut Result<f64>);
...
pub fn cv_superres_SuperResolution_setLabmda_double(instance: *mut c_void, val: f64, ocvrs_return: *mut Result<()>);
