...
// H5_GETCHUNKDIMS /home/pro/projects/opencv-lib/opencv-3.4/install/include/opencv2/hdf/hdf5.hpp:66
pub const HDF5_H5_GETCHUNKDIMS: i32 = 102;
/// Get the dimension information of a dataset. see also: dsgetsize()
// H5_GETDIMS /home/pro/projects/opencv-lib/opencv-3.4/install/include/opencv2/hdf/hdf5.hpp:64
pub const HDF5_H5_GETDIMS: i32 = 100;
/// Get the maximum dimension information of a dataset. see also: dsgetsize()
// H5_GETMAXDIMS /home/pro/projects/opencv-lib/opencv-3.4/install/include/opencv2/hdf/hdf5.hpp:65
pub const HDF5_H5_GETMAXDIMS: i32 = 101;
/// No compression, see also: dscreate()
// H5_NONE /home/pro/projects/opencv-lib/opencv-3.4/install/include/opencv2/hdf/hdf5.hpp:63
pub const HDF5_H5_NONE: i32 = -1;
/// The dimension size is unlimited, see also: dscreate()
// H5_UNLIMITED /home/pro/projects/opencv-lib/opencv-3.4/install/include/opencv2/hdf/hdf5.hpp:62
...
///
///
/// ![Visualization of 10x10 CV_64FC2 (Hilbert matrix) using HDFView tool](https://docs.opencv.org/3.4.20/hdfview_demo.gif)
///
...
// HDF5 /home/pro/projects/opencv-lib/opencv-3.4/install/include/opencv2/hdf/hdf5.hpp:56
...
pub trait HDF5Trait: crate::hdf::HDF5TraitConst {
	...
	///
	///  [create_group](https://github.com/opencv/opencv_contrib/blob/3.4.20/modules/hdf/samples/create_groups.cpp#L1)
	///
	///  The corresponding result visualized using the HDFView tool is
	///
	///  ![Visualization of groups using the HDFView tool](https://docs.opencv.org/3.4.20/create_groups.png)
	///
	///
	...
	///
	///  [snippets_write_str](https://github.com/opencv/opencv_contrib/blob/3.4.20/modules/hdf/samples/read_write_attributes.cpp#L1)
	///
	///
	...
	///
	///  [snippets_read_str](https://github.com/opencv/opencv_contrib/blob/3.4.20/modules/hdf/samples/read_write_attributes.cpp#L1)
	///
	///
