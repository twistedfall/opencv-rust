extern "C" {
	...
	// cv::Ptr<cv::TrackerMIL>::to_PtrOfAlgorithm() generated
	// ("cv::Ptr<cv::TrackerMIL>::to_PtrOfAlgorithm", vec![(pred!(mut, [], []), _)]),
	cv::Ptr<cv::Algorithm>* cv_PtrLcv_TrackerMILG_to_PtrOfAlgorithm(cv::Ptr<cv::TrackerMIL>* instance) {
