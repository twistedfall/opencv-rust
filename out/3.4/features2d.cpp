...
extern "C" {
	...
	void cv_AGAST_const__InputArrayR_vectorLKeyPointGR_int_bool_int(const cv::_InputArray* image, std::vector<cv::KeyPoint>* keypoints, int threshold, bool nonmaxSuppression, int type, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_FAST_const__InputArrayR_vectorLKeyPointGR_int_bool_int(const cv::_InputArray* image, std::vector<cv::KeyPoint>* keypoints, int threshold, bool nonmaxSuppression, int type, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_drawKeypoints_const__InputArrayR_const_vectorLKeyPointGR_const__InputOutputArrayR_const_ScalarR_int(const cv::_InputArray* image, const std::vector<cv::KeyPoint>* keypoints, const cv::_InputOutputArray* outImage, const cv::Scalar* color, int flags, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_drawMatches_const__InputArrayR_const_vectorLKeyPointGR_const__InputArrayR_const_vectorLKeyPointGR_const_vectorLDMatchGR_const__InputOutputArrayR_const_ScalarR_const_ScalarR_const_vectorLcharGR_int(const cv::_InputArray* img1, const std::vector<cv::KeyPoint>* keypoints1, const cv::_InputArray* img2, const std::vector<cv::KeyPoint>* keypoints2, const std::vector<cv::DMatch>* matches1to2, const cv::_InputOutputArray* outImg, const cv::Scalar* matchColor, const cv::Scalar* singlePointColor, const std::vector<char>* matchesMask, int flags, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_drawMatches_const__InputArrayR_const_vectorLKeyPointGR_const__InputArrayR_const_vectorLKeyPointGR_const_vectorLDMatchGR_const__InputOutputArrayR_const_int_const_ScalarR_const_ScalarR_const_vectorLcharGR_int(const cv::_InputArray* img1, const std::vector<cv::KeyPoint>* keypoints1, const cv::_InputArray* img2, const std::vector<cv::KeyPoint>* keypoints2, const std::vector<cv::DMatch>* matches1to2, const cv::_InputOutputArray* outImg, const int matchesThickness, const cv::Scalar* matchColor, const cv::Scalar* singlePointColor, const std::vector<char>* matchesMask, int flags, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_drawMatches_const__InputArrayR_const_vectorLKeyPointGR_const__InputArrayR_const_vectorLKeyPointGR_const_vectorLvectorLDMatchGGR_const__InputOutputArrayR_const_ScalarR_const_ScalarR_const_vectorLvectorLcharGGR_int(const cv::_InputArray* img1, const std::vector<cv::KeyPoint>* keypoints1, const cv::_InputArray* img2, const std::vector<cv::KeyPoint>* keypoints2, const std::vector<std::vector<cv::DMatch>>* matches1to2, const cv::_InputOutputArray* outImg, const cv::Scalar* matchColor, const cv::Scalar* singlePointColor, const std::vector<std::vector<char>>* matchesMask, int flags, ResultVoid* ocvrs_return) {
		try {
			cv::drawMatches(*img1, *keypoints1, *img2, *keypoints2, *matches1to2, *outImg, *matchColor, *singlePointColor, *matchesMask, flags);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	...
	void cv_AKAZE_create_int_int_int_float_int_int_int(int descriptor_type, int descriptor_size, int descriptor_channels, float threshold, int nOctaves, int nOctaveLayers, int diffusivity, Result<cv::Ptr<cv::AKAZE>*>* ocvrs_return) {
		try {
	...
	void cv_AKAZE_setDescriptorType_int(cv::AKAZE* instance, int dtype, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_AKAZE_getDescriptorType_const(const cv::AKAZE* instance, Result<int>* ocvrs_return) {
		try {
	...
	void cv_AKAZE_setDiffusivity_int(cv::AKAZE* instance, int diff, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_AKAZE_getDiffusivity_const(const cv::AKAZE* instance, Result<int>* ocvrs_return) {
		try {
	...
	void cv_AgastFeatureDetector_create_int_bool_int(int threshold, bool nonmaxSuppression, int type, Result<cv::Ptr<cv::AgastFeatureDetector>*>* ocvrs_return) {
		try {
	...
	void cv_AgastFeatureDetector_setType_int(cv::AgastFeatureDetector* instance, int type, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_AgastFeatureDetector_getType_const(const cv::AgastFeatureDetector* instance, Result<int>* ocvrs_return) {
		try {
	...
	void cv_DescriptorMatcher_create_int(int matcherType, Result<cv::Ptr<cv::DescriptorMatcher>*>* ocvrs_return) {
		try {
	...
	void cv_FastFeatureDetector_create_int_bool_int(int threshold, bool nonmaxSuppression, int type, Result<cv::Ptr<cv::FastFeatureDetector>*>* ocvrs_return) {
		try {
	...
	void cv_FastFeatureDetector_setType_int(cv::FastFeatureDetector* instance, int type, ResultVoid* ocvrs_return) {
		try {
			instance->setType(type);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	...
	void cv_FastFeatureDetector_getType_const(const cv::FastFeatureDetector* instance, Result<int>* ocvrs_return) {
		try {
			int ret = instance->getType();
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	...
	void cv_KAZE_create_bool_bool_float_int_int_int(bool extended, bool upright, float threshold, int nOctaves, int nOctaveLayers, int diffusivity, Result<cv::Ptr<cv::KAZE>*>* ocvrs_return) {
		try {
	...
	void cv_KAZE_setDiffusivity_int(cv::KAZE* instance, int diff, ResultVoid* ocvrs_return) {
		try {
			instance->setDiffusivity(diff);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	...
	void cv_KAZE_getDiffusivity_const(const cv::KAZE* instance, Result<int>* ocvrs_return) {
		try {
			int ret = instance->getDiffusivity();
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	...
	void cv_ORB_create_int_float_int_int_int_int_int_int_int(int nfeatures, float scaleFactor, int nlevels, int edgeThreshold, int firstLevel, int WTA_K, int scoreType, int patchSize, int fastThreshold, Result<cv::Ptr<cv::ORB>*>* ocvrs_return) {
		try {
	...
	void cv_ORB_setScoreType_int(cv::ORB* instance, int scoreType, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_ORB_getScoreType_const(const cv::ORB* instance, Result<int>* ocvrs_return) {
		try {
