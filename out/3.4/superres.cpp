...
extern "C" {
	...
	void cv_superres_SuperResolution_getLabmda_const(const cv::superres::SuperResolution* instance, Result<double>* ocvrs_return) {
		try {
			double ret = instance->getLabmda();
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_superres_SuperResolution_setLabmda_double(cv::superres::SuperResolution* instance, double val, ResultVoid* ocvrs_return) {
		try {
			instance->setLabmda(val);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
