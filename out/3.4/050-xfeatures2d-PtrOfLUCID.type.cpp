extern "C" {
	...
	// cv::Ptr<cv::xfeatures2d::LUCID>::new(TraitClass) generated
	// ("cv::Ptr<cv::xfeatures2d::LUCID>::new", vec![(pred!(const, ["val"], ["cv::xfeatures2d::LUCID"]), _)]),
	cv::Ptr<cv::xfeatures2d::LUCID>* cv_PtrLcv_xfeatures2d_LUCIDG_new_const_LUCID(cv::xfeatures2d::LUCID* val) {
