...
extern "C" {
	...
	void cv_drawMarker_MatR_Point_const_ScalarR(cv::Mat* img, cv::Point* position, const cv::Scalar* color, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_drawMarker_MatR_Point_const_ScalarR_int_int_int_int(cv::Mat* img, cv::Point* position, const cv::Scalar* color, int markerType, int markerSize, int thickness, int line_type, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_const__OutputArrayR_int_int(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, const cv::_OutputArray* hierarchy, int mode, int method, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_const__OutputArrayR_int_int_Point(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, const cv::_OutputArray* hierarchy, int mode, int method, cv::Point* offset, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_int_int(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, int mode, int method, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_int_int_Point(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, int mode, int method, cv::Point* offset, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_initWideAngleProjMap_const__InputArrayR_const__InputArrayR_Size_int_int_const__OutputArrayR_const__OutputArrayR_int_double(const cv::_InputArray* cameraMatrix, const cv::_InputArray* distCoeffs, cv::Size* imageSize, int destImageWidth, int m1type, const cv::_OutputArray* map1, const cv::_OutputArray* map2, int projType, double alpha, Result<float>* ocvrs_return) {
		try {
	...
	void cv_putText_const__InputOutputArrayR_const_StringR_Point_int_double_Scalar(const cv::_InputOutputArray* img, const char* text, cv::Point* org, int fontFace, double fontScale, cv::Scalar* color, ResultVoid* ocvrs_return) {
		try {
			cv::putText(*img, cv::String(text), *org, fontFace, fontScale, *color);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_rectangle_MatR_Rect_const_ScalarR(cv::Mat* img, cv::Rect* rec, const cv::Scalar* color, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_rectangle_MatR_Rect_const_ScalarR_int_int_int(cv::Mat* img, cv::Rect* rec, const cv::Scalar* color, int thickness, int lineType, int shift, ResultVoid* ocvrs_return) {
		try {
