extern "C" {
	...
	// cv::Ptr<cv::xfeatures2d::HarrisLaplaceFeatureDetector>::new(TraitClass) generated
	// ("cv::Ptr<cv::xfeatures2d::HarrisLaplaceFeatureDetector>::new", vec![(pred!(const, ["val"], ["cv::xfeatures2d::HarrisLaplaceFeatureDetector"]), _)]),
	cv::Ptr<cv::xfeatures2d::HarrisLaplaceFeatureDetector>* cv_PtrLcv_xfeatures2d_HarrisLaplaceFeatureDetectorG_new_const_HarrisLaplaceFeatureDetector(cv::xfeatures2d::HarrisLaplaceFeatureDetector* val) {
