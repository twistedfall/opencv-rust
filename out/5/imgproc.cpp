...
extern "C" {
	...
	void cv_createLineSegmentDetector_LineSegmentDetectorModes_double_double_double_double_double_double_int(cv::LineSegmentDetectorModes refine, double scale, double sigma_scale, double quant, double ang_th, double log_eps, double density_th, int n_bins, Result<cv::Ptr<cv::LineSegmentDetector>*>* ocvrs_return) {
		try {
	...
	void cv_filter2D_const__InputArrayR_const__OutputArrayR_const__InputArrayR(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* kernel, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_filter2D_const__InputArrayR_const__OutputArrayR_const__InputArrayR_const_Filter2DParamsR(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* kernel, const cv::Filter2DParams* params, ResultVoid* ocvrs_return) {
		try {
	...
	void cv_getTextSize_Size_const_StringR_Point_FontFaceR_int(cv::Size* imgsize, const char* text, cv::Point* org, cv::FontFace* fface, int size, Result<cv::Rect>* ocvrs_return) {
		try {
			cv::Rect ret = cv::getTextSize(*imgsize, std::string(text), *org, *fface, size);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_getTextSize_Size_const_StringR_Point_FontFaceR_int_int_PutTextFlags_Range(cv::Size* imgsize, const char* text, cv::Point* org, cv::FontFace* fface, int size, int weight, cv::PutTextFlags flags, cv::Range* wrap, Result<cv::Rect>* ocvrs_return) {
		try {
			cv::Rect ret = cv::getTextSize(*imgsize, std::string(text), *org, *fface, size, weight, flags, *wrap);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_putText_const__InputOutputArrayR_const_StringR_Point_Scalar_FontFaceR_int(const cv::_InputOutputArray* img, const char* text, cv::Point* org, cv::Scalar* color, cv::FontFace* fface, int size, Result<cv::Point>* ocvrs_return) {
		try {
			cv::Point ret = cv::putText(*img, std::string(text), *org, *color, *fface, size);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_putText_const__InputOutputArrayR_const_StringR_Point_Scalar_FontFaceR_int_int_PutTextFlags_Range(const cv::_InputOutputArray* img, const char* text, cv::Point* org, cv::Scalar* color, cv::FontFace* fface, int size, int weight, cv::PutTextFlags flags, cv::Range* wrap, Result<cv::Point>* ocvrs_return) {
		try {
			cv::Point ret = cv::putText(*img, std::string(text), *org, *color, *fface, size, weight, flags, *wrap);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_remap_const__InputArrayR_const__OutputArrayR_const__InputArrayR_const__InputArrayR_int_int_const_ScalarR_AlgorithmHint(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* map1, const cv::_InputArray* map2, int interpolation, int borderMode, const cv::Scalar* borderValue, cv::AlgorithmHint hint, ResultVoid* ocvrs_return) {
		try {
			cv::remap(*src, *dst, *map1, *map2, interpolation, borderMode, *borderValue, hint);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_warpAffine_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Size_int_int_const_ScalarR_AlgorithmHint(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* M, cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue, cv::AlgorithmHint hint, ResultVoid* ocvrs_return) {
		try {
			cv::warpAffine(*src, *dst, *M, *dsize, flags, borderMode, *borderValue, hint);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_warpPerspective_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Size_int_int_const_ScalarR_AlgorithmHint(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* M, cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue, cv::AlgorithmHint hint, ResultVoid* ocvrs_return) {
		try {
			cv::warpPerspective(*src, *dst, *M, *dsize, flags, borderMode, *borderValue, hint);
			Ok(ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_FontFace_FontFace(Result<cv::FontFace*>* ocvrs_return) {
		try {
			cv::FontFace* ret = new cv::FontFace();
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_FontFace_FontFace_const_StringR(const char* fontPathOrName, Result<cv::FontFace*>* ocvrs_return) {
		try {
			cv::FontFace* ret = new cv::FontFace(std::string(fontPathOrName));
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_FontFace_set_const_StringR(cv::FontFace* instance, const char* fontPathOrName, Result<bool>* ocvrs_return) {
		try {
			bool ret = instance->set(std::string(fontPathOrName));
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_FontFace_getName_const(const cv::FontFace* instance, Result<void*>* ocvrs_return) {
		try {
			cv::String ret = instance->getName();
	...
	void cv_FontFace_setInstance_const_vectorLintGR(cv::FontFace* instance, const std::vector<int>* params, Result<bool>* ocvrs_return) {
		try {
			bool ret = instance->setInstance(*params);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_FontFace_getInstance_const_vectorLintGR(const cv::FontFace* instance, std::vector<int>* params, Result<bool>* ocvrs_return) {
		try {
			bool ret = instance->getInstance(*params);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_FontFace_getBuiltinFontData_const_StringR_const_unsigned_charXR_size_tR(const char* fontName, const unsigned char** data, size_t* datasize, Result<bool>* ocvrs_return) {
		try {
			bool ret = cv::FontFace::getBuiltinFontData(std::string(fontName), *data, *datasize);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}

	// cv::FontFace::implicitClone() generated
	// ("cv::FontFace::implicitClone", vec![(pred!(const, [], []), _)]),
	cv::FontFace* cv_FontFace_implicitClone_const(const cv::FontFace* instance) {
			return new cv::FontFace(*instance);
	}

	// cv::FontFace::delete() generated
	// ("cv::FontFace::delete", vec![(pred!(mut, [], []), _)]),
	void cv_FontFace_delete(cv::FontFace* instance) {
			delete instance;
	}
