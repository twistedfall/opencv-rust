extern "C" {
	// std::tuple<cv::GMat, cv::GMat>::new(TraitClass, TraitClass) generated
	// ("std::tuple<cv::GMat, cv::GMat>::new", vec![(pred!(const, ["arg", "arg_1"], ["cv::GMat", "cv::GMat"]), _)]),
	...
	// std::tuple<cv::GMat, cv::GMat>::get_0() generated
	// ("std::tuple<cv::GMat, cv::GMat>::get_0", vec![(pred!(const, [], []), _)]),
	...
	// std::tuple<cv::GMat, cv::GMat>::get_1() generated
	// ("std::tuple<cv::GMat, cv::GMat>::get_1", vec![(pred!(const, [], []), _)]),
	...
	// std::tuple<cv::GMat, cv::GMat>::delete() generated
	// ("std::tuple<cv::GMat, cv::GMat>::delete", vec![(pred!(mut, [], []), _)]),
