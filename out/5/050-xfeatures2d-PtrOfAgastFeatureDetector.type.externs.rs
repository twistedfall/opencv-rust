...
pub fn cv_PtrLcv_xfeatures2d_AgastFeatureDetectorG_getInnerPtr_const(instance: *const c_void) -> *mut c_void;
...
pub fn cv_PtrLcv_xfeatures2d_AgastFeatureDetectorG_getInnerPtrMut(instance: *mut c_void) -> *mut c_void;
...
pub fn cv_PtrLcv_xfeatures2d_AgastFeatureDetectorG_new_null_const() -> *mut c_void;
...
pub fn cv_PtrLcv_xfeatures2d_AgastFeatureDetectorG_delete(instance: *mut c_void);
...
pub fn cv_PtrLcv_xfeatures2d_AgastFeatureDetectorG_to_PtrOfAlgorithm(instance: *mut c_void) -> *mut c_void;
...
pub fn cv_PtrLcv_xfeatures2d_AgastFeatureDetectorG_to_PtrOfFeature2D(instance: *mut c_void) -> *mut c_void;
