...
pub fn cv_PtrLcv_large_kinfu_VolumeParamsG_getInnerPtr_const(instance: *const c_void) -> *mut c_void;
...
pub fn cv_PtrLcv_large_kinfu_VolumeParamsG_getInnerPtrMut(instance: *mut c_void) -> *mut c_void;
// cv::Ptr<cv::large_kinfu::VolumeParams>::new_null() generated
// ("cv::Ptr<cv::large_kinfu::VolumeParams>::new_null", vec![(pred!(const, [], []), _)]),
pub fn cv_PtrLcv_large_kinfu_VolumeParamsG_new_null_const() -> *mut c_void;
// cv::Ptr<cv::large_kinfu::VolumeParams>::delete() generated
// ("cv::Ptr<cv::large_kinfu::VolumeParams>::delete", vec![(pred!(mut, [], []), _)]),
pub fn cv_PtrLcv_large_kinfu_VolumeParamsG_delete(instance: *mut c_void);
...
pub fn cv_PtrLcv_large_kinfu_VolumeParamsG_new_const_VolumeParams(val: *mut c_void) -> *mut c_void;
