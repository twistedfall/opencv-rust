...
pub fn std_vectorLcv_stereo_MatchQuasiDenseG_push_const_MatchQuasiDense(instance: *mut c_void, val: *const crate::xstereo::MatchQuasiDense);
...
pub fn std_vectorLcv_stereo_MatchQuasiDenseG_insert_size_t_const_MatchQuasiDense(instance: *mut c_void, index: size_t, val: *const crate::xstereo::MatchQuasiDense);
...
pub fn std_vectorLcv_stereo_MatchQuasiDenseG_get_const_size_t(instance: *const c_void, index: size_t, ocvrs_return: *mut crate::xstereo::MatchQuasiDense);
...
pub fn std_vectorLcv_stereo_MatchQuasiDenseG_set_size_t_const_MatchQuasiDense(instance: *mut c_void, index: size_t, val: *const crate::xstereo::MatchQuasiDense);
...
pub fn std_vectorLcv_stereo_MatchQuasiDenseG_data_const(instance: *const c_void) -> *const crate::xstereo::MatchQuasiDense;
// std::vector<cv::stereo::MatchQuasiDense>::dataMut() generated
// ("std::vector<cv::stereo::MatchQuasiDense>::dataMut", vec![(pred!(mut, [], []), _)]),
pub fn std_vectorLcv_stereo_MatchQuasiDenseG_dataMut(instance: *mut c_void) -> *mut crate::xstereo::MatchQuasiDense;
...
pub fn cv_fromSlice_const_const_MatchQuasiDenseX_size_t(data: *const crate::xstereo::MatchQuasiDense, len: size_t) -> *mut c_void;
