...
pub fn cv_stereo_MatchQuasiDense_MatchQuasiDense(ocvrs_return: *mut Result<crate::xstereo::MatchQuasiDense>);
...
pub fn cv_stereo_MatchQuasiDense_operatorL_const_const_MatchQuasiDenseR(instance: *const crate::xstereo::MatchQuasiDense, rhs: *const crate::xstereo::MatchQuasiDense, ocvrs_return: *mut Result<bool>);
...
pub fn cv_stereo_QuasiDenseStereo_propParam_const(instance: *const c_void, ocvrs_return: *mut crate::xstereo::PropagationParameters);
...
pub fn cv_stereo_QuasiDenseStereo_propParam_const_PropagationParameters(instance: *mut c_void, val: *const crate::xstereo::PropagationParameters);
