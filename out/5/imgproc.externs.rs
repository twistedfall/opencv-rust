...
pub fn cv_createLineSegmentDetector_LineSegmentDetectorModes_double_double_double_double_double_double_int(refine: crate::imgproc::LineSegmentDetectorModes, scale: f64, sigma_scale: f64, quant: f64, ang_th: f64, log_eps: f64, density_th: f64, n_bins: i32, ocvrs_return: *mut Result<*mut c_void>);
...
pub fn cv_filter2D_const__InputArrayR_const__OutputArrayR_const__InputArrayR(src: *const c_void, dst: *const c_void, kernel: *const c_void, ocvrs_return: *mut Result<()>);
...
pub fn cv_filter2D_const__InputArrayR_const__OutputArrayR_const__InputArrayR_const_Filter2DParamsR(src: *const c_void, dst: *const c_void, kernel: *const c_void, params: *const crate::imgproc::Filter2DParams, ocvrs_return: *mut Result<()>);
...
pub fn cv_getTextSize_Size_const_StringR_Point_FontFaceR_int(imgsize: *const core::Size, text: *const c_char, org: *const core::Point, fface: *mut c_void, size: i32, ocvrs_return: *mut Result<core::Rect>);
...
pub fn cv_getTextSize_Size_const_StringR_Point_FontFaceR_int_int_PutTextFlags_Range(imgsize: *const core::Size, text: *const c_char, org: *const core::Point, fface: *mut c_void, size: i32, weight: i32, flags: crate::imgproc::PutTextFlags, wrap: *mut c_void, ocvrs_return: *mut Result<core::Rect>);
...
pub fn cv_putText_const__InputOutputArrayR_const_StringR_Point_Scalar_FontFaceR_int(img: *const c_void, text: *const c_char, org: *const core::Point, color: *const core::Scalar, fface: *mut c_void, size: i32, ocvrs_return: *mut Result<core::Point>);
...
pub fn cv_putText_const__InputOutputArrayR_const_StringR_Point_Scalar_FontFaceR_int_int_PutTextFlags_Range(img: *const c_void, text: *const c_char, org: *const core::Point, color: *const core::Scalar, fface: *mut c_void, size: i32, weight: i32, flags: crate::imgproc::PutTextFlags, wrap: *mut c_void, ocvrs_return: *mut Result<core::Point>);
...
pub fn cv_remap_const__InputArrayR_const__OutputArrayR_const__InputArrayR_const__InputArrayR_int_int_const_ScalarR_AlgorithmHint(src: *const c_void, dst: *const c_void, map1: *const c_void, map2: *const c_void, interpolation: i32, border_mode: i32, border_value: *const core::Scalar, hint: core::AlgorithmHint, ocvrs_return: *mut Result<()>);
...
pub fn cv_warpAffine_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Size_int_int_const_ScalarR_AlgorithmHint(src: *const c_void, dst: *const c_void, m: *const c_void, dsize: *const core::Size, flags: i32, border_mode: i32, border_value: *const core::Scalar, hint: core::AlgorithmHint, ocvrs_return: *mut Result<()>);
...
pub fn cv_warpPerspective_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Size_int_int_const_ScalarR_AlgorithmHint(src: *const c_void, dst: *const c_void, m: *const c_void, dsize: *const core::Size, flags: i32, border_mode: i32, border_value: *const core::Scalar, hint: core::AlgorithmHint, ocvrs_return: *mut Result<()>);
...
pub fn cv_FontFace_FontFace(ocvrs_return: *mut Result<*mut c_void>);
...
pub fn cv_FontFace_FontFace_const_StringR(font_path_or_name: *const c_char, ocvrs_return: *mut Result<*mut c_void>);
...
pub fn cv_FontFace_set_const_StringR(instance: *mut c_void, font_path_or_name: *const c_char, ocvrs_return: *mut Result<bool>);
...
pub fn cv_FontFace_getName_const(instance: *const c_void, ocvrs_return: *mut Result<*mut c_void>);
...
pub fn cv_FontFace_setInstance_const_vectorLintGR(instance: *mut c_void, params: *const c_void, ocvrs_return: *mut Result<bool>);
...
pub fn cv_FontFace_getInstance_const_vectorLintGR(instance: *const c_void, params: *mut c_void, ocvrs_return: *mut Result<bool>);
...
pub fn cv_FontFace_getBuiltinFontData_const_StringR_const_unsigned_charXR_size_tR(font_name: *const c_char, data: *mut *const u8, datasize: *mut size_t, ocvrs_return: *mut Result<bool>);
// cv::FontFace::implicitClone() generated
// ("cv::FontFace::implicitClone", vec![(pred!(const, [], []), _)]),
pub fn cv_FontFace_implicitClone_const(instance: *const c_void) -> *mut c_void;
// cv::FontFace::delete() generated
// ("cv::FontFace::delete", vec![(pred!(mut, [], []), _)]),
pub fn cv_FontFace_delete(instance: *mut c_void);
