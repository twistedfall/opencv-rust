...
// DescriptorMatcher /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:75
pub trait CUDA_DescriptorMatcherTraitConst: core::AlgorithmTraitConst {
	...
	// isMaskSupported()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:100
	...
	// getTrainDescriptors()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:117
	...
	// empty()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:125
...
pub trait CUDA_DescriptorMatcherTrait: core::AlgorithmTrait + crate::cudafeatures2d::CUDA_DescriptorMatcherTraitConst {
	...
	/// train image.
	// add(const std::vector<GpuMat> &)(CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:113
	...
	// clear()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:121
	...
	// train()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:132
	...
	/// * mask: noArray()
	// match(InputArray, InputArray, std::vector<DMatch> &, InputArray)(InputArray, InputArray, CppPassByVoidPtr, InputArray) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:154
	...
	/// * mask: noArray()
	// cv::cuda::DescriptorMatcher::match(InputArray, InputArray, CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:154
	...
	// match(InputArray, std::vector<DMatch> &, const std::vector<GpuMat> &)(InputArray, CppPassByVoidPtr, CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:160
	...
	#[inline]
	fn match__1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::DMatch>, masks: &core::Vector<core::GpuMat>) -> Result<()> {
		input_array_arg!(query_descriptors);
		return_send!(via ocvrs_return);
	...
	/// This alternative version of [CUDA_DescriptorMatcherTrait::match_] function uses the following default values for its arguments:
	/// * masks: std::vector<GpuMat>()
	// cv::cuda::DescriptorMatcher::match(InputArray, CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:160
	// ("cv::cuda::DescriptorMatcher::match", vec![(pred!(mut, ["queryDescriptors", "matches"], ["const cv::_InputArray*", "std::vector<cv::DMatch>*"]), _)]),
	#[inline]
	fn match__def_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::DMatch>) -> Result<()> {
		input_array_arg!(query_descriptors);
		return_send!(via ocvrs_return);
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// matchAsync(InputArray, InputArray, OutputArray, InputArray, Stream &)(InputArray, InputArray, OutputArray, InputArray, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:181
	...
	#[inline]
	fn match_async(&mut self, query_descriptors: &impl ToInputArray, train_descriptors: &impl ToInputArray, matches: &mut impl ToOutputArray, mask: &impl ToInputArray, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(query_descriptors);
		input_array_arg!(train_descriptors);
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// cv::cuda::DescriptorMatcher::matchAsync(InputArray, InputArray, OutputArray) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:181
	...
	/// * masks: std::vector<GpuMat>()
	/// * stream: Stream::Null()
	// matchAsync(InputArray, OutputArray, const std::vector<GpuMat> &, Stream &)(InputArray, OutputArray, CppPassByVoidPtr, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:188
	...
	#[inline]
	fn match_async_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut impl ToOutputArray, masks: &core::Vector<core::GpuMat>, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(query_descriptors);
		output_array_arg!(matches);
		return_send!(via ocvrs_return);
	...
	/// * masks: std::vector<GpuMat>()
	/// * stream: Stream::Null()
	// cv::cuda::DescriptorMatcher::matchAsync(InputArray, OutputArray) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:188
	...
	// matchConvert(InputArray, std::vector<DMatch> &)(InputArray, CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:201
	// ("cv::cuda::DescriptorMatcher::matchConvert", vec![(pred!(mut, ["gpu_matches", "matches"], ["const cv::_InputArray*", "std::vector<cv::DMatch>*"]), _)]),
	#[inline]
	fn match_convert(&mut self, gpu_matches: &impl ToInputArray, matches: &mut core::Vector<core::DMatch>) -> Result<()> {
	...
	// knnMatch(InputArray, InputArray, std::vector<std::vector<DMatch>> &, int, InputArray, bool)(InputArray, InputArray, CppPassByVoidPtr, Primitive, InputArray, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:226
	...
	/// * mask: noArray()
	/// * compact_result: false
	// cv::cuda::DescriptorMatcher::knnMatch(InputArray, InputArray, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:226
	...
	/// * masks: std::vector<GpuMat>()
	/// * compact_result: false
	// knnMatch(InputArray, std::vector<std::vector<DMatch>> &, int, const std::vector<GpuMat> &, bool)(InputArray, CppPassByVoidPtr, Primitive, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:234
	...
	#[inline]
	fn knn_match_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, k: i32, masks: &core::Vector<core::GpuMat>, compact_result: bool) -> Result<()> {
		input_array_arg!(query_descriptors);
		return_send!(via ocvrs_return);
	...
	/// * masks: std::vector<GpuMat>()
	/// * compact_result: false
	// cv::cuda::DescriptorMatcher::knnMatch(InputArray, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:234
	...
	#[inline]
	fn knn_match_def_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, k: i32) -> Result<()> {
		input_array_arg!(query_descriptors);
		return_send!(via ocvrs_return);
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// knnMatchAsync(InputArray, InputArray, OutputArray, int, InputArray, Stream &)(InputArray, InputArray, OutputArray, Primitive, InputArray, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:257
	...
	#[inline]
	fn knn_match_async(&mut self, query_descriptors: &impl ToInputArray, train_descriptors: &impl ToInputArray, matches: &mut impl ToOutputArray, k: i32, mask: &impl ToInputArray, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(query_descriptors);
		input_array_arg!(train_descriptors);
		output_array_arg!(matches);
		input_array_arg!(mask);
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// cv::cuda::DescriptorMatcher::knnMatchAsync(InputArray, InputArray, OutputArray, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:257
	...
	/// * masks: std::vector<GpuMat>()
	/// * stream: Stream::Null()
	// knnMatchAsync(InputArray, OutputArray, int, const std::vector<GpuMat> &, Stream &)(InputArray, OutputArray, Primitive, CppPassByVoidPtr, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:265
	...
	#[inline]
	fn knn_match_async_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut impl ToOutputArray, k: i32, masks: &core::Vector<core::GpuMat>, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(query_descriptors);
		output_array_arg!(matches);
		return_send!(via ocvrs_return);
	...
	/// * masks: std::vector<GpuMat>()
	/// * stream: Stream::Null()
	// cv::cuda::DescriptorMatcher::knnMatchAsync(InputArray, OutputArray, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:265
	...
	/// ## C++ default parameters
	/// * compact_result: false
	// knnMatchConvert(InputArray, std::vector<std::vector<DMatch>> &, bool)(InputArray, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:282
	...
	#[inline]
	fn knn_match_convert(&mut self, gpu_matches: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, compact_result: bool) -> Result<()> {
		input_array_arg!(gpu_matches);
		return_send!(via ocvrs_return);
	...
	/// * compact_result: false
	// cv::cuda::DescriptorMatcher::knnMatchConvert(InputArray, CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:282
	...
	#[inline]
	fn knn_match_convert_def(&mut self, gpu_matches: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>) -> Result<()> {
		input_array_arg!(gpu_matches);
		return_send!(via ocvrs_return);
	...
	/// * mask: noArray()
	/// * compact_result: false
	// radiusMatch(InputArray, InputArray, std::vector<std::vector<DMatch>> &, float, InputArray, bool)(InputArray, InputArray, CppPassByVoidPtr, Primitive, InputArray, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:309
	...
	#[inline]
	fn radius_match(&mut self, query_descriptors: &impl ToInputArray, train_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, max_distance: f32, mask: &impl ToInputArray, compact_result: bool) -> Result<()> {
		input_array_arg!(query_descriptors);
		input_array_arg!(train_descriptors);
		input_array_arg!(mask);
		return_send!(via ocvrs_return);
	...
	/// * mask: noArray()
	/// * compact_result: false
	// cv::cuda::DescriptorMatcher::radiusMatch(InputArray, InputArray, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:309
	...
	#[inline]
	fn radius_match_def(&mut self, query_descriptors: &impl ToInputArray, train_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, max_distance: f32) -> Result<()> {
		input_array_arg!(query_descriptors);
		input_array_arg!(train_descriptors);
		return_send!(via ocvrs_return);
	...
	/// * masks: std::vector<GpuMat>()
	/// * compact_result: false
	// radiusMatch(InputArray, std::vector<std::vector<DMatch>> &, float, const std::vector<GpuMat> &, bool)(InputArray, CppPassByVoidPtr, Primitive, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:317
	...
	#[inline]
	fn radius_match_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, max_distance: f32, masks: &core::Vector<core::GpuMat>, compact_result: bool) -> Result<()> {
		input_array_arg!(query_descriptors);
		return_send!(via ocvrs_return);
	...
	/// * masks: std::vector<GpuMat>()
	/// * compact_result: false
	// cv::cuda::DescriptorMatcher::radiusMatch(InputArray, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:317
	...
	#[inline]
	fn radius_match_def_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, max_distance: f32) -> Result<()> {
		input_array_arg!(query_descriptors);
		return_send!(via ocvrs_return);
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// radiusMatchAsync(InputArray, InputArray, OutputArray, float, InputArray, Stream &)(InputArray, InputArray, OutputArray, Primitive, InputArray, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:341
	...
	#[inline]
	fn radius_match_async(&mut self, query_descriptors: &impl ToInputArray, train_descriptors: &impl ToInputArray, matches: &mut impl ToOutputArray, max_distance: f32, mask: &impl ToInputArray, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(query_descriptors);
		input_array_arg!(train_descriptors);
		output_array_arg!(matches);
		input_array_arg!(mask);
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// cv::cuda::DescriptorMatcher::radiusMatchAsync(InputArray, InputArray, OutputArray, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:341
	...
	/// * masks: std::vector<GpuMat>()
	/// * stream: Stream::Null()
	// radiusMatchAsync(InputArray, OutputArray, float, const std::vector<GpuMat> &, Stream &)(InputArray, OutputArray, Primitive, CppPassByVoidPtr, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:349
	...
	#[inline]
	fn radius_match_async_1(&mut self, query_descriptors: &impl ToInputArray, matches: &mut impl ToOutputArray, max_distance: f32, masks: &core::Vector<core::GpuMat>, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(query_descriptors);
		output_array_arg!(matches);
		return_send!(via ocvrs_return);
	...
	/// * masks: std::vector<GpuMat>()
	/// * stream: Stream::Null()
	// cv::cuda::DescriptorMatcher::radiusMatchAsync(InputArray, OutputArray, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:349
	...
	/// ## C++ default parameters
	/// * compact_result: false
	// radiusMatchConvert(InputArray, std::vector<std::vector<DMatch>> &, bool)(InputArray, CppPassByVoidPtr, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:366
	...
	#[inline]
	fn radius_match_convert(&mut self, gpu_matches: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>, compact_result: bool) -> Result<()> {
		input_array_arg!(gpu_matches);
		return_send!(via ocvrs_return);
	...
	/// * compact_result: false
	// cv::cuda::DescriptorMatcher::radiusMatchConvert(InputArray, CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:366
	...
	#[inline]
	fn radius_match_convert_def(&mut self, gpu_matches: &impl ToInputArray, matches: &mut core::Vector<core::Vector<core::DMatch>>) -> Result<()> {
		input_array_arg!(gpu_matches);
		return_send!(via ocvrs_return);
...
impl CUDA_DescriptorMatcher {
	...
	// createBFMatcher(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:92
	...
	/// * norm_type: cv::NORM_L2
	// cv::cuda::DescriptorMatcher::createBFMatcher() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:92
...
// FastFeatureDetector /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:426
pub trait CUDA_FastFeatureDetectorTraitConst: crate::cudafeatures2d::CUDA_Feature2DAsyncTraitConst {
	...
	// getMaxNumPoints()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:441
...
pub trait CUDA_FastFeatureDetectorTrait: crate::cudafeatures2d::CUDA_FastFeatureDetectorTraitConst + crate::cudafeatures2d::CUDA_Feature2DAsyncTrait {
	...
	// setThreshold(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:438
	...
	// setMaxNumPoints(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:440
...
impl CUDA_FastFeatureDetector {
	// LOCATION_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:429
	pub const LOCATION_ROW: i32 = 0;
	// RESPONSE_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:430
	pub const RESPONSE_ROW: i32 = 1;
	// ROWS_COUNT /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:431
	pub const ROWS_COUNT: i32 = 2;
	// FEATURE_SIZE /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:432
	...
	/// * max_npoints: 5000
	// create(int, bool, int, int)(Primitive, Primitive, Primitive, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:434
	...
	/// * typ: cv::FastFeatureDetector::TYPE_9_16
	/// * max_npoints: 5000
	// cv::cuda::FastFeatureDetector::create() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:434
...
// Feature2DAsync /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:377
...
pub trait CUDA_Feature2DAsyncTrait: crate::cudafeatures2d::CUDA_Feature2DAsyncTraitConst + crate::features2d::Feature2DTrait {
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// detectAsync(InputArray, OutputArray, InputArray, Stream &)(InputArray, OutputArray, InputArray, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:390
	...
	#[inline]
	fn detect_async(&mut self, image: &impl ToInputArray, keypoints: &mut impl ToOutputArray, mask: &impl ToInputArray, stream: &mut impl core::StreamTrait) -> Result<()> {
	...
	/// * mask: noArray()
	/// * stream: Stream::Null()
	// cv::cuda::Feature2DAsync::detectAsync(InputArray, OutputArray) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:390
	...
	/// ## C++ default parameters
	/// * stream: Stream::Null()
	// computeAsync(InputArray, OutputArray, OutputArray, Stream &)(InputArray, OutputArray, OutputArray, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:402
	...
	#[inline]
	fn compute_async(&mut self, image: &impl ToInputArray, keypoints: &mut impl ToOutputArray, descriptors: &mut impl ToOutputArray, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(image);
		output_array_arg!(keypoints);
	...
	/// * stream: Stream::Null()
	// cv::cuda::Feature2DAsync::computeAsync(InputArray, OutputArray, OutputArray) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:402
	...
	/// * stream: Stream::Null()
	// detectAndComputeAsync(InputArray, InputArray, OutputArray, OutputArray, bool, Stream &)(InputArray, InputArray, OutputArray, OutputArray, Primitive, TraitClass) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:408
	...
	#[inline]
	fn detect_and_compute_async(&mut self, image: &impl ToInputArray, mask: &impl ToInputArray, keypoints: &mut impl ToOutputArray, descriptors: &mut impl ToOutputArray, use_provided_keypoints: bool, stream: &mut impl core::StreamTrait) -> Result<()> {
		input_array_arg!(image);
		input_array_arg!(mask);
		output_array_arg!(keypoints);
		output_array_arg!(descriptors);
	...
	/// * use_provided_keypoints: false
	/// * stream: Stream::Null()
	// cv::cuda::Feature2DAsync::detectAndComputeAsync(InputArray, InputArray, OutputArray, OutputArray) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:408
	...
	// convert(InputArray, std::vector<KeyPoint> &)(InputArray, CppPassByVoidPtr) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:416
...
// ORB /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:452
pub trait CUDA_ORBTraitConst: crate::cudafeatures2d::CUDA_Feature2DAsyncTraitConst {
	fn as_raw_CUDA_ORB(&self) -> *const c_void;

	// getMaxFeatures()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:475
	...
	// getScaleFactor()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:478
	...
	// getNLevels()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:481
	...
	// getEdgeThreshold()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:484
	...
	// getFirstLevel()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:487
	...
	// getWTA_K()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:490
	...
	// getScoreType()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:493
	...
	// getPatchSize()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:496
	...
	// getFastThreshold()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:499
	...
	// getBlurForDescriptor()() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:503
...
pub trait CUDA_ORBTrait: crate::cudafeatures2d::CUDA_Feature2DAsyncTrait + crate::cudafeatures2d::CUDA_ORBTraitConst {
	...
	// setMaxFeatures(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:474
	...
	// setScaleFactor(double)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:477
	...
	// setNLevels(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:480
	...
	// setEdgeThreshold(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:483
	...
	// setFirstLevel(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:486
	...
	// setWTA_K(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:489
	...
	// setScoreType(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:492
	...
	// setPatchSize(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:495
	...
	// setFastThreshold(int)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:498
	...
	// setBlurForDescriptor(bool)(Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:502
...
impl CUDA_ORB {
	// X_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:455
	pub const X_ROW: i32 = 0;
	// Y_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:456
	pub const Y_ROW: i32 = 1;
	// RESPONSE_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:457
	pub const RESPONSE_ROW: i32 = 2;
	// ANGLE_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:458
	pub const ANGLE_ROW: i32 = 3;
	// OCTAVE_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:459
	pub const OCTAVE_ROW: i32 = 4;
	// SIZE_ROW /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:460
	pub const SIZE_ROW: i32 = 5;
	// ROWS_COUNT /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:461
	...
	// create(int, float, int, int, int, int, int, int, int, bool)(Primitive, Primitive, Primitive, Primitive, Primitive, Primitive, Primitive, Primitive, Primitive, Primitive) /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:463
	...
	/// * fast_threshold: 20
	/// * blur_for_descriptor: false
	// cv::cuda::ORB::create() /home/pro/projects/opencv-lib/opencv-4/install/include/opencv4/opencv2/cudafeatures2d.hpp:463
