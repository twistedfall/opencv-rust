...
extern "C" {
	...
	void cv_cudacodec_createNVSurfaceToColorConverter_const_ColorSpaceStandard(const cv::cudacodec::ColorSpaceStandard colorSpace, Result<cv::Ptr<cv::cudacodec::NVSurfaceToColorConverter>*>* ocvrs_return) {
		try {
			cv::Ptr<cv::cudacodec::NVSurfaceToColorConverter> ret = cv::cudacodec::createNVSurfaceToColorConverter(colorSpace);
			Ok(new cv::Ptr<cv::cudacodec::NVSurfaceToColorConverter>(ret), ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_cudacodec_createNVSurfaceToColorConverter_const_ColorSpaceStandard_const_bool(const cv::cudacodec::ColorSpaceStandard colorSpace, const bool videoFullRangeFlag, Result<cv::Ptr<cv::cudacodec::NVSurfaceToColorConverter>*>* ocvrs_return) {
		try {
			cv::Ptr<cv::cudacodec::NVSurfaceToColorConverter> ret = cv::cudacodec::createNVSurfaceToColorConverter(colorSpace, videoFullRangeFlag);
			Ok(new cv::Ptr<cv::cudacodec::NVSurfaceToColorConverter>(ret), ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_cudacodec_NVSurfaceToColorConverter_convert_const__InputArrayR_const__OutputArrayR_const_SurfaceFormat_const_ColorFormat_const_BitDepth_const_bool_const_bool_StreamR(cv::cudacodec::NVSurfaceToColorConverter* instance, const cv::_InputArray* yuv, const cv::_OutputArray* color, const cv::cudacodec::SurfaceFormat surfaceFormat, const cv::cudacodec::ColorFormat outputFormat, const cv::cudacodec::BitDepth bitDepth, const bool planar, const bool videoFullRangeFlag, cv::cuda::Stream* stream, Result<bool>* ocvrs_return) {
		try {
			bool ret = instance->convert(*yuv, *color, surfaceFormat, outputFormat, bitDepth, planar, videoFullRangeFlag, *stream);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_cudacodec_NVSurfaceToColorConverter_convert_const__InputArrayR_const__OutputArrayR_const_SurfaceFormat_const_ColorFormat(cv::cudacodec::NVSurfaceToColorConverter* instance, const cv::_InputArray* yuv, const cv::_OutputArray* color, const cv::cudacodec::SurfaceFormat surfaceFormat, const cv::cudacodec::ColorFormat outputFormat, Result<bool>* ocvrs_return) {
		try {
			bool ret = instance->convert(*yuv, *color, surfaceFormat, outputFormat);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_cudacodec_NVSurfaceToColorConverter_delete(cv::cudacodec::NVSurfaceToColorConverter* instance) {
			delete instance;
	}
	...
	void cv_cudacodec_VideoReader_set_const_ColorFormat_const_BitDepth_const_bool(cv::cudacodec::VideoReader* instance, const cv::cudacodec::ColorFormat colorFormat, const cv::cudacodec::BitDepth bitDepth, const bool planar, Result<bool>* ocvrs_return) {
		try {
			bool ret = instance->set(colorFormat, bitDepth, planar);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
