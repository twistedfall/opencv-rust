...
pub static ELEMENT_EXPORT_TWEAK: Lazy<HashMap<&str, fn(&mut ExportConfig)>> = Lazy::new(|| {
	hashmap! {
		...
		"cv::bioinspired::RetinaParameters" => ExportConfig::make_boxed as _,
		...
		"cv::detail::CheckContext" => ExportConfig::make_boxed as _,
		...
		"cvv::impl::CallMetaData" => ExportConfig::make_boxed as _,
		...
		"cv::GTypeInfo" => ExportConfig::make_boxed as _,
