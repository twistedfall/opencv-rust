...
pub static FUNC_RENAME: Lazy<HashMap<&str, &str>> = Lazy::new(|| hashmap! {
	...
	"cv_operatorA_const_MatExprX_const_MatExprX" => "+_matexpr_matexpr",
	"cv_operatorA_const_MatExprX_const_MatX" => "+_matexpr_mat",
	"cv_operatorA_const_MatExprX_const_ScalarX" => "+_matexpr_scalar",
	"cv_operatorA_const_MatX_const_MatExprX" => "+_mat_matexpr",
	"cv_operatorA_const_MatX_const_MatX" => "+_mat_mat",
	"cv_operatorA_const_MatX_const_ScalarX" => "+_mat_scalar",
	"cv_operatorA_const_ScalarX_const_MatExprX" => "+_scalar_matexpr",
	"cv_operatorA_const_ScalarX_const_MatX" => "+_scalar_mat",
	"cv_operatorD_const_MatExprX_const_MatExprX" => "+_matexpr_matexpr",
	"cv_operatorD_const_MatExprX_const_MatX" => "+_matexpr_mat",
	"cv_operatorD_const_MatExprX_double" => "+_matexpr_f64",
	"cv_operatorD_const_MatX_const_MatExprX" => "+_mat_matexpr",
	"cv_operatorD_const_MatX_const_MatX" => "+_mat_mat",
	"cv_operatorD_const_MatX_double" => "+_mat_f64",
	"cv_operatorD_double_const_MatExprX" => "+_f64_matexpr",
	"cv_operatorD_double_const_MatX" => "+_f64_mat",
	"cv_operatorS_const_MatExprX" => "+_matexpr",
	"cv_operatorS_const_MatExprX_const_MatExprX" => "+_matexpr_matexpr",
	"cv_operatorS_const_MatExprX_const_MatX" => "+_matexpr_mat",
	"cv_operatorS_const_MatExprX_const_ScalarX" => "+_matexpr_scalar",
	"cv_operatorS_const_MatX" => "+_mat",
	"cv_operatorS_const_MatX_const_MatExprX" => "+_mat_matexpr",
	"cv_operatorS_const_MatX_const_MatX" => "+_mat_mat",
	"cv_operatorS_const_MatX_const_ScalarX" => "+_mat_scalar",
	"cv_operatorS_const_ScalarX_const_MatExprX" => "+_scalar_matexpr",
	"cv_operatorS_const_ScalarX_const_MatX" => "+_scalar_mat",
	"cv_operatorX_const_MatExprX_const_MatExprX" => "+_matexpr_matexpr",
	"cv_operatorX_const_MatExprX_const_MatX" => "+_matexpr_mat",
	"cv_operatorX_const_MatExprX_double" => "+_matexpr_f64",
	"cv_operatorX_const_MatX_const_MatExprX" => "+_mat_matexpr",
	"cv_operatorX_const_MatX_const_MatX" => "+_mat_mat",
	...
	"cv_read_const_FileNodeX_doubleR_double" => "+_f64",
	"cv_read_const_FileNodeX_floatR_float" => "+_f32",
	"cv_read_const_FileNodeX_intR_int" => "+_i32",
	...
	"cv_dnn_Dict_set_double_const_StringX_const_doubleR" => "+_f64",
	"cv_dnn_Dict_set_int64_t_const_StringX_const_int64_tR" => "+_i64",
	...
	"cv_dnn_Net_getMemoryConsumption_const_int_const_vector_MatShape_X_size_tR_size_tR" => "+_for_layer",
...
pub static FUNC_CFG_ATTR: Lazy<HashMap<&str, (&str, &str)>> = Lazy::new(|| hashmap! {
	...
	"cv_getImpl_vector_int_X_vector_String_X" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"), // missing in windows dll
	...
	// ### surface_matching ###
	"cv_ppf_match_3d_PPF3DDetector_read_const_FileNodeX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"), // missing in windows dll
	"cv_ppf_match_3d_PPF3DDetector_write_const_FileStorageX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"), // missing in windows dll
	...
	"cv_CvHaarEvaluator_FeatureHaar_eval_const_const_MatX_Rect_floatX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"),
	...
	"cv_CvHaarEvaluator_writeFeature_const_FileStorageX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"),
	"cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_TrackerAdaBoostingTargetState_const_Point2fX_int_int_bool_const_MatX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"),
	...
	"cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_setTargetResponses_const_MatX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"),
	"cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_TrackerMILTargetState_const_Point2fX_int_int_bool_const_MatX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"),
	...
	"cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_setFeatures_const_MatX" => ("not(target_os = \"windows\")", "!defined(OCVRS_TARGET_OS_WINDOWS)"),
