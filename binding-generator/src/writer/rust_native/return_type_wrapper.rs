...
use crate::{CompiledInterpolation, ReturnTypeWrapper, StrExt, StringExt};
...
impl RustNativeGeneratedElement for ReturnTypeWrapper<'_, '_> {
	...
	fn gen_cpp(&self) -> String {
		...
		static CPP_TPL: Lazy<CompiledInterpolation> =
			Lazy::new(|| include_str!("tpl/return_type_wrapper/cpp.tpl.cpp").compile_interpolation());
