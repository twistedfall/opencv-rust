...
impl core::ToInputArray for {{rust_local}} {
	...
	fn input_array(&self) -> Result<core::_InputArray> {
		extern "C" { fn cv_{{rust_local}}_input_array(instance: {{rust_extern_const}}) -> sys::Result<*mut c_void>; }
...
impl core::ToOutputArray for {{rust_local}} {
	...
	fn output_array(&mut self) -> Result<core::_OutputArray> {
		extern "C" { fn cv_{{rust_local}}_output_array(instance: {{rust_extern_mut}}) -> sys::Result<*mut c_void>; }
...
impl core::ToInputOutputArray for {{rust_local}} {
	...
	fn input_output_array(&mut self) -> Result<core::_InputOutputArray> {
		extern "C" { fn cv_{{rust_local}}_input_output_array(instance: {{rust_extern_mut}}) -> sys::Result<*mut c_void>; }
