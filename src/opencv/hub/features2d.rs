...
impl dyn AKAZE + '_ {
	...
	pub fn create(descriptor_type: crate::features2d::AKAZE_DescriptorType, descriptor_size: i32, descriptor_channels: i32, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: crate::features2d::KAZE_DiffusivityType) -> Result<core::Ptr::<dyn crate::features2d::AKAZE>> {
		unsafe { sys::cv_AKAZE_create_DescriptorType_int_int_float_int_int_DiffusivityType(descriptor_type, descriptor_size, descriptor_channels, threshold, n_octaves, n_octave_layers, diffusivity) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::features2d::AKAZE>::from_raw(ptr) })
	}
...
impl dyn AgastFeatureDetector + '_ {
	...
	pub fn create(threshold: i32, nonmax_suppression: bool, typ: crate::features2d::AgastFeatureDetector_DetectorType) -> Result<core::Ptr::<dyn crate::features2d::AgastFeatureDetector>> {
		unsafe { sys::cv_AgastFeatureDetector_create_int_bool_DetectorType(threshold, nonmax_suppression, typ) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::features2d::AgastFeatureDetector>::from_raw(ptr) })
	}
...
impl dyn DescriptorMatcher + '_ {
	...
	pub fn create_with_matcher_type(matcher_type: crate::features2d::DescriptorMatcher_MatcherType) -> Result<core::Ptr::<dyn crate::features2d::DescriptorMatcher>> {
		unsafe { sys::cv_DescriptorMatcher_create_const_MatcherTypeX(&matcher_type) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::features2d::DescriptorMatcher>::from_raw(ptr) })
	}
...
impl dyn FastFeatureDetector + '_ {
	...
	pub fn create(threshold: i32, nonmax_suppression: bool, typ: crate::features2d::FastFeatureDetector_DetectorType) -> Result<core::Ptr::<dyn crate::features2d::FastFeatureDetector>> {
		unsafe { sys::cv_FastFeatureDetector_create_int_bool_DetectorType(threshold, nonmax_suppression, typ) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::features2d::FastFeatureDetector>::from_raw(ptr) })
	}
...
impl dyn KAZE + '_ {
	...
	pub fn create(extended: bool, upright: bool, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: crate::features2d::KAZE_DiffusivityType) -> Result<core::Ptr::<dyn crate::features2d::KAZE>> {
		unsafe { sys::cv_KAZE_create_bool_bool_float_int_int_DiffusivityType(extended, upright, threshold, n_octaves, n_octave_layers, diffusivity) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::features2d::KAZE>::from_raw(ptr) })
	}
...
impl dyn ORB + '_ {
	...
	pub fn create(nfeatures: i32, scale_factor: f32, nlevels: i32, edge_threshold: i32, first_level: i32, wta_k: i32, score_type: crate::features2d::ORB_ScoreType, patch_size: i32, fast_threshold: i32) -> Result<core::Ptr::<dyn crate::features2d::ORB>> {
		unsafe { sys::cv_ORB_create_int_float_int_int_int_int_ScoreType_int_int(nfeatures, scale_factor, nlevels, edge_threshold, first_level, wta_k, score_type, patch_size, fast_threshold) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::features2d::ORB>::from_raw(ptr) })
	}
