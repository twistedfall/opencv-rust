...
pub trait ClassificationModelTrait: crate::dnn::ModelTrait {
	...
	fn classify(&mut self, frame: &dyn core::ToInputArray, class_id: &mut i32, conf: &mut f32) -> Result<()> {
		...
		unsafe { sys::cv_dnn_ClassificationModel_classify_const__InputArrayX_intX_floatX(self.as_raw_ClassificationModel(), frame.as_raw__InputArray(), class_id, conf) }.into_result()
	}
...
impl Drop for ClassificationModel {
	fn drop(&mut self) {
		...
		unsafe { cv_ClassificationModel_delete(self.as_raw_ClassificationModel()) };
	}
}

impl ClassificationModel {
	pub fn as_raw_ClassificationModel(&self) -> *mut c_void { self.ptr }
...
impl crate::dnn::ClassificationModelTrait for ClassificationModel {
	fn as_raw_ClassificationModel(&self) -> *mut c_void { self.ptr }
}

impl crate::dnn::ModelTrait for ClassificationModel {
	fn as_raw_Model(&self) -> *mut c_void { self.ptr }
}
...
impl ClassificationModel {
	...
	pub fn new(model: &str, config: &str) -> Result<crate::dnn::ClassificationModel> {
		string_arg!(model);
		string_arg!(config);
		unsafe { sys::cv_dnn_ClassificationModel_ClassificationModel_const_StringX_const_StringX(model.as_ptr(), config.as_ptr()) }.into_result().map(|ptr| crate::dnn::ClassificationModel { ptr })
	}
	...
	pub fn new_1(network: &crate::dnn::Net) -> Result<crate::dnn::ClassificationModel> {
		unsafe { sys::cv_dnn_ClassificationModel_ClassificationModel_const_NetX(network.as_raw_Net()) }.into_result().map(|ptr| crate::dnn::ClassificationModel { ptr })
	}
...
pub trait DetectionModelTrait: crate::dnn::ModelTrait {
	...
	/// * conf_threshold: 0.5f
	/// * nms_threshold: 0.0f
	fn detect(&mut self, frame: &dyn core::ToInputArray, class_ids: &mut types::VectorOfi32, confidences: &mut types::VectorOff32, boxes: &mut types::VectorOfRect, conf_threshold: f32, nms_threshold: f32) -> Result<()> {
		input_array_arg!(frame);
		unsafe { sys::cv_dnn_DetectionModel_detect_const__InputArrayX_vector_int_X_vector_float_X_vector_Rect_X_float_float(self.as_raw_DetectionModel(), frame.as_raw__InputArray(), class_ids.as_raw_VectorOfi32(), confidences.as_raw_VectorOff32(), boxes.as_raw_VectorOfRect(), conf_threshold, nms_threshold) }.into_result()
	}
...
impl Drop for DetectionModel {
	fn drop(&mut self) {
		...
		unsafe { cv_DetectionModel_delete(self.as_raw_DetectionModel()) };
	}
}

impl DetectionModel {
	pub fn as_raw_DetectionModel(&self) -> *mut c_void { self.ptr }
...
impl crate::dnn::DetectionModelTrait for DetectionModel {
	fn as_raw_DetectionModel(&self) -> *mut c_void { self.ptr }
}
...
impl DetectionModel {
	...
	pub fn new(model: &str, config: &str) -> Result<crate::dnn::DetectionModel> {
		string_arg!(model);
		string_arg!(config);
		unsafe { sys::cv_dnn_DetectionModel_DetectionModel_const_StringX_const_StringX(model.as_ptr(), config.as_ptr()) }.into_result().map(|ptr| crate::dnn::DetectionModel { ptr })
	}
	...
	pub fn new_1(network: &crate::dnn::Net) -> Result<crate::dnn::DetectionModel> {
		unsafe { sys::cv_dnn_DetectionModel_DetectionModel_const_NetX(network.as_raw_Net()) }.into_result().map(|ptr| crate::dnn::DetectionModel { ptr })
	}
...
pub trait KeypointsModelTrait: crate::dnn::ModelTrait {
	...
	/// ## C++ default parameters
	/// * thresh: 0.5
	fn estimate(&mut self, frame: &dyn core::ToInputArray, thresh: f32) -> Result<types::VectorOfPoint2f> {
		input_array_arg!(frame);
		unsafe { sys::cv_dnn_KeypointsModel_estimate_const__InputArrayX_float(self.as_raw_KeypointsModel(), frame.as_raw__InputArray(), thresh) }.into_result().map(|ptr| types::VectorOfPoint2f { ptr })
	}
...
impl Drop for KeypointsModel {
	fn drop(&mut self) {
		...
		unsafe { cv_KeypointsModel_delete(self.as_raw_KeypointsModel()) };
	}
}

impl KeypointsModel {
	pub fn as_raw_KeypointsModel(&self) -> *mut c_void { self.ptr }
...
impl crate::dnn::KeypointsModelTrait for KeypointsModel {
	fn as_raw_KeypointsModel(&self) -> *mut c_void { self.ptr }
}
...
impl KeypointsModel {
	...
	pub fn new(model: &str, config: &str) -> Result<crate::dnn::KeypointsModel> {
		string_arg!(model);
		string_arg!(config);
		unsafe { sys::cv_dnn_KeypointsModel_KeypointsModel_const_StringX_const_StringX(model.as_ptr(), config.as_ptr()) }.into_result().map(|ptr| crate::dnn::KeypointsModel { ptr })
	}
	...
	pub fn new_1(network: &crate::dnn::Net) -> Result<crate::dnn::KeypointsModel> {
		unsafe { sys::cv_dnn_KeypointsModel_KeypointsModel_const_NetX(network.as_raw_Net()) }.into_result().map(|ptr| crate::dnn::KeypointsModel { ptr })
	}
...
pub trait LayerTrait: core::AlgorithmTrait {
	...
	fn init_vk_com(&mut self, inputs: &types::VectorOfPtrOfBackendWrapper) -> Result<types::PtrOfBackendNode> {
		unsafe { sys::cv_dnn_Layer_initVkCom_const_vector_Ptr_BackendWrapper__X(self.as_raw_Layer(), inputs.as_raw_VectorOfPtrOfBackendWrapper()) }.into_result().map(|ptr| types::PtrOfBackendNode { ptr })
	}
	...
	fn init_cuda(&mut self, context: *mut c_void, inputs: &types::VectorOfPtrOfBackendWrapper, outputs: &types::VectorOfPtrOfBackendWrapper) -> Result<types::PtrOfBackendNode> {
		unsafe { sys::cv_dnn_Layer_initCUDA_voidX_const_vector_Ptr_BackendWrapper__X_const_vector_Ptr_BackendWrapper__X(self.as_raw_Layer(), context, inputs.as_raw_VectorOfPtrOfBackendWrapper(), outputs.as_raw_VectorOfPtrOfBackendWrapper()) }.into_result().map(|ptr| types::PtrOfBackendNode { ptr })
	}
...
pub trait ModelTrait: crate::dnn::NetTrait {
	...
	fn set_input_size(&mut self, size: core::Size) -> Result<crate::dnn::Model> {
		unsafe { sys::cv_dnn_Model_setInputSize_const_SizeX(self.as_raw_Model(), &size) }.into_result().map(|ptr| crate::dnn::Model { ptr })
	}
	...
	fn set_input_mean(&mut self, mean: core::Scalar) -> Result<crate::dnn::Model> {
		unsafe { sys::cv_dnn_Model_setInputMean_const_ScalarX(self.as_raw_Model(), &mean) }.into_result().map(|ptr| crate::dnn::Model { ptr })
	}
	...
	fn set_input_params(&mut self, scale: f64, size: core::Size, mean: core::Scalar, swap_rb: bool, crop: bool) -> Result<()> {
		unsafe { sys::cv_dnn_Model_setInputParams_double_const_SizeX_const_ScalarX_bool_bool(self.as_raw_Model(), scale, &size, &mean, swap_rb, crop) }.into_result()
	}
	...
	fn predict(&mut self, frame: &dyn core::ToInputArray, outs: &mut dyn core::ToOutputArray) -> Result<()> {
		...
		unsafe { sys::cv_dnn_Model_predict_const__InputArrayX_const__OutputArrayX(self.as_raw_Model(), frame.as_raw__InputArray(), outs.as_raw__OutputArray()) }.into_result()
	}
...
impl Drop for Model {
	fn drop(&mut self) {
		...
		unsafe { cv_Model_delete(self.as_raw_Model()) };
	}
}

impl Model {
	pub fn as_raw_Model(&self) -> *mut c_void { self.ptr }
...
impl Model {
	...
	pub fn new(model: &str, config: &str) -> Result<crate::dnn::Model> {
		string_arg!(model);
		string_arg!(config);
		unsafe { sys::cv_dnn_Model_Model_const_StringX_const_StringX(model.as_ptr(), config.as_ptr()) }.into_result().map(|ptr| crate::dnn::Model { ptr })
	}
	...
	pub fn new_1(network: &crate::dnn::Net) -> Result<crate::dnn::Model> {
		unsafe { sys::cv_dnn_Model_Model_const_NetX(network.as_raw_Net()) }.into_result().map(|ptr| crate::dnn::Model { ptr })
	}
...
pub trait SegmentationModelTrait: crate::dnn::ModelTrait {
	...
	fn segment(&mut self, frame: &dyn core::ToInputArray, mask: &mut dyn core::ToOutputArray) -> Result<()> {
		...
		unsafe { sys::cv_dnn_SegmentationModel_segment_const__InputArrayX_const__OutputArrayX(self.as_raw_SegmentationModel(), frame.as_raw__InputArray(), mask.as_raw__OutputArray()) }.into_result()
	}
...
impl Drop for SegmentationModel {
	fn drop(&mut self) {
		...
		unsafe { cv_SegmentationModel_delete(self.as_raw_SegmentationModel()) };
	}
}

impl SegmentationModel {
	pub fn as_raw_SegmentationModel(&self) -> *mut c_void { self.ptr }
...
impl crate::dnn::SegmentationModelTrait for SegmentationModel {
	fn as_raw_SegmentationModel(&self) -> *mut c_void { self.ptr }
}
...
impl SegmentationModel {
	...
	pub fn new(model: &str, config: &str) -> Result<crate::dnn::SegmentationModel> {
		string_arg!(model);
		string_arg!(config);
		unsafe { sys::cv_dnn_SegmentationModel_SegmentationModel_const_StringX_const_StringX(model.as_ptr(), config.as_ptr()) }.into_result().map(|ptr| crate::dnn::SegmentationModel { ptr })
	}
	...
	pub fn new_1(network: &crate::dnn::Net) -> Result<crate::dnn::SegmentationModel> {
		unsafe { sys::cv_dnn_SegmentationModel_SegmentationModel_const_NetX(network.as_raw_Net()) }.into_result().map(|ptr| crate::dnn::SegmentationModel { ptr })
	}
