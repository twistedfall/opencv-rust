...
pub fn compute_image_features2(features_finder: &core::Ptr::<crate::features2d::Feature2D>, image: &dyn core::ToInputArray, features: &mut crate::stitching::Detail_ImageFeatures, mask: &dyn core::ToInputArray) -> Result<()> {
	...
	unsafe { sys::cv_detail_computeImageFeatures_const_Ptr_Feature2D_X_const__InputArrayX_ImageFeaturesX_const__InputArrayX(features_finder.as_raw_PtrOfFeature2D(), image.as_raw__InputArray(), features.as_raw_mut_Detail_ImageFeatures(), mask.as_raw__InputArray()) }.into_result()
}
...
pub fn compute_image_features(features_finder: &core::Ptr::<crate::features2d::Feature2D>, images: &dyn core::ToInputArray, features: &mut core::Vector::<crate::stitching::Detail_ImageFeatures>, masks: &dyn core::ToInputArray) -> Result<()> {
	...
	unsafe { sys::cv_detail_computeImageFeatures_const_Ptr_Feature2D_X_const__InputArrayX_vector_ImageFeatures_X_const__InputArrayX(features_finder.as_raw_PtrOfFeature2D(), images.as_raw__InputArray(), features.as_raw_mut_VectorOfDetail_ImageFeatures(), masks.as_raw__InputArray()) }.into_result()
}

pub fn create_laplace_pyr_gpu(img: &dyn core::ToInputArray, num_levels: i32, pyr: &mut core::Vector::<core::UMat>) -> Result<()> {
	input_array_arg!(img);
	unsafe { sys::cv_detail_createLaplacePyrGpu_const__InputArrayX_int_vector_UMat_X(img.as_raw__InputArray(), num_levels, pyr.as_raw_mut_VectorOfUMat()) }.into_result()
}

pub fn create_laplace_pyr(img: &dyn core::ToInputArray, num_levels: i32, pyr: &mut core::Vector::<core::UMat>) -> Result<()> {
	input_array_arg!(img);
	unsafe { sys::cv_detail_createLaplacePyr_const__InputArrayX_int_vector_UMat_X(img.as_raw__InputArray(), num_levels, pyr.as_raw_mut_VectorOfUMat()) }.into_result()
}
...
pub fn restore_image_from_laplace_pyr_gpu(pyr: &mut core::Vector::<core::UMat>) -> Result<()> {
	unsafe { sys::cv_detail_restoreImageFromLaplacePyrGpu_vector_UMat_X(pyr.as_raw_mut_VectorOfUMat()) }.into_result()
}

pub fn restore_image_from_laplace_pyr(pyr: &mut core::Vector::<core::UMat>) -> Result<()> {
	unsafe { sys::cv_detail_restoreImageFromLaplacePyr_vector_UMat_X(pyr.as_raw_mut_VectorOfUMat()) }.into_result()
}
...
pub fn select_random_subset(count: i32, size: i32, subset: &mut core::Vector::<i32>) -> Result<()> {
	unsafe { sys::cv_detail_selectRandomSubset_int_int_vector_int_X(count, size, subset.as_raw_mut_VectorOfi32()) }.into_result()
}
...
pub trait AffineWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_AffineWarper_create_const_float(self.as_raw_AffineWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl AffineWarper {
	pub fn as_raw_AffineWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_AffineWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for AffineWarper {}

impl crate::stitching::AffineWarperTrait for AffineWarper {
	fn as_raw_AffineWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_AffineWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::WarperCreator for AffineWarper {
	fn as_raw_WarperCreator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_WarperCreator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait CompressedRectilinearPortraitWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_CompressedRectilinearPortraitWarper_create_const_float(self.as_raw_CompressedRectilinearPortraitWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
boxed_ptr! { CompressedRectilinearPortraitWarper }
...
impl CompressedRectilinearPortraitWarper {
	pub fn as_raw_CompressedRectilinearPortraitWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_CompressedRectilinearPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::CompressedRectilinearPortraitWarperTrait for CompressedRectilinearPortraitWarper {
	fn as_raw_CompressedRectilinearPortraitWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_CompressedRectilinearPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl CompressedRectilinearPortraitWarper {
	...
	pub fn new(a: f32, b: f32) -> Result<crate::stitching::CompressedRectilinearPortraitWarper> {
		unsafe { sys::cv_CompressedRectilinearPortraitWarper_CompressedRectilinearPortraitWarper_float_float(a, b) }.into_result().map(|ptr| unsafe { crate::stitching::CompressedRectilinearPortraitWarper::from_raw(ptr) })
	}
...
pub trait CompressedRectilinearWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_CompressedRectilinearWarper_create_const_float(self.as_raw_CompressedRectilinearWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
boxed_ptr! { CompressedRectilinearWarper }
...
impl CompressedRectilinearWarper {
	pub fn as_raw_CompressedRectilinearWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_CompressedRectilinearWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::CompressedRectilinearWarperTrait for CompressedRectilinearWarper {
	fn as_raw_CompressedRectilinearWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_CompressedRectilinearWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl CompressedRectilinearWarper {
	...
	pub fn new(a: f32, b: f32) -> Result<crate::stitching::CompressedRectilinearWarper> {
		unsafe { sys::cv_CompressedRectilinearWarper_CompressedRectilinearWarper_float_float(a, b) }.into_result().map(|ptr| unsafe { crate::stitching::CompressedRectilinearWarper::from_raw(ptr) })
	}
...
pub trait CylindricalWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_CylindricalWarper_create_const_float(self.as_raw_CylindricalWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl CylindricalWarper {
	pub fn as_raw_CylindricalWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_CylindricalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for CylindricalWarper {}

impl crate::stitching::CylindricalWarperTrait for CylindricalWarper {
	fn as_raw_CylindricalWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_CylindricalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait FisheyeWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_FisheyeWarper_create_const_float(self.as_raw_FisheyeWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl FisheyeWarper {
	pub fn as_raw_FisheyeWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_FisheyeWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for FisheyeWarper {}

impl crate::stitching::FisheyeWarperTrait for FisheyeWarper {
	fn as_raw_FisheyeWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_FisheyeWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait MercatorWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_MercatorWarper_create_const_float(self.as_raw_MercatorWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl MercatorWarper {
	pub fn as_raw_MercatorWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_MercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for MercatorWarper {}

impl crate::stitching::MercatorWarperTrait for MercatorWarper {
	fn as_raw_MercatorWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_MercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait PaniniPortraitWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_PaniniPortraitWarper_create_const_float(self.as_raw_PaniniPortraitWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
boxed_ptr! { PaniniPortraitWarper }
...
impl PaniniPortraitWarper {
	pub fn as_raw_PaniniPortraitWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_PaniniPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for PaniniPortraitWarper {}

impl crate::stitching::PaniniPortraitWarperTrait for PaniniPortraitWarper {
	fn as_raw_PaniniPortraitWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_PaniniPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl PaniniPortraitWarper {
	...
	pub fn new(a: f32, b: f32) -> Result<crate::stitching::PaniniPortraitWarper> {
		unsafe { sys::cv_PaniniPortraitWarper_PaniniPortraitWarper_float_float(a, b) }.into_result().map(|ptr| unsafe { crate::stitching::PaniniPortraitWarper::from_raw(ptr) })
	}
...
pub trait PaniniWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_PaniniWarper_create_const_float(self.as_raw_PaniniWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl PaniniWarper {
	pub fn as_raw_PaniniWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_PaniniWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for PaniniWarper {}

impl crate::stitching::PaniniWarperTrait for PaniniWarper {
	fn as_raw_PaniniWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_PaniniWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl PaniniWarper {
	...
	pub fn new(a: f32, b: f32) -> Result<crate::stitching::PaniniWarper> {
		unsafe { sys::cv_PaniniWarper_PaniniWarper_float_float(a, b) }.into_result().map(|ptr| unsafe { crate::stitching::PaniniWarper::from_raw(ptr) })
	}
...
pub trait PlaneWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_PlaneWarper_create_const_float(self.as_raw_PlaneWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl PlaneWarper {
	pub fn as_raw_PlaneWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_PlaneWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for PlaneWarper {}

impl crate::stitching::PlaneWarperTrait for PlaneWarper {
	fn as_raw_PlaneWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_PlaneWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait PyRotationWarperTrait {
	...
	fn warp_point(&mut self, pt: core::Point2f, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray) -> Result<core::Point2f> {
		input_array_arg!(k);
		input_array_arg!(r);
		unsafe { sys::cv_PyRotationWarper_warpPoint_const_Point2fX_const__InputArrayX_const__InputArrayX(self.as_raw_mut_PyRotationWarper(), &pt, k.as_raw__InputArray(), r.as_raw__InputArray()) }.into_result()
	}
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		unsafe { sys::cv_PyRotationWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_PyRotationWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		unsafe { sys::cv_PyRotationWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_PyRotationWarper(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp_backward(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst_size: core::Size, dst: &mut dyn core::ToOutputArray) -> Result<()> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_PyRotationWarper_warpBackward_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_Size_const__OutputArrayX(self.as_raw_mut_PyRotationWarper(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, &dst_size, dst.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp_roi(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray) -> Result<core::Rect> {
		input_array_arg!(k);
		input_array_arg!(r);
		unsafe { sys::cv_PyRotationWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX(self.as_raw_mut_PyRotationWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray()) }.into_result()
	}
...
impl PyRotationWarper {
	pub fn as_raw_PyRotationWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_PyRotationWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for PyRotationWarper {}

impl crate::stitching::PyRotationWarperTrait for PyRotationWarper {
	fn as_raw_PyRotationWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_PyRotationWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl PyRotationWarper {
	pub fn new(typ: &str, scale: f32) -> Result<crate::stitching::PyRotationWarper> {
		string_arg!(typ);
		unsafe { sys::cv_PyRotationWarper_PyRotationWarper_String_float(typ.as_ptr() as _, scale) }.into_result().map(|ptr| unsafe { crate::stitching::PyRotationWarper::from_raw(ptr) })
	}
	
	pub fn default() -> Result<crate::stitching::PyRotationWarper> {
		unsafe { sys::cv_PyRotationWarper_PyRotationWarper() }.into_result().map(|ptr| unsafe { crate::stitching::PyRotationWarper::from_raw(ptr) })
	}
...
pub trait SphericalWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_SphericalWarper_create_const_float(self.as_raw_SphericalWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl SphericalWarper {
	pub fn as_raw_SphericalWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_SphericalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for SphericalWarper {}

impl crate::stitching::SphericalWarperTrait for SphericalWarper {
	fn as_raw_SphericalWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_SphericalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait StereographicWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_StereographicWarper_create_const_float(self.as_raw_StereographicWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
impl StereographicWarper {
	pub fn as_raw_StereographicWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_StereographicWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for StereographicWarper {}

impl crate::stitching::StereographicWarperTrait for StereographicWarper {
	fn as_raw_StereographicWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_StereographicWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait StitcherTrait {
	...
	fn orig_resol(&self) -> f64 {
		unsafe { sys::cv_Stitcher_ORIG_RESOL_const(self.as_raw_Stitcher()) }.into_result().expect("Infallible function failed: orig_resol")
	}
	...
	fn features_finder(&mut self) -> Result<core::Ptr::<crate::features2d::Feature2D>> {
		unsafe { sys::cv_Stitcher_featuresFinder(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::features2d::Feature2D>::from_raw(ptr) })
	}
	
	fn features_finder_1(&self) -> Result<core::Ptr::<crate::features2d::Feature2D>> {
		unsafe { sys::cv_Stitcher_featuresFinder_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::features2d::Feature2D>::from_raw(ptr) })
	}
	...
	fn features_matcher(&mut self) -> Result<core::Ptr::<dyn crate::stitching::Detail_FeaturesMatcher>> {
		unsafe { sys::cv_Stitcher_featuresMatcher(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_FeaturesMatcher>::from_raw(ptr) })
	}
	
	fn features_matcher_1(&self) -> Result<core::Ptr::<dyn crate::stitching::Detail_FeaturesMatcher>> {
		unsafe { sys::cv_Stitcher_featuresMatcher_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_FeaturesMatcher>::from_raw(ptr) })
	}
	...
	fn matching_mask(&self) -> Result<core::UMat> {
		unsafe { sys::cv_Stitcher_matchingMask_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::UMat::from_raw(ptr) })
	}
	
	fn set_matching_mask(&mut self, mask: &core::UMat) -> Result<()> {
		unsafe { sys::cv_Stitcher_setMatchingMask_const_UMatX(self.as_raw_mut_Stitcher(), mask.as_raw_UMat()) }.into_result()
	}
	
	fn bundle_adjuster(&mut self) -> Result<core::Ptr::<dyn crate::stitching::Detail_BundleAdjusterBase>> {
		unsafe { sys::cv_Stitcher_bundleAdjuster(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_BundleAdjusterBase>::from_raw(ptr) })
	}
	
	fn bundle_adjuster_1(&self) -> Result<core::Ptr::<dyn crate::stitching::Detail_BundleAdjusterBase>> {
		unsafe { sys::cv_Stitcher_bundleAdjuster_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_BundleAdjusterBase>::from_raw(ptr) })
	}
	...
	fn estimator(&mut self) -> Result<core::Ptr::<dyn crate::stitching::Detail_Estimator>> {
		unsafe { sys::cv_Stitcher_estimator(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_Estimator>::from_raw(ptr) })
	}
	
	fn estimator_1(&self) -> Result<core::Ptr::<dyn crate::stitching::Detail_Estimator>> {
		unsafe { sys::cv_Stitcher_estimator_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_Estimator>::from_raw(ptr) })
	}
	...
	fn warper(&mut self) -> Result<core::Ptr::<dyn crate::stitching::WarperCreator>> {
		unsafe { sys::cv_Stitcher_warper(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::WarperCreator>::from_raw(ptr) })
	}
	
	fn warper_1(&self) -> Result<core::Ptr::<dyn crate::stitching::WarperCreator>> {
		unsafe { sys::cv_Stitcher_warper_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::WarperCreator>::from_raw(ptr) })
	}
	...
	fn exposure_compensator(&mut self) -> Result<core::Ptr::<dyn crate::stitching::Detail_ExposureCompensator>> {
		unsafe { sys::cv_Stitcher_exposureCompensator(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_ExposureCompensator>::from_raw(ptr) })
	}
	
	fn exposure_compensator_1(&self) -> Result<core::Ptr::<dyn crate::stitching::Detail_ExposureCompensator>> {
		unsafe { sys::cv_Stitcher_exposureCompensator_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_ExposureCompensator>::from_raw(ptr) })
	}
	...
	fn seam_finder(&mut self) -> Result<core::Ptr::<dyn crate::stitching::Detail_SeamFinder>> {
		unsafe { sys::cv_Stitcher_seamFinder(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_SeamFinder>::from_raw(ptr) })
	}
	
	fn seam_finder_1(&self) -> Result<core::Ptr::<dyn crate::stitching::Detail_SeamFinder>> {
		unsafe { sys::cv_Stitcher_seamFinder_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_SeamFinder>::from_raw(ptr) })
	}
	...
	fn blender(&mut self) -> Result<core::Ptr::<crate::stitching::Detail_Blender>> {
		unsafe { sys::cv_Stitcher_blender(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::stitching::Detail_Blender>::from_raw(ptr) })
	}
	
	fn blender_1(&self) -> Result<core::Ptr::<crate::stitching::Detail_Blender>> {
		unsafe { sys::cv_Stitcher_blender_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::stitching::Detail_Blender>::from_raw(ptr) })
	}
	...
	fn estimate_transform(&mut self, images: &dyn core::ToInputArray, masks: &dyn core::ToInputArray) -> Result<crate::stitching::Stitcher_Status> {
		input_array_arg!(images);
		input_array_arg!(masks);
		unsafe { sys::cv_Stitcher_estimateTransform_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Stitcher(), images.as_raw__InputArray(), masks.as_raw__InputArray()) }.into_result()
	}
	...
	fn compose_panorama(&mut self, pano: &mut dyn core::ToOutputArray) -> Result<crate::stitching::Stitcher_Status> {
		...
		unsafe { sys::cv_Stitcher_composePanorama_const__OutputArrayX(self.as_raw_mut_Stitcher(), pano.as_raw__OutputArray()) }.into_result()
	}
	...
	fn compose_panorama_images(&mut self, images: &dyn core::ToInputArray, pano: &mut dyn core::ToOutputArray) -> Result<crate::stitching::Stitcher_Status> {
		input_array_arg!(images);
		output_array_arg!(pano);
		unsafe { sys::cv_Stitcher_composePanorama_const__InputArrayX_const__OutputArrayX(self.as_raw_mut_Stitcher(), images.as_raw__InputArray(), pano.as_raw__OutputArray()) }.into_result()
	}
	...
	fn stitch(&mut self, images: &dyn core::ToInputArray, pano: &mut dyn core::ToOutputArray) -> Result<crate::stitching::Stitcher_Status> {
		input_array_arg!(images);
		output_array_arg!(pano);
		unsafe { sys::cv_Stitcher_stitch_const__InputArrayX_const__OutputArrayX(self.as_raw_mut_Stitcher(), images.as_raw__InputArray(), pano.as_raw__OutputArray()) }.into_result()
	}
	...
	fn stitch_mask(&mut self, images: &dyn core::ToInputArray, masks: &dyn core::ToInputArray, pano: &mut dyn core::ToOutputArray) -> Result<crate::stitching::Stitcher_Status> {
		...
		input_array_arg!(masks);
		output_array_arg!(pano);
		unsafe { sys::cv_Stitcher_stitch_const__InputArrayX_const__InputArrayX_const__OutputArrayX(self.as_raw_mut_Stitcher(), images.as_raw__InputArray(), masks.as_raw__InputArray(), pano.as_raw__OutputArray()) }.into_result()
	}
	
	fn component(&self) -> Result<core::Vector::<i32>> {
		unsafe { sys::cv_Stitcher_component_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Vector::<i32>::from_raw(ptr) })
	}
	
	fn cameras(&self) -> Result<core::Vector::<crate::stitching::Detail_CameraParams>> {
		unsafe { sys::cv_Stitcher_cameras_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Vector::<crate::stitching::Detail_CameraParams>::from_raw(ptr) })
	}
	...
	fn result_mask(&self) -> Result<core::UMat> {
		unsafe { sys::cv_Stitcher_resultMask_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::UMat::from_raw(ptr) })
	}
...
impl Stitcher {
	pub fn as_raw_Stitcher(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Stitcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Stitcher {}

impl crate::stitching::StitcherTrait for Stitcher {
	fn as_raw_Stitcher(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Stitcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Stitcher {
	...
	pub fn create(mode: crate::stitching::Stitcher_Mode) -> Result<core::Ptr::<crate::stitching::Stitcher>> {
		unsafe { sys::cv_Stitcher_create_Mode(mode) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::stitching::Stitcher>::from_raw(ptr) })
	}
...
pub trait TransverseMercatorWarperTrait: crate::stitching::WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_TransverseMercatorWarper_create_const_float(self.as_raw_TransverseMercatorWarper(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
boxed_ptr! { TransverseMercatorWarper }
...
impl TransverseMercatorWarper {
	pub fn as_raw_TransverseMercatorWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_TransverseMercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::TransverseMercatorWarperTrait for TransverseMercatorWarper {
	fn as_raw_TransverseMercatorWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_TransverseMercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait WarperCreator {
	...
	fn create(&self, scale: f32) -> Result<core::Ptr::<dyn crate::stitching::Detail_RotationWarper>> {
		unsafe { sys::cv_WarperCreator_create_const_float(self.as_raw_WarperCreator(), scale) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_RotationWarper>::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_AffineBasedEstimator }
...
impl Detail_AffineBasedEstimator {
	pub fn as_raw_Detail_AffineBasedEstimator(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_AffineBasedEstimator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_AffineBasedEstimatorTrait for Detail_AffineBasedEstimator {
	fn as_raw_Detail_AffineBasedEstimator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_AffineBasedEstimator(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_Estimator for Detail_AffineBasedEstimator {
	fn as_raw_Detail_Estimator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_Estimator(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_AffineBasedEstimator {
	pub fn default() -> Result<crate::stitching::Detail_AffineBasedEstimator> {
		unsafe { sys::cv_detail_AffineBasedEstimator_AffineBasedEstimator() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_AffineBasedEstimator::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_AffineBestOf2NearestMatcher }
...
impl Detail_AffineBestOf2NearestMatcher {
	pub fn as_raw_Detail_AffineBestOf2NearestMatcher(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_AffineBestOf2NearestMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_AffineBestOf2NearestMatcherTrait for Detail_AffineBestOf2NearestMatcher {
	fn as_raw_Detail_AffineBestOf2NearestMatcher(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_AffineBestOf2NearestMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_BestOf2NearestMatcherTrait for Detail_AffineBestOf2NearestMatcher {
	fn as_raw_Detail_BestOf2NearestMatcher(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BestOf2NearestMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_FeaturesMatcher for Detail_AffineBestOf2NearestMatcher {
	fn as_raw_Detail_FeaturesMatcher(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_FeaturesMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_AffineBestOf2NearestMatcher {
	...
	pub fn new(full_affine: bool, try_use_gpu: bool, match_conf: f32, num_matches_thresh1: i32) -> Result<crate::stitching::Detail_AffineBestOf2NearestMatcher> {
		unsafe { sys::cv_detail_AffineBestOf2NearestMatcher_AffineBestOf2NearestMatcher_bool_bool_float_int(full_affine, try_use_gpu, match_conf, num_matches_thresh1) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_AffineBestOf2NearestMatcher::from_raw(ptr) })
	}
...
pub trait Detail_AffineWarperTrait: crate::stitching::Detail_PlaneWarperTrait {
	...
	fn warp_point(&mut self, pt: core::Point2f, k: &dyn core::ToInputArray, h: &dyn core::ToInputArray) -> Result<core::Point2f> {
		input_array_arg!(k);
		input_array_arg!(h);
		unsafe { sys::cv_detail_AffineWarper_warpPoint_const_Point2fX_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_AffineWarper(), &pt, k.as_raw__InputArray(), h.as_raw__InputArray()) }.into_result()
	}
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, h: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_AffineWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_AffineWarper(), &src_size, k.as_raw__InputArray(), h.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, h: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(h);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_AffineWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_AffineWarper(), src.as_raw__InputArray(), k.as_raw__InputArray(), h.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp_roi(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, h: &dyn core::ToInputArray) -> Result<core::Rect> {
		input_array_arg!(k);
		input_array_arg!(h);
		unsafe { sys::cv_detail_AffineWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_AffineWarper(), &src_size, k.as_raw__InputArray(), h.as_raw__InputArray()) }.into_result()
	}
...
impl Detail_AffineWarper {
	pub fn as_raw_Detail_AffineWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_AffineWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_AffineWarper {}

impl crate::stitching::Detail_AffineWarperTrait for Detail_AffineWarper {
	fn as_raw_Detail_AffineWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_AffineWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_PlaneWarperTrait for Detail_AffineWarper {
	fn as_raw_Detail_PlaneWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PlaneWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_RotationWarper for Detail_AffineWarper {
	fn as_raw_Detail_RotationWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_RotationWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_AffineWarper {
	...
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_AffineWarper> {
		unsafe { sys::cv_detail_AffineWarper_AffineWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_AffineWarper::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_BestOf2NearestMatcher }
...
impl Detail_BestOf2NearestMatcher {
	pub fn as_raw_Detail_BestOf2NearestMatcher(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BestOf2NearestMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BestOf2NearestMatcher {
	...
	pub fn new(try_use_gpu: bool, match_conf: f32, num_matches_thresh1: i32, num_matches_thresh2: i32) -> Result<crate::stitching::Detail_BestOf2NearestMatcher> {
		unsafe { sys::cv_detail_BestOf2NearestMatcher_BestOf2NearestMatcher_bool_float_int_int(try_use_gpu, match_conf, num_matches_thresh1, num_matches_thresh2) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BestOf2NearestMatcher::from_raw(ptr) })
	}
	...
	pub fn create(try_use_gpu: bool, match_conf: f32, num_matches_thresh1: i32, num_matches_thresh2: i32) -> Result<core::Ptr::<crate::stitching::Detail_BestOf2NearestMatcher>> {
		unsafe { sys::cv_detail_BestOf2NearestMatcher_create_bool_float_int_int(try_use_gpu, match_conf, num_matches_thresh1, num_matches_thresh2) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::stitching::Detail_BestOf2NearestMatcher>::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_BestOf2NearestRangeMatcher }
...
impl Detail_BestOf2NearestRangeMatcher {
	pub fn as_raw_Detail_BestOf2NearestRangeMatcher(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BestOf2NearestRangeMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_BestOf2NearestRangeMatcherTrait for Detail_BestOf2NearestRangeMatcher {
	fn as_raw_Detail_BestOf2NearestRangeMatcher(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BestOf2NearestRangeMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BestOf2NearestRangeMatcher {
	...
	pub fn new(range_width: i32, try_use_gpu: bool, match_conf: f32, num_matches_thresh1: i32, num_matches_thresh2: i32) -> Result<crate::stitching::Detail_BestOf2NearestRangeMatcher> {
		unsafe { sys::cv_detail_BestOf2NearestRangeMatcher_BestOf2NearestRangeMatcher_int_bool_float_int_int(range_width, try_use_gpu, match_conf, num_matches_thresh1, num_matches_thresh2) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BestOf2NearestRangeMatcher::from_raw(ptr) })
	}
...
pub trait Detail_BlenderTrait {
	...
	fn prepare(&mut self, corners: &core::Vector::<core::Point>, sizes: &core::Vector::<core::Size>) -> Result<()> {
		unsafe { sys::cv_detail_Blender_prepare_const_vector_Point_X_const_vector_Size_X(self.as_raw_mut_Detail_Blender(), corners.as_raw_VectorOfPoint(), sizes.as_raw_VectorOfSize()) }.into_result()
	}
	...
	fn prepare_1(&mut self, dst_roi: core::Rect) -> Result<()> {
		unsafe { sys::cv_detail_Blender_prepare_Rect(self.as_raw_mut_Detail_Blender(), &dst_roi) }.into_result()
	}
	...
	fn feed(&mut self, img: &dyn core::ToInputArray, mask: &dyn core::ToInputArray, tl: core::Point) -> Result<()> {
		input_array_arg!(img);
		input_array_arg!(mask);
		unsafe { sys::cv_detail_Blender_feed_const__InputArrayX_const__InputArrayX_Point(self.as_raw_mut_Detail_Blender(), img.as_raw__InputArray(), mask.as_raw__InputArray(), &tl) }.into_result()
	}
	...
	fn blend(&mut self, dst: &mut dyn core::ToInputOutputArray, dst_mask: &mut dyn core::ToInputOutputArray) -> Result<()> {
		...
		unsafe { sys::cv_detail_Blender_blend_const__InputOutputArrayX_const__InputOutputArrayX(self.as_raw_mut_Detail_Blender(), dst.as_raw__InputOutputArray(), dst_mask.as_raw__InputOutputArray()) }.into_result()
	}
...
impl Detail_Blender {
	pub fn as_raw_Detail_Blender(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_Blender(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_Blender {}

impl crate::stitching::Detail_BlenderTrait for Detail_Blender {
	fn as_raw_Detail_Blender(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_Blender(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_Blender {
	...
	pub fn create_default(typ: i32, try_gpu: bool) -> Result<core::Ptr::<crate::stitching::Detail_Blender>> {
		unsafe { sys::cv_detail_Blender_createDefault_int_bool(typ, try_gpu) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::stitching::Detail_Blender>::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_BlocksChannelsCompensator }
...
impl Detail_BlocksChannelsCompensator {
	pub fn as_raw_Detail_BlocksChannelsCompensator(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BlocksChannelsCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_BlocksChannelsCompensatorTrait for Detail_BlocksChannelsCompensator {
	fn as_raw_Detail_BlocksChannelsCompensator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BlocksChannelsCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_BlocksCompensator for Detail_BlocksChannelsCompensator {
	fn as_raw_Detail_BlocksCompensator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BlocksCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_ExposureCompensator for Detail_BlocksChannelsCompensator {
	fn as_raw_Detail_ExposureCompensator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_ExposureCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BlocksChannelsCompensator {
	...
	pub fn new(bl_width: i32, bl_height: i32, nr_feeds: i32) -> Result<crate::stitching::Detail_BlocksChannelsCompensator> {
		unsafe { sys::cv_detail_BlocksChannelsCompensator_BlocksChannelsCompensator_int_int_int(bl_width, bl_height, nr_feeds) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BlocksChannelsCompensator::from_raw(ptr) })
	}
...
pub trait Detail_BlocksCompensator: crate::stitching::Detail_ExposureCompensator {
	...
	fn apply(&mut self, index: i32, corner: core::Point, image: &mut dyn core::ToInputOutputArray, mask: &dyn core::ToInputArray) -> Result<()> {
		...
		input_array_arg!(mask);
		unsafe { sys::cv_detail_BlocksCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(self.as_raw_mut_Detail_BlocksCompensator(), index, &corner, image.as_raw__InputOutputArray(), mask.as_raw__InputArray()) }.into_result()
	}
	
	fn get_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_BlocksCompensator_getMatGains_vector_Mat_X(self.as_raw_mut_Detail_BlocksCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	
	fn set_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_BlocksCompensator_setMatGains_vector_Mat_X(self.as_raw_mut_Detail_BlocksCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	...
	fn set_block_size_1(&mut self, size: core::Size) -> Result<()> {
		unsafe { sys::cv_detail_BlocksCompensator_setBlockSize_Size(self.as_raw_mut_Detail_BlocksCompensator(), &size) }.into_result()
	}
...
pub trait Detail_BlocksGainCompensatorTrait: crate::stitching::Detail_BlocksCompensator {
	...
	fn apply(&mut self, index: i32, corner: core::Point, image: &mut dyn core::ToInputOutputArray, mask: &dyn core::ToInputArray) -> Result<()> {
		input_output_array_arg!(image);
		input_array_arg!(mask);
		unsafe { sys::cv_detail_BlocksGainCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(self.as_raw_mut_Detail_BlocksGainCompensator(), index, &corner, image.as_raw__InputOutputArray(), mask.as_raw__InputArray()) }.into_result()
	}
	
	fn get_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_BlocksGainCompensator_getMatGains_vector_Mat_X(self.as_raw_mut_Detail_BlocksGainCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	
	fn set_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_BlocksGainCompensator_setMatGains_vector_Mat_X(self.as_raw_mut_Detail_BlocksGainCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
...
boxed_ptr! { Detail_BlocksGainCompensator }
...
impl Detail_BlocksGainCompensator {
	pub fn as_raw_Detail_BlocksGainCompensator(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BlocksGainCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_BlocksGainCompensatorTrait for Detail_BlocksGainCompensator {
	fn as_raw_Detail_BlocksGainCompensator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BlocksGainCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BlocksGainCompensator {
	...
	pub fn new(bl_width: i32, bl_height: i32) -> Result<crate::stitching::Detail_BlocksGainCompensator> {
		unsafe { sys::cv_detail_BlocksGainCompensator_BlocksGainCompensator_int_int(bl_width, bl_height) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BlocksGainCompensator::from_raw(ptr) })
	}
	
	pub fn new_1(bl_width: i32, bl_height: i32, nr_feeds: i32) -> Result<crate::stitching::Detail_BlocksGainCompensator> {
		unsafe { sys::cv_detail_BlocksGainCompensator_BlocksGainCompensator_int_int_int(bl_width, bl_height, nr_feeds) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BlocksGainCompensator::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_BundleAdjusterAffine }
...
impl Detail_BundleAdjusterAffine {
	pub fn as_raw_Detail_BundleAdjusterAffine(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BundleAdjusterAffine(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_BundleAdjusterAffineTrait for Detail_BundleAdjusterAffine {
	fn as_raw_Detail_BundleAdjusterAffine(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BundleAdjusterAffine(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_BundleAdjusterBase for Detail_BundleAdjusterAffine {
	fn as_raw_Detail_BundleAdjusterBase(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BundleAdjusterBase(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BundleAdjusterAffine {
	pub fn default() -> Result<crate::stitching::Detail_BundleAdjusterAffine> {
		unsafe { sys::cv_detail_BundleAdjusterAffine_BundleAdjusterAffine() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BundleAdjusterAffine::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_BundleAdjusterAffinePartial }
...
impl Detail_BundleAdjusterAffinePartial {
	pub fn as_raw_Detail_BundleAdjusterAffinePartial(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BundleAdjusterAffinePartial(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_BundleAdjusterAffinePartialTrait for Detail_BundleAdjusterAffinePartial {
	fn as_raw_Detail_BundleAdjusterAffinePartial(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BundleAdjusterAffinePartial(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BundleAdjusterAffinePartial {
	pub fn default() -> Result<crate::stitching::Detail_BundleAdjusterAffinePartial> {
		unsafe { sys::cv_detail_BundleAdjusterAffinePartial_BundleAdjusterAffinePartial() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BundleAdjusterAffinePartial::from_raw(ptr) })
	}
...
pub trait Detail_BundleAdjusterBase: crate::stitching::Detail_Estimator {
	...
	fn refinement_mask(&self) -> Result<core::Mat> {
		unsafe { sys::cv_detail_BundleAdjusterBase_refinementMask_const(self.as_raw_Detail_BundleAdjusterBase()) }.into_result().map(|ptr| unsafe { core::Mat::from_raw(ptr) })
	}
	
	fn set_refinement_mask(&mut self, mask: &core::Mat) -> Result<()> {
		unsafe { sys::cv_detail_BundleAdjusterBase_setRefinementMask_const_MatX(self.as_raw_mut_Detail_BundleAdjusterBase(), mask.as_raw_Mat()) }.into_result()
	}
	...
	fn set_term_criteria(&mut self, term_criteria: core::TermCriteria) -> Result<()> {
		unsafe { sys::cv_detail_BundleAdjusterBase_setTermCriteria_const_TermCriteriaX(self.as_raw_mut_Detail_BundleAdjusterBase(), &term_criteria) }.into_result()
	}
...
boxed_ptr! { Detail_BundleAdjusterRay }
...
impl Detail_BundleAdjusterRay {
	pub fn as_raw_Detail_BundleAdjusterRay(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BundleAdjusterRay(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_BundleAdjusterRayTrait for Detail_BundleAdjusterRay {
	fn as_raw_Detail_BundleAdjusterRay(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BundleAdjusterRay(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BundleAdjusterRay {
	pub fn default() -> Result<crate::stitching::Detail_BundleAdjusterRay> {
		unsafe { sys::cv_detail_BundleAdjusterRay_BundleAdjusterRay() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BundleAdjusterRay::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_BundleAdjusterReproj }
...
impl Detail_BundleAdjusterReproj {
	pub fn as_raw_Detail_BundleAdjusterReproj(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_BundleAdjusterReproj(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_BundleAdjusterReprojTrait for Detail_BundleAdjusterReproj {
	fn as_raw_Detail_BundleAdjusterReproj(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_BundleAdjusterReproj(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_BundleAdjusterReproj {
	pub fn default() -> Result<crate::stitching::Detail_BundleAdjusterReproj> {
		unsafe { sys::cv_detail_BundleAdjusterReproj_BundleAdjusterReproj() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_BundleAdjusterReproj::from_raw(ptr) })
	}
...
pub trait Detail_CameraParamsTrait {
	...
	fn set_focal(&mut self, val: f64) -> () {
		unsafe { sys::cv_detail_CameraParams_setFocal_double(self.as_raw_mut_Detail_CameraParams(), val) }.into_result().expect("Infallible function failed: set_focal")
	}
	...
	fn set_aspect(&mut self, val: f64) -> () {
		unsafe { sys::cv_detail_CameraParams_setAspect_double(self.as_raw_mut_Detail_CameraParams(), val) }.into_result().expect("Infallible function failed: set_aspect")
	}
	...
	fn set_ppx(&mut self, val: f64) -> () {
		unsafe { sys::cv_detail_CameraParams_setPpx_double(self.as_raw_mut_Detail_CameraParams(), val) }.into_result().expect("Infallible function failed: set_ppx")
	}
	...
	fn set_ppy(&mut self, val: f64) -> () {
		unsafe { sys::cv_detail_CameraParams_setPpy_double(self.as_raw_mut_Detail_CameraParams(), val) }.into_result().expect("Infallible function failed: set_ppy")
	}
	
	fn r(&mut self) -> core::Mat {
		unsafe { sys::cv_detail_CameraParams_R(self.as_raw_mut_Detail_CameraParams()) }.into_result().map(|ptr| unsafe { core::Mat::from_raw(ptr) }).expect("Infallible function failed: r")
	}
	
	fn set_r(&mut self, mut val: core::Mat) -> () {
		unsafe { sys::cv_detail_CameraParams_setR_Mat(self.as_raw_mut_Detail_CameraParams(), val.as_raw_mut_Mat()) }.into_result().expect("Infallible function failed: set_r")
	}
	
	fn t(&mut self) -> core::Mat {
		unsafe { sys::cv_detail_CameraParams_t(self.as_raw_mut_Detail_CameraParams()) }.into_result().map(|ptr| unsafe { core::Mat::from_raw(ptr) }).expect("Infallible function failed: t")
	}
	
	fn set_t(&mut self, mut val: core::Mat) -> () {
		unsafe { sys::cv_detail_CameraParams_setT_Mat(self.as_raw_mut_Detail_CameraParams(), val.as_raw_mut_Mat()) }.into_result().expect("Infallible function failed: set_t")
	}
	
	fn k(&self) -> Result<core::Mat> {
		unsafe { sys::cv_detail_CameraParams_K_const(self.as_raw_Detail_CameraParams()) }.into_result().map(|ptr| unsafe { core::Mat::from_raw(ptr) })
	}
...
impl Detail_CameraParams {
	pub fn as_raw_Detail_CameraParams(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CameraParams(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_CameraParams {}

impl crate::stitching::Detail_CameraParamsTrait for Detail_CameraParams {
	fn as_raw_Detail_CameraParams(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CameraParams(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_CameraParams {
	pub fn default() -> Result<crate::stitching::Detail_CameraParams> {
		unsafe { sys::cv_detail_CameraParams_CameraParams() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_CameraParams::from_raw(ptr) })
	}
	
	pub fn copy(other: &crate::stitching::Detail_CameraParams) -> Result<crate::stitching::Detail_CameraParams> {
		unsafe { sys::cv_detail_CameraParams_CameraParams_const_CameraParamsX(other.as_raw_Detail_CameraParams()) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_CameraParams::from_raw(ptr) })
	}
...
pub trait Detail_ChannelsCompensatorTrait: crate::stitching::Detail_ExposureCompensator {
	...
	fn apply(&mut self, index: i32, corner: core::Point, image: &mut dyn core::ToInputOutputArray, mask: &dyn core::ToInputArray) -> Result<()> {
		input_output_array_arg!(image);
		input_array_arg!(mask);
		unsafe { sys::cv_detail_ChannelsCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(self.as_raw_mut_Detail_ChannelsCompensator(), index, &corner, image.as_raw__InputOutputArray(), mask.as_raw__InputArray()) }.into_result()
	}
	
	fn get_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_ChannelsCompensator_getMatGains_vector_Mat_X(self.as_raw_mut_Detail_ChannelsCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	
	fn set_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_ChannelsCompensator_setMatGains_vector_Mat_X(self.as_raw_mut_Detail_ChannelsCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	...
	fn gains(&self) -> Result<core::Vector::<core::Scalar>> {
		unsafe { sys::cv_detail_ChannelsCompensator_gains_const(self.as_raw_Detail_ChannelsCompensator()) }.into_result().map(|ptr| unsafe { core::Vector::<core::Scalar>::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_ChannelsCompensator }
...
impl Detail_ChannelsCompensator {
	pub fn as_raw_Detail_ChannelsCompensator(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_ChannelsCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_ChannelsCompensatorTrait for Detail_ChannelsCompensator {
	fn as_raw_Detail_ChannelsCompensator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_ChannelsCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_ChannelsCompensator {
	...
	pub fn new(nr_feeds: i32) -> Result<crate::stitching::Detail_ChannelsCompensator> {
		unsafe { sys::cv_detail_ChannelsCompensator_ChannelsCompensator_int(nr_feeds) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_ChannelsCompensator::from_raw(ptr) })
	}
...
pub trait Detail_CompressedRectilinearPortraitProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn set_a(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_CompressedRectilinearPortraitProjector_setA_float(self.as_raw_mut_Detail_CompressedRectilinearPortraitProjector(), val) }.into_result().expect("Infallible function failed: set_a")
	}
	...
	fn set_b(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_CompressedRectilinearPortraitProjector_setB_float(self.as_raw_mut_Detail_CompressedRectilinearPortraitProjector(), val) }.into_result().expect("Infallible function failed: set_b")
	}
	
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CompressedRectilinearPortraitProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_CompressedRectilinearPortraitProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CompressedRectilinearPortraitProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_CompressedRectilinearPortraitProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_CompressedRectilinearPortraitProjector }
...
impl Detail_CompressedRectilinearPortraitProjector {
	pub fn as_raw_Detail_CompressedRectilinearPortraitProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CompressedRectilinearPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CompressedRectilinearPortraitProjectorTrait for Detail_CompressedRectilinearPortraitProjector {
	fn as_raw_Detail_CompressedRectilinearPortraitProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CompressedRectilinearPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_ProjectorBaseTrait for Detail_CompressedRectilinearPortraitProjector {
	fn as_raw_Detail_ProjectorBase(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_ProjectorBase(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_CompressedRectilinearPortraitWarper }
...
impl Detail_CompressedRectilinearPortraitWarper {
	pub fn as_raw_Detail_CompressedRectilinearPortraitWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CompressedRectilinearPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CompressedRectilinearPortraitWarperTrait for Detail_CompressedRectilinearPortraitWarper {
	fn as_raw_Detail_CompressedRectilinearPortraitWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CompressedRectilinearPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_CompressedRectilinearPortraitWarper {
	...
	pub fn new(scale: f32, a: f32, b: f32) -> Result<crate::stitching::Detail_CompressedRectilinearPortraitWarper> {
		unsafe { sys::cv_detail_CompressedRectilinearPortraitWarper_CompressedRectilinearPortraitWarper_float_float_float(scale, a, b) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_CompressedRectilinearPortraitWarper::from_raw(ptr) })
	}
...
pub trait Detail_CompressedRectilinearProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn set_a(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_CompressedRectilinearProjector_setA_float(self.as_raw_mut_Detail_CompressedRectilinearProjector(), val) }.into_result().expect("Infallible function failed: set_a")
	}
	...
	fn set_b(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_CompressedRectilinearProjector_setB_float(self.as_raw_mut_Detail_CompressedRectilinearProjector(), val) }.into_result().expect("Infallible function failed: set_b")
	}
	
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CompressedRectilinearProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_CompressedRectilinearProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CompressedRectilinearProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_CompressedRectilinearProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_CompressedRectilinearProjector }
...
impl Detail_CompressedRectilinearProjector {
	pub fn as_raw_Detail_CompressedRectilinearProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CompressedRectilinearProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CompressedRectilinearProjectorTrait for Detail_CompressedRectilinearProjector {
	fn as_raw_Detail_CompressedRectilinearProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CompressedRectilinearProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_CompressedRectilinearWarper }
...
impl Detail_CompressedRectilinearWarper {
	pub fn as_raw_Detail_CompressedRectilinearWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CompressedRectilinearWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CompressedRectilinearWarperTrait for Detail_CompressedRectilinearWarper {
	fn as_raw_Detail_CompressedRectilinearWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CompressedRectilinearWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_CompressedRectilinearWarper {
	...
	pub fn new(scale: f32, a: f32, b: f32) -> Result<crate::stitching::Detail_CompressedRectilinearWarper> {
		unsafe { sys::cv_detail_CompressedRectilinearWarper_CompressedRectilinearWarper_float_float_float(scale, a, b) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_CompressedRectilinearWarper::from_raw(ptr) })
	}
...
pub trait Detail_CylindricalPortraitProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CylindricalPortraitProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_CylindricalPortraitProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CylindricalPortraitProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_CylindricalPortraitProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_CylindricalPortraitProjector }
...
impl Detail_CylindricalPortraitProjector {
	pub fn as_raw_Detail_CylindricalPortraitProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CylindricalPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CylindricalPortraitProjectorTrait for Detail_CylindricalPortraitProjector {
	fn as_raw_Detail_CylindricalPortraitProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CylindricalPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_CylindricalPortraitWarper }
...
impl Detail_CylindricalPortraitWarper {
	pub fn as_raw_Detail_CylindricalPortraitWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CylindricalPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CylindricalPortraitWarperTrait for Detail_CylindricalPortraitWarper {
	fn as_raw_Detail_CylindricalPortraitWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CylindricalPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_CylindricalPortraitWarper {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_CylindricalPortraitWarper> {
		unsafe { sys::cv_detail_CylindricalPortraitWarper_CylindricalPortraitWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_CylindricalPortraitWarper::from_raw(ptr) })
	}
...
pub trait Detail_CylindricalProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CylindricalProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_CylindricalProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_CylindricalProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_CylindricalProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_CylindricalProjector }
...
impl Detail_CylindricalProjector {
	pub fn as_raw_Detail_CylindricalProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CylindricalProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CylindricalProjectorTrait for Detail_CylindricalProjector {
	fn as_raw_Detail_CylindricalProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CylindricalProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait Detail_CylindricalWarperTrait {
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_CylindricalWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_CylindricalWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_CylindricalWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_CylindricalWarper(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
...
boxed_ptr! { Detail_CylindricalWarper }
...
impl Detail_CylindricalWarper {
	pub fn as_raw_Detail_CylindricalWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CylindricalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CylindricalWarperTrait for Detail_CylindricalWarper {
	fn as_raw_Detail_CylindricalWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CylindricalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_CylindricalWarper {
	...
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_CylindricalWarper> {
		unsafe { sys::cv_detail_CylindricalWarper_CylindricalWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_CylindricalWarper::from_raw(ptr) })
	}
...
pub trait Detail_CylindricalWarperGpuTrait: crate::stitching::Detail_CylindricalWarperTrait {
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_CylindricalWarperGpu_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_CylindricalWarperGpu(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_CylindricalWarperGpu_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_CylindricalWarperGpu(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
...
boxed_ptr! { Detail_CylindricalWarperGpu }
...
impl Detail_CylindricalWarperGpu {
	pub fn as_raw_Detail_CylindricalWarperGpu(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_CylindricalWarperGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_CylindricalWarperGpuTrait for Detail_CylindricalWarperGpu {
	fn as_raw_Detail_CylindricalWarperGpu(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_CylindricalWarperGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_CylindricalWarperGpu {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_CylindricalWarperGpu> {
		unsafe { sys::cv_detail_CylindricalWarperGpu_CylindricalWarperGpu_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_CylindricalWarperGpu::from_raw(ptr) })
	}
...
pub trait Detail_DisjointSetsTrait {
	...
	fn parent(&mut self) -> core::Vector::<i32> {
		unsafe { sys::cv_detail_DisjointSets_parent(self.as_raw_mut_Detail_DisjointSets()) }.into_result().map(|ptr| unsafe { core::Vector::<i32>::from_raw(ptr) }).expect("Infallible function failed: parent")
	}
	
	fn set_parent(&mut self, mut val: core::Vector::<i32>) -> () {
		unsafe { sys::cv_detail_DisjointSets_setParent_vector_int_(self.as_raw_mut_Detail_DisjointSets(), val.as_raw_mut_VectorOfi32()) }.into_result().expect("Infallible function failed: set_parent")
	}
	
	fn size(&mut self) -> core::Vector::<i32> {
		unsafe { sys::cv_detail_DisjointSets_size(self.as_raw_mut_Detail_DisjointSets()) }.into_result().map(|ptr| unsafe { core::Vector::<i32>::from_raw(ptr) }).expect("Infallible function failed: size")
	}
	
	fn set_size(&mut self, mut val: core::Vector::<i32>) -> () {
		unsafe { sys::cv_detail_DisjointSets_setSize_vector_int_(self.as_raw_mut_Detail_DisjointSets(), val.as_raw_mut_VectorOfi32()) }.into_result().expect("Infallible function failed: set_size")
	}
...
impl Detail_DisjointSets {
	pub fn as_raw_Detail_DisjointSets(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_DisjointSets(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_DisjointSets {}

impl crate::stitching::Detail_DisjointSetsTrait for Detail_DisjointSets {
	fn as_raw_Detail_DisjointSets(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_DisjointSets(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_DisjointSets {
	...
	pub fn new(elem_count: i32) -> Result<crate::stitching::Detail_DisjointSets> {
		unsafe { sys::cv_detail_DisjointSets_DisjointSets_int(elem_count) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_DisjointSets::from_raw(ptr) })
	}
...
pub trait Detail_DpSeamFinderTrait: crate::stitching::Detail_SeamFinder {
	...
	fn set_cost_function_1(&mut self, val: &str) -> Result<()> {
		string_arg!(val);
		unsafe { sys::cv_detail_DpSeamFinder_setCostFunction_String(self.as_raw_mut_Detail_DpSeamFinder(), val.as_ptr() as _) }.into_result()
	}
	
	fn find(&mut self, src: &core::Vector::<core::UMat>, corners: &core::Vector::<core::Point>, masks: &mut core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_DpSeamFinder_find_const_vector_UMat_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_DpSeamFinder(), src.as_raw_VectorOfUMat(), corners.as_raw_VectorOfPoint(), masks.as_raw_mut_VectorOfUMat()) }.into_result()
	}
...
impl Detail_DpSeamFinder {
	pub fn as_raw_Detail_DpSeamFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_DpSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_DpSeamFinder {}

impl crate::stitching::Detail_DpSeamFinderTrait for Detail_DpSeamFinder {
	fn as_raw_Detail_DpSeamFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_DpSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_SeamFinder for Detail_DpSeamFinder {
	fn as_raw_Detail_SeamFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_DpSeamFinder {
	...
	pub fn new(cost_func: crate::stitching::Detail_DpSeamFinder_CostFunction) -> Result<crate::stitching::Detail_DpSeamFinder> {
		unsafe { sys::cv_detail_DpSeamFinder_DpSeamFinder_CostFunction(cost_func) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_DpSeamFinder::from_raw(ptr) })
	}
	
	pub fn new_1(cost_func: &str) -> Result<crate::stitching::Detail_DpSeamFinder> {
		string_arg!(cost_func);
		unsafe { sys::cv_detail_DpSeamFinder_DpSeamFinder_String(cost_func.as_ptr() as _) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_DpSeamFinder::from_raw(ptr) })
	}
...
pub trait Detail_ExposureCompensator {
	...
	fn feed(&mut self, corners: &core::Vector::<core::Point>, images: &core::Vector::<core::UMat>, masks: &core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_ExposureCompensator_feed_const_vector_Point_X_const_vector_UMat_X_const_vector_UMat_X(self.as_raw_mut_Detail_ExposureCompensator(), corners.as_raw_VectorOfPoint(), images.as_raw_VectorOfUMat(), masks.as_raw_VectorOfUMat()) }.into_result()
	}
	...
	fn apply(&mut self, index: i32, corner: core::Point, image: &mut dyn core::ToInputOutputArray, mask: &dyn core::ToInputArray) -> Result<()> {
		input_output_array_arg!(image);
		input_array_arg!(mask);
		unsafe { sys::cv_detail_ExposureCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(self.as_raw_mut_Detail_ExposureCompensator(), index, &corner, image.as_raw__InputOutputArray(), mask.as_raw__InputArray()) }.into_result()
	}
	
	fn get_mat_gains(&mut self, unnamed: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_ExposureCompensator_getMatGains_vector_Mat_X(self.as_raw_mut_Detail_ExposureCompensator(), unnamed.as_raw_mut_VectorOfMat()) }.into_result()
	}
	
	fn set_mat_gains(&mut self, unnamed: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_ExposureCompensator_setMatGains_vector_Mat_X(self.as_raw_mut_Detail_ExposureCompensator(), unnamed.as_raw_mut_VectorOfMat()) }.into_result()
	}
...
impl dyn Detail_ExposureCompensator + '_ {
	pub fn create_default(typ: i32) -> Result<core::Ptr::<dyn crate::stitching::Detail_ExposureCompensator>> {
		unsafe { sys::cv_detail_ExposureCompensator_createDefault_int(typ) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_ExposureCompensator>::from_raw(ptr) })
	}
...
pub trait Detail_FeatherBlenderTrait: crate::stitching::Detail_BlenderTrait {
	...
	fn prepare(&mut self, dst_roi: core::Rect) -> Result<()> {
		unsafe { sys::cv_detail_FeatherBlender_prepare_Rect(self.as_raw_mut_Detail_FeatherBlender(), &dst_roi) }.into_result()
	}
	
	fn feed(&mut self, img: &dyn core::ToInputArray, mask: &dyn core::ToInputArray, tl: core::Point) -> Result<()> {
		input_array_arg!(img);
		input_array_arg!(mask);
		unsafe { sys::cv_detail_FeatherBlender_feed_const__InputArrayX_const__InputArrayX_Point(self.as_raw_mut_Detail_FeatherBlender(), img.as_raw__InputArray(), mask.as_raw__InputArray(), &tl) }.into_result()
	}
	
	fn blend(&mut self, dst: &mut dyn core::ToInputOutputArray, dst_mask: &mut dyn core::ToInputOutputArray) -> Result<()> {
		input_output_array_arg!(dst);
		input_output_array_arg!(dst_mask);
		unsafe { sys::cv_detail_FeatherBlender_blend_const__InputOutputArrayX_const__InputOutputArrayX(self.as_raw_mut_Detail_FeatherBlender(), dst.as_raw__InputOutputArray(), dst_mask.as_raw__InputOutputArray()) }.into_result()
	}
	...
	fn create_weight_maps(&mut self, masks: &core::Vector::<core::UMat>, corners: &core::Vector::<core::Point>, weight_maps: &mut core::Vector::<core::UMat>) -> Result<core::Rect> {
		unsafe { sys::cv_detail_FeatherBlender_createWeightMaps_const_vector_UMat_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_FeatherBlender(), masks.as_raw_VectorOfUMat(), corners.as_raw_VectorOfPoint(), weight_maps.as_raw_mut_VectorOfUMat()) }.into_result()
	}
...
boxed_ptr! { Detail_FeatherBlender }
...
impl Detail_FeatherBlender {
	pub fn as_raw_Detail_FeatherBlender(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_FeatherBlender(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_FeatherBlenderTrait for Detail_FeatherBlender {
	fn as_raw_Detail_FeatherBlender(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_FeatherBlender(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_FeatherBlender {
	...
	pub fn new(sharpness: f32) -> Result<crate::stitching::Detail_FeatherBlender> {
		unsafe { sys::cv_detail_FeatherBlender_FeatherBlender_float(sharpness) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_FeatherBlender::from_raw(ptr) })
	}
...
pub trait Detail_FisheyeProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_FisheyeProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_FisheyeProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_FisheyeProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_FisheyeProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_FisheyeProjector }
...
impl Detail_FisheyeProjector {
	pub fn as_raw_Detail_FisheyeProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_FisheyeProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_FisheyeProjectorTrait for Detail_FisheyeProjector {
	fn as_raw_Detail_FisheyeProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_FisheyeProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_FisheyeWarper }
...
impl Detail_FisheyeWarper {
	pub fn as_raw_Detail_FisheyeWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_FisheyeWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_FisheyeWarper {}

impl crate::stitching::Detail_FisheyeWarperTrait for Detail_FisheyeWarper {
	fn as_raw_Detail_FisheyeWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_FisheyeWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_FisheyeWarper {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_FisheyeWarper> {
		unsafe { sys::cv_detail_FisheyeWarper_FisheyeWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_FisheyeWarper::from_raw(ptr) })
	}
...
pub trait Detail_GainCompensatorTrait: crate::stitching::Detail_ExposureCompensator {
	...
	fn apply(&mut self, index: i32, corner: core::Point, image: &mut dyn core::ToInputOutputArray, mask: &dyn core::ToInputArray) -> Result<()> {
		input_output_array_arg!(image);
		input_array_arg!(mask);
		unsafe { sys::cv_detail_GainCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(self.as_raw_mut_Detail_GainCompensator(), index, &corner, image.as_raw__InputOutputArray(), mask.as_raw__InputArray()) }.into_result()
	}
	
	fn get_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_GainCompensator_getMatGains_vector_Mat_X(self.as_raw_mut_Detail_GainCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	
	fn set_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_GainCompensator_setMatGains_vector_Mat_X(self.as_raw_mut_Detail_GainCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	...
	fn gains(&self) -> Result<core::Vector::<f64>> {
		unsafe { sys::cv_detail_GainCompensator_gains_const(self.as_raw_Detail_GainCompensator()) }.into_result().map(|ptr| unsafe { core::Vector::<f64>::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_GainCompensator }
...
impl Detail_GainCompensator {
	pub fn as_raw_Detail_GainCompensator(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_GainCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_GainCompensatorTrait for Detail_GainCompensator {
	fn as_raw_Detail_GainCompensator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_GainCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_GainCompensator {
	pub fn default() -> Result<crate::stitching::Detail_GainCompensator> {
		unsafe { sys::cv_detail_GainCompensator_GainCompensator() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_GainCompensator::from_raw(ptr) })
	}
	
	pub fn new(nr_feeds: i32) -> Result<crate::stitching::Detail_GainCompensator> {
		unsafe { sys::cv_detail_GainCompensator_GainCompensator_int(nr_feeds) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_GainCompensator::from_raw(ptr) })
	}
...
impl Detail_Graph {
	pub fn as_raw_Detail_Graph(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_Graph(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_Graph {}

impl crate::stitching::Detail_GraphTrait for Detail_Graph {
	fn as_raw_Detail_Graph(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_Graph(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_Graph {
	...
	pub fn new(num_vertices: i32) -> Result<crate::stitching::Detail_Graph> {
		unsafe { sys::cv_detail_Graph_Graph_int(num_vertices) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_Graph::from_raw(ptr) })
	}
...
pub trait Detail_GraphCutSeamFinderTrait: crate::stitching::Detail_GraphCutSeamFinderBaseTrait + crate::stitching::Detail_SeamFinder {
	...
	fn find(&mut self, src: &core::Vector::<core::UMat>, corners: &core::Vector::<core::Point>, masks: &mut core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_GraphCutSeamFinder_find_const_vector_UMat_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_GraphCutSeamFinder(), src.as_raw_VectorOfUMat(), corners.as_raw_VectorOfPoint(), masks.as_raw_mut_VectorOfUMat()) }.into_result()
	}
...
boxed_ptr! { Detail_GraphCutSeamFinder }
...
impl Detail_GraphCutSeamFinder {
	pub fn as_raw_Detail_GraphCutSeamFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_GraphCutSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_GraphCutSeamFinderTrait for Detail_GraphCutSeamFinder {
	fn as_raw_Detail_GraphCutSeamFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_GraphCutSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_GraphCutSeamFinderBaseTrait for Detail_GraphCutSeamFinder {
	fn as_raw_Detail_GraphCutSeamFinderBase(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_GraphCutSeamFinderBase(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_GraphCutSeamFinder {
	...
	pub fn new(cost_type: i32, terminal_cost: f32, bad_region_penalty: f32) -> Result<crate::stitching::Detail_GraphCutSeamFinder> {
		unsafe { sys::cv_detail_GraphCutSeamFinder_GraphCutSeamFinder_int_float_float(cost_type, terminal_cost, bad_region_penalty) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_GraphCutSeamFinder::from_raw(ptr) })
	}
	...
	pub fn new_1(cost_type: &str, terminal_cost: f32, bad_region_penalty: f32) -> Result<crate::stitching::Detail_GraphCutSeamFinder> {
		string_arg!(cost_type);
		unsafe { sys::cv_detail_GraphCutSeamFinder_GraphCutSeamFinder_String_float_float(cost_type.as_ptr() as _, terminal_cost, bad_region_penalty) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_GraphCutSeamFinder::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_GraphCutSeamFinderBase }
...
impl Detail_GraphCutSeamFinderBase {
	pub fn as_raw_Detail_GraphCutSeamFinderBase(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_GraphCutSeamFinderBase(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait Detail_GraphEdgeTrait {
	...
	fn set_from(&mut self, val: i32) -> () {
		unsafe { sys::cv_detail_GraphEdge_setFrom_int(self.as_raw_mut_Detail_GraphEdge(), val) }.into_result().expect("Infallible function failed: set_from")
	}
	...
	fn set_to(&mut self, val: i32) -> () {
		unsafe { sys::cv_detail_GraphEdge_setTo_int(self.as_raw_mut_Detail_GraphEdge(), val) }.into_result().expect("Infallible function failed: set_to")
	}
	...
	fn set_weight(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_GraphEdge_setWeight_float(self.as_raw_mut_Detail_GraphEdge(), val) }.into_result().expect("Infallible function failed: set_weight")
	}
...
impl Detail_GraphEdge {
	pub fn as_raw_Detail_GraphEdge(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_GraphEdge(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_GraphEdge {}

impl crate::stitching::Detail_GraphEdgeTrait for Detail_GraphEdge {
	fn as_raw_Detail_GraphEdge(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_GraphEdge(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_GraphEdge {
	pub fn new(from: i32, to: i32, weight: f32) -> Result<crate::stitching::Detail_GraphEdge> {
		unsafe { sys::cv_detail_GraphEdge_GraphEdge_int_int_float(from, to, weight) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_GraphEdge::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_HomographyBasedEstimator }
...
impl Detail_HomographyBasedEstimator {
	pub fn as_raw_Detail_HomographyBasedEstimator(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_HomographyBasedEstimator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_HomographyBasedEstimatorTrait for Detail_HomographyBasedEstimator {
	fn as_raw_Detail_HomographyBasedEstimator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_HomographyBasedEstimator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_HomographyBasedEstimator {
	...
	pub fn new(is_focals_estimated: bool) -> Result<crate::stitching::Detail_HomographyBasedEstimator> {
		unsafe { sys::cv_detail_HomographyBasedEstimator_HomographyBasedEstimator_bool(is_focals_estimated) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_HomographyBasedEstimator::from_raw(ptr) })
	}
...
pub trait Detail_ImageFeaturesTrait {
	...
	fn set_img_idx(&mut self, val: i32) -> () {
		unsafe { sys::cv_detail_ImageFeatures_setImg_idx_int(self.as_raw_mut_Detail_ImageFeatures(), val) }.into_result().expect("Infallible function failed: set_img_idx")
	}
	...
	fn set_img_size(&mut self, val: core::Size) -> () {
		unsafe { sys::cv_detail_ImageFeatures_setImg_size_Size(self.as_raw_mut_Detail_ImageFeatures(), &val) }.into_result().expect("Infallible function failed: set_img_size")
	}
	
	fn keypoints(&mut self) -> core::Vector::<core::KeyPoint> {
		unsafe { sys::cv_detail_ImageFeatures_keypoints(self.as_raw_mut_Detail_ImageFeatures()) }.into_result().map(|ptr| unsafe { core::Vector::<core::KeyPoint>::from_raw(ptr) }).expect("Infallible function failed: keypoints")
	}
	
	fn set_keypoints(&mut self, mut val: core::Vector::<core::KeyPoint>) -> () {
		unsafe { sys::cv_detail_ImageFeatures_setKeypoints_vector_KeyPoint_(self.as_raw_mut_Detail_ImageFeatures(), val.as_raw_mut_VectorOfKeyPoint()) }.into_result().expect("Infallible function failed: set_keypoints")
	}
	
	fn descriptors(&mut self) -> core::UMat {
		unsafe { sys::cv_detail_ImageFeatures_descriptors(self.as_raw_mut_Detail_ImageFeatures()) }.into_result().map(|ptr| unsafe { core::UMat::from_raw(ptr) }).expect("Infallible function failed: descriptors")
	}
	
	fn set_descriptors(&mut self, mut val: core::UMat) -> () {
		unsafe { sys::cv_detail_ImageFeatures_setDescriptors_UMat(self.as_raw_mut_Detail_ImageFeatures(), val.as_raw_mut_UMat()) }.into_result().expect("Infallible function failed: set_descriptors")
	}
	
	fn get_keypoints(&mut self) -> Result<core::Vector::<core::KeyPoint>> {
		unsafe { sys::cv_detail_ImageFeatures_getKeypoints(self.as_raw_mut_Detail_ImageFeatures()) }.into_result().map(|ptr| unsafe { core::Vector::<core::KeyPoint>::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_ImageFeatures }
...
impl Detail_ImageFeatures {
	pub fn as_raw_Detail_ImageFeatures(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_ImageFeatures(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_ImageFeatures {}

impl crate::stitching::Detail_ImageFeaturesTrait for Detail_ImageFeatures {
	fn as_raw_Detail_ImageFeatures(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_ImageFeatures(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait Detail_MatchesInfoTrait {
	...
	fn set_src_img_idx(&mut self, val: i32) -> () {
		unsafe { sys::cv_detail_MatchesInfo_setSrc_img_idx_int(self.as_raw_mut_Detail_MatchesInfo(), val) }.into_result().expect("Infallible function failed: set_src_img_idx")
	}
	...
	fn set_dst_img_idx(&mut self, val: i32) -> () {
		unsafe { sys::cv_detail_MatchesInfo_setDst_img_idx_int(self.as_raw_mut_Detail_MatchesInfo(), val) }.into_result().expect("Infallible function failed: set_dst_img_idx")
	}
	
	fn matches(&mut self) -> core::Vector::<core::DMatch> {
		unsafe { sys::cv_detail_MatchesInfo_matches(self.as_raw_mut_Detail_MatchesInfo()) }.into_result().map(|ptr| unsafe { core::Vector::<core::DMatch>::from_raw(ptr) }).expect("Infallible function failed: matches")
	}
	
	fn set_matches(&mut self, mut val: core::Vector::<core::DMatch>) -> () {
		unsafe { sys::cv_detail_MatchesInfo_setMatches_vector_DMatch_(self.as_raw_mut_Detail_MatchesInfo(), val.as_raw_mut_VectorOfDMatch()) }.into_result().expect("Infallible function failed: set_matches")
	}
	
	/// Geometrically consistent matches mask
	fn inliers_mask(&mut self) -> core::Vector::<u8> {
		unsafe { sys::cv_detail_MatchesInfo_inliers_mask(self.as_raw_mut_Detail_MatchesInfo()) }.into_result().map(|ptr| unsafe { core::Vector::<u8>::from_raw(ptr) }).expect("Infallible function failed: inliers_mask")
	}
	
	/// Geometrically consistent matches mask
	fn set_inliers_mask(&mut self, mut val: core::Vector::<u8>) -> () {
		unsafe { sys::cv_detail_MatchesInfo_setInliers_mask_vector_unsigned_char_(self.as_raw_mut_Detail_MatchesInfo(), val.as_raw_mut_VectorOfu8()) }.into_result().expect("Infallible function failed: set_inliers_mask")
	}
	...
	fn set_num_inliers(&mut self, val: i32) -> () {
		unsafe { sys::cv_detail_MatchesInfo_setNum_inliers_int(self.as_raw_mut_Detail_MatchesInfo(), val) }.into_result().expect("Infallible function failed: set_num_inliers")
	}
	
	/// Estimated transformation
	fn h(&mut self) -> core::Mat {
		unsafe { sys::cv_detail_MatchesInfo_H(self.as_raw_mut_Detail_MatchesInfo()) }.into_result().map(|ptr| unsafe { core::Mat::from_raw(ptr) }).expect("Infallible function failed: h")
	}
	
	/// Estimated transformation
	fn set_h(&mut self, mut val: core::Mat) -> () {
		unsafe { sys::cv_detail_MatchesInfo_setH_Mat(self.as_raw_mut_Detail_MatchesInfo(), val.as_raw_mut_Mat()) }.into_result().expect("Infallible function failed: set_h")
	}
	...
	fn set_confidence(&mut self, val: f64) -> () {
		unsafe { sys::cv_detail_MatchesInfo_setConfidence_double(self.as_raw_mut_Detail_MatchesInfo(), val) }.into_result().expect("Infallible function failed: set_confidence")
	}
	
	fn get_matches(&mut self) -> Result<core::Vector::<core::DMatch>> {
		unsafe { sys::cv_detail_MatchesInfo_getMatches(self.as_raw_mut_Detail_MatchesInfo()) }.into_result().map(|ptr| unsafe { core::Vector::<core::DMatch>::from_raw(ptr) })
	}
	
	fn get_inliers(&mut self) -> Result<core::Vector::<u8>> {
		unsafe { sys::cv_detail_MatchesInfo_getInliers(self.as_raw_mut_Detail_MatchesInfo()) }.into_result().map(|ptr| unsafe { core::Vector::<u8>::from_raw(ptr) })
	}
...
impl Detail_MatchesInfo {
	pub fn as_raw_Detail_MatchesInfo(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_MatchesInfo(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_MatchesInfo {}

impl crate::stitching::Detail_MatchesInfoTrait for Detail_MatchesInfo {
	fn as_raw_Detail_MatchesInfo(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_MatchesInfo(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_MatchesInfo {
	pub fn default() -> Result<crate::stitching::Detail_MatchesInfo> {
		unsafe { sys::cv_detail_MatchesInfo_MatchesInfo() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_MatchesInfo::from_raw(ptr) })
	}
	
	pub fn copy(other: &crate::stitching::Detail_MatchesInfo) -> Result<crate::stitching::Detail_MatchesInfo> {
		unsafe { sys::cv_detail_MatchesInfo_MatchesInfo_const_MatchesInfoX(other.as_raw_Detail_MatchesInfo()) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_MatchesInfo::from_raw(ptr) })
	}
...
pub trait Detail_MercatorProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_MercatorProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_MercatorProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_MercatorProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_MercatorProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_MercatorProjector }
...
impl Detail_MercatorProjector {
	pub fn as_raw_Detail_MercatorProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_MercatorProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_MercatorProjectorTrait for Detail_MercatorProjector {
	fn as_raw_Detail_MercatorProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_MercatorProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_MercatorWarper }
...
impl Detail_MercatorWarper {
	pub fn as_raw_Detail_MercatorWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_MercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_MercatorWarper {}

impl crate::stitching::Detail_MercatorWarperTrait for Detail_MercatorWarper {
	fn as_raw_Detail_MercatorWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_MercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_MercatorWarper {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_MercatorWarper> {
		unsafe { sys::cv_detail_MercatorWarper_MercatorWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_MercatorWarper::from_raw(ptr) })
	}
...
pub trait Detail_MultiBandBlenderTrait: crate::stitching::Detail_BlenderTrait {
	...
	fn prepare(&mut self, dst_roi: core::Rect) -> Result<()> {
		unsafe { sys::cv_detail_MultiBandBlender_prepare_Rect(self.as_raw_mut_Detail_MultiBandBlender(), &dst_roi) }.into_result()
	}
	
	fn feed(&mut self, img: &dyn core::ToInputArray, mask: &dyn core::ToInputArray, tl: core::Point) -> Result<()> {
		input_array_arg!(img);
		input_array_arg!(mask);
		unsafe { sys::cv_detail_MultiBandBlender_feed_const__InputArrayX_const__InputArrayX_Point(self.as_raw_mut_Detail_MultiBandBlender(), img.as_raw__InputArray(), mask.as_raw__InputArray(), &tl) }.into_result()
	}
	
	fn blend(&mut self, dst: &mut dyn core::ToInputOutputArray, dst_mask: &mut dyn core::ToInputOutputArray) -> Result<()> {
		input_output_array_arg!(dst);
		input_output_array_arg!(dst_mask);
		unsafe { sys::cv_detail_MultiBandBlender_blend_const__InputOutputArrayX_const__InputOutputArrayX(self.as_raw_mut_Detail_MultiBandBlender(), dst.as_raw__InputOutputArray(), dst_mask.as_raw__InputOutputArray()) }.into_result()
	}
...
boxed_ptr! { Detail_MultiBandBlender }
...
impl Detail_MultiBandBlender {
	pub fn as_raw_Detail_MultiBandBlender(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_MultiBandBlender(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_MultiBandBlenderTrait for Detail_MultiBandBlender {
	fn as_raw_Detail_MultiBandBlender(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_MultiBandBlender(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_MultiBandBlender {
	...
	pub fn new(try_gpu: i32, num_bands: i32, weight_type: i32) -> Result<crate::stitching::Detail_MultiBandBlender> {
		unsafe { sys::cv_detail_MultiBandBlender_MultiBandBlender_int_int_int(try_gpu, num_bands, weight_type) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_MultiBandBlender::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_NoBundleAdjuster }
...
impl Detail_NoBundleAdjuster {
	pub fn as_raw_Detail_NoBundleAdjuster(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_NoBundleAdjuster(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_NoBundleAdjusterTrait for Detail_NoBundleAdjuster {
	fn as_raw_Detail_NoBundleAdjuster(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_NoBundleAdjuster(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_NoBundleAdjuster {
	pub fn default() -> Result<crate::stitching::Detail_NoBundleAdjuster> {
		unsafe { sys::cv_detail_NoBundleAdjuster_NoBundleAdjuster() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_NoBundleAdjuster::from_raw(ptr) })
	}
...
pub trait Detail_NoExposureCompensatorTrait: crate::stitching::Detail_ExposureCompensator {
	...
	fn apply(&mut self, unnamed: i32, unnamed_1: core::Point, unnamed_2: &mut dyn core::ToInputOutputArray, unnamed_3: &dyn core::ToInputArray) -> Result<()> {
		...
		unsafe { sys::cv_detail_NoExposureCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(self.as_raw_mut_Detail_NoExposureCompensator(), unnamed, &unnamed_1, unnamed_2.as_raw__InputOutputArray(), unnamed_3.as_raw__InputArray()) }.into_result()
	}
	
	fn get_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_NoExposureCompensator_getMatGains_vector_Mat_X(self.as_raw_mut_Detail_NoExposureCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
	
	fn set_mat_gains(&mut self, umv: &mut core::Vector::<core::Mat>) -> Result<()> {
		unsafe { sys::cv_detail_NoExposureCompensator_setMatGains_vector_Mat_X(self.as_raw_mut_Detail_NoExposureCompensator(), umv.as_raw_mut_VectorOfMat()) }.into_result()
	}
...
boxed_ptr! { Detail_NoExposureCompensator }
...
impl Detail_NoExposureCompensator {
	pub fn as_raw_Detail_NoExposureCompensator(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_NoExposureCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_NoExposureCompensatorTrait for Detail_NoExposureCompensator {
	fn as_raw_Detail_NoExposureCompensator(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_NoExposureCompensator(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait Detail_NoSeamFinderTrait: crate::stitching::Detail_SeamFinder {
	...
	fn find(&mut self, unnamed: &core::Vector::<core::UMat>, unnamed_1: &core::Vector::<core::Point>, unnamed_2: &mut core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_NoSeamFinder_find_const_vector_UMat_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_NoSeamFinder(), unnamed.as_raw_VectorOfUMat(), unnamed_1.as_raw_VectorOfPoint(), unnamed_2.as_raw_mut_VectorOfUMat()) }.into_result()
	}
...
impl Detail_NoSeamFinder {
	pub fn as_raw_Detail_NoSeamFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_NoSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_NoSeamFinder {}

impl crate::stitching::Detail_NoSeamFinderTrait for Detail_NoSeamFinder {
	fn as_raw_Detail_NoSeamFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_NoSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait Detail_PairwiseSeamFinder: crate::stitching::Detail_SeamFinder {
	...
	fn find(&mut self, src: &core::Vector::<core::UMat>, corners: &core::Vector::<core::Point>, masks: &mut core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_PairwiseSeamFinder_find_const_vector_UMat_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_PairwiseSeamFinder(), src.as_raw_VectorOfUMat(), corners.as_raw_VectorOfPoint(), masks.as_raw_mut_VectorOfUMat()) }.into_result()
	}
...
pub trait Detail_PaniniPortraitProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn set_a(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_PaniniPortraitProjector_setA_float(self.as_raw_mut_Detail_PaniniPortraitProjector(), val) }.into_result().expect("Infallible function failed: set_a")
	}
	...
	fn set_b(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_PaniniPortraitProjector_setB_float(self.as_raw_mut_Detail_PaniniPortraitProjector(), val) }.into_result().expect("Infallible function failed: set_b")
	}
	
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PaniniPortraitProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_PaniniPortraitProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PaniniPortraitProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_PaniniPortraitProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_PaniniPortraitProjector }
...
impl Detail_PaniniPortraitProjector {
	pub fn as_raw_Detail_PaniniPortraitProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PaniniPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_PaniniPortraitProjectorTrait for Detail_PaniniPortraitProjector {
	fn as_raw_Detail_PaniniPortraitProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PaniniPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_PaniniPortraitWarper }
...
impl Detail_PaniniPortraitWarper {
	pub fn as_raw_Detail_PaniniPortraitWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PaniniPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_PaniniPortraitWarperTrait for Detail_PaniniPortraitWarper {
	fn as_raw_Detail_PaniniPortraitWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PaniniPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_PaniniPortraitWarper {
	...
	pub fn new(scale: f32, a: f32, b: f32) -> Result<crate::stitching::Detail_PaniniPortraitWarper> {
		unsafe { sys::cv_detail_PaniniPortraitWarper_PaniniPortraitWarper_float_float_float(scale, a, b) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_PaniniPortraitWarper::from_raw(ptr) })
	}
...
pub trait Detail_PaniniProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn set_a(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_PaniniProjector_setA_float(self.as_raw_mut_Detail_PaniniProjector(), val) }.into_result().expect("Infallible function failed: set_a")
	}
	...
	fn set_b(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_PaniniProjector_setB_float(self.as_raw_mut_Detail_PaniniProjector(), val) }.into_result().expect("Infallible function failed: set_b")
	}
	
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PaniniProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_PaniniProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PaniniProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_PaniniProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_PaniniProjector }
...
impl Detail_PaniniProjector {
	pub fn as_raw_Detail_PaniniProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PaniniProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_PaniniProjector {}

impl crate::stitching::Detail_PaniniProjectorTrait for Detail_PaniniProjector {
	fn as_raw_Detail_PaniniProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PaniniProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_PaniniWarper {
	pub fn as_raw_Detail_PaniniWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PaniniWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_PaniniWarper {}

impl crate::stitching::Detail_PaniniWarperTrait for Detail_PaniniWarper {
	fn as_raw_Detail_PaniniWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PaniniWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_PaniniWarper {
	...
	pub fn new(scale: f32, a: f32, b: f32) -> Result<crate::stitching::Detail_PaniniWarper> {
		unsafe { sys::cv_detail_PaniniWarper_PaniniWarper_float_float_float(scale, a, b) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_PaniniWarper::from_raw(ptr) })
	}
...
pub trait Detail_PlanePortraitProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PlanePortraitProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_PlanePortraitProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PlanePortraitProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_PlanePortraitProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_PlanePortraitProjector }
...
impl Detail_PlanePortraitProjector {
	pub fn as_raw_Detail_PlanePortraitProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PlanePortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_PlanePortraitProjectorTrait for Detail_PlanePortraitProjector {
	fn as_raw_Detail_PlanePortraitProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PlanePortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_PlanePortraitWarper }
...
impl Detail_PlanePortraitWarper {
	pub fn as_raw_Detail_PlanePortraitWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PlanePortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_PlanePortraitWarperTrait for Detail_PlanePortraitWarper {
	fn as_raw_Detail_PlanePortraitWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PlanePortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_PlanePortraitWarper {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_PlanePortraitWarper> {
		unsafe { sys::cv_detail_PlanePortraitWarper_PlanePortraitWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_PlanePortraitWarper::from_raw(ptr) })
	}
...
pub trait Detail_PlaneProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PlaneProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_PlaneProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_PlaneProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_PlaneProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_PlaneProjector }
...
impl Detail_PlaneProjector {
	pub fn as_raw_Detail_PlaneProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PlaneProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_PlaneProjector {}

impl crate::stitching::Detail_PlaneProjectorTrait for Detail_PlaneProjector {
	fn as_raw_Detail_PlaneProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PlaneProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait Detail_PlaneWarperTrait {
	...
	fn warp_point(&mut self, pt: core::Point2f, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray) -> Result<core::Point2f> {
		input_array_arg!(k);
		input_array_arg!(r);
		unsafe { sys::cv_detail_PlaneWarper_warpPoint_const_Point2fX_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_PlaneWarper(), &pt, k.as_raw__InputArray(), r.as_raw__InputArray()) }.into_result()
	}
	...
	fn warp_point_1(&mut self, pt: core::Point2f, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, t: &dyn core::ToInputArray) -> Result<core::Point2f> {
		...
		input_array_arg!(r);
		input_array_arg!(t);
		unsafe { sys::cv_detail_PlaneWarper_warpPoint_const_Point2fX_const__InputArrayX_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_PlaneWarper(), &pt, k.as_raw__InputArray(), r.as_raw__InputArray(), t.as_raw__InputArray()) }.into_result()
	}
	...
	fn build_maps_1(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_PlaneWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_PlaneWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_PlaneWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_PlaneWarper(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp_roi(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray) -> Result<core::Rect> {
		input_array_arg!(k);
		input_array_arg!(r);
		unsafe { sys::cv_detail_PlaneWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_PlaneWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray()) }.into_result()
	}
	...
	fn warp_roi_1(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, t: &dyn core::ToInputArray) -> Result<core::Rect> {
		...
		input_array_arg!(r);
		input_array_arg!(t);
		unsafe { sys::cv_detail_PlaneWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_PlaneWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), t.as_raw__InputArray()) }.into_result()
	}
...
impl Detail_PlaneWarper {
	pub fn as_raw_Detail_PlaneWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PlaneWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_PlaneWarper {
	...
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_PlaneWarper> {
		unsafe { sys::cv_detail_PlaneWarper_PlaneWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_PlaneWarper::from_raw(ptr) })
	}
...
pub trait Detail_PlaneWarperGpuTrait: crate::stitching::Detail_PlaneWarperTrait {
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_PlaneWarperGpu_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_PlaneWarperGpu(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_PlaneWarperGpu_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_PlaneWarperGpu(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
...
boxed_ptr! { Detail_PlaneWarperGpu }
...
impl Detail_PlaneWarperGpu {
	pub fn as_raw_Detail_PlaneWarperGpu(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_PlaneWarperGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_PlaneWarperGpuTrait for Detail_PlaneWarperGpu {
	fn as_raw_Detail_PlaneWarperGpu(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PlaneWarperGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_PlaneWarperGpu {
	...
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_PlaneWarperGpu> {
		unsafe { sys::cv_detail_PlaneWarperGpu_PlaneWarperGpu_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_PlaneWarperGpu::from_raw(ptr) })
	}
...
pub trait Detail_ProjectorBaseTrait {
	...
	fn set_scale(&mut self, val: f32) -> () {
		unsafe { sys::cv_detail_ProjectorBase_setScale_float(self.as_raw_mut_Detail_ProjectorBase(), val) }.into_result().expect("Infallible function failed: set_scale")
	}
	
	fn k(&mut self) -> &mut [f32; 9] {
		unsafe { sys::cv_detail_ProjectorBase_k(self.as_raw_mut_Detail_ProjectorBase()) }.into_result().and_then(|x| unsafe { x.as_mut() }.ok_or_else(|| Error::new(core::StsNullPtr, "Function returned Null pointer".to_string()))).expect("Infallible function failed: k")
	}
	
	fn rinv(&mut self) -> &mut [f32; 9] {
		unsafe { sys::cv_detail_ProjectorBase_rinv(self.as_raw_mut_Detail_ProjectorBase()) }.into_result().and_then(|x| unsafe { x.as_mut() }.ok_or_else(|| Error::new(core::StsNullPtr, "Function returned Null pointer".to_string()))).expect("Infallible function failed: rinv")
	}
	
	fn r_kinv(&mut self) -> &mut [f32; 9] {
		unsafe { sys::cv_detail_ProjectorBase_r_kinv(self.as_raw_mut_Detail_ProjectorBase()) }.into_result().and_then(|x| unsafe { x.as_mut() }.ok_or_else(|| Error::new(core::StsNullPtr, "Function returned Null pointer".to_string()))).expect("Infallible function failed: r_kinv")
	}
	
	fn k_rinv(&mut self) -> &mut [f32; 9] {
		unsafe { sys::cv_detail_ProjectorBase_k_rinv(self.as_raw_mut_Detail_ProjectorBase()) }.into_result().and_then(|x| unsafe { x.as_mut() }.ok_or_else(|| Error::new(core::StsNullPtr, "Function returned Null pointer".to_string()))).expect("Infallible function failed: k_rinv")
	}
	
	fn t(&mut self) -> &mut [f32; 3] {
		unsafe { sys::cv_detail_ProjectorBase_t(self.as_raw_mut_Detail_ProjectorBase()) }.into_result().and_then(|x| unsafe { x.as_mut() }.ok_or_else(|| Error::new(core::StsNullPtr, "Function returned Null pointer".to_string()))).expect("Infallible function failed: t")
	}
	...
	fn set_camera_params(&mut self, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, t: &dyn core::ToInputArray) -> Result<()> {
		...
		input_array_arg!(r);
		input_array_arg!(t);
		unsafe { sys::cv_detail_ProjectorBase_setCameraParams_const__InputArrayX_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_ProjectorBase(), k.as_raw__InputArray(), r.as_raw__InputArray(), t.as_raw__InputArray()) }.into_result()
	}
...
boxed_ptr! { Detail_ProjectorBase }
...
impl Detail_ProjectorBase {
	pub fn as_raw_Detail_ProjectorBase(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_ProjectorBase(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
pub trait Detail_RotationWarper {
	...
	fn warp_point(&mut self, pt: core::Point2f, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray) -> Result<core::Point2f> {
		input_array_arg!(k);
		input_array_arg!(r);
		unsafe { sys::cv_detail_RotationWarper_warpPoint_const_Point2fX_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_RotationWarper(), &pt, k.as_raw__InputArray(), r.as_raw__InputArray()) }.into_result()
	}
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_RotationWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_RotationWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_RotationWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_RotationWarper(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp_roi(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray) -> Result<core::Rect> {
		input_array_arg!(k);
		input_array_arg!(r);
		unsafe { sys::cv_detail_RotationWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX(self.as_raw_mut_Detail_RotationWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray()) }.into_result()
	}
...
pub trait Detail_SeamFinder {
	...
	fn find(&mut self, src: &core::Vector::<core::UMat>, corners: &core::Vector::<core::Point>, masks: &mut core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_SeamFinder_find_const_vector_UMat_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_SeamFinder(), src.as_raw_VectorOfUMat(), corners.as_raw_VectorOfPoint(), masks.as_raw_mut_VectorOfUMat()) }.into_result()
	}
...
impl dyn Detail_SeamFinder + '_ {
	pub fn create_default(typ: i32) -> Result<core::Ptr::<dyn crate::stitching::Detail_SeamFinder>> {
		unsafe { sys::cv_detail_SeamFinder_createDefault_int(typ) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_SeamFinder>::from_raw(ptr) })
	}
...
pub trait Detail_SphericalPortraitProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_SphericalPortraitProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_SphericalPortraitProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_SphericalPortraitProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_SphericalPortraitProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_SphericalPortraitProjector }
...
impl Detail_SphericalPortraitProjector {
	pub fn as_raw_Detail_SphericalPortraitProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SphericalPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SphericalPortraitProjectorTrait for Detail_SphericalPortraitProjector {
	fn as_raw_Detail_SphericalPortraitProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SphericalPortraitProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_SphericalPortraitWarper }
...
impl Detail_SphericalPortraitWarper {
	pub fn as_raw_Detail_SphericalPortraitWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SphericalPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SphericalPortraitWarperTrait for Detail_SphericalPortraitWarper {
	fn as_raw_Detail_SphericalPortraitWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SphericalPortraitWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_SphericalPortraitWarper {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_SphericalPortraitWarper> {
		unsafe { sys::cv_detail_SphericalPortraitWarper_SphericalPortraitWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_SphericalPortraitWarper::from_raw(ptr) })
	}
...
impl Detail_SphericalProjector {
	pub fn map_forward(self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_SphericalProjector_mapForward_float_float_floatX_floatX(&self, x, y, u, v) }.into_result()
	}
	
	pub fn map_backward(self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_SphericalProjector_mapBackward_float_float_floatX_floatX(&self, u, v, x, y) }.into_result()
	}
...
pub trait Detail_SphericalWarperTrait {
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_SphericalWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_SphericalWarper(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_SphericalWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_SphericalWarper(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
...
boxed_ptr! { Detail_SphericalWarper }
...
impl Detail_SphericalWarper {
	pub fn as_raw_Detail_SphericalWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SphericalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SphericalWarperTrait for Detail_SphericalWarper {
	fn as_raw_Detail_SphericalWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SphericalWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_SphericalWarper {
	...
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_SphericalWarper> {
		unsafe { sys::cv_detail_SphericalWarper_SphericalWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_SphericalWarper::from_raw(ptr) })
	}
...
pub trait Detail_SphericalWarperGpuTrait: crate::stitching::Detail_SphericalWarperTrait {
	...
	fn build_maps(&mut self, src_size: core::Size, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, xmap: &mut dyn core::ToOutputArray, ymap: &mut dyn core::ToOutputArray) -> Result<core::Rect> {
		...
		output_array_arg!(xmap);
		output_array_arg!(ymap);
		unsafe { sys::cv_detail_SphericalWarperGpu_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_mut_Detail_SphericalWarperGpu(), &src_size, k.as_raw__InputArray(), r.as_raw__InputArray(), xmap.as_raw__OutputArray(), ymap.as_raw__OutputArray()) }.into_result()
	}
	...
	fn warp(&mut self, src: &dyn core::ToInputArray, k: &dyn core::ToInputArray, r: &dyn core::ToInputArray, interp_mode: i32, border_mode: i32, dst: &mut dyn core::ToOutputArray) -> Result<core::Point> {
		...
		input_array_arg!(r);
		output_array_arg!(dst);
		unsafe { sys::cv_detail_SphericalWarperGpu_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(self.as_raw_mut_Detail_SphericalWarperGpu(), src.as_raw__InputArray(), k.as_raw__InputArray(), r.as_raw__InputArray(), interp_mode, border_mode, dst.as_raw__OutputArray()) }.into_result()
	}
...
boxed_ptr! { Detail_SphericalWarperGpu }
...
impl Detail_SphericalWarperGpu {
	pub fn as_raw_Detail_SphericalWarperGpu(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SphericalWarperGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SphericalWarperGpuTrait for Detail_SphericalWarperGpu {
	fn as_raw_Detail_SphericalWarperGpu(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SphericalWarperGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_SphericalWarperGpu {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_SphericalWarperGpu> {
		unsafe { sys::cv_detail_SphericalWarperGpu_SphericalWarperGpu_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_SphericalWarperGpu::from_raw(ptr) })
	}
...
pub trait Detail_StereographicProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_StereographicProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_StereographicProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_StereographicProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_StereographicProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_StereographicProjector }
...
impl Detail_StereographicProjector {
	pub fn as_raw_Detail_StereographicProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_StereographicProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_StereographicProjectorTrait for Detail_StereographicProjector {
	fn as_raw_Detail_StereographicProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_StereographicProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_StereographicWarper }
...
impl Detail_StereographicWarper {
	pub fn as_raw_Detail_StereographicWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_StereographicWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_StereographicWarperTrait for Detail_StereographicWarper {
	fn as_raw_Detail_StereographicWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_StereographicWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_StereographicWarper {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_StereographicWarper> {
		unsafe { sys::cv_detail_StereographicWarper_StereographicWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_StereographicWarper::from_raw(ptr) })
	}
...
pub trait Detail_TransverseMercatorProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_TransverseMercatorProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_TransverseMercatorProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_TransverseMercatorProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_TransverseMercatorProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_TransverseMercatorProjector }
...
impl Detail_TransverseMercatorProjector {
	pub fn as_raw_Detail_TransverseMercatorProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_TransverseMercatorProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_TransverseMercatorProjectorTrait for Detail_TransverseMercatorProjector {
	fn as_raw_Detail_TransverseMercatorProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_TransverseMercatorProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_TransverseMercatorWarper }
...
impl Detail_TransverseMercatorWarper {
	pub fn as_raw_Detail_TransverseMercatorWarper(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_TransverseMercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_TransverseMercatorWarperTrait for Detail_TransverseMercatorWarper {
	fn as_raw_Detail_TransverseMercatorWarper(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_TransverseMercatorWarper(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_TransverseMercatorWarper {
	pub fn new(scale: f32) -> Result<crate::stitching::Detail_TransverseMercatorWarper> {
		unsafe { sys::cv_detail_TransverseMercatorWarper_TransverseMercatorWarper_float(scale) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_TransverseMercatorWarper::from_raw(ptr) })
	}
...
pub trait Detail_VoronoiSeamFinderTrait: crate::stitching::Detail_PairwiseSeamFinder {
	...
	fn find(&mut self, src: &core::Vector::<core::UMat>, corners: &core::Vector::<core::Point>, masks: &mut core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_VoronoiSeamFinder_find_const_vector_UMat_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_VoronoiSeamFinder(), src.as_raw_VectorOfUMat(), corners.as_raw_VectorOfPoint(), masks.as_raw_mut_VectorOfUMat()) }.into_result()
	}
	
	fn find_1(&mut self, size: &core::Vector::<core::Size>, corners: &core::Vector::<core::Point>, masks: &mut core::Vector::<core::UMat>) -> Result<()> {
		unsafe { sys::cv_detail_VoronoiSeamFinder_find_const_vector_Size_X_const_vector_Point_X_vector_UMat_X(self.as_raw_mut_Detail_VoronoiSeamFinder(), size.as_raw_VectorOfSize(), corners.as_raw_VectorOfPoint(), masks.as_raw_mut_VectorOfUMat()) }.into_result()
	}
...
boxed_ptr! { Detail_VoronoiSeamFinder }
...
impl Detail_VoronoiSeamFinder {
	pub fn as_raw_Detail_VoronoiSeamFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_VoronoiSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for Detail_VoronoiSeamFinder {}

impl crate::stitching::Detail_PairwiseSeamFinder for Detail_VoronoiSeamFinder {
	fn as_raw_Detail_PairwiseSeamFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_PairwiseSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_VoronoiSeamFinderTrait for Detail_VoronoiSeamFinder {
	fn as_raw_Detail_VoronoiSeamFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_VoronoiSeamFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
