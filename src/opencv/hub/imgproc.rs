...
//!
//! ![Delaunay triangulation (black) and Voronoi (red)](https://docs.opencv.org/3.4.8/delaunay_voronoi.png)
//!
...
/// ![autumn](https://docs.opencv.org/3.4.8/colormaps/colorscale_autumn.jpg)
pub const COLORMAP_AUTUMN: i32 = 0;
/// ![bone](https://docs.opencv.org/3.4.8/colormaps/colorscale_bone.jpg)
pub const COLORMAP_BONE: i32 = 1;
/// ![cividis](https://docs.opencv.org/3.4.8/colormaps/colorscale_cividis.jpg)
pub const COLORMAP_CIVIDIS: i32 = 17;
/// ![cool](https://docs.opencv.org/3.4.8/colormaps/colorscale_cool.jpg)
pub const COLORMAP_COOL: i32 = 8;
/// ![hot](https://docs.opencv.org/3.4.8/colormaps/colorscale_hot.jpg)
pub const COLORMAP_HOT: i32 = 11;
/// ![HSV](https://docs.opencv.org/3.4.8/colormaps/colorscale_hsv.jpg)
pub const COLORMAP_HSV: i32 = 9;
/// ![inferno](https://docs.opencv.org/3.4.8/colormaps/colorscale_inferno.jpg)
pub const COLORMAP_INFERNO: i32 = 14;
/// ![jet](https://docs.opencv.org/3.4.8/colormaps/colorscale_jet.jpg)
pub const COLORMAP_JET: i32 = 2;
/// ![magma](https://docs.opencv.org/3.4.8/colormaps/colorscale_magma.jpg)
pub const COLORMAP_MAGMA: i32 = 13;
/// ![ocean](https://docs.opencv.org/3.4.8/colormaps/colorscale_ocean.jpg)
pub const COLORMAP_OCEAN: i32 = 5;
/// ![parula](https://docs.opencv.org/3.4.8/colormaps/colorscale_parula.jpg)
pub const COLORMAP_PARULA: i32 = 12;
/// ![pink](https://docs.opencv.org/3.4.8/colormaps/colorscale_pink.jpg)
pub const COLORMAP_PINK: i32 = 10;
/// ![plasma](https://docs.opencv.org/3.4.8/colormaps/colorscale_plasma.jpg)
pub const COLORMAP_PLASMA: i32 = 15;
/// ![rainbow](https://docs.opencv.org/3.4.8/colormaps/colorscale_rainbow.jpg)
pub const COLORMAP_RAINBOW: i32 = 4;
/// ![spring](https://docs.opencv.org/3.4.8/colormaps/colorscale_spring.jpg)
pub const COLORMAP_SPRING: i32 = 7;
/// ![summer](https://docs.opencv.org/3.4.8/colormaps/colorscale_summer.jpg)
pub const COLORMAP_SUMMER: i32 = 6;
/// ![turbo](https://docs.opencv.org/3.4.8/colormaps/colorscale_turbo.jpg)
pub const COLORMAP_TURBO: i32 = 20;
/// ![twilight](https://docs.opencv.org/3.4.8/colormaps/colorscale_twilight.jpg)
pub const COLORMAP_TWILIGHT: i32 = 18;
/// ![twilight shifted](https://docs.opencv.org/3.4.8/colormaps/colorscale_twilight_shifted.jpg)
pub const COLORMAP_TWILIGHT_SHIFTED: i32 = 19;
/// ![viridis](https://docs.opencv.org/3.4.8/colormaps/colorscale_viridis.jpg)
pub const COLORMAP_VIRIDIS: i32 = 16;
/// ![winter](https://docs.opencv.org/3.4.8/colormaps/colorscale_winter.jpg)
...
/// basically *21HT*, described in [Yuen90](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Yuen90)
...
/// Finds edges in an image using the Canny algorithm [Canny86](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Canny86) .
///
...
/// two weighted point configurations. One of the applications described in [RubnerSept98](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_RubnerSept98),
/// [Rubner2000](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Rubner2000) is multi-dimensional histogram comparison for image retrieval. EMD is a transportation
...
/// in [Matas00](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Matas00)
///
/// See the line detection example below:
/// @include snippets/imgproc_HoughLinesP.cpp
/// This is a sample picture the function parameters have been tuned for:
///
/// ![image](https://docs.opencv.org/3.4.8/building.jpg)
///
/// And this is the output of the above program in case of the probabilistic Hough transform:
///
/// ![image](https://docs.opencv.org/3.4.8/houghp.png)
///
/// ## Parameters
...
///
/// The function cv::convexHull finds the convex hull of a 2D point set using the Sklansky's algorithm [Sklansky82](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Sklansky82)
...
///
/// ![image](https://docs.opencv.org/3.4.8/defects.png)
///
/// ## Parameters
...
///
/// ![image](https://docs.opencv.org/3.4.8/cornersubpix.png)
///
...
/// algorithm described in [Felzenszwalb04](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Felzenszwalb04) . This algorithm is parallelized with the TBB library.
///
/// In other cases, the algorithm [Borgefors86](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Borgefors86) is used. This means that for a pixel the function
...
///
/// ![Parameters of Elliptic Arc](https://docs.opencv.org/3.4.8/ellipse.svg)
///
/// ## Parameters
/// * img: Image.
...
///
/// The function retrieves contours from the binary image using the algorithm [Suzuki85](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Suzuki85) . The contours
...
/// The Approximate Mean Square (AMS) proposed by [Taubin1991](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Taubin1991) is used.
///
...
/// The function calculates the ellipse that fits a set of 2D points.
/// It returns the rotated rectangle in which the ellipse is inscribed.
/// The Direct least square (Direct) method by [Fitzgibbon1999](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Fitzgibbon1999) is used.
///
/// For an ellipse, this basis set is ![inline formula](https://latex.codecogs.com/png.latex?%20%5Cchi%3D%20%5Cleft%28x%5E2%2C%20x%20y%2C%20y%5E2%2C%20x%2C%20y%2C%201%5Cright%29%20),
/// which is a set of six free coefficients ![inline formula](https://latex.codecogs.com/png.latex?%20A%5ET%3D%5Cleft%5C%7BA_%7B%5Ctext%7Bxx%7D%7D%2CA_%7B%5Ctext%7Bxy%7D%7D%2CA_%7B%5Ctext%7Byy%7D%7D%2CA_x%2CA_y%2CA_0%5Cright%5C%7D%20).
/// However, to specify an ellipse, all that is needed is five numbers; the major and minor axes lengths ![inline formula](https://latex.codecogs.com/png.latex?%20%28a%2Cb%29%20),
...
/// all. It returns the rotated rectangle in which the ellipse is inscribed. The first algorithm described by [Fitzgibbon95](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Fitzgibbon95)
...
/// described in [Shi94](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Shi94)
///
...
///
/// ![integral calculation example](https://docs.opencv.org/3.4.8/integral.png)
///
/// ## Parameters
...
///
/// ![Sample output of the minimum enclosing triangle function](https://docs.opencv.org/3.4.8/minenclosingtriangle.png)
///
/// The implementation of the algorithm is based on O'Rourke's [ORourke86](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_ORourke86) and Klee and Laskowski's
/// [KleeLaskowski85](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_KleeLaskowski85) papers. O'Rourke provides a ![inline formula](https://latex.codecogs.com/png.latex?%5Ctheta%28n%29) algorithm for finding the minimal
...
///
/// ![sample output](https://docs.opencv.org/3.4.8/pointpolygon.png)
///
/// ## Parameters
/// * contour: Input contour.
...
///
/// ![intersection examples](https://docs.opencv.org/3.4.8/intersection.png)
///
/// ## Parameters
...
/// ![Polar remaps reference](https://docs.opencv.org/3.4.8/polar_remap_doc.png)
///
...
/// algorithm, described in [Meyer92](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Meyer92) .
///
...
///
/// following the algorithm described at [Rafael12](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Rafael12) .
///
///
/// Note: Implementation has been removed due original code license conflict
pub trait LineSegmentDetector: core::AlgorithmTrait {
    ...
    ///
    /// ![image](https://docs.opencv.org/3.4.8/building_lsd.png)
    ///
    /// ## Parameters
...
impl Subdiv2D {
    ...
    ///
    /// ![sample output](https://docs.opencv.org/3.4.8/quadedge.png)
    ///
    /// ## Returns
