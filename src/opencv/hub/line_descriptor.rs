...
pub fn draw_keylines(image: &core::Mat, keylines: &core::Vector<crate::line_descriptor::KeyLine>, out_image: &mut core::Mat, color: core::Scalar, flags: i32) -> Result<()> {
	let ret = unsafe { sys::cv_line_descriptor_drawKeylines_const_MatR_const_vector_KeyLine_R_MatR_const_ScalarR_int(image.as_raw_Mat(), keylines.as_raw_VectorOfKeyLine(), out_image.as_raw_mut_Mat(), &color, flags) }.into_result()?;
	Ok(ret)
}
...
pub trait BinaryDescriptorTraitConst: core::AlgorithmTraitConst {
	...
	fn write(&self, fs: &mut core::FileStorage) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_write_const_FileStorageR(self.as_raw_BinaryDescriptor(), fs.as_raw_mut_FileStorage()) }.into_result()?;
		Ok(ret)
	}
	...
	fn detect(&self, images: &core::Vector<core::Mat>, keylines: &mut core::Vector<core::Vector<crate::line_descriptor::KeyLine>>, masks: &core::Vector<core::Mat>) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_detect_const_const_vector_Mat_R_vector_vector_KeyLine__R_const_vector_Mat_R(self.as_raw_BinaryDescriptor(), images.as_raw_VectorOfMat(), keylines.as_raw_mut_VectorOfVectorOfKeyLine(), masks.as_raw_VectorOfMat()) }.into_result()?;
		Ok(ret)
	}
	...
	fn compute(&self, image: &core::Mat, keylines: &mut core::Vector<crate::line_descriptor::KeyLine>, descriptors: &mut core::Mat, return_float_descr: bool) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_compute_const_const_MatR_vector_KeyLine_R_MatR_bool(self.as_raw_BinaryDescriptor(), image.as_raw_Mat(), keylines.as_raw_mut_VectorOfKeyLine(), descriptors.as_raw_mut_Mat(), return_float_descr) }.into_result()?;
		Ok(ret)
	}
	...
	fn compute_1(&self, images: &core::Vector<core::Mat>, keylines: &mut core::Vector<core::Vector<crate::line_descriptor::KeyLine>>, descriptors: &mut core::Vector<core::Mat>, return_float_descr: bool) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_compute_const_const_vector_Mat_R_vector_vector_KeyLine__R_vector_Mat_R_bool(self.as_raw_BinaryDescriptor(), images.as_raw_VectorOfMat(), keylines.as_raw_mut_VectorOfVectorOfKeyLine(), descriptors.as_raw_mut_VectorOfMat(), return_float_descr) }.into_result()?;
		Ok(ret)
	}
	...
	fn descriptor_size(&self) -> Result<i32> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_descriptorSize_const(self.as_raw_BinaryDescriptor()) }.into_result()?;
		Ok(ret)
	}
	...
	fn descriptor_type(&self) -> Result<i32> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_descriptorType_const(self.as_raw_BinaryDescriptor()) }.into_result()?;
		Ok(ret)
	}
	...
	fn default_norm(&self) -> Result<i32> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_defaultNorm_const(self.as_raw_BinaryDescriptor()) }.into_result()?;
		Ok(ret)
	}
...
pub trait BinaryDescriptorTrait: core::AlgorithmTrait + crate::line_descriptor::BinaryDescriptorTraitConst {
	...
	fn get_num_of_octaves(&mut self) -> Result<i32> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_getNumOfOctaves(self.as_raw_mut_BinaryDescriptor()) }.into_result()?;
		Ok(ret)
	}
	...
	fn set_num_of_octaves(&mut self, octaves: i32) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_setNumOfOctaves_int(self.as_raw_mut_BinaryDescriptor(), octaves) }.into_result()?;
		Ok(ret)
	}
	...
	fn get_width_of_band(&mut self) -> Result<i32> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_getWidthOfBand(self.as_raw_mut_BinaryDescriptor()) }.into_result()?;
		Ok(ret)
	}
	...
	fn set_width_of_band(&mut self, width: i32) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_setWidthOfBand_int(self.as_raw_mut_BinaryDescriptor(), width) }.into_result()?;
		Ok(ret)
	}
	...
	fn get_reduction_ratio(&mut self) -> Result<i32> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_getReductionRatio(self.as_raw_mut_BinaryDescriptor()) }.into_result()?;
		Ok(ret)
	}
	...
	fn set_reduction_ratio(&mut self, r_ratio: i32) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_setReductionRatio_int(self.as_raw_mut_BinaryDescriptor(), r_ratio) }.into_result()?;
		Ok(ret)
	}
	...
	fn read(&mut self, fn_: &core::FileNode) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_read_const_FileNodeR(self.as_raw_mut_BinaryDescriptor(), fn_.as_raw_FileNode()) }.into_result()?;
		Ok(ret)
	}
	...
	fn detect_1(&mut self, image: &core::Mat, keypoints: &mut core::Vector<crate::line_descriptor::KeyLine>, mask: &core::Mat) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_detect_const_MatR_vector_KeyLine_R_const_MatR(self.as_raw_mut_BinaryDescriptor(), image.as_raw_Mat(), keypoints.as_raw_mut_VectorOfKeyLine(), mask.as_raw_Mat()) }.into_result()?;
		Ok(ret)
	}
...
impl BinaryDescriptor {
	...
	pub fn new(parameters: &crate::line_descriptor::BinaryDescriptor_Params) -> Result<crate::line_descriptor::BinaryDescriptor> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_BinaryDescriptor_const_ParamsR(parameters.as_raw_BinaryDescriptor_Params()) }.into_result()?;
	...
	pub fn create_binary_descriptor() -> Result<core::Ptr<crate::line_descriptor::BinaryDescriptor>> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_createBinaryDescriptor() }.into_result()?;
	...
	pub fn create_binary_descriptor_1(mut parameters: crate::line_descriptor::BinaryDescriptor_Params) -> Result<core::Ptr<crate::line_descriptor::BinaryDescriptor>> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_createBinaryDescriptor_Params(parameters.as_raw_mut_BinaryDescriptor_Params()) }.into_result()?;
		let ret = unsafe { core::Ptr::<crate::line_descriptor::BinaryDescriptor>::opencv_from_extern(ret) };
		Ok(ret)
	}
...
pub trait BinaryDescriptor_ParamsTraitConst {
	...
	#[inline]
	fn write(&self, fs: &mut core::FileStorage) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_Params_write_const_FileStorageR(self.as_raw_BinaryDescriptor_Params(), fs.as_raw_mut_FileStorage()) }.into_result()?;
		Ok(ret)
	}
...
pub trait BinaryDescriptor_ParamsTrait: crate::line_descriptor::BinaryDescriptor_ParamsTraitConst {
	...
	#[inline]
	fn read(&mut self, fn_: &core::FileNode) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_Params_read_const_FileNodeR(self.as_raw_mut_BinaryDescriptor_Params(), fn_.as_raw_FileNode()) }.into_result()?;
		Ok(ret)
	}
...
impl BinaryDescriptor_Params {
	...
	pub fn default() -> Result<crate::line_descriptor::BinaryDescriptor_Params> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptor_Params_Params() }.into_result()?;
...
pub trait BinaryDescriptorMatcherTraitConst: core::AlgorithmTraitConst {
	...
	fn match_(&self, query_descriptors: &core::Mat, train_descriptors: &core::Mat, matches: &mut core::Vector<core::DMatch>, mask: &core::Mat) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_match_const_const_MatR_const_MatR_vector_DMatch_R_const_MatR(self.as_raw_BinaryDescriptorMatcher(), query_descriptors.as_raw_Mat(), train_descriptors.as_raw_Mat(), matches.as_raw_mut_VectorOfDMatch(), mask.as_raw_Mat()) }.into_result()?;
		Ok(ret)
	}
...
pub trait BinaryDescriptorMatcherTrait: core::AlgorithmTrait + crate::line_descriptor::BinaryDescriptorMatcherTraitConst {
	...
	fn match_query(&mut self, query_descriptors: &core::Mat, matches: &mut core::Vector<core::DMatch>, masks: &core::Vector<core::Mat>) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_match_const_MatR_vector_DMatch_R_const_vector_Mat_R(self.as_raw_mut_BinaryDescriptorMatcher(), query_descriptors.as_raw_Mat(), matches.as_raw_mut_VectorOfDMatch(), masks.as_raw_VectorOfMat()) }.into_result()?;
		Ok(ret)
	}
	...
	fn knn_match_query(&mut self, query_descriptors: &core::Mat, matches: &mut core::Vector<core::Vector<core::DMatch>>, k: i32, masks: &core::Vector<core::Mat>, compact_result: bool) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_knnMatch_const_MatR_vector_vector_DMatch__R_int_const_vector_Mat_R_bool(self.as_raw_mut_BinaryDescriptorMatcher(), query_descriptors.as_raw_Mat(), matches.as_raw_mut_VectorOfVectorOfDMatch(), k, masks.as_raw_VectorOfMat(), compact_result) }.into_result()?;
		Ok(ret)
	}
	...
	fn add(&mut self, descriptors: &core::Vector<core::Mat>) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_add_const_vector_Mat_R(self.as_raw_mut_BinaryDescriptorMatcher(), descriptors.as_raw_VectorOfMat()) }.into_result()?;
		Ok(ret)
	}
	...
	fn train(&mut self) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_train(self.as_raw_mut_BinaryDescriptorMatcher()) }.into_result()?;
		Ok(ret)
	}
	...
	fn clear(&mut self) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_clear(self.as_raw_mut_BinaryDescriptorMatcher()) }.into_result()?;
		Ok(ret)
	}
...
impl BinaryDescriptorMatcher {
	...
	pub fn create_binary_descriptor_matcher() -> Result<core::Ptr<crate::line_descriptor::BinaryDescriptorMatcher>> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_createBinaryDescriptorMatcher() }.into_result()?;
	...
	pub fn default() -> Result<crate::line_descriptor::BinaryDescriptorMatcher> {
		let ret = unsafe { sys::cv_line_descriptor_BinaryDescriptorMatcher_BinaryDescriptorMatcher() }.into_result()?;
...
impl KeyLine {
	...
	pub fn get_start_point(self) -> Result<core::Point2f> {
		let ret = unsafe { sys::cv_line_descriptor_KeyLine_getStartPoint_const(self.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	...
	pub fn get_end_point(self) -> Result<core::Point2f> {
		let ret = unsafe { sys::cv_line_descriptor_KeyLine_getEndPoint_const(self.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	...
	pub fn get_start_point_in_octave(self) -> Result<core::Point2f> {
		let ret = unsafe { sys::cv_line_descriptor_KeyLine_getStartPointInOctave_const(self.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	...
	pub fn get_end_point_in_octave(self) -> Result<core::Point2f> {
		let ret = unsafe { sys::cv_line_descriptor_KeyLine_getEndPointInOctave_const(self.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	...
	pub fn default() -> Result<crate::line_descriptor::KeyLine> {
		let ret = unsafe { sys::cv_line_descriptor_KeyLine_KeyLine() }.into_result()?;
		Ok(ret)
	}
...
pub trait LSDDetectorTraitConst: core::AlgorithmTraitConst {
	...
	fn detect_multiple(&self, images: &core::Vector<core::Mat>, keylines: &mut core::Vector<core::Vector<crate::line_descriptor::KeyLine>>, scale: i32, num_octaves: i32, masks: &core::Vector<core::Mat>) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_LSDDetector_detect_const_const_vector_Mat_R_vector_vector_KeyLine__R_int_int_const_vector_Mat_R(self.as_raw_LSDDetector(), images.as_raw_VectorOfMat(), keylines.as_raw_mut_VectorOfVectorOfKeyLine(), scale, num_octaves, masks.as_raw_VectorOfMat()) }.into_result()?;
		Ok(ret)
	}
...
pub trait LSDDetectorTrait: core::AlgorithmTrait + crate::line_descriptor::LSDDetectorTraitConst {
	...
	fn detect(&mut self, image: &core::Mat, keypoints: &mut core::Vector<crate::line_descriptor::KeyLine>, scale: i32, num_octaves: i32, mask: &core::Mat) -> Result<()> {
		let ret = unsafe { sys::cv_line_descriptor_LSDDetector_detect_const_MatR_vector_KeyLine_R_int_int_const_MatR(self.as_raw_mut_LSDDetector(), image.as_raw_Mat(), keypoints.as_raw_mut_VectorOfKeyLine(), scale, num_octaves, mask.as_raw_Mat()) }.into_result()?;
		Ok(ret)
	}
...
impl LSDDetector {
	...
	pub fn default() -> Result<crate::line_descriptor::LSDDetector> {
		let ret = unsafe { sys::cv_line_descriptor_LSDDetector_LSDDetector() }.into_result()?;
	...
	pub fn new(_params: crate::line_descriptor::LSDParam) -> Result<crate::line_descriptor::LSDDetector> {
		let ret = unsafe { sys::cv_line_descriptor_LSDDetector_LSDDetector_LSDParam(_params.opencv_as_extern()) }.into_result()?;
		let ret = unsafe { crate::line_descriptor::LSDDetector::opencv_from_extern(ret) };
		Ok(ret)
	}
	...
	pub fn create_lsd_detector() -> Result<core::Ptr<crate::line_descriptor::LSDDetector>> {
		let ret = unsafe { sys::cv_line_descriptor_LSDDetector_createLSDDetector() }.into_result()?;
	...
	pub fn create_lsd_detector_with_params(params: crate::line_descriptor::LSDParam) -> Result<core::Ptr<crate::line_descriptor::LSDDetector>> {
		let ret = unsafe { sys::cv_line_descriptor_LSDDetector_createLSDDetector_LSDParam(params.opencv_as_extern()) }.into_result()?;
		let ret = unsafe { core::Ptr::<crate::line_descriptor::LSDDetector>::opencv_from_extern(ret) };
		Ok(ret)
	}
...
impl LSDParam {
	...
	pub fn default() -> Result<crate::line_descriptor::LSDParam> {
		let ret = unsafe { sys::cv_line_descriptor_LSDParam_LSDParam() }.into_result()?;
		Ok(ret)
	}
