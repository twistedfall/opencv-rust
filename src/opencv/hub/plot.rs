...
pub trait Plot2d: core::AlgorithmTrait + crate::plot::Plot2dConst {
	...
	fn set_min_x(&mut self, _plot_min_x: f64) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setMinX_double(self.as_raw_mut_Plot2d(), _plot_min_x) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_min_y(&mut self, _plot_min_y: f64) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setMinY_double(self.as_raw_mut_Plot2d(), _plot_min_y) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_max_x(&mut self, _plot_max_x: f64) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setMaxX_double(self.as_raw_mut_Plot2d(), _plot_max_x) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_max_y(&mut self, _plot_max_y: f64) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setMaxY_double(self.as_raw_mut_Plot2d(), _plot_max_y) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_plot_line_width(&mut self, _plot_line_width: i32) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPlotLineWidth_int(self.as_raw_mut_Plot2d(), _plot_line_width) }.into_result()?;
		Ok(ret)
	}
	...
	fn set_need_plot_line(&mut self, _need_plot_line: bool) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setNeedPlotLine_bool(self.as_raw_mut_Plot2d(), _need_plot_line) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_plot_line_color(&mut self, _plot_line_color: core::Scalar) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPlotLineColor_Scalar(self.as_raw_mut_Plot2d(), _plot_line_color.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_plot_background_color(&mut self, _plot_background_color: core::Scalar) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPlotBackgroundColor_Scalar(self.as_raw_mut_Plot2d(), _plot_background_color.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_plot_axis_color(&mut self, _plot_axis_color: core::Scalar) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPlotAxisColor_Scalar(self.as_raw_mut_Plot2d(), _plot_axis_color.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_plot_grid_color(&mut self, _plot_grid_color: core::Scalar) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPlotGridColor_Scalar(self.as_raw_mut_Plot2d(), _plot_grid_color.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_plot_text_color(&mut self, _plot_text_color: core::Scalar) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPlotTextColor_Scalar(self.as_raw_mut_Plot2d(), _plot_text_color.opencv_as_extern()) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_plot_size(&mut self, _plot_size_width: i32, _plot_size_height: i32) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPlotSize_int_int(self.as_raw_mut_Plot2d(), _plot_size_width, _plot_size_height) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_show_grid(&mut self, need_show_grid: bool) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setShowGrid_bool(self.as_raw_mut_Plot2d(), need_show_grid) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_show_text(&mut self, need_show_text: bool) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setShowText_bool(self.as_raw_mut_Plot2d(), need_show_text) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_grid_lines_number(&mut self, grid_lines_number: i32) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setGridLinesNumber_int(self.as_raw_mut_Plot2d(), grid_lines_number) }.into_result()?;
		Ok(ret)
	}
	
	#[inline]
	fn set_invert_orientation(&mut self, _invert_orientation: bool) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setInvertOrientation_bool(self.as_raw_mut_Plot2d(), _invert_orientation) }.into_result()?;
		Ok(ret)
	}
	...
	fn set_point_idx_to_print(&mut self, point_idx: i32) -> Result<()> {
		let ret = unsafe { sys::cv_plot_Plot2d_setPointIdxToPrint_int(self.as_raw_mut_Plot2d(), point_idx) }.into_result()?;
		Ok(ret)
	}
	...
	fn render(&mut self, _plot_result: &mut dyn core::ToOutputArray) -> Result<()> {
		...
		let ret = unsafe { sys::cv_plot_Plot2d_render_const__OutputArrayR(self.as_raw_mut_Plot2d(), _plot_result.as_raw__OutputArray()) }.into_result()?;
		Ok(ret)
	}
...
impl dyn Plot2d + '_ {
	...
	pub fn create(data: &dyn core::ToInputArray) -> Result<core::Ptr<dyn crate::plot::Plot2d>> {
		...
		let ret = unsafe { sys::cv_plot_Plot2d_create_const__InputArrayR(data.as_raw__InputArray()) }.into_result()?;
	...
	pub fn create_1(data_x: &dyn core::ToInputArray, data_y: &dyn core::ToInputArray) -> Result<core::Ptr<dyn crate::plot::Plot2d>> {
		...
		let ret = unsafe { sys::cv_plot_Plot2d_create_const__InputArrayR_const__InputArrayR(data_x.as_raw__InputArray(), data_y.as_raw__InputArray()) }.into_result()?;
		let ret = unsafe { core::Ptr::<dyn crate::plot::Plot2d>::opencv_from_extern(ret) };
		Ok(ret)
	}
