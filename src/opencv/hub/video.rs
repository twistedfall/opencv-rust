...
pub fn read_optical_flow(path: &str) -> Result<core::Mat> {
	string_arg!(path);
	unsafe { sys::cv_readOpticalFlow_const_StringX(path.as_ptr()) }.into_result().map(|ptr| unsafe { core::Mat::from_raw(ptr) })
}
...
impl dyn DISOpticalFlow + '_ {
	...
	pub fn create(preset: i32) -> Result<core::Ptr::<dyn crate::video::DISOpticalFlow>> {
		unsafe { sys::cv_DISOpticalFlow_create_int(preset) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::video::DISOpticalFlow>::from_raw(ptr) })
	}
...
impl dyn VariationalRefinement + '_ {
	...
	pub fn create() -> Result<core::Ptr::<dyn crate::video::VariationalRefinement>> {
		unsafe { sys::cv_VariationalRefinement_create() }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::video::VariationalRefinement>::from_raw(ptr) })
	}
