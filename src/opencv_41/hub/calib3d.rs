...
//! ![inline formula](https://latex.codecogs.com/png.latex?y%27%27). This distortion can be modelled in the following way, see e.g. [Louhichi07](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_Louhichi07).
//!
...
/// Estimation" ([penate2013exhaustive](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_penate2013exhaustive)). In this case the function also estimates the parameters ![inline formula](https://latex.codecogs.com/png.latex?f_x) and ![inline formula](https://latex.codecogs.com/png.latex?f_y)
