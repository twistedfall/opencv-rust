...
//! [Felzenszwalb2010a](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_Felzenszwalb2010a) . It is based on a Dalal-Triggs detector that uses a single filter on histogram
...
//! [Felzenszwalb2010b](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_Felzenszwalb2010b) . The algorithm prunes partial hypotheses using thresholds on their scores.The
