...
//! ----------------------------------------------------------
//!
//! The object detector described below has been initially proposed by Paul Viola [Viola01](https://docs.opencv.org/4.1.0/d0/de3/citelist.html#CITEREF_Viola01) and
//! improved by Rainer Lienhart [Lienhart02](https://docs.opencv.org/4.1.0/d0/de3/citelist.html#CITEREF_Lienhart02) .
//!
...
//! Haar-like features:
//!
//! ![image](https://docs.opencv.org/4.1.0/haarfeatures.png)
//!
...
///
/// the HOG descriptor algorithm introduced by Navneet Dalal and Bill Triggs [Dalal2005](https://docs.opencv.org/4.1.0/d0/de3/citelist.html#CITEREF_Dalal2005) .
///
/// useful links:
///
...
impl HOGDescriptor {
    ...
    pub fn set_svm_detector_mat(&mut self, svmdetector: &core::Mat) -> Result<()> {
        unsafe { sys::cv_HOGDescriptor_setSVMDetector_Mat(self.as_raw_HOGDescriptor(), svmdetector.as_raw_Mat()) }.into_result()
    }
