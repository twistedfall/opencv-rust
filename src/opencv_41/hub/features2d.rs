...
pub enum AKAZE_DescriptorType {
    DESCRIPTOR_KAZE_UPRIGHT = AKAZE_DESCRIPTOR_KAZE_UPRIGHT as isize,
    DESCRIPTOR_KAZE = AKAZE_DESCRIPTOR_KAZE as isize,
    DESCRIPTOR_MLDB_UPRIGHT = AKAZE_DESCRIPTOR_MLDB_UPRIGHT as isize,
    DESCRIPTOR_MLDB = AKAZE_DESCRIPTOR_MLDB as isize,
}

#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
pub enum AgastFeatureDetector_DetectorType {
    AGAST_5_8 = AgastFeatureDetector_AGAST_5_8 as isize,
    AGAST_7_12d = AgastFeatureDetector_AGAST_7_12d as isize,
    AGAST_7_12s = AgastFeatureDetector_AGAST_7_12s as isize,
    OAST_9_16 = AgastFeatureDetector_OAST_9_16 as isize,
}

#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
pub enum DescriptorMatcher_MatcherType {
    FLANNBASED = DescriptorMatcher_FLANNBASED as isize,
    BRUTEFORCE = DescriptorMatcher_BRUTEFORCE as isize,
    BRUTEFORCE_L1 = DescriptorMatcher_BRUTEFORCE_L1 as isize,
    BRUTEFORCE_HAMMING = DescriptorMatcher_BRUTEFORCE_HAMMING as isize,
    BRUTEFORCE_HAMMINGLUT = DescriptorMatcher_BRUTEFORCE_HAMMINGLUT as isize,
    BRUTEFORCE_SL2 = DescriptorMatcher_BRUTEFORCE_SL2 as isize,
}
...
pub enum DrawMatchesFlags {
    DEFAULT = DrawMatchesFlags_DEFAULT as isize,
    DRAW_OVER_OUTIMG = DrawMatchesFlags_DRAW_OVER_OUTIMG as isize,
    NOT_DRAW_SINGLE_POINTS = DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS as isize,
    DRAW_RICH_KEYPOINTS = DrawMatchesFlags_DRAW_RICH_KEYPOINTS as isize,
}

#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
pub enum FastFeatureDetector_DetectorType {
    TYPE_5_8 = FastFeatureDetector_TYPE_5_8 as isize,
    TYPE_7_12 = FastFeatureDetector_TYPE_7_12 as isize,
    TYPE_9_16 = FastFeatureDetector_TYPE_9_16 as isize,
}

#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
pub enum KAZE_DiffusivityType {
    DIFF_PM_G1 = KAZE_DIFF_PM_G1 as isize,
    DIFF_PM_G2 = KAZE_DIFF_PM_G2 as isize,
    DIFF_WEICKERT = KAZE_DIFF_WEICKERT as isize,
    DIFF_CHARBONNIER = KAZE_DIFF_CHARBONNIER as isize,
}

#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
pub enum ORB_ScoreType {
    HARRIS_SCORE = ORB_HARRIS_SCORE as isize,
    FAST_SCORE = ORB_FAST_SCORE as isize,
}
...
/// Detects corners using the AGAST algorithm by [mair2010_agast](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_mair2010_agast) .
///
...
/// The perl script and examples of tree generation are placed in features2d/doc folder.
/// Detects corners using the AGAST algorithm by [mair2010_agast](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_mair2010_agast) .
pub fn AGAST_with_type(image: &dyn core::ToInputArray, keypoints: &mut types::VectorOfKeyPoint, threshold: i32, nonmax_suppression: bool, _type: crate::features2d::AgastFeatureDetector_DetectorType) -> Result<()> {
    input_array_arg!(image);
    unsafe { sys::cv_AGAST__InputArray_VectorOfKeyPoint_int_bool_AgastFeatureDetector_DetectorType(image.as_raw__InputArray(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression, _type) }.into_result()
}
...
///
/// Detects corners using the FAST algorithm by [Rosten06](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Rosten06) .
///
///
...
/// cv.FAST_FEATURE_DETECTOR_TYPE_7_12 and cv.FAST_FEATURE_DETECTOR_TYPE_9_16. For corner
/// detection, use cv.FAST.detect() method.
pub fn FAST_with_type(image: &dyn core::ToInputArray, keypoints: &mut types::VectorOfKeyPoint, threshold: i32, nonmax_suppression: bool, _type: crate::features2d::FastFeatureDetector_DetectorType) -> Result<()> {
    input_array_arg!(image);
    unsafe { sys::cv_FAST__InputArray_VectorOfKeyPoint_int_bool_FastFeatureDetector_DetectorType(image.as_raw__InputArray(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression, _type) }.into_result()
}
...
pub fn draw_keypoints(image: &dyn core::ToInputArray, keypoints: &types::VectorOfKeyPoint, out_image: &mut dyn core::ToInputOutputArray, color: core::Scalar, flags: crate::features2d::DrawMatchesFlags) -> Result<()> {
    ...
    unsafe { sys::cv_drawKeypoints__InputArray_VectorOfKeyPoint__InputOutputArray_Scalar_DrawMatchesFlags(image.as_raw__InputArray(), keypoints.as_raw_VectorOfKeyPoint(), out_image.as_raw__InputOutputArray(), color, flags) }.into_result()
}
...
/// * flags: DrawMatchesFlags::DEFAULT
pub fn draw_matches(img1: &dyn core::ToInputArray, keypoints1: &types::VectorOfKeyPoint, img2: &dyn core::ToInputArray, keypoints2: &types::VectorOfKeyPoint, matches1to2: &types::VectorOfDMatch, out_img: &mut dyn core::ToInputOutputArray, match_color: core::Scalar, single_point_color: core::Scalar, matches_mask: &types::VectorOfchar, flags: crate::features2d::DrawMatchesFlags) -> Result<()> {
    input_array_arg!(img1);
    input_array_arg!(img2);
    input_output_array_arg!(out_img);
    unsafe { sys::cv_drawMatches__InputArray_VectorOfKeyPoint__InputArray_VectorOfKeyPoint_VectorOfDMatch__InputOutputArray_Scalar_Scalar_VectorOfchar_DrawMatchesFlags(img1.as_raw__InputArray(), keypoints1.as_raw_VectorOfKeyPoint(), img2.as_raw__InputArray(), keypoints2.as_raw_VectorOfKeyPoint(), matches1to2.as_raw_VectorOfDMatch(), out_img.as_raw__InputOutputArray(), match_color, single_point_color, matches_mask.as_raw_VectorOfchar(), flags) }.into_result()
}
...
/// Class implementing the AKAZE keypoint detector and descriptor extractor, described in [ANB13](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_ANB13).
///
...
pub trait AKAZE: crate::features2d::Feature2DTrait {
    ...
    fn set_descriptor_type(&mut self, dtype: crate::features2d::AKAZE_DescriptorType) -> Result<()> {
        unsafe { sys::cv_AKAZE_setDescriptorType_AKAZE_DescriptorType(self.as_raw_AKAZE(), dtype) }.into_result()
    }
    ...
    fn set_diffusivity(&mut self, diff: crate::features2d::KAZE_DiffusivityType) -> Result<()> {
        unsafe { sys::cv_AKAZE_setDiffusivity_KAZE_DiffusivityType(self.as_raw_AKAZE(), diff) }.into_result()
    }
...
impl dyn AKAZE + '_ {
    ...
    pub fn create(descriptor_type: crate::features2d::AKAZE_DescriptorType, descriptor_size: i32, descriptor_channels: i32, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: crate::features2d::KAZE_DiffusivityType) -> Result<types::PtrOfAKAZE> {
        unsafe { sys::cv_AKAZE_create_AKAZE_DescriptorType_int_int_float_int_int_KAZE_DiffusivityType(descriptor_type, descriptor_size, descriptor_channels, threshold, n_octaves, n_octave_layers, diffusivity) }.into_result().map(|ptr| types::PtrOfAKAZE { ptr })
    }
...
pub trait AgastFeatureDetector: crate::features2d::Feature2DTrait {
    ...
    fn set_type(&mut self, _type: crate::features2d::AgastFeatureDetector_DetectorType) -> Result<()> {
        unsafe { sys::cv_AgastFeatureDetector_setType_AgastFeatureDetector_DetectorType(self.as_raw_AgastFeatureDetector(), _type) }.into_result()
    }
...
impl dyn AgastFeatureDetector + '_ {
    ...
    pub fn create(threshold: i32, nonmax_suppression: bool, _type: crate::features2d::AgastFeatureDetector_DetectorType) -> Result<types::PtrOfAgastFeatureDetector> {
        unsafe { sys::cv_AgastFeatureDetector_create_int_bool_AgastFeatureDetector_DetectorType(threshold, nonmax_suppression, _type) }.into_result().map(|ptr| types::PtrOfAgastFeatureDetector { ptr })
    }
...
/// Class implementing the BRISK keypoint detector and descriptor extractor, described in [LCS11](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_LCS11) .
pub struct BRISK {
    #[doc(hidden)] pub(crate) ptr: *mut c_void
}
...
impl dyn DescriptorMatcher + '_ {
    ...
    pub fn create_with_matcher_type(matcher_type: &crate::features2d::DescriptorMatcher_MatcherType) -> Result<types::PtrOfDescriptorMatcher> {
        unsafe { sys::cv_DescriptorMatcher_create_DescriptorMatcher_MatcherType(matcher_type) }.into_result().map(|ptr| types::PtrOfDescriptorMatcher { ptr })
    }
...
pub trait FastFeatureDetector: crate::features2d::Feature2DTrait {
    ...
    fn set_type(&mut self, _type: crate::features2d::FastFeatureDetector_DetectorType) -> Result<()> {
        unsafe { sys::cv_FastFeatureDetector_setType_FastFeatureDetector_DetectorType(self.as_raw_FastFeatureDetector(), _type) }.into_result()
    }
...
impl dyn FastFeatureDetector + '_ {
    ...
    pub fn create(threshold: i32, nonmax_suppression: bool, _type: crate::features2d::FastFeatureDetector_DetectorType) -> Result<types::PtrOfFastFeatureDetector> {
        unsafe { sys::cv_FastFeatureDetector_create_int_bool_FastFeatureDetector_DetectorType(threshold, nonmax_suppression, _type) }.into_result().map(|ptr| types::PtrOfFastFeatureDetector { ptr })
    }
...
/// Class implementing the KAZE keypoint detector and descriptor extractor, described in [ABD12](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_ABD12) .
///
///
...
pub trait KAZE: crate::features2d::Feature2DTrait {
    ...
    fn set_diffusivity(&mut self, diff: crate::features2d::KAZE_DiffusivityType) -> Result<()> {
        unsafe { sys::cv_KAZE_setDiffusivity_KAZE_DiffusivityType(self.as_raw_KAZE(), diff) }.into_result()
    }
...
impl dyn KAZE + '_ {
    ...
    pub fn create(extended: bool, upright: bool, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: crate::features2d::KAZE_DiffusivityType) -> Result<types::PtrOfKAZE> {
        unsafe { sys::cv_KAZE_create_bool_bool_float_int_int_KAZE_DiffusivityType(extended, upright, threshold, n_octaves, n_octave_layers, diffusivity) }.into_result().map(|ptr| types::PtrOfKAZE { ptr })
    }
...
///
/// - the grey image algorithm is taken from: [nister2008linear](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_nister2008linear) ;  the paper claims to be faster
/// than union-find method; it actually get 1.5~2m/s on my centrino L7200 1.2GHz laptop.
///
/// - the color image algorithm is taken from: [forssen2007maximally](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_forssen2007maximally) ; it should be much slower
...
///
/// described in [RRKB11](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_RRKB11) . The algorithm uses FAST in pyramids to detect stable keypoints, selects
...
pub trait ORB: crate::features2d::Feature2DTrait {
    ...
    fn set_score_type(&mut self, score_type: crate::features2d::ORB_ScoreType) -> Result<()> {
        unsafe { sys::cv_ORB_setScoreType_ORB_ScoreType(self.as_raw_ORB(), score_type) }.into_result()
    }
...
impl dyn ORB + '_ {
    ...
    pub fn create(nfeatures: i32, scale_factor: f32, nlevels: i32, edge_threshold: i32, first_level: i32, wta_k: i32, score_type: crate::features2d::ORB_ScoreType, patch_size: i32, fast_threshold: i32) -> Result<types::PtrOfORB> {
        unsafe { sys::cv_ORB_create_int_float_int_int_int_int_ORB_ScoreType_int_int(nfeatures, scale_factor, nlevels, edge_threshold, first_level, wta_k, score_type, patch_size, fast_threshold) }.into_result().map(|ptr| types::PtrOfORB { ptr })
    }
