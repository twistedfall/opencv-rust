...
pub fn cv_PCACompute_Mat_Mat_Mat_Mat_double(data: *mut c_void, mean: *mut c_void, eigenvectors: *mut c_void, eigenvalues: *mut c_void, retained_variance: f64) -> cv_return_value_void;
pub fn cv_PCACompute_Mat_Mat_Mat_Mat_int(data: *mut c_void, mean: *mut c_void, eigenvectors: *mut c_void, eigenvalues: *mut c_void, max_components: i32) -> cv_return_value_void;
...
pub fn cv_PSNR_Mat_Mat_double(src1: *mut c_void, src2: *mut c_void, r: f64) -> cv_return_value_double;
...
pub fn cv_completeSymm_Mat_bool(m: *mut c_void, lower_to_upper: bool) -> cv_return_value_void;
...
pub fn cv_copyTo_Mat_Mat_Mat(src: *mut c_void, dst: *mut c_void, mask: *mut c_void) -> cv_return_value_void;
...
pub fn cv_eigenNonSymmetric_Mat_Mat_Mat(src: *mut c_void, eigenvalues: *mut c_void, eigenvectors: *mut c_void) -> cv_return_value_void;
...
pub fn cv_utils_dumpInputArrayOfArrays_VectorOfMat(argument: *mut c_void) -> cv_return_value_char_X;
pub fn cv_utils_dumpInputArray_Mat(argument: *mut c_void) -> cv_return_value_char_X;
...
pub fn cv_Mat_mul_const_Mat_double(instance: *const c_void, m: *mut c_void, scale: f64) -> cv_return_value_void_X;
...
pub fn cv_checkChessboard_Mat_Size(img: *mut c_void, size: core::Size) -> cv_return_value_bool;
...
pub fn cv_drawFrameAxes_Mat_Mat_Mat_Mat_Mat_float_int(image: *mut c_void, camera_matrix: *mut c_void, dist_coeffs: *mut c_void, rvec: *mut c_void, tvec: *mut c_void, length: f32, thickness: i32) -> cv_return_value_void;
...
pub fn cv_filterHomographyDecompByVisibleRefpoints_VectorOfMat_VectorOfMat_Mat_Mat_Mat_Mat(rotations: *mut c_void, normals: *mut c_void, before_points: *mut c_void, after_points: *mut c_void, possible_solutions: *mut c_void, points_mask: *mut c_void) -> cv_return_value_void;
...
pub fn cv_findChessboardCornersSB_Mat_Size_Mat_int(image: *mut c_void, pattern_size: core::Size, corners: *mut c_void, flags: i32) -> cv_return_value_bool;
...
pub fn cv_findFundamentalMat_Mat_Mat_Mat_int_double_double(points1: *mut c_void, points2: *mut c_void, mask: *mut c_void, method: i32, ransac_reproj_threshold: f64, confidence: f64) -> cv_return_value_void_X;
...
pub fn cv_initWideAngleProjMap_Mat_Mat_Size_int_int_Mat_Mat_UndistortTypes_double(camera_matrix: *mut c_void, dist_coeffs: *mut c_void, image_size: core::Size, dest_image_width: i32, m1type: i32, map1: *mut c_void, map2: *mut c_void, proj_type: crate::calib3d::UndistortTypes, alpha: f64) -> cv_return_value_float;
...
pub fn cv_recoverPose_Mat_Mat_Mat_Mat_Mat_Mat_double_Mat_Mat(e: *mut c_void, points1: *mut c_void, points2: *mut c_void, camera_matrix: *mut c_void, r: *mut c_void, t: *mut c_void, distance_thresh: f64, mask: *mut c_void, triangulated_points: *mut c_void) -> cv_return_value_int;
...
pub fn cv_undistortPoints_Mat_Mat_Mat_Mat_Mat_Mat_TermCriteria(src: *mut c_void, dst: *mut c_void, camera_matrix: *mut c_void, dist_coeffs: *mut c_void, r: *mut c_void, p: *mut c_void, criteria: *mut c_void) -> cv_return_value_void;
...
pub fn cv_LMSolver_run_const_Mat(instance: *const c_void, param: *mut c_void) -> cv_return_value_int;
...
pub fn cv_dnn_blobFromImage_Mat_Mat_double_Size_Scalar_bool_bool_int(image: *mut c_void, blob: *mut c_void, scalefactor: f64, size: core::Size, mean: core::Scalar, swap_rb: bool, crop: bool, ddepth: i32) -> cv_return_value_void;
pub fn cv_dnn_blobFromImage_Mat_double_Size_Scalar_bool_bool_int(image: *mut c_void, scalefactor: f64, size: core::Size, mean: core::Scalar, swap_rb: bool, crop: bool, ddepth: i32) -> cv_return_value_void_X;
pub fn cv_dnn_blobFromImages_VectorOfMat_Mat_double_Size_Scalar_bool_bool_int(images: *mut c_void, blob: *mut c_void, scalefactor: f64, size: core::Size, mean: core::Scalar, swap_rb: bool, crop: bool, ddepth: i32) -> cv_return_value_void;
...
pub fn cv_dnn_Layer_finalize_VectorOfMat_VectorOfMat(instance: *mut c_void, inputs: *mut c_void, outputs: *mut c_void) -> cv_return_value_void;
pub fn cv_dnn_Layer_forward_VectorOfMat_VectorOfMat_VectorOfMat(instance: *mut c_void, inputs: *mut c_void, outputs: *mut c_void, internals: *mut c_void) -> cv_return_value_void;
pub fn cv_dnn_Layer_forward_fallback_VectorOfMat_VectorOfMat_VectorOfMat(instance: *mut c_void, inputs: *mut c_void, outputs: *mut c_void, internals: *mut c_void) -> cv_return_value_void;
...
pub fn cv_dnn_Net_forward_VectorOfMat_String(instance: *mut c_void, output_blobs: *mut c_void, output_name: *const c_char) -> cv_return_value_void;
pub fn cv_dnn_Net_forward_VectorOfMat_VectorOfString(instance: *mut c_void, output_blobs: *mut c_void, out_blob_names: *mut c_void) -> cv_return_value_void;
...
pub fn cv_dnn_Net_setInput_Mat_String_double_Scalar(instance: *mut c_void, blob: *mut c_void, name: *const c_char, scalefactor: f64, mean: core::Scalar) -> cv_return_value_void;
...
pub fn cv_AGAST_Mat_VectorOfKeyPoint_int_bool_AgastFeatureDetector_DetectorType(image: *mut c_void, keypoints: *mut c_void, threshold: i32, nonmax_suppression: bool, _type: crate::features2d::AgastFeatureDetector_DetectorType) -> cv_return_value_void;
...
pub fn cv_FAST_Mat_VectorOfKeyPoint_int_bool_FastFeatureDetector_DetectorType(image: *mut c_void, keypoints: *mut c_void, threshold: i32, nonmax_suppression: bool, _type: crate::features2d::FastFeatureDetector_DetectorType) -> cv_return_value_void;
...
pub fn cv_drawKeypoints_Mat_VectorOfKeyPoint_Mat_Scalar_DrawMatchesFlags(image: *mut c_void, keypoints: *mut c_void, out_image: *mut c_void, color: core::Scalar, flags: crate::features2d::DrawMatchesFlags) -> cv_return_value_void;
pub fn cv_drawMatches_Mat_VectorOfKeyPoint_Mat_VectorOfKeyPoint_VectorOfDMatch_Mat_Scalar_Scalar_VectorOfchar_DrawMatchesFlags(img1: *mut c_void, keypoints1: *mut c_void, img2: *mut c_void, keypoints2: *mut c_void, matches1to2: *mut c_void, out_img: *mut c_void, match_color: core::Scalar, single_point_color: core::Scalar, matches_mask: *mut c_void, flags: crate::features2d::DrawMatchesFlags) -> cv_return_value_void;
pub fn cv_drawMatches_Mat_VectorOfKeyPoint_Mat_VectorOfKeyPoint_VectorOfVectorOfDMatch_Mat_Scalar_Scalar_VectorOfVectorOfchar_DrawMatchesFlags(img1: *mut c_void, keypoints1: *mut c_void, img2: *mut c_void, keypoints2: *mut c_void, matches1to2: *mut c_void, out_img: *mut c_void, match_color: core::Scalar, single_point_color: core::Scalar, matches_mask: *mut c_void, flags: crate::features2d::DrawMatchesFlags) -> cv_return_value_void;
...
extern "C" {
pub fn cv_ft_FT02D_FL_process_Mat_int_Mat(matrix: *mut c_void, radius: i32, output: *mut c_void) -> cv_return_value_void;
pub fn cv_ft_FT02D_FL_process_float_Mat_int_Mat(matrix: *mut c_void, radius: i32, output: *mut c_void) -> cv_return_value_void;
...
pub fn cv_ft_FT12D_components_Mat_Mat_Mat(matrix: *mut c_void, kernel: *mut c_void, components: *mut c_void) -> cv_return_value_void;
pub fn cv_ft_FT12D_createPolynomMatrixHorizontal_int_Mat_int(radius: i32, matrix: *mut c_void, chn: i32) -> cv_return_value_void;
pub fn cv_ft_FT12D_createPolynomMatrixVertical_int_Mat_int(radius: i32, matrix: *mut c_void, chn: i32) -> cv_return_value_void;
pub fn cv_ft_FT12D_inverseFT_Mat_Mat_Mat_int_int(components: *mut c_void, kernel: *mut c_void, output: *mut c_void, width: i32, height: i32) -> cv_return_value_void;
pub fn cv_ft_FT12D_polynomial_Mat_Mat_Mat_Mat_Mat_Mat_Mat(matrix: *mut c_void, kernel: *mut c_void, c00: *mut c_void, c10: *mut c_void, c01: *mut c_void, components: *mut c_void, mask: *mut c_void) -> cv_return_value_void;
pub fn cv_ft_FT12D_process_Mat_Mat_Mat_Mat(matrix: *mut c_void, kernel: *mut c_void, output: *mut c_void, mask: *mut c_void) -> cv_return_value_void;
...
pub fn cv_selectROI_Mat_bool_bool(img: *mut c_void, show_crosshair: bool, from_center: bool) -> cv_return_value_RectWrapper;
pub fn cv_selectROI_String_Mat_bool_bool(window_name: *const c_char, img: *mut c_void, show_crosshair: bool, from_center: bool) -> cv_return_value_RectWrapper;
pub fn cv_selectROIs_String_Mat_VectorOfRect_bool_bool(window_name: *const c_char, img: *mut c_void, bounding_boxes: *mut c_void, show_crosshair: bool, from_center: bool) -> cv_return_value_void;
...
pub fn cv_HoughLinesPointSet_Mat_Mat_int_int_double_double_double_double_double_double(_point: *mut c_void, _lines: *mut c_void, lines_max: i32, threshold: i32, min_rho: f64, max_rho: f64, rho_step: f64, min_theta: f64, max_theta: f64, theta_step: f64) -> cv_return_value_void;
...
pub fn cv_applyColorMap_Mat_Mat_Mat(src: *mut c_void, dst: *mut c_void, user_color: *mut c_void) -> cv_return_value_void;
...
pub fn cv_boundingRect_Mat(array: *mut c_void) -> cv_return_value_RectWrapper;
...
pub fn cv_cvtColorTwoPlane_Mat_Mat_Mat_int(src1: *mut c_void, src2: *mut c_void, dst: *mut c_void, code: i32) -> cv_return_value_void;
pub fn cv_cvtColor_Mat_Mat_int_int(src: *mut c_void, dst: *mut c_void, code: i32, dst_cn: i32) -> cv_return_value_void;
pub fn cv_demosaicing_Mat_Mat_int_int(src: *mut c_void, dst: *mut c_void, code: i32, dst_cn: i32) -> cv_return_value_void;
...
pub fn cv_fitEllipseAMS_Mat(points: *mut c_void) -> cv_return_value_void_X;
pub fn cv_fitEllipseDirect_Mat(points: *mut c_void) -> cv_return_value_void_X;
...
pub fn cv_getPerspectiveTransform_Mat_Mat_int(src: *mut c_void, dst: *mut c_void, solve_method: i32) -> cv_return_value_void_X;
...
pub fn cv_goodFeaturesToTrack_Mat_Mat_int_double_double_Mat_int_int_bool_double(image: *mut c_void, corners: *mut c_void, max_corners: i32, quality_level: f64, min_distance: f64, mask: *mut c_void, block_size: i32, gradient_size: i32, use_harris_detector: bool, k: f64) -> cv_return_value_void;
...
pub fn cv_sqrBoxFilter_Mat_Mat_int_Size_Point_bool_int(src: *mut c_void, dst: *mut c_void, ddepth: i32, ksize: core::Size, anchor: core::Point, normalize: bool, border_type: i32) -> cv_return_value_void;
...
pub fn cv_warpPolar_Mat_Mat_Size_Point2f_double_int(src: *mut c_void, dst: *mut c_void, dsize: core::Size, center: core::Point2f, max_radius: f64, flags: i32) -> cv_return_value_void;
pub fn cv_watershed_Mat_Mat(image: *mut c_void, markers: *mut c_void) -> cv_return_value_void;
pub fn cv_wrapperEMD_Mat_Mat_int_Mat_PtrOffloat_Mat(signature1: *mut c_void, signature2: *mut c_void, dist_type: i32, cost: *mut c_void, lower_bound: *mut c_void, flow: *mut c_void) -> cv_return_value_float;
...
pub fn cv_ml_EM_predict_const_Mat_Mat_int(instance: *const c_void, samples: *mut c_void, results: *mut c_void, flags: i32) -> cv_return_value_float;
...
pub fn cv_ml_RTrees_getVotes_const_Mat_Mat_int(instance: *const c_void, samples: *mut c_void, results: *mut c_void, flags: i32) -> cv_return_value_void;
...
pub fn cv_ml_SVM_trainAuto_Mat_int_Mat_int_PtrOfParamGrid_PtrOfParamGrid_PtrOfParamGrid_PtrOfParamGrid_PtrOfParamGrid_PtrOfParamGrid_bool(instance: *mut c_void, samples: *mut c_void, layout: i32, responses: *mut c_void, k_fold: i32, cgrid: *mut c_void, gamma_grid: *mut c_void, p_grid: *mut c_void, nu_grid: *mut c_void, coeff_grid: *mut c_void, degree_grid: *mut c_void, balanced: bool) -> cv_return_value_bool;
...
pub fn cv_HOGDescriptor_setSVMDetector_Mat(instance: *mut c_void, svmdetector: *mut c_void) -> cv_return_value_void;
...
pub fn cv_plot_Plot2d_create_Mat(data: *mut c_void) -> cv_return_value_void_X;
...
pub fn cv_PyRotationWarper_warpPoint_Point2f_Mat_Mat(instance: *mut c_void, pt: core::Point2f, k: *mut c_void, r: *mut c_void) -> cv_return_value_Point2fWrapper;
pub fn cv_PyRotationWarper_buildMaps_Size_Mat_Mat_Mat_Mat(instance: *mut c_void, src_size: core::Size, k: *mut c_void, r: *mut c_void, xmap: *mut c_void, ymap: *mut c_void) -> cv_return_value_RectWrapper;
pub fn cv_PyRotationWarper_warp_Mat_Mat_Mat_int_int_Mat(instance: *mut c_void, src: *mut c_void, k: *mut c_void, r: *mut c_void, interp_mode: i32, border_mode: i32, dst: *mut c_void) -> cv_return_value_PointWrapper;
pub fn cv_PyRotationWarper_warpBackward_Mat_Mat_Mat_int_int_Size_Mat(instance: *mut c_void, src: *mut c_void, k: *mut c_void, r: *mut c_void, interp_mode: i32, border_mode: i32, dst_size: core::Size, dst: *mut c_void) -> cv_return_value_void;
pub fn cv_PyRotationWarper_warpRoi_Size_Mat_Mat(instance: *mut c_void, src_size: core::Size, k: *mut c_void, r: *mut c_void) -> cv_return_value_RectWrapper;
...
pub fn cv_Stitcher_estimateTransform_VectorOfMat_VectorOfMat(instance: *mut c_void, images: *mut c_void, masks: *mut c_void) -> cv_return_value_Stitcher_Status;
...
pub fn cv_Stitcher_stitch_VectorOfMat_VectorOfMat_Mat(instance: *mut c_void, images: *mut c_void, masks: *mut c_void, pano: *mut c_void) -> cv_return_value_Stitcher_Status;
...
pub fn cv_computeECC_Mat_Mat_Mat(template_image: *mut c_void, input_image: *mut c_void, input_mask: *mut c_void) -> cv_return_value_double;
...
pub fn cv_findTransformECC_Mat_Mat_Mat_int_TermCriteria_Mat_int(template_image: *mut c_void, input_image: *mut c_void, warp_matrix: *mut c_void, motion_type: i32, criteria: *mut c_void, input_mask: *mut c_void, gauss_filt_size: i32) -> cv_return_value_double;
...
pub fn cv_writeOpticalFlow_String_Mat(path: *const c_char, flow: *mut c_void) -> cv_return_value_bool;
...
pub fn cv_BackgroundSubtractorMOG2_apply_Mat_Mat_double(instance: *mut c_void, image: *mut c_void, fgmask: *mut c_void, learning_rate: f64) -> cv_return_value_void;
...
pub fn cv_VariationalRefinement_calcUV_Mat_Mat_Mat_Mat(instance: *mut c_void, i0: *mut c_void, i1: *mut c_void, flow_u: *mut c_void, flow_v: *mut c_void) -> cv_return_value_void;
