...
/// ## C++ default parameters
/// * offset: Point()
pub fn find_contours_with_hierarchy(image: &core::Mat, contours: &mut types::VectorOfMat, hierarchy: &mut core::Mat, mode: i32, method: i32, offset: core::Point) -> Result<()> {
...
/// ## C++ default parameters
/// * offset: Point()
pub fn find_contours(image: &core::Mat, contours: &mut types::VectorOfMat, mode: i32, method: i32, offset: core::Point) -> Result<()> {
...
pub fn get_perspective_transform_mat(src: &core::Mat, dst: &core::Mat, solve_method: i32) -> Result<core::Mat> {
    unsafe { sys::cv_getPerspectiveTransform_Mat_Mat_int(src.as_raw_Mat(), dst.as_raw_Mat(), solve_method) }.into_result().map(|ptr| core::Mat { ptr })
}
...
/// ## C++ default parameters
/// * solve_method: DECOMP_LU
pub fn get_perspective_transform(src: &[core::Point2f], dst: &[core::Point2f], solve_method: i32) -> Result<core::Mat> {
