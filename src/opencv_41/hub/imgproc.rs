...
//!
//! ![Delaunay triangulation (black) and Voronoi (red)](https://docs.opencv.org/4.1.2/delaunay_voronoi.png)
//!
...
/// ![autumn](https://docs.opencv.org/4.1.2/colormaps/colorscale_autumn.jpg)
pub const COLORMAP_AUTUMN: i32 = 0;
/// ![bone](https://docs.opencv.org/4.1.2/colormaps/colorscale_bone.jpg)
pub const COLORMAP_BONE: i32 = 1;
/// ![cividis](https://docs.opencv.org/4.1.2/colormaps/colorscale_cividis.jpg)
pub const COLORMAP_CIVIDIS: i32 = 17;
/// ![cool](https://docs.opencv.org/4.1.2/colormaps/colorscale_cool.jpg)
pub const COLORMAP_COOL: i32 = 8;
/// ![hot](https://docs.opencv.org/4.1.2/colormaps/colorscale_hot.jpg)
pub const COLORMAP_HOT: i32 = 11;
/// ![HSV](https://docs.opencv.org/4.1.2/colormaps/colorscale_hsv.jpg)
pub const COLORMAP_HSV: i32 = 9;
/// ![inferno](https://docs.opencv.org/4.1.2/colormaps/colorscale_inferno.jpg)
pub const COLORMAP_INFERNO: i32 = 14;
/// ![jet](https://docs.opencv.org/4.1.2/colormaps/colorscale_jet.jpg)
pub const COLORMAP_JET: i32 = 2;
/// ![magma](https://docs.opencv.org/4.1.2/colormaps/colorscale_magma.jpg)
pub const COLORMAP_MAGMA: i32 = 13;
/// ![ocean](https://docs.opencv.org/4.1.2/colormaps/colorscale_ocean.jpg)
pub const COLORMAP_OCEAN: i32 = 5;
/// ![parula](https://docs.opencv.org/4.1.2/colormaps/colorscale_parula.jpg)
pub const COLORMAP_PARULA: i32 = 12;
/// ![pink](https://docs.opencv.org/4.1.2/colormaps/colorscale_pink.jpg)
pub const COLORMAP_PINK: i32 = 10;
/// ![plasma](https://docs.opencv.org/4.1.2/colormaps/colorscale_plasma.jpg)
pub const COLORMAP_PLASMA: i32 = 15;
/// ![rainbow](https://docs.opencv.org/4.1.2/colormaps/colorscale_rainbow.jpg)
pub const COLORMAP_RAINBOW: i32 = 4;
/// ![spring](https://docs.opencv.org/4.1.2/colormaps/colorscale_spring.jpg)
pub const COLORMAP_SPRING: i32 = 7;
/// ![summer](https://docs.opencv.org/4.1.2/colormaps/colorscale_summer.jpg)
pub const COLORMAP_SUMMER: i32 = 6;
/// ![turbo](https://docs.opencv.org/4.1.2/colormaps/colorscale_turbo.jpg)
pub const COLORMAP_TURBO: i32 = 20;
/// ![twilight](https://docs.opencv.org/4.1.2/colormaps/colorscale_twilight.jpg)
pub const COLORMAP_TWILIGHT: i32 = 18;
/// ![twilight shifted](https://docs.opencv.org/4.1.2/colormaps/colorscale_twilight_shifted.jpg)
pub const COLORMAP_TWILIGHT_SHIFTED: i32 = 19;
/// ![viridis](https://docs.opencv.org/4.1.2/colormaps/colorscale_viridis.jpg)
pub const COLORMAP_VIRIDIS: i32 = 16;
/// ![winter](https://docs.opencv.org/4.1.2/colormaps/colorscale_winter.jpg)
...
/// basically *21HT*, described in [Yuen90](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Yuen90)
...
/// Finds edges in an image using the Canny algorithm [Canny86](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Canny86) .
///
...
/// two weighted point configurations. One of the applications described in [RubnerSept98](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_RubnerSept98),
/// [Rubner2000](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Rubner2000) is multi-dimensional histogram comparison for image retrieval. EMD is a transportation
...
/// in [Matas00](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Matas00)
///
/// See the line detection example below:
/// @include snippets/imgproc_HoughLinesP.cpp
/// This is a sample picture the function parameters have been tuned for:
///
/// ![image](https://docs.opencv.org/4.1.2/building.jpg)
///
/// And this is the output of the above program in case of the probabilistic Hough transform:
///
/// ![image](https://docs.opencv.org/4.1.2/houghp.png)
///
/// ## Parameters
...
///
/// The function cv::convexHull finds the convex hull of a 2D point set using the Sklansky's algorithm [Sklansky82](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Sklansky82)
...
///
/// ![image](https://docs.opencv.org/4.1.2/defects.png)
///
/// ## Parameters
...
///
/// ![image](https://docs.opencv.org/4.1.2/cornersubpix.png)
///
...
/// algorithm described in [Felzenszwalb04](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Felzenszwalb04) . This algorithm is parallelized with the TBB library.
///
/// In other cases, the algorithm [Borgefors86](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Borgefors86) is used. This means that for a pixel the function
...
pub fn draw_marker(img: &mut dyn core::ToInputOutputArray, position: core::Point, color: core::Scalar, marker_type: i32, marker_size: i32, thickness: i32, line_type: i32) -> Result<()> {
    input_output_array_arg!(img);
    unsafe { sys::cv_drawMarker__InputOutputArray_Point_Scalar_int_int_int_int(img.as_raw__InputOutputArray(), position, color, marker_type, marker_size, thickness, line_type) }.into_result()
}
...
///
/// ![Parameters of Elliptic Arc](https://docs.opencv.org/4.1.2/ellipse.svg)
///
/// ## Parameters
/// * img: Image.
...
///
/// The function retrieves contours from the binary image using the algorithm [Suzuki85](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Suzuki85) . The contours
...
pub fn find_contours_with_hierarchy(image: &dyn core::ToInputArray, contours: &mut dyn core::ToOutputArray, hierarchy: &mut dyn core::ToOutputArray, mode: i32, method: i32, offset: core::Point) -> Result<()> {
    ...
    unsafe { sys::cv_findContours__InputArray__OutputArray__OutputArray_int_int_Point(image.as_raw__InputArray(), contours.as_raw__OutputArray(), hierarchy.as_raw__OutputArray(), mode, method, offset) }.into_result()
}
...
pub fn find_contours(image: &dyn core::ToInputArray, contours: &mut dyn core::ToOutputArray, mode: i32, method: i32, offset: core::Point) -> Result<()> {
    input_array_arg!(image);
    output_array_arg!(contours);
    unsafe { sys::cv_findContours__InputArray__OutputArray_int_int_Point(image.as_raw__InputArray(), contours.as_raw__OutputArray(), mode, method, offset) }.into_result()
}
...
/// The Approximate Mean Square (AMS) proposed by [Taubin1991](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Taubin1991) is used.
///
...
/// The function calculates the ellipse that fits a set of 2D points.
/// It returns the rotated rectangle in which the ellipse is inscribed.
/// The Direct least square (Direct) method by [Fitzgibbon1999](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Fitzgibbon1999) is used.
///
/// For an ellipse, this basis set is ![inline formula](https://latex.codecogs.com/png.latex?%20%5Cchi%3D%20%5Cleft%28x%5E2%2C%20x%20y%2C%20y%5E2%2C%20x%2C%20y%2C%201%5Cright%29%20),
/// which is a set of six free coefficients ![inline formula](https://latex.codecogs.com/png.latex?%20A%5ET%3D%5Cleft%5C%7BA_%7B%5Ctext%7Bxx%7D%7D%2CA_%7B%5Ctext%7Bxy%7D%7D%2CA_%7B%5Ctext%7Byy%7D%7D%2CA_x%2CA_y%2CA_0%5Cright%5C%7D%20).
/// However, to specify an ellipse, all that is needed is five numbers; the major and minor axes lengths ![inline formula](https://latex.codecogs.com/png.latex?%20%28a%2Cb%29%20),
...
/// all. It returns the rotated rectangle in which the ellipse is inscribed. The first algorithm described by [Fitzgibbon95](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Fitzgibbon95)
...
pub fn get_perspective_transform(src: &dyn core::ToInputArray, dst: &dyn core::ToInputArray, solve_method: i32) -> Result<core::Mat> {
    input_array_arg!(src);
    input_array_arg!(dst);
    unsafe { sys::cv_getPerspectiveTransform__InputArray__InputArray_int(src.as_raw__InputArray(), dst.as_raw__InputArray(), solve_method) }.into_result().map(|ptr| core::Mat { ptr })
}
...
pub fn get_perspective_transform_slice(src: &[core::Point2f], dst: &[core::Point2f], solve_method: i32) -> Result<core::Mat> {
    unsafe { sys::cv_getPerspectiveTransform_const_Point2f_X_const_Point2f_X_int(src.as_ptr(), dst.as_ptr(), solve_method) }.into_result().map(|ptr| core::Mat { ptr })
}
...
/// described in [Shi94](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Shi94)
///
...
///
/// ![integral calculation example](https://docs.opencv.org/4.1.2/integral.png)
///
/// ## Parameters
...
///
/// ![Sample output of the minimum enclosing triangle function](https://docs.opencv.org/4.1.2/minenclosingtriangle.png)
///
/// The implementation of the algorithm is based on O'Rourke's [ORourke86](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_ORourke86) and Klee and Laskowski's
/// [KleeLaskowski85](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_KleeLaskowski85) papers. O'Rourke provides a ![inline formula](https://latex.codecogs.com/png.latex?%5Ctheta%28n%29) algorithm for finding the minimal
...
///
/// ![sample output](https://docs.opencv.org/4.1.2/pointpolygon.png)
///
/// ## Parameters
/// * contour: Input contour.
...
pub fn rectangle(img: &mut dyn core::ToInputOutputArray, rec: core::Rect, color: core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result<()> {
    input_output_array_arg!(img);
    unsafe { sys::cv_rectangle__InputOutputArray_Rect_Scalar_int_int_int(img.as_raw__InputOutputArray(), rec, color, thickness, line_type, shift) }.into_result()
}
...
///
/// ![intersection examples](https://docs.opencv.org/4.1.2/intersection.png)
///
/// ## Parameters
...
/// ![Polar remaps reference](https://docs.opencv.org/4.1.2/polar_remap_doc.png)
///
...
/// algorithm, described in [Meyer92](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Meyer92) .
///
...
/// finds arbitrary template in the grayscale image using Generalized Hough Transform
///
/// Detects position only without translation and rotation [Ballard1981](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Ballard1981) .
...
/// finds arbitrary template in the grayscale image using Generalized Hough Transform
///
/// Detects position, translation and rotation [Guil1999](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Guil1999) .
...
///
/// following the algorithm described at [Rafael12](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Rafael12) .
///
///
/// Note: Implementation has been removed due original code license conflict
pub trait LineSegmentDetector: core::AlgorithmTrait {
    ...
    ///
    /// ![image](https://docs.opencv.org/4.1.2/building_lsd.png)
    ///
    /// ## Parameters
...
impl Subdiv2D {
    ...
    ///
    /// ![sample output](https://docs.opencv.org/4.1.2/quadedge.png)
    ///
    /// ## Returns
