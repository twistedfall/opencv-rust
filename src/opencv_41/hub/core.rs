...
/// ## C++ default parameters
/// * r: 255.
pub fn psnr(src1: &core::Mat, src2: &core::Mat, r: f64) -> Result<f64> {
    unsafe { sys::cv_PSNR_Mat_Mat_double(src1.as_raw_Mat(), src2.as_raw_Mat(), r) }.into_result()
}
...
pub fn copy_to(src: &core::Mat, dst: &mut core::Mat, mask: &core::Mat) -> Result<()> {
    unsafe { sys::cv_copyTo_Mat_Mat_Mat(src.as_raw_Mat(), dst.as_raw_Mat(), mask.as_raw_Mat()) }.into_result()
}
