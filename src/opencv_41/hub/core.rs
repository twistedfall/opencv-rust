...
pub enum AccessFlag {
    ...
    // ACCESS_MASK = ACCESS_MASK as isize, // duplicate discriminant
...
/// ![Graphs for the different norm functions from the above example](https://docs.opencv.org/4.1.0/NormTypes_OneArray_1-2-INF.png)
///
...
/// ![image](https://docs.opencv.org/4.1.0/rotatedrect.png)
///
/// ## See also
...
pub static CV_VERSION: &'static str = "4.1.0";
