...
//! the papers [OF06](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_OF06) and [G11](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_G11) . However, there are some extensions and deviations from the original
//! paper methods.
//!
//! ### References
//!
...
//!
//! The Fast Marching Method [Telea04](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Telea04) is used in of the video stabilization routines to do motion and
