...
//! image, we first compute a non-binary descriptor as described in [LBD](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_LBD) . Such algorithm works on
//! lines extracted using EDLine detector, as explained in [EDL](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_EDL) . Given a line, we consider a
...
/// ----------------------------
///
/// The lines extraction methodology described in the following is mainly based on [EDL](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_EDL) . The
...
/// -------------------
///
/// The theory described in this section is based on [MIH](https://docs.opencv.org/4.1.1/d0/de3/citelist.html#CITEREF_MIH) . Given a dataset populated with binary
