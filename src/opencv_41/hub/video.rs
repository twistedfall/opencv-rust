...
/// The function implements the CAMSHIFT object tracking algorithm [Bradski98](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Bradski98) . First, it finds an
...
/// level of robustness.
///
/// The function finds an optical flow for each prev pixel using the [Farneback2003](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Farneback2003) algorithm so that
///
...
/// optical flow equations (this matrix is called a spatial gradient matrix in [Bouguet00](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Bouguet00)), divided
/// by number of pixels in a window; if this value is less than minEigThreshold, then a corresponding
/// feature is filtered out and its flow is not processed, so it allows to remove bad points and get a
/// performance boost.
///
/// The function implements a sparse iterative version of the Lucas-Kanade optical flow in pyramids. See
/// [Bouguet00](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Bouguet00) . The function is parallelized with the TBB library.
///
///
/// Note:
///
...
/// Computes the Enhanced Correlation Coefficient value between two images [EP08](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_EP08) .
///
/// ## Parameters
...
/// Finds the geometric transform (warp) between two images in terms of the ECC criterion [EP08](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_EP08) .
///
/// ## Parameters
/// * templateImage: single-channel template image; CV_8U or CV_32F array.
...
/// ([EP08](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_EP08)), that is
///
...
///
/// The class implements the K-nearest neighbours background subtraction described in [Zivkovic2006](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Zivkovic2006) .
...
///
/// The class implements the Gaussian mixture model background subtraction described in [Zivkovic2004](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Zivkovic2004)
/// and [Zivkovic2006](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Zivkovic2006) .
...
/// details about the algorithm can be found at [Kroeger2016](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Kroeger2016) . Includes three presets with preselected
...
/// [Welch95](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Welch95) . However, you can modify transitionMatrix, controlMatrix, and measurementMatrix to get
...
/// ![inline formula](https://latex.codecogs.com/png.latex?E%28U%29%20%3D%20%5Cint_%7B%5COmega%7D%20%5Cdelta%20%5CPsi%28E_I%29%20%2B%20%5Cgamma%20%5CPsi%28E_G%29%20%2B%20%5Calpha%20%5CPsi%28E_S%29%20),
/// where ![inline formula](https://latex.codecogs.com/png.latex?E_I%2CE_G%2CE_S) are color constancy, gradient constancy and smoothness terms
...
/// procedure can be found in [Brox2004](https://docs.opencv.org/4.1.2/d0/de3/citelist.html#CITEREF_Brox2004)
pub trait VariationalRefinement: crate::video::DenseOpticalFlow {
    ...
    fn calc_uv(&mut self, i0: &dyn core::ToInputArray, i1: &dyn core::ToInputArray, flow_u: &mut dyn core::ToInputOutputArray, flow_v: &mut dyn core::ToInputOutputArray) -> Result<()> {
        ...
        unsafe { sys::cv_VariationalRefinement_calcUV__InputArray__InputArray__InputOutputArray__InputOutputArray(self.as_raw_VariationalRefinement(), i0.as_raw__InputArray(), i1.as_raw__InputArray(), flow_u.as_raw__InputOutputArray(), flow_v.as_raw__InputOutputArray()) }.into_result()
    }
