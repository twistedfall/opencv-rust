...
///
/// See the original paper [He2012](https://docs.opencv.org/3.4.7/d0/de3/citelist.html#CITEREF_He2012) for details.
///
/// ## Parameters
...
/// [Cheng2015](https://docs.opencv.org/3.4.7/d0/de3/citelist.html#CITEREF_Cheng2015) .
///
...
pub trait LearningBasedWB: crate::xphoto::WhiteBalancer {
    ...
    ///
    /// In accordance with [Cheng2015](https://docs.opencv.org/3.4.7/d0/de3/citelist.html#CITEREF_Cheng2015) , computes the following features for the input image:
...
///
/// For more information see [DD02](https://docs.opencv.org/3.4.7/d0/de3/citelist.html#CITEREF_DD02) .
