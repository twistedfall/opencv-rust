...
//! ![inline formula](https://latex.codecogs.com/png.latex?y%27%27). This distortion can be modelled in the following way, see e.g. [Louhichi07](https://docs.opencv.org/3.4.7/d0/de3/citelist.html#CITEREF_Louhichi07).
//!
