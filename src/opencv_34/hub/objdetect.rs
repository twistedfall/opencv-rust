...
//! ----------------------------------------------------------
//!
//! The object detector described below has been initially proposed by Paul Viola [Viola01](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Viola01) and
//! improved by Rainer Lienhart [Lienhart02](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Lienhart02) .
//!
...
//! Haar-like features:
//!
//! ![image](https://docs.opencv.org/3.4.8/haarfeatures.png)
//!
...
///
/// the HOG descriptor algorithm introduced by Navneet Dalal and Bill Triggs [Dalal2005](https://docs.opencv.org/3.4.8/d0/de3/citelist.html#CITEREF_Dalal2005) .
///
/// useful links:
///
