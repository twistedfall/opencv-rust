...
pub fn cv_CirclesGridFinderParameters2_CirclesGridFinderParameters2() -> cv_return_value_CirclesGridFinderParameters2;
...
pub fn cv_estimateRigidTransform_Mat_Mat_bool_int_double_int(src: *mut c_void, dst: *mut c_void, full_affine: bool, ransac_max_iters: i32, ransac_good_ratio: f64, ransac_size0: i32) -> cv_return_value_void_X;
...
pub fn cv_viz_computeNormals_Mesh_Mat(mesh: *mut c_void, normals: *mut c_void) -> cv_return_value_void;
pub fn cv_viz_getWindowByName_String(window_name: *const c_char) -> cv_return_value_void_X;
pub fn cv_viz_imshow_String_Mat_Size(window_name: *const c_char, image: *mut c_void, window_size: core::Size) -> cv_return_value_void_X;
pub fn cv_viz_isNan_double(x: f64) -> cv_return_value_bool;
pub fn cv_viz_isNan_float(x: f32) -> cv_return_value_bool;
pub fn cv_viz_readCloud_String_Mat_Mat(file: *const c_char, colors: *mut c_void, normals: *mut c_void) -> cv_return_value_void_X;
pub fn cv_viz_readMesh_String(file: *const c_char) -> cv_return_value_void_X;
pub fn cv_viz_readTrajectory_Mat_String_int_int_String(traj: *mut c_void, files_format: *const c_char, start: i32, end: i32, tag: *const c_char) -> cv_return_value_void;
pub fn cv_viz_unregisterAllWindows() -> cv_return_value_void;
pub fn cv_viz_writeCloud_String_Mat_Mat_Mat_bool(file: *const c_char, cloud: *mut c_void, colors: *mut c_void, normals: *mut c_void, binary: bool) -> cv_return_value_void;
pub fn cv_viz_writeTrajectory_Mat_String_int_String(traj: *mut c_void, files_format: *const c_char, start: i32, tag: *const c_char) -> cv_return_value_void;
...
pub fn cv_viz_Viz3d_showImage_Mat_Size(instance: *mut c_void, image: *mut c_void, window_size: core::Size) -> cv_return_value_void;
...
pub fn cv_viz_Viz3d_setBackgroundTexture_Mat(instance: *mut c_void, image: *mut c_void) -> cv_return_value_void;
...
pub fn cv_viz_WCameraPosition_WCameraPosition_Vec2d_Mat_double_Color(fov: core::Vec2d, image: *mut c_void, scale: f64, color: *mut c_void) -> cv_return_value_void_X;
...
pub fn cv_viz_WCloud_WCloud_Mat_Mat(cloud: *mut c_void, colors: *mut c_void) -> cv_return_value_void_X;
pub fn cv_viz_WCloud_WCloud_Mat_Color(cloud: *mut c_void, color: *mut c_void) -> cv_return_value_void_X;
pub fn cv_viz_WCloud_WCloud_Mat_Mat_Mat(cloud: *mut c_void, colors: *mut c_void, normals: *mut c_void) -> cv_return_value_void_X;
pub fn cv_viz_WCloud_WCloud_Mat_Color_Mat(cloud: *mut c_void, color: *mut c_void, normals: *mut c_void) -> cv_return_value_void_X;
...
pub fn cv_viz_WCloudNormals_WCloudNormals_Mat_Mat_int_double_Color(cloud: *mut c_void, normals: *mut c_void, level: i32, scale: f64, color: *mut c_void) -> cv_return_value_void_X;
...
pub fn cv_viz_WImage3D_WImage3D_Mat_Size2d(image: *mut c_void, size: core::Size2d) -> cv_return_value_void_X;
pub fn cv_viz_WImage3D_WImage3D_Mat_Size2d_Vec3d_Vec3d_Vec3d(image: *mut c_void, size: core::Size2d, center: core::Vec3d, normal: core::Vec3d, up_vector: core::Vec3d) -> cv_return_value_void_X;
pub fn cv_viz_WImage3D_setImage_Mat(instance: *mut c_void, image: *mut c_void) -> cv_return_value_void;
...
pub fn cv_viz_WImageOverlay_WImageOverlay_Mat_Rect(image: *mut c_void, rect: core::Rect) -> cv_return_value_void_X;
pub fn cv_viz_WImageOverlay_setImage_Mat(instance: *mut c_void, image: *mut c_void) -> cv_return_value_void;
...
pub fn cv_viz_WMesh_WMesh_Mat_Mat_Mat_Mat(cloud: *mut c_void, polygons: *mut c_void, colors: *mut c_void, normals: *mut c_void) -> cv_return_value_void_X;
#[doc(hidden)] pub fn cv_WPaintedCloud_delete(ptr : *mut c_void);
pub fn cv_viz_WPaintedCloud_WPaintedCloud_Mat(cloud: *mut c_void) -> cv_return_value_void_X;
...
pub fn cv_viz_WPolyLine_WPolyLine_Mat_Mat(points: *mut c_void, colors: *mut c_void) -> cv_return_value_void_X;
pub fn cv_viz_WPolyLine_WPolyLine_Mat_Color(points: *mut c_void, color: *mut c_void) -> cv_return_value_void_X;
...
pub fn cv_viz_WTrajectory_WTrajectory_Mat_int_double_Color(path: *mut c_void, display_mode: i32, scale: f64, color: *mut c_void) -> cv_return_value_void_X;
#[doc(hidden)] pub fn cv_WTrajectoryFrustums_delete(ptr : *mut c_void);
pub fn cv_viz_WTrajectoryFrustums_WTrajectoryFrustums_Mat_Vec2d_double_Color(path: *mut c_void, fov: core::Vec2d, scale: f64, color: *mut c_void) -> cv_return_value_void_X;
#[doc(hidden)] pub fn cv_WTrajectorySpheres_delete(ptr : *mut c_void);
pub fn cv_viz_WTrajectorySpheres_WTrajectorySpheres_Mat_double_double_Color_Color(path: *mut c_void, line_length: f64, radius: f64, from: *mut c_void, to: *mut c_void) -> cv_return_value_void_X;
