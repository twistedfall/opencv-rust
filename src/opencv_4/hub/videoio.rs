...
impl VideoCapture {
    ...
    /// ## C++ default parameters
    /// * timeout_ns: 0
    pub fn wait_any(streams: &types::VectorOfVideoCapture, ready_index: &mut types::VectorOfint, timeout_ns: i64) -> Result<bool> {
        unsafe { sys::cv_VideoCapture_waitAny_VectorOfVideoCapture_VectorOfint_int64(streams.as_raw_VectorOfVideoCapture(), ready_index.as_raw_VectorOfint(), timeout_ns) }.into_result()
    }
...
pub const CAP_INTELPERC_GENERATORS_MASK: i32 = 0x38000000; // 939524096
