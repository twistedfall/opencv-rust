...
impl CustomPattern {
    ...
    pub fn get_pattern_points(&mut self, original_points: &mut core::Mat) -> Result<()> {
        unsafe { sys::cv_ccalib_CustomPattern_getPatternPoints_Mat(self.as_raw_CustomPattern(), original_points.as_raw_Mat()) }.into_result()
    }
