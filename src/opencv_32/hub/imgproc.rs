...
/// ![autumn](https://docs.opencv.org/3.2.0/colormaps/colorscale_autumn.jpg)
pub const COLORMAP_AUTUMN: i32 = 0;
/// ![bone](https://docs.opencv.org/3.2.0/colormaps/colorscale_bone.jpg)
pub const COLORMAP_BONE: i32 = 1;
/// ![cool](https://docs.opencv.org/3.2.0/colormaps/colorscale_cool.jpg)
pub const COLORMAP_COOL: i32 = 8;
/// ![hot](https://docs.opencv.org/3.2.0/colormaps/colorscale_hot.jpg)
pub const COLORMAP_HOT: i32 = 11;
/// ![HSV](https://docs.opencv.org/3.2.0/colormaps/colorscale_hsv.jpg)
pub const COLORMAP_HSV: i32 = 9;
/// ![jet](https://docs.opencv.org/3.2.0/colormaps/colorscale_jet.jpg)
pub const COLORMAP_JET: i32 = 2;
/// ![ocean](https://docs.opencv.org/3.2.0/colormaps/colorscale_ocean.jpg)
pub const COLORMAP_OCEAN: i32 = 5;
/// ![parula](https://docs.opencv.org/3.2.0/colormaps/colorscale_parula.jpg)
pub const COLORMAP_PARULA: i32 = 12;
/// ![pink](https://docs.opencv.org/3.2.0/colormaps/colorscale_pink.jpg)
pub const COLORMAP_PINK: i32 = 10;
/// ![rainbow](https://docs.opencv.org/3.2.0/colormaps/colorscale_rainbow.jpg)
pub const COLORMAP_RAINBOW: i32 = 4;
/// ![spring](https://docs.opencv.org/3.2.0/colormaps/colorscale_spring.jpg)
pub const COLORMAP_SPRING: i32 = 7;
/// ![summer](https://docs.opencv.org/3.2.0/colormaps/colorscale_summer.jpg)
pub const COLORMAP_SUMMER: i32 = 6;
/// ![winter](https://docs.opencv.org/3.2.0/colormaps/colorscale_winter.jpg)
...
/// is equivalent to
///
/// ![block formula](https://latex.codecogs.com/png.latex?%5Ctexttt%7BSobel%28src%2C%20dst%2C%20ddepth%2C%20dx%2C%20dy%2C%20CV%5C_SCHARR%2C%20scale%2C%20delta%2C%20borderType%29%7D%20.)
///
/// ## Parameters
/// * src: input image.
...
pub fn bounding_rect(points: &dyn core::ToInputArray) -> Result<core::Rect> {
    ...
    unsafe { sys::cv_boundingRect__InputArray(points.as_raw__InputArray()) }.into_result()
}
...
///
/// ![block formula](https://latex.codecogs.com/png.latex?%5Csum%20_i%28DI_%7Bp_i%7D%20%20%5Ccdot%20%7BDI_%7Bp_i%7D%7D%5ET%29%20-%20%20%5Csum%20_i%28DI_%7Bp_i%7D%20%20%5Ccdot%20%7BDI_%7Bp_i%7D%7D%5ET%20%20%5Ccdot%20p_i%29)
///
...
pub fn demosaicing(_src: &dyn core::ToInputArray, _dst: &mut dyn core::ToOutputArray, code: i32, dcn: i32) -> Result<()> {
    ...
    unsafe { sys::cv_demosaicing__InputArray__OutputArray_int_int(_src.as_raw__InputArray(), _dst.as_raw__OutputArray(), code, dcn) }.into_result()
}
...
///
/// ![block formula](https://latex.codecogs.com/png.latex?dst%28x%2C%20y%29%20%3D%20src%28x%20%2B%20%20%5Ctexttt%7Bcenter.x%7D%20-%20%28%20%5Ctexttt%7Bdst.cols%7D%20-1%29%2A0.5%2C%20y%20%2B%20%20%5Ctexttt%7Bcenter.y%7D%20-%20%28%20%5Ctexttt%7Bdst.rows%7D%20-1%29%2A0.5%29)
///
...
///
/// where
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0AI%20%3D%20%28dx%2Cdy%29%20%3D%20%28x%20-%20center.x%2Cy%20-%20center.y%29%20%5C%5C%0A%5Crho%20%3D%20Kx%20%5Ccdot%20%5Ctexttt%7Bmagnitude%7D%20%28I%29%20%2C%5C%5C%0A%5Cphi%20%3D%20Ky%20%5Ccdot%20%5Ctexttt%7Bangle%7D%20%28I%29_%7B0..360%20deg%7D%0A%5Cend%7Barray%7D)
///
/// and
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0AKx%20%3D%20src.cols%20%2F%20maxRadius%20%5C%5C%0AKy%20%3D%20src.rows%20%2F%20360%0A%5Cend%7Barray%7D)
///
///
/// ## Parameters
/// * src: Source image
...
///
/// where
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0AI%20%3D%20%28dx%2Cdy%29%20%3D%20%28x%20-%20center.x%2Cy%20-%20center.y%29%20%5C%5C%0A%5Crho%20%3D%20M%20%5Ccdot%20log_e%28%5Ctexttt%7Bmagnitude%7D%20%28I%29%29%20%2C%5C%5C%0A%5Cphi%20%3D%20Ky%20%5Ccdot%20%5Ctexttt%7Bangle%7D%20%28I%29_%7B0..360%20deg%7D%20%5C%5C%0A%5Cend%7Barray%7D)
///
/// and
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0AM%20%3D%20src.cols%20%2F%20log_e%28maxRadius%29%20%5C%5C%0AKy%20%3D%20src.rows%20%2F%20360%20%5C%5C%0A%5Cend%7Barray%7D)
///
...
pub fn sqr_box_filter(_src: &dyn core::ToInputArray, _dst: &mut dyn core::ToOutputArray, ddepth: i32, ksize: core::Size, anchor: core::Point, normalize: bool, border_type: i32) -> Result<()> {
    input_array_arg!(_src);
    output_array_arg!(_dst);
    unsafe { sys::cv_sqrBoxFilter__InputArray__OutputArray_int_Size_Point_bool_int(_src.as_raw__InputArray(), _dst.as_raw__OutputArray(), ddepth, ksize, anchor, normalize, border_type) }.into_result()
}
