...
/// ## C++ default parameters
/// * is_projective: false
pub fn reconstruct_2(images: &types::VectorOfstd_string, rs: &mut core::Mat, ts: &mut core::Mat, k: &mut core::Mat, points3d: &mut core::Mat, is_projective: bool) -> Result<()> {
    unsafe { sys::cv_sfm_reconstruct_VectorOfstd_string_Mat_Mat_Mat_Mat_bool(images.as_raw_VectorOfstd_string(), rs.as_raw_Mat(), ts.as_raw_Mat(), k.as_raw_Mat(), points3d.as_raw_Mat(), is_projective) }.into_result()
}
...
/// ## C++ default parameters
/// * is_projective: false
pub fn reconstruct_3(images: &types::VectorOfstd_string, ps: &mut core::Mat, points3d: &mut core::Mat, k: &mut core::Mat, is_projective: bool) -> Result<()> {
    unsafe { sys::cv_sfm_reconstruct_VectorOfstd_string_Mat_Mat_Mat_bool(images.as_raw_VectorOfstd_string(), ps.as_raw_Mat(), points3d.as_raw_Mat(), k.as_raw_Mat(), is_projective) }.into_result()
}
...
pub trait BaseSFM {
    ...
    fn run_3(&mut self, images: &types::VectorOfstd_string, k: &mut core::Mat, rs: &mut core::Mat, ts: &mut core::Mat, points3d: &mut core::Mat) -> Result<()> {
        unsafe { sys::cv_sfm_BaseSFM_run_VectorOfstd_string_Mat_Mat_Mat_Mat(self.as_raw_BaseSFM(), images.as_raw_VectorOfstd_string(), k.as_raw_Mat(), rs.as_raw_Mat(), ts.as_raw_Mat(), points3d.as_raw_Mat()) }.into_result()
    }
...
pub trait SFMLibmvEuclideanReconstruction: crate::sfm::BaseSFM {
    ...
    /// - For now DAISY features are used in order to compute the 2d points tracks and it only works for 3-4 images.
    fn run_3(&mut self, images: &types::VectorOfstd_string, k: &mut core::Mat, rs: &mut core::Mat, ts: &mut core::Mat, points3d: &mut core::Mat) -> Result<()> {
        unsafe { sys::cv_sfm_SFMLibmvEuclideanReconstruction_run_VectorOfstd_string_Mat_Mat_Mat_Mat(self.as_raw_SFMLibmvEuclideanReconstruction(), images.as_raw_VectorOfstd_string(), k.as_raw_Mat(), rs.as_raw_Mat(), ts.as_raw_Mat(), points3d.as_raw_Mat()) }.into_result()
    }
