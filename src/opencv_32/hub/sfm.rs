...
/// ## C++ default parameters
/// * is_projective: false
pub fn reconstruct(images: &types::VectorOfstd_string, rs: &mut dyn core::ToOutputArray, ts: &mut dyn core::ToOutputArray, k: &mut dyn core::ToInputOutputArray, points3d: &mut dyn core::ToOutputArray, is_projective: bool) -> Result<()> {
    output_array_arg!(rs);
    output_array_arg!(ts);
    input_output_array_arg!(k);
    output_array_arg!(points3d);
    unsafe { sys::cv_sfm_reconstruct_VectorOfstd_string__OutputArray__OutputArray__InputOutputArray__OutputArray_bool(images.as_raw_VectorOfstd_string(), rs.as_raw__OutputArray(), ts.as_raw__OutputArray(), k.as_raw__InputOutputArray(), points3d.as_raw__OutputArray(), is_projective) }.into_result()
}
...
/// ## C++ default parameters
/// * is_projective: false
pub fn reconstruct_1(images: &types::VectorOfstd_string, ps: &mut dyn core::ToOutputArray, points3d: &mut dyn core::ToOutputArray, k: &mut dyn core::ToInputOutputArray, is_projective: bool) -> Result<()> {
    output_array_arg!(ps);
    output_array_arg!(points3d);
    input_output_array_arg!(k);
    unsafe { sys::cv_sfm_reconstruct_VectorOfstd_string__OutputArray__OutputArray__InputOutputArray_bool(images.as_raw_VectorOfstd_string(), ps.as_raw__OutputArray(), points3d.as_raw__OutputArray(), k.as_raw__InputOutputArray(), is_projective) }.into_result()
}
...
pub trait BaseSFM {
    ...
    fn run_2(&mut self, images: &types::VectorOfstd_string) -> Result<()> {
        unsafe { sys::cv_sfm_BaseSFM_run_VectorOfstd_string(self.as_raw_BaseSFM(), images.as_raw_VectorOfstd_string()) }.into_result()
    }
    
    fn run_3(&mut self, images: &types::VectorOfstd_string, k: &mut dyn core::ToInputOutputArray, rs: &mut dyn core::ToOutputArray, ts: &mut dyn core::ToOutputArray, points3d: &mut dyn core::ToOutputArray) -> Result<()> {
        input_output_array_arg!(k);
        output_array_arg!(rs);
        output_array_arg!(ts);
        output_array_arg!(points3d);
        unsafe { sys::cv_sfm_BaseSFM_run_VectorOfstd_string__InputOutputArray__OutputArray__OutputArray__OutputArray(self.as_raw_BaseSFM(), images.as_raw_VectorOfstd_string(), k.as_raw__InputOutputArray(), rs.as_raw__OutputArray(), ts.as_raw__OutputArray(), points3d.as_raw__OutputArray()) }.into_result()
    }
...
pub trait SFMLibmvEuclideanReconstruction: crate::sfm::BaseSFM {
    ...
    /// - For now DAISY features are used in order to compute the 2d points tracks and it only works for 3-4 images.
    fn run_2(&mut self, images: &types::VectorOfstd_string) -> Result<()> {
        unsafe { sys::cv_sfm_SFMLibmvEuclideanReconstruction_run_VectorOfstd_string(self.as_raw_SFMLibmvEuclideanReconstruction(), images.as_raw_VectorOfstd_string()) }.into_result()
    }
    ...
    fn run_3(&mut self, images: &types::VectorOfstd_string, k: &mut dyn core::ToInputOutputArray, rs: &mut dyn core::ToOutputArray, ts: &mut dyn core::ToOutputArray, points3d: &mut dyn core::ToOutputArray) -> Result<()> {
        ...
        output_array_arg!(ts);
        output_array_arg!(points3d);
        unsafe { sys::cv_sfm_SFMLibmvEuclideanReconstruction_run_VectorOfstd_string__InputOutputArray__OutputArray__OutputArray__OutputArray(self.as_raw_SFMLibmvEuclideanReconstruction(), images.as_raw_VectorOfstd_string(), k.as_raw__InputOutputArray(), rs.as_raw__OutputArray(), ts.as_raw__OutputArray(), points3d.as_raw__OutputArray()) }.into_result()
    }
