...
// identifier: cv_AGAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression
  unsafe {
    let rv = sys::cv_features2d_cv_AGAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression(image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression);
...
// identifier: cv_AGAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression_int_type
  unsafe {
    let rv = sys::cv_features2d_cv_AGAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression_int_type(image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression, _type);
    if !rv.error_msg.is_null() {
      let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
      ::libc::free(rv.error_msg as _);
      Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
// identifier: cv_FAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression
  unsafe {
    let rv = sys::cv_features2d_cv_FAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression(image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression);
    if !rv.error_msg.is_null() {
      let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
      ::libc::free(rv.error_msg as _);
      Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
// identifier: cv_FAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression_int_type
  unsafe {
    let rv = sys::cv_features2d_cv_FAST_Mat_image_VectorOfKeyPoint_keypoints_int_threshold_bool_nonmaxSuppression_int_type(image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression, _type);
    if !rv.error_msg.is_null() {
      let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
      ::libc::free(rv.error_msg as _);
      Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
// identifier: cv_drawKeypoints_Mat_image_VectorOfKeyPoint_keypoints_Mat_outImage_Scalar_color_int_flags
  unsafe {
    let rv = sys::cv_features2d_cv_drawKeypoints_Mat_image_VectorOfKeyPoint_keypoints_Mat_outImage_Scalar_color_int_flags(image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), out_image.as_raw_Mat(), color, flags);
    if !rv.error_msg.is_null() {
      let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
      ::libc::free(rv.error_msg as _);
      Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
// identifier: cv_drawMatches_Mat_img1_VectorOfKeyPoint_keypoints1_Mat_img2_VectorOfKeyPoint_keypoints2_VectorOfDMatch_matches1to2_Mat_outImg_Scalar_matchColor_Scalar_singlePointColor_VectorOfchar_matchesMask_int_flags
  unsafe {
    let rv = sys::cv_features2d_cv_drawMatches_Mat_img1_VectorOfKeyPoint_keypoints1_Mat_img2_VectorOfKeyPoint_keypoints2_VectorOfDMatch_matches1to2_Mat_outImg_Scalar_matchColor_Scalar_singlePointColor_VectorOfchar_matchesMask_int_flags(img1.as_raw_Mat(), keypoints1.as_raw_VectorOfKeyPoint(), img2.as_raw_Mat(), keypoints2.as_raw_VectorOfKeyPoint(), matches1to2.as_raw_VectorOfDMatch(), out_img.as_raw_Mat(), match_color, single_point_color, matches_mask.as_raw_VectorOfchar(), flags);
    if !rv.error_msg.is_null() {
      let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
      ::libc::free(rv.error_msg as _);
      Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
// identifier: cv_getNearestPoint_VectorOfPoint2f_recallPrecisionCurve_float_l_precision
  unsafe {
    let rv = sys::cv_features2d_cv_getNearestPoint_VectorOfPoint2f_recallPrecisionCurve_float_l_precision(recall_precision_curve.as_raw_VectorOfPoint2f(), l_precision);
    if !rv.error_msg.is_null() {
      let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
      ::libc::free(rv.error_msg as _);
      Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
// identifier: cv_getRecall_VectorOfPoint2f_recallPrecisionCurve_float_l_precision
  unsafe {
    let rv = sys::cv_features2d_cv_getRecall_VectorOfPoint2f_recallPrecisionCurve_float_l_precision(recall_precision_curve.as_raw_VectorOfPoint2f(), l_precision);
    if !rv.error_msg.is_null() {
      let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
      ::libc::free(rv.error_msg as _);
      Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
pub trait AKAZE : super::features2d::Feature2D {
  ...
  // identifier: cv_AKAZE_setDescriptorType_int_dtype
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_setDescriptorType_int_dtype(self.as_raw_AKAZE(), dtype);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getDescriptorType
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getDescriptorType(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_setDescriptorSize_int_dsize
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_setDescriptorSize_int_dsize(self.as_raw_AKAZE(), dsize);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getDescriptorSize
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getDescriptorSize(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_setDescriptorChannels_int_dch
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_setDescriptorChannels_int_dch(self.as_raw_AKAZE(), dch);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getDescriptorChannels
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getDescriptorChannels(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_setThreshold_double_threshold
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_setThreshold_double_threshold(self.as_raw_AKAZE(), threshold);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getThreshold(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_setNOctaves_int_octaves
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_setNOctaves_int_octaves(self.as_raw_AKAZE(), octaves);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getNOctaves
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getNOctaves(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_setNOctaveLayers_int_octaveLayers
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_setNOctaveLayers_int_octaveLayers(self.as_raw_AKAZE(), octave_layers);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getNOctaveLayers
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getNOctaveLayers(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_setDiffusivity_int_diff
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_setDiffusivity_int_diff(self.as_raw_AKAZE(), diff);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getDiffusivity
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getDiffusivity(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AKAZE_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_getDefaultName(self.as_raw_AKAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> AKAZE + 'a {
  ...
  // identifier: cv_AKAZE_create_int_descriptor_type_int_descriptor_size_int_descriptor_channels_float_threshold_int_nOctaves_int_nOctaveLayers_int_diffusivity
    unsafe {
      let rv = sys::cv_features2d_cv_AKAZE_create_int_descriptor_type_int_descriptor_size_int_descriptor_channels_float_threshold_int_nOctaves_int_nOctaveLayers_int_diffusivity(descriptor_type, descriptor_size, descriptor_channels, threshold, n_octaves, n_octave_layers, diffusivity);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfAKAZE { ptr: rv.result })
      }
    }
  }
...
pub trait AgastFeatureDetector : super::features2d::Feature2D {
  ...
  // identifier: cv_AgastFeatureDetector_setThreshold_int_threshold
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_setThreshold_int_threshold(self.as_raw_AgastFeatureDetector(), threshold);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AgastFeatureDetector_getThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_getThreshold(self.as_raw_AgastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AgastFeatureDetector_setNonmaxSuppression_bool_f
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_setNonmaxSuppression_bool_f(self.as_raw_AgastFeatureDetector(), f);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AgastFeatureDetector_getNonmaxSuppression
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_getNonmaxSuppression(self.as_raw_AgastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AgastFeatureDetector_setType_int_type
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_setType_int_type(self.as_raw_AgastFeatureDetector(), _type);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_AgastFeatureDetector_getType
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_getType(self.as_raw_AgastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_default_name(&self) -> Result<String> {
  // identifier: cv_AgastFeatureDetector_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_getDefaultName(self.as_raw_AgastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> AgastFeatureDetector + 'a {
  ...
  // identifier: cv_AgastFeatureDetector_create_int_threshold_bool_nonmaxSuppression_int_type
    unsafe {
      let rv = sys::cv_features2d_cv_AgastFeatureDetector_create_int_threshold_bool_nonmaxSuppression_int_type(threshold, nonmax_suppression, _type);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfAgastFeatureDetector { ptr: rv.result })
      }
    }
  }
...
impl Drop for super::features2d::BFMatcher {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_BFMatcher(self.ptr) };
    }
}
impl super::features2d::BFMatcher {
    #[doc(hidden)] pub fn as_raw_BFMatcher(&self) -> *mut c_void { self.ptr }
}

impl super::features2d::DescriptorMatcher for BFMatcher {
...
impl BFMatcher {
  ...
  /// * norm_type: NORM_L2
  /// * cross_check: false
  pub fn new(norm_type: i32, cross_check: bool) -> Result<super::features2d::BFMatcher> {
  // identifier: cv_BFMatcher_BFMatcher_int_normType_bool_crossCheck
    unsafe {
      let rv = sys::cv_features2d_cv_BFMatcher_BFMatcher_int_normType_bool_crossCheck(norm_type, cross_check);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(super::features2d::BFMatcher { ptr: rv.result })
      }
    }
  }
  ...
  // identifier: cv_BFMatcher_create_int_normType_bool_crossCheck
    unsafe {
      let rv = sys::cv_features2d_cv_BFMatcher_create_int_normType_bool_crossCheck(norm_type, cross_check);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfBFMatcher { ptr: rv.result })
      }
    }
  }
  ...
  // identifier: cv_BFMatcher_clone_bool_emptyTrainData
    unsafe {
      let rv = sys::cv_features2d_cv_BFMatcher_clone_bool_emptyTrainData(self.as_raw_BFMatcher(), empty_train_data);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfDescriptorMatcher { ptr: rv.result })
      }
    }
  }
...
impl Drop for super::features2d::BOWImgDescriptorExtractor {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_BOWImgDescriptorExtractor(self.ptr) };
    }
}
impl super::features2d::BOWImgDescriptorExtractor {
    #[doc(hidden)] pub fn as_raw_BOWImgDescriptorExtractor(&self) -> *mut c_void { self.ptr }
}
impl BOWImgDescriptorExtractor {

  /// @overload
  pub fn new(dmatcher: &types::PtrOfDescriptorMatcher) -> Result<super::features2d::BOWImgDescriptorExtractor> {
  // identifier: cv_BOWImgDescriptorExtractor_BOWImgDescriptorExtractor_PtrOfDescriptorMatcher_dmatcher
    unsafe {
      let rv = sys::cv_features2d_cv_BOWImgDescriptorExtractor_BOWImgDescriptorExtractor_PtrOfDescriptorMatcher_dmatcher(dmatcher.as_raw_PtrOfDescriptorMatcher());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(super::features2d::BOWImgDescriptorExtractor { ptr: rv.result })
      }
    }
  }
  ...
  // identifier: cv_BOWImgDescriptorExtractor_compute_Mat_keypointDescriptors_Mat_imgDescriptor_VectorOfVectorOfint_pointIdxsOfClusters
    unsafe {
      let rv = sys::cv_features2d_cv_BOWImgDescriptorExtractor_compute_Mat_keypointDescriptors_Mat_imgDescriptor_VectorOfVectorOfint_pointIdxsOfClusters(self.as_raw_BOWImgDescriptorExtractor(), keypoint_descriptors.as_raw_Mat(), img_descriptor.as_raw_Mat(), point_idxs_of_clusters.as_raw_VectorOfVectorOfint());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_BOWImgDescriptorExtractor_compute2_Mat_image_VectorOfKeyPoint_keypoints_Mat_imgDescriptor
    unsafe {
      let rv = sys::cv_features2d_cv_BOWImgDescriptorExtractor_compute2_Mat_image_VectorOfKeyPoint_keypoints_Mat_imgDescriptor(self.as_raw_BOWImgDescriptorExtractor(), image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), img_descriptor.as_raw_Mat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl Drop for super::features2d::BOWKMeansTrainer {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_BOWKMeansTrainer(self.ptr) };
    }
}
impl super::features2d::BOWKMeansTrainer {
    #[doc(hidden)] pub fn as_raw_BOWKMeansTrainer(&self) -> *mut c_void { self.ptr }
}

impl super::features2d::BOWTrainer for BOWKMeansTrainer {
...
impl BOWKMeansTrainer {
  ...
  pub fn new_with_criteria(cluster_count: i32, termcrit: &core::TermCriteria, attempts: i32, flags: i32) -> Result<super::features2d::BOWKMeansTrainer> {
  // identifier: cv_BOWKMeansTrainer_BOWKMeansTrainer_int_clusterCount_TermCriteria_termcrit_int_attempts_int_flags
    unsafe {
      let rv = sys::cv_features2d_cv_BOWKMeansTrainer_BOWKMeansTrainer_int_clusterCount_TermCriteria_termcrit_int_attempts_int_flags(cluster_count, termcrit.as_raw_TermCriteria(), attempts, flags);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(super::features2d::BOWKMeansTrainer { ptr: rv.result })
      }
    }
  }
...
pub trait BOWTrainer {
  ...
  // identifier: cv_BOWTrainer_descriptorsCount
    unsafe {
      let rv = sys::cv_features2d_cv_BOWTrainer_descriptorsCount(self.as_raw_BOWTrainer());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_BOWTrainer_cluster
    unsafe {
      let rv = sys::cv_features2d_cv_BOWTrainer_cluster(self.as_raw_BOWTrainer());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn cluster_v0(&self, descriptors: &core::Mat) -> Result<core::Mat> {
  // identifier: cv_BOWTrainer_cluster_Mat_descriptors
    unsafe {
      let rv = sys::cv_features2d_cv_BOWTrainer_cluster_Mat_descriptors(self.as_raw_BOWTrainer(), descriptors.as_raw_Mat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl Drop for super::features2d::BRISK {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_BRISK(self.ptr) };
    }
}
impl super::features2d::BRISK {
...
impl super::features2d::Feature2D for BRISK {
...
impl BRISK {
  ...
  // identifier: cv_BRISK_create_int_thresh_int_octaves_float_patternScale
    unsafe {
      let rv = sys::cv_features2d_cv_BRISK_create_int_thresh_int_octaves_float_patternScale(thresh, octaves, pattern_scale);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfBRISK { ptr: rv.result })
      }
    }
  }
  ...
  pub fn create_v0(radius_list: &types::VectorOffloat, number_list: &types::VectorOfint, d_max: f32, d_min: f32, index_change: &types::VectorOfint) -> Result<types::PtrOfBRISK> {
  // identifier: cv_BRISK_create_VectorOffloat_radiusList_VectorOfint_numberList_float_dMax_float_dMin_VectorOfint_indexChange
    unsafe {
      let rv = sys::cv_features2d_cv_BRISK_create_VectorOffloat_radiusList_VectorOfint_numberList_float_dMax_float_dMin_VectorOfint_indexChange(radius_list.as_raw_VectorOffloat(), number_list.as_raw_VectorOfint(), d_max, d_min, index_change.as_raw_VectorOfint());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  /// * d_min: 8.2f
  /// * index_change: std::vector<int>()
  pub fn create_v1(thresh: i32, octaves: i32, radius_list: &types::VectorOffloat, number_list: &types::VectorOfint, d_max: f32, d_min: f32, index_change: &types::VectorOfint) -> Result<types::PtrOfBRISK> {
  // identifier: cv_BRISK_create_int_thresh_int_octaves_VectorOffloat_radiusList_VectorOfint_numberList_float_dMax_float_dMin_VectorOfint_indexChange
    unsafe {
      let rv = sys::cv_features2d_cv_BRISK_create_int_thresh_int_octaves_VectorOffloat_radiusList_VectorOfint_numberList_float_dMax_float_dMin_VectorOfint_indexChange(thresh, octaves, radius_list.as_raw_VectorOffloat(), number_list.as_raw_VectorOfint(), d_max, d_min, index_change.as_raw_VectorOfint());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_BRISK_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_BRISK_getDefaultName(self.as_raw_BRISK());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
pub trait DescriptorMatcher : core::Algorithm {
  ...
  // identifier: cv_DescriptorMatcher_isMaskSupported
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_isMaskSupported(self.as_raw_DescriptorMatcher());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_match_Mat_queryDescriptors_Mat_trainDescriptors_VectorOfDMatch_matches_Mat_mask
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_match_Mat_queryDescriptors_Mat_trainDescriptors_VectorOfDMatch_matches_Mat_mask(self.as_raw_DescriptorMatcher(), query_descriptors.as_raw_Mat(), train_descriptors.as_raw_Mat(), matches.as_raw_VectorOfDMatch(), mask.as_raw_Mat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_knnMatch_Mat_queryDescriptors_Mat_trainDescriptors_VectorOfVectorOfDMatch_matches_int_k_Mat_mask_bool_compactResult
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_knnMatch_Mat_queryDescriptors_Mat_trainDescriptors_VectorOfVectorOfDMatch_matches_int_k_Mat_mask_bool_compactResult(self.as_raw_DescriptorMatcher(), query_descriptors.as_raw_Mat(), train_descriptors.as_raw_Mat(), matches.as_raw_VectorOfVectorOfDMatch(), k, mask.as_raw_Mat(), compact_result);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_radiusMatch_Mat_queryDescriptors_Mat_trainDescriptors_VectorOfVectorOfDMatch_matches_float_maxDistance_Mat_mask_bool_compactResult
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_radiusMatch_Mat_queryDescriptors_Mat_trainDescriptors_VectorOfVectorOfDMatch_matches_float_maxDistance_Mat_mask_bool_compactResult(self.as_raw_DescriptorMatcher(), query_descriptors.as_raw_Mat(), train_descriptors.as_raw_Mat(), matches.as_raw_VectorOfVectorOfDMatch(), max_distance, mask.as_raw_Mat(), compact_result);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_match_Mat_queryDescriptors_VectorOfDMatch_matches_VectorOfMat_masks
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_match_Mat_queryDescriptors_VectorOfDMatch_matches_VectorOfMat_masks(self.as_raw_DescriptorMatcher(), query_descriptors.as_raw_Mat(), matches.as_raw_VectorOfDMatch(), masks.as_raw_VectorOfMat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_knnMatch_Mat_queryDescriptors_VectorOfVectorOfDMatch_matches_int_k_VectorOfMat_masks_bool_compactResult
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_knnMatch_Mat_queryDescriptors_VectorOfVectorOfDMatch_matches_int_k_VectorOfMat_masks_bool_compactResult(self.as_raw_DescriptorMatcher(), query_descriptors.as_raw_Mat(), matches.as_raw_VectorOfVectorOfDMatch(), k, masks.as_raw_VectorOfMat(), compact_result);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_write_String_fileName
    unsafe {
      let file_name = CString::new(file_name).unwrap();
      let rv = sys::cv_features2d_cv_DescriptorMatcher_write_String_fileName(self.as_raw_DescriptorMatcher(), file_name.as_ptr() as _);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_read_String_fileName
    unsafe {
      let file_name = CString::new(file_name).unwrap();
      let rv = sys::cv_features2d_cv_DescriptorMatcher_read_String_fileName(self.as_raw_DescriptorMatcher(), file_name.as_ptr() as _);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_DescriptorMatcher_clone_bool_emptyTrainData
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_clone_bool_emptyTrainData(self.as_raw_DescriptorMatcher(), empty_train_data);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> DescriptorMatcher + 'a {
  ...
  // identifier: cv_DescriptorMatcher_create_String_descriptorMatcherType
    unsafe {
      ...
      let rv = sys::cv_features2d_cv_DescriptorMatcher_create_String_descriptorMatcherType(descriptor_matcher_type.as_ptr() as _);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  pub fn create_v0(matcher_type: i32) -> Result<types::PtrOfDescriptorMatcher> {
  // identifier: cv_DescriptorMatcher_create_int_matcherType
    unsafe {
      let rv = sys::cv_features2d_cv_DescriptorMatcher_create_int_matcherType(matcher_type);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl Drop for super::features2d::DrawMatchesFlags {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_DrawMatchesFlags(self.ptr) };
    }
}
impl super::features2d::DrawMatchesFlags {
...
pub trait FastFeatureDetector : super::features2d::Feature2D {
  #[doc(hidden)] fn as_raw_FastFeatureDetector(&self) -> *mut c_void;
  fn set_threshold(&mut self, threshold: i32) -> Result<()> {
  // identifier: cv_FastFeatureDetector_setThreshold_int_threshold
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_setThreshold_int_threshold(self.as_raw_FastFeatureDetector(), threshold);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_threshold(&self) -> Result<i32> {
  // identifier: cv_FastFeatureDetector_getThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_getThreshold(self.as_raw_FastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_FastFeatureDetector_setNonmaxSuppression_bool_f
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_setNonmaxSuppression_bool_f(self.as_raw_FastFeatureDetector(), f);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_nonmax_suppression(&self) -> Result<bool> {
  // identifier: cv_FastFeatureDetector_getNonmaxSuppression
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_getNonmaxSuppression(self.as_raw_FastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_FastFeatureDetector_setType_int_type
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_setType_int_type(self.as_raw_FastFeatureDetector(), _type);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_type(&self) -> Result<i32> {
  // identifier: cv_FastFeatureDetector_getType
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_getType(self.as_raw_FastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_default_name(&self) -> Result<String> {
  // identifier: cv_FastFeatureDetector_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_getDefaultName(self.as_raw_FastFeatureDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> FastFeatureDetector + 'a {
  ...
  // identifier: cv_FastFeatureDetector_create_int_threshold_bool_nonmaxSuppression_int_type
    unsafe {
      let rv = sys::cv_features2d_cv_FastFeatureDetector_create_int_threshold_bool_nonmaxSuppression_int_type(threshold, nonmax_suppression, _type);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfFastFeatureDetector { ptr: rv.result })
      }
    }
  }
...
pub trait Feature2D : core::Algorithm {
  ...
  // identifier: cv_Feature2D_detect_Mat_image_VectorOfKeyPoint_keypoints_Mat_mask
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_detect_Mat_image_VectorOfKeyPoint_keypoints_Mat_mask(self.as_raw_Feature2D(), image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), mask.as_raw_Mat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_Feature2D_detect_VectorOfMat_images_VectorOfVectorOfKeyPoint_keypoints_VectorOfMat_masks
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_detect_VectorOfMat_images_VectorOfVectorOfKeyPoint_keypoints_VectorOfMat_masks(self.as_raw_Feature2D(), images.as_raw_VectorOfMat(), keypoints.as_raw_VectorOfVectorOfKeyPoint(), masks.as_raw_VectorOfMat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_Feature2D_compute_Mat_image_VectorOfKeyPoint_keypoints_Mat_descriptors
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_compute_Mat_image_VectorOfKeyPoint_keypoints_Mat_descriptors(self.as_raw_Feature2D(), image.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), descriptors.as_raw_Mat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  /// descriptors computed for a keypoints[i]. Row j is the keypoints (or keypoints[i]) is the
  /// descriptor for keypoint j-th keypoint.
  fn compute_v0(&mut self, images: &types::VectorOfMat, keypoints: &types::VectorOfVectorOfKeyPoint, descriptors: &mut types::VectorOfMat) -> Result<()> {
  // identifier: cv_Feature2D_compute_VectorOfMat_images_VectorOfVectorOfKeyPoint_keypoints_VectorOfMat_descriptors
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_compute_VectorOfMat_images_VectorOfVectorOfKeyPoint_keypoints_VectorOfMat_descriptors(self.as_raw_Feature2D(), images.as_raw_VectorOfMat(), keypoints.as_raw_VectorOfVectorOfKeyPoint(), descriptors.as_raw_VectorOfMat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_Feature2D_detectAndCompute_Mat_image_Mat_mask_VectorOfKeyPoint_keypoints_Mat_descriptors_bool_useProvidedKeypoints
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_detectAndCompute_Mat_image_Mat_mask_VectorOfKeyPoint_keypoints_Mat_descriptors_bool_useProvidedKeypoints(self.as_raw_Feature2D(), image.as_raw_Mat(), mask.as_raw_Mat(), keypoints.as_raw_VectorOfKeyPoint(), descriptors.as_raw_Mat(), use_provided_keypoints);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_Feature2D_descriptorSize
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_descriptorSize(self.as_raw_Feature2D());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_Feature2D_descriptorType
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_descriptorType(self.as_raw_Feature2D());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_Feature2D_defaultNorm
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_defaultNorm(self.as_raw_Feature2D());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn write(&self, file_name:&str) -> Result<()> {
  // identifier: cv_Feature2D_write_String_fileName
    unsafe {
      let file_name = CString::new(file_name).unwrap();
      let rv = sys::cv_features2d_cv_Feature2D_write_String_fileName(self.as_raw_Feature2D(), file_name.as_ptr() as _);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_Feature2D_read_String_fileName
    unsafe {
      let file_name = CString::new(file_name).unwrap();
      let rv = sys::cv_features2d_cv_Feature2D_read_String_fileName(self.as_raw_Feature2D(), file_name.as_ptr() as _);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn empty(&self) -> Result<bool> {
  // identifier: cv_Feature2D_empty
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_empty(self.as_raw_Feature2D());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_default_name(&self) -> Result<String> {
  // identifier: cv_Feature2D_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_Feature2D_getDefaultName(self.as_raw_Feature2D());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl Drop for super::features2d::FlannBasedMatcher {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_FlannBasedMatcher(self.ptr) };
    }
}
impl super::features2d::FlannBasedMatcher {
    #[doc(hidden)] pub fn as_raw_FlannBasedMatcher(&self) -> *mut c_void { self.ptr }
}

impl super::features2d::DescriptorMatcher for FlannBasedMatcher {
    #[doc(hidden)] fn as_raw_DescriptorMatcher(&self) -> *mut c_void { self.ptr }
}
...
impl FlannBasedMatcher {
  ...
  // identifier: cv_FlannBasedMatcher_create
    unsafe {
      let rv = sys::cv_features2d_cv_FlannBasedMatcher_create();
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfFlannBasedMatcher { ptr: rv.result })
      }
    }
  }
  ...
  /// * empty_train_data: false
  pub fn clone(&self, empty_train_data: bool) -> Result<types::PtrOfDescriptorMatcher> {
  // identifier: cv_FlannBasedMatcher_clone_bool_emptyTrainData
    unsafe {
      let rv = sys::cv_features2d_cv_FlannBasedMatcher_clone_bool_emptyTrainData(self.as_raw_FlannBasedMatcher(), empty_train_data);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
pub trait GFTTDetector : super::features2d::Feature2D {
  ...
  // identifier: cv_GFTTDetector_setMaxFeatures_int_maxFeatures
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_setMaxFeatures_int_maxFeatures(self.as_raw_GFTTDetector(), max_features);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_getMaxFeatures
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_getMaxFeatures(self.as_raw_GFTTDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_setQualityLevel_double_qlevel
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_setQualityLevel_double_qlevel(self.as_raw_GFTTDetector(), qlevel);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_getQualityLevel
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_getQualityLevel(self.as_raw_GFTTDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_setMinDistance_double_minDistance
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_setMinDistance_double_minDistance(self.as_raw_GFTTDetector(), min_distance);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_getMinDistance
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_getMinDistance(self.as_raw_GFTTDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_setBlockSize_int_blockSize
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_setBlockSize_int_blockSize(self.as_raw_GFTTDetector(), block_size);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_getBlockSize
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_getBlockSize(self.as_raw_GFTTDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_setHarrisDetector_bool_val
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_setHarrisDetector_bool_val(self.as_raw_GFTTDetector(), val);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_getHarrisDetector
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_getHarrisDetector(self.as_raw_GFTTDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_setK_double_k
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_setK_double_k(self.as_raw_GFTTDetector(), k);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_GFTTDetector_getK
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_getK(self.as_raw_GFTTDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_default_name(&self) -> Result<String> {
  // identifier: cv_GFTTDetector_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_getDefaultName(self.as_raw_GFTTDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> GFTTDetector + 'a {
  ...
  // identifier: cv_GFTTDetector_create_int_maxCorners_double_qualityLevel_double_minDistance_int_blockSize_bool_useHarrisDetector_double_k
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_create_int_maxCorners_double_qualityLevel_double_minDistance_int_blockSize_bool_useHarrisDetector_double_k(max_corners, quality_level, min_distance, block_size, use_harris_detector, k);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfGFTTDetector { ptr: rv.result })
      }
    }
  }
  ...
  /// * use_harris_detector: false
  /// * k: 0.04
  pub fn create_v0(max_corners: i32, quality_level: f64, min_distance: f64, block_size: i32, gradiant_size: i32, use_harris_detector: bool, k: f64) -> Result<types::PtrOfGFTTDetector> {
  // identifier: cv_GFTTDetector_create_int_maxCorners_double_qualityLevel_double_minDistance_int_blockSize_int_gradiantSize_bool_useHarrisDetector_double_k
    unsafe {
      let rv = sys::cv_features2d_cv_GFTTDetector_create_int_maxCorners_double_qualityLevel_double_minDistance_int_blockSize_int_gradiantSize_bool_useHarrisDetector_double_k(max_corners, quality_level, min_distance, block_size, gradiant_size, use_harris_detector, k);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
pub trait KAZE : super::features2d::Feature2D {
  ...
  // identifier: cv_KAZE_setExtended_bool_extended
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_setExtended_bool_extended(self.as_raw_KAZE(), extended);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KAZE_getExtended
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_getExtended(self.as_raw_KAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KAZE_setUpright_bool_upright
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_setUpright_bool_upright(self.as_raw_KAZE(), upright);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KAZE_getUpright
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_getUpright(self.as_raw_KAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KAZE_setThreshold_double_threshold
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_setThreshold_double_threshold(self.as_raw_KAZE(), threshold);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_threshold(&self) -> Result<f64> {
  // identifier: cv_KAZE_getThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_getThreshold(self.as_raw_KAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KAZE_setNOctaves_int_octaves
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_setNOctaves_int_octaves(self.as_raw_KAZE(), octaves);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_n_octaves(&self) -> Result<i32> {
  // identifier: cv_KAZE_getNOctaves
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_getNOctaves(self.as_raw_KAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KAZE_setNOctaveLayers_int_octaveLayers
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_setNOctaveLayers_int_octaveLayers(self.as_raw_KAZE(), octave_layers);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_n_octave_layers(&self) -> Result<i32> {
  // identifier: cv_KAZE_getNOctaveLayers
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_getNOctaveLayers(self.as_raw_KAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KAZE_setDiffusivity_int_diff
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_setDiffusivity_int_diff(self.as_raw_KAZE(), diff);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_diffusivity(&self) -> Result<i32> {
  // identifier: cv_KAZE_getDiffusivity
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_getDiffusivity(self.as_raw_KAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_default_name(&self) -> Result<String> {
  // identifier: cv_KAZE_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_getDefaultName(self.as_raw_KAZE());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> KAZE + 'a {
  ...
  // identifier: cv_KAZE_create_bool_extended_bool_upright_float_threshold_int_nOctaves_int_nOctaveLayers_int_diffusivity
    unsafe {
      let rv = sys::cv_features2d_cv_KAZE_create_bool_extended_bool_upright_float_threshold_int_nOctaves_int_nOctaveLayers_int_diffusivity(extended, upright, threshold, n_octaves, n_octave_layers, diffusivity);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfKAZE { ptr: rv.result })
      }
    }
  }
...
impl Drop for super::features2d::KeyPointsFilter {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_KeyPointsFilter(self.ptr) };
    }
}
impl super::features2d::KeyPointsFilter {
    #[doc(hidden)] pub fn as_raw_KeyPointsFilter(&self) -> *mut c_void { self.ptr }
}
impl KeyPointsFilter {

  pub fn new() -> Result<super::features2d::KeyPointsFilter> {
  // identifier: cv_KeyPointsFilter_KeyPointsFilter
    unsafe {
      ...
      if !rv.error_msg.is_null() {
        ...
        Ok(super::features2d::KeyPointsFilter { ptr: rv.result })
      }
    }
  }
  ...
  // identifier: cv_KeyPointsFilter_runByImageBorder_VectorOfKeyPoint_keypoints_Size_imageSize_int_borderSize
    unsafe {
      let rv = sys::cv_features2d_cv_KeyPointsFilter_runByImageBorder_VectorOfKeyPoint_keypoints_Size_imageSize_int_borderSize(keypoints.as_raw_VectorOfKeyPoint(), image_size, border_size);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KeyPointsFilter_runByKeypointSize_VectorOfKeyPoint_keypoints_float_minSize_float_maxSize
    unsafe {
      let rv = sys::cv_features2d_cv_KeyPointsFilter_runByKeypointSize_VectorOfKeyPoint_keypoints_float_minSize_float_maxSize(keypoints.as_raw_VectorOfKeyPoint(), min_size, max_size);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KeyPointsFilter_runByPixelsMask_VectorOfKeyPoint_keypoints_Mat_mask
    unsafe {
      let rv = sys::cv_features2d_cv_KeyPointsFilter_runByPixelsMask_VectorOfKeyPoint_keypoints_Mat_mask(keypoints.as_raw_VectorOfKeyPoint(), mask.as_raw_Mat());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KeyPointsFilter_removeDuplicated_VectorOfKeyPoint_keypoints
    unsafe {
      let rv = sys::cv_features2d_cv_KeyPointsFilter_removeDuplicated_VectorOfKeyPoint_keypoints(keypoints.as_raw_VectorOfKeyPoint());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KeyPointsFilter_removeDuplicatedSorted_VectorOfKeyPoint_keypoints
    unsafe {
      let rv = sys::cv_features2d_cv_KeyPointsFilter_removeDuplicatedSorted_VectorOfKeyPoint_keypoints(keypoints.as_raw_VectorOfKeyPoint());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_KeyPointsFilter_retainBest_VectorOfKeyPoint_keypoints_int_npoints
    unsafe {
      let rv = sys::cv_features2d_cv_KeyPointsFilter_retainBest_VectorOfKeyPoint_keypoints_int_npoints(keypoints.as_raw_VectorOfKeyPoint(), npoints);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
pub trait MSER : super::features2d::Feature2D {
  ...
  // identifier: cv_MSER_detectRegions_Mat_image_VectorOfVectorOfPoint_msers_VectorOfRect_bboxes
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_detectRegions_Mat_image_VectorOfVectorOfPoint_msers_VectorOfRect_bboxes(self.as_raw_MSER(), image.as_raw_Mat(), msers.as_raw_VectorOfVectorOfPoint(), bboxes.as_raw_VectorOfRect());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_setDelta_int_delta
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_setDelta_int_delta(self.as_raw_MSER(), delta);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_getDelta
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_getDelta(self.as_raw_MSER());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_setMinArea_int_minArea
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_setMinArea_int_minArea(self.as_raw_MSER(), min_area);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_getMinArea
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_getMinArea(self.as_raw_MSER());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_setMaxArea_int_maxArea
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_setMaxArea_int_maxArea(self.as_raw_MSER(), max_area);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_getMaxArea
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_getMaxArea(self.as_raw_MSER());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_setPass2Only_bool_f
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_setPass2Only_bool_f(self.as_raw_MSER(), f);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_MSER_getPass2Only
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_getPass2Only(self.as_raw_MSER());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_default_name(&self) -> Result<String> {
  // identifier: cv_MSER_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_getDefaultName(self.as_raw_MSER());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> MSER + 'a {
  ...
  // identifier: cv_MSER_create_int__delta_int__min_area_int__max_area_double__max_variation_double__min_diversity_int__max_evolution_double__area_threshold_double__min_margin_int__edge_blur_size
    unsafe {
      let rv = sys::cv_features2d_cv_MSER_create_int__delta_int__min_area_int__max_area_double__max_variation_double__min_diversity_int__max_evolution_double__area_threshold_double__min_margin_int__edge_blur_size(_delta, _min_area, _max_area, _max_variation, _min_diversity, _max_evolution, _area_threshold, _min_margin, _edge_blur_size);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfMSER { ptr: rv.result })
      }
    }
  }
...
pub trait ORB : super::features2d::Feature2D {
  #[doc(hidden)] fn as_raw_ORB(&self) -> *mut c_void;
  fn set_max_features(&mut self, max_features: i32) -> Result<()> {
  // identifier: cv_ORB_setMaxFeatures_int_maxFeatures
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setMaxFeatures_int_maxFeatures(self.as_raw_ORB(), max_features);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_max_features(&self) -> Result<i32> {
  // identifier: cv_ORB_getMaxFeatures
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getMaxFeatures(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setScaleFactor_double_scaleFactor
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setScaleFactor_double_scaleFactor(self.as_raw_ORB(), scale_factor);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getScaleFactor
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getScaleFactor(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setNLevels_int_nlevels
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setNLevels_int_nlevels(self.as_raw_ORB(), nlevels);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getNLevels
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getNLevels(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setEdgeThreshold_int_edgeThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setEdgeThreshold_int_edgeThreshold(self.as_raw_ORB(), edge_threshold);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getEdgeThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getEdgeThreshold(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setFirstLevel_int_firstLevel
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setFirstLevel_int_firstLevel(self.as_raw_ORB(), first_level);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getFirstLevel
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getFirstLevel(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setWTA_K_int_wta_k
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setWTA_K_int_wta_k(self.as_raw_ORB(), wta_k);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getWTA_K
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getWTA_K(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setScoreType_int_scoreType
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setScoreType_int_scoreType(self.as_raw_ORB(), score_type);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getScoreType
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getScoreType(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setPatchSize_int_patchSize
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setPatchSize_int_patchSize(self.as_raw_ORB(), patch_size);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getPatchSize
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getPatchSize(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_setFastThreshold_int_fastThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_setFastThreshold_int_fastThreshold(self.as_raw_ORB(), fast_threshold);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  // identifier: cv_ORB_getFastThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getFastThreshold(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
  ...
  fn get_default_name(&self) -> Result<String> {
  // identifier: cv_ORB_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_getDefaultName(self.as_raw_ORB());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl<'a> ORB + 'a {
  ...
  // identifier: cv_ORB_create_int_nfeatures_float_scaleFactor_int_nlevels_int_edgeThreshold_int_firstLevel_int_WTA_K_int_scoreType_int_patchSize_int_fastThreshold
    unsafe {
      let rv = sys::cv_features2d_cv_ORB_create_int_nfeatures_float_scaleFactor_int_nlevels_int_edgeThreshold_int_firstLevel_int_WTA_K_int_scoreType_int_patchSize_int_fastThreshold(nfeatures, scale_factor, nlevels, edge_threshold, first_level, wta_k, score_type, patch_size, fast_threshold);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfORB { ptr: rv.result })
      }
    }
  }
...
impl Drop for super::features2d::SimpleBlobDetector {
    fn drop(&mut self) {
        unsafe { sys::cv_delete_SimpleBlobDetector(self.ptr) };
    }
}
impl super::features2d::SimpleBlobDetector {
...
impl super::features2d::Feature2D for SimpleBlobDetector {
    #[doc(hidden)] fn as_raw_Feature2D(&self) -> *mut c_void { self.ptr }
}
impl SimpleBlobDetector {
  ...
  pub fn create(parameters: super::features2d::SimpleBlobDetector_Params) -> Result<types::PtrOfSimpleBlobDetector> {
  // identifier: cv_SimpleBlobDetector_create_SimpleBlobDetector_Params_parameters
    unsafe {
      let rv = sys::cv_features2d_cv_SimpleBlobDetector_create_SimpleBlobDetector_Params_parameters(parameters);
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
      } else {
        Ok(types::PtrOfSimpleBlobDetector { ptr: rv.result })
      }
    }
  }

  pub fn get_default_name(&self) -> Result<String> {
  // identifier: cv_SimpleBlobDetector_getDefaultName
    unsafe {
      let rv = sys::cv_features2d_cv_SimpleBlobDetector_getDefaultName(self.as_raw_SimpleBlobDetector());
      if !rv.error_msg.is_null() {
        let v = CStr::from_ptr(rv.error_msg as _).to_bytes().to_vec();
        ::libc::free(rv.error_msg as _);
        Err(Error { code: rv.error_code, message: String::from_utf8(v).unwrap() })
...
impl SimpleBlobDetector_Params {
  ...
  pub fn new() -> Result<super::features2d::SimpleBlobDetector_Params> {
