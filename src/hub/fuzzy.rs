...
///
/// Note:
/// F-transform technique of first degreee is described in paper [Vlas](https://docs.opencv.org/3.4.6/d0/de3/citelist.html#CITEREF_Vlas):FT.
///
/// ## C++ default parameters
/// * mask: noArray()
...
///
/// Note:
/// The algorithms are described in paper [Perf](https://docs.opencv.org/3.4.6/d0/de3/citelist.html#CITEREF_Perf):rec.
