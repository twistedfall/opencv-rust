...
fn vec() -> Result<()> {
    ...
    ps.push(p1);
    assert_eq!(ps.len(), 1);
    imgproc::fill_poly(&mut m, &ps, Scalar::new(127., 127., 127., 0.), core::LINE_8, 0, Point::default())?;
    assert_eq!(*m.at_2d::<core::Vec3b>(0, 0)?, core::Vec3b::from([127, 127, 127]));
    assert_eq!(*m.at_2d::<core::Vec3b>(0, 9)?, core::Vec3b::default());
    assert_eq!(*m.at_2d::<core::Vec3b>(9, 9)?, core::Vec3b::from([127, 127, 127]));
    Ok(())
}
