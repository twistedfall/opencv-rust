...
extern "C" {
	...
	Result<cv::Scalar> cv_quality_QualityBRISQUE_compute_const__InputArrayX(cv::quality::QualityBRISQUE* instance, const cv::_InputArray* img) {
		try {
	...
	Result<cv::Ptr<cv::quality::QualityBRISQUE>*> cv_quality_QualityBRISQUE_create_const_StringX_const_StringX(const char* model_file_path, const char* range_file_path) {
		try {
	...
	Result<cv::Ptr<cv::quality::QualityBRISQUE>*> cv_quality_QualityBRISQUE_create_const_Ptr_SVM_X_const_MatX(const cv::Ptr<cv::ml::SVM>* model, const cv::Mat* range) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualityBRISQUE_compute_const__InputArrayX_const_StringX_const_StringX(const cv::_InputArray* img, const char* model_file_path, const char* range_file_path) {
		try {
	...
	Result_void cv_quality_QualityBRISQUE_computeFeatures_const__InputArrayX_const__OutputArrayX(const cv::_InputArray* img, const cv::_OutputArray* features) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualityBase_compute_const__InputArrayX(cv::quality::QualityBase* instance, const cv::_InputArray* img) {
		try {
			cv::Scalar ret = instance->compute(*img);
			return Ok(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::Scalar>))
	...
	Result_void cv_quality_QualityBase_getQualityMap_const_const__OutputArrayX(const cv::quality::QualityBase* instance, const cv::_OutputArray* dst) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualityGMSD_compute_const__InputArrayX(cv::quality::QualityGMSD* instance, const cv::_InputArray* cmp) {
		try {
	...
	Result<cv::Ptr<cv::quality::QualityGMSD>*> cv_quality_QualityGMSD_create_const__InputArrayX(const cv::_InputArray* ref) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualityGMSD_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX(const cv::_InputArray* ref, const cv::_InputArray* cmp, const cv::_OutputArray* qualityMap) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualityMSE_compute_const__InputArrayX(cv::quality::QualityMSE* instance, const cv::_InputArray* cmpImgs) {
		try {
	...
	Result<cv::Ptr<cv::quality::QualityMSE>*> cv_quality_QualityMSE_create_const__InputArrayX(const cv::_InputArray* ref) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualityMSE_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX(const cv::_InputArray* ref, const cv::_InputArray* cmp, const cv::_OutputArray* qualityMap) {
		try {
	...
	Result<cv::Ptr<cv::quality::QualityPSNR>*> cv_quality_QualityPSNR_create_const__InputArrayX_double(const cv::_InputArray* ref, double maxPixelValue) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualityPSNR_compute_const__InputArrayX(cv::quality::QualityPSNR* instance, const cv::_InputArray* cmp) {
		try {
			cv::Scalar ret = instance->compute(*cmp);
			return Ok(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::Scalar>))
	...
	Result<cv::Scalar> cv_quality_QualityPSNR_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX_double(const cv::_InputArray* ref, const cv::_InputArray* cmp, const cv::_OutputArray* qualityMap, double maxPixelValue) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualitySSIM_compute_const__InputArrayX(cv::quality::QualitySSIM* instance, const cv::_InputArray* cmp) {
		try {
			cv::Scalar ret = instance->compute(*cmp);
			return Ok(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::Scalar>))
	...
	Result<cv::Ptr<cv::quality::QualitySSIM>*> cv_quality_QualitySSIM_create_const__InputArrayX(const cv::_InputArray* ref) {
		try {
	...
	Result<cv::Scalar> cv_quality_QualitySSIM_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX(const cv::_InputArray* ref, const cv::_InputArray* cmp, const cv::_OutputArray* qualityMap) {
		try {
