...
extern "C" {
	...
	Result_void cv_kinfu_Params_setPropDepthFactor_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->depthFactor = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropBilateral_sigma_depth_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->bilateral_sigma_depth = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropBilateral_sigma_spatial_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->bilateral_sigma_spatial = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropBilateral_kernel_size_int(cv::kinfu::Params* instance, int val) {
		try {
			instance->bilateral_kernel_size = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropPyramidLevels_int(cv::kinfu::Params* instance, int val) {
		try {
			instance->pyramidLevels = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropVoxelSize_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->voxelSize = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropTsdf_min_camera_movement_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->tsdf_min_camera_movement = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropTsdf_trunc_dist_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->tsdf_trunc_dist = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropTsdf_max_weight_int(cv::kinfu::Params* instance, int val) {
		try {
			instance->tsdf_max_weight = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropRaycast_step_factor_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->raycast_step_factor = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropIcpDistThresh_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->icpDistThresh = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropIcpAngleThresh_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->icpAngleThresh = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result<std::vector<int>*> cv_kinfu_Params_getPropIcpIterations(cv::kinfu::Params* instance) {
		try {
			std::vector<int> ret = instance->icpIterations;
			return Ok(new std::vector<int>(ret));
		} OCVRS_CATCH(OCVRS_TYPE(Result<std::vector<int>*>))
	...
	Result_void cv_kinfu_Params_setPropIcpIterations_vector_int_(cv::kinfu::Params* instance, std::vector<int>* val) {
		try {
			instance->icpIterations = *val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_kinfu_Params_setPropTruncateThreshold_float(cv::kinfu::Params* instance, float val) {
		try {
			instance->truncateThreshold = val;
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result<const float> cv_kinfu_Volume_getPropVoxelSize_const(const cv::kinfu::Volume* instance) {
		try {
			const float ret = instance->voxelSize;
			return Ok<const float>(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<const float>))
	}
	
	Result<const float> cv_kinfu_Volume_getPropVoxelSizeInv_const(const cv::kinfu::Volume* instance) {
		try {
	...
	Result<const cv::Affine3f> cv_kinfu_Volume_getPropPose_const(const cv::kinfu::Volume* instance) {
		try {
	...
	Result<const float> cv_kinfu_Volume_getPropRaycastStepFactor_const(const cv::kinfu::Volume* instance) {
		try {
