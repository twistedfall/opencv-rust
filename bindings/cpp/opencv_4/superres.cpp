...
extern "C" {
	...
	Result<double> cv_superres_SuperResolution_getLambda_const(void* instance) {
		try {
	...
	Result_void cv_superres_SuperResolution_setLambda_double(void* instance, double val) {
		try {
