...
extern "C" {
	...
	Result_void cv_detail_computeImageFeatures_const_Ptr_Feature2D_X_const__InputArrayX_ImageFeaturesX_const__InputArrayX(void* featuresFinder, void* image, void* features, void* mask) {
		try {
			cv::detail::computeImageFeatures(*reinterpret_cast<const cv::Ptr<cv::Feature2D>*>(featuresFinder), *reinterpret_cast<const cv::_InputArray*>(image), *reinterpret_cast<cv::detail::ImageFeatures*>(features), *reinterpret_cast<const cv::_InputArray*>(mask));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_computeImageFeatures_const_Ptr_Feature2D_X_const__InputArrayX_vector_ImageFeatures_X_const__InputArrayX(void* featuresFinder, void* images, void* features, void* masks) {
		try {
			cv::detail::computeImageFeatures(*reinterpret_cast<const cv::Ptr<cv::Feature2D>*>(featuresFinder), *reinterpret_cast<const cv::_InputArray*>(images), *reinterpret_cast<std::vector<cv::detail::ImageFeatures>*>(features), *reinterpret_cast<const cv::_InputArray*>(masks));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_PyRotationWarper_PyRotationWarper_String_float(char* type, float scale) {
		try {
	...
	Result<void*> cv_PyRotationWarper_PyRotationWarper() {
		try {
	...
	Result<cv::Point2f> cv_PyRotationWarper_warpPoint_const_Point2fX_const__InputArrayX_const__InputArrayX(void* instance, const cv::Point2f* pt, void* K, void* R) {
		try {
			cv::Point2f ret = reinterpret_cast<cv::PyRotationWarper*>(instance)->warpPoint(*pt, *reinterpret_cast<const cv::_InputArray*>(K), *reinterpret_cast<const cv::_InputArray*>(R));
			return Ok<cv::Point2f>(ret);
		} OCVRS_CATCH(Result<cv::Point2f>)
	}
	
	Result<cv::Rect> cv_PyRotationWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(void* instance, cv::Size src_size, void* K, void* R, void* xmap, void* ymap) {
		try {
			cv::Rect ret = reinterpret_cast<cv::PyRotationWarper*>(instance)->buildMaps(src_size, *reinterpret_cast<const cv::_InputArray*>(K), *reinterpret_cast<const cv::_InputArray*>(R), *reinterpret_cast<const cv::_OutputArray*>(xmap), *reinterpret_cast<const cv::_OutputArray*>(ymap));
			return Ok<cv::Rect>(ret);
		} OCVRS_CATCH(Result<cv::Rect>)
	}
	
	Result<cv::Point> cv_PyRotationWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(void* instance, void* src, void* K, void* R, int interp_mode, int border_mode, void* dst) {
		try {
			cv::Point ret = reinterpret_cast<cv::PyRotationWarper*>(instance)->warp(*reinterpret_cast<const cv::_InputArray*>(src), *reinterpret_cast<const cv::_InputArray*>(K), *reinterpret_cast<const cv::_InputArray*>(R), interp_mode, border_mode, *reinterpret_cast<const cv::_OutputArray*>(dst));
			return Ok<cv::Point>(ret);
		} OCVRS_CATCH(Result<cv::Point>)
	}
	
	Result_void cv_PyRotationWarper_warpBackward_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_Size_const__OutputArrayX(void* instance, void* src, void* K, void* R, int interp_mode, int border_mode, cv::Size dst_size, void* dst) {
		try {
			reinterpret_cast<cv::PyRotationWarper*>(instance)->warpBackward(*reinterpret_cast<const cv::_InputArray*>(src), *reinterpret_cast<const cv::_InputArray*>(K), *reinterpret_cast<const cv::_InputArray*>(R), interp_mode, border_mode, dst_size, *reinterpret_cast<const cv::_OutputArray*>(dst));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<cv::Rect> cv_PyRotationWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX(void* instance, cv::Size src_size, void* K, void* R) {
		try {
			cv::Rect ret = reinterpret_cast<cv::PyRotationWarper*>(instance)->warpRoi(src_size, *reinterpret_cast<const cv::_InputArray*>(K), *reinterpret_cast<const cv::_InputArray*>(R));
			return Ok<cv::Rect>(ret);
		} OCVRS_CATCH(Result<cv::Rect>)
	}
	
	Result<float> cv_PyRotationWarper_getScale_const(void* instance) {
		try {
	...
	Result_void cv_PyRotationWarper_setScale_float(void* instance, float unnamed) {
		try {
			reinterpret_cast<cv::PyRotationWarper*>(instance)->setScale(unnamed);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<double> cv_Stitcher_ORIG_RESOL_const(void* instance) {
		try {
			double ret = reinterpret_cast<cv::Stitcher*>(instance)->ORIG_RESOL;
	...
	Result<void*> cv_Stitcher_create_Mode(cv::Stitcher::Mode mode) {
		try {
	...
	Result<cv::InterpolationFlags> cv_Stitcher_interpolationFlags_const(void* instance) {
		try {
			cv::InterpolationFlags ret = reinterpret_cast<cv::Stitcher*>(instance)->interpolationFlags();
			return Ok<cv::InterpolationFlags>(ret);
		} OCVRS_CATCH(Result<cv::InterpolationFlags>)
	}
	
	Result_void cv_Stitcher_setInterpolationFlags_InterpolationFlags(void* instance, cv::InterpolationFlags interp_flags) {
		try {
			reinterpret_cast<cv::Stitcher*>(instance)->setInterpolationFlags(interp_flags);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_Stitcher_featuresFinder(void* instance) {
		try {
			cv::Ptr<cv::Feature2D> ret = reinterpret_cast<cv::Stitcher*>(instance)->featuresFinder();
			return Ok<void*>(new cv::Ptr<cv::Feature2D>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_Stitcher_setFeaturesFinder_Ptr_Feature2D_(void* instance, void* features_finder) {
		try {
			reinterpret_cast<cv::Stitcher*>(instance)->setFeaturesFinder(*reinterpret_cast<cv::Ptr<cv::Feature2D>*>(features_finder));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_Stitcher_estimator(void* instance) {
		try {
			cv::Ptr<cv::detail::Estimator> ret = reinterpret_cast<cv::Stitcher*>(instance)->estimator();
			return Ok<void*>(new cv::Ptr<cv::detail::Estimator>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	
	Result<void*> cv_Stitcher_estimator_const(void* instance) {
		try {
			cv::Ptr<cv::detail::Estimator> ret = reinterpret_cast<cv::Stitcher*>(instance)->estimator();
			return Ok<void*>(new cv::Ptr<cv::detail::Estimator>(ret));
		} OCVRS_CATCH(Result<void*>)
	...
	Result_void cv_Stitcher_setEstimator_Ptr_Estimator_(void* instance, void* estimator) {
		try {
			reinterpret_cast<cv::Stitcher*>(instance)->setEstimator(*reinterpret_cast<cv::Ptr<cv::detail::Estimator>*>(estimator));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<cv::Stitcher::Status> cv_Stitcher_estimateTransform_const__InputArrayX_const__InputArrayX(void* instance, void* images, void* masks) {
		try {
			cv::Stitcher::Status ret = reinterpret_cast<cv::Stitcher*>(instance)->estimateTransform(*reinterpret_cast<const cv::_InputArray*>(images), *reinterpret_cast<const cv::_InputArray*>(masks));
	...
	Result<cv::Stitcher::Status> cv_Stitcher_stitch_const__InputArrayX_const__InputArrayX_const__OutputArrayX(void* instance, void* images, void* masks, void* pano) {
		try {
			cv::Stitcher::Status ret = reinterpret_cast<cv::Stitcher*>(instance)->stitch(*reinterpret_cast<const cv::_InputArray*>(images), *reinterpret_cast<const cv::_InputArray*>(masks), *reinterpret_cast<const cv::_OutputArray*>(pano));
			return Ok<cv::Stitcher::Status>(ret);
		} OCVRS_CATCH(Result<cv::Stitcher::Status>)
	}
	...
	Result<void*> cv_Stitcher_resultMask_const(void* instance) {
		try {
	...
	Result<void*> cv_detail_AffineBasedEstimator_AffineBasedEstimator() {
		try {
	...
	Result<cv::Rect> cv_detail_AffineWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(void* instance, cv::Size src_size, void* K, void* H, void* xmap, void* ymap) {
		try {
	...
	Result<cv::Rect> cv_detail_AffineWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX(void* instance, cv::Size src_size, void* K, void* H) {
		try {
	...
	Result<void*> cv_detail_BestOf2NearestMatcher_create_bool_float_int_int(bool try_use_gpu, float match_conf, int num_matches_thresh1, int num_matches_thresh2) {
		try {
			...
			return Ok<void*>(new cv::Ptr<cv::detail::BestOf2NearestMatcher>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_detail_BlocksChannelsCompensator_BlocksChannelsCompensator_int_int_int(int bl_width, int bl_height, int nr_feeds) {
		try {
	...
	Result_void cv_detail_BlocksCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(void* instance, int index, cv::Point corner, void* image, void* mask) {
		try {
			reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->apply(index, corner, *reinterpret_cast<const cv::_InputOutputArray*>(image), *reinterpret_cast<const cv::_InputArray*>(mask));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_BlocksCompensator_getMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->getMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_BlocksCompensator_setMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->setMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_BlocksCompensator_setNrFeeds_int(void* instance, int nr_feeds) {
		try {
			reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->setNrFeeds(nr_feeds);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<int> cv_detail_BlocksCompensator_getNrFeeds(void* instance) {
		try {
			int ret = reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->getNrFeeds();
			return Ok<int>(ret);
		} OCVRS_CATCH(Result<int>)
	}
	
	Result_void cv_detail_BlocksCompensator_setBlockSize_int_int(void* instance, int width, int height) {
		try {
			reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->setBlockSize(width, height);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_BlocksCompensator_setBlockSize_Size(void* instance, cv::Size size) {
		try {
			reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->setBlockSize(size);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<cv::Size> cv_detail_BlocksCompensator_getBlockSize_const(void* instance) {
		try {
			cv::Size ret = reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->getBlockSize();
			return Ok<cv::Size>(ret);
		} OCVRS_CATCH(Result<cv::Size>)
	}
	
	Result_void cv_detail_BlocksCompensator_setNrGainsFilteringIterations_int(void* instance, int nr_iterations) {
		try {
			reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->setNrGainsFilteringIterations(nr_iterations);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<int> cv_detail_BlocksCompensator_getNrGainsFilteringIterations_const(void* instance) {
		try {
			int ret = reinterpret_cast<cv::detail::BlocksCompensator*>(instance)->getNrGainsFilteringIterations();
			return Ok<int>(ret);
		} OCVRS_CATCH(Result<int>)
	}
	...
	Result<void*> cv_detail_BlocksGainCompensator_BlocksGainCompensator_int_int_int(int bl_width, int bl_height, int nr_feeds) {
		try {
	...
	Result_void cv_detail_BlocksGainCompensator_getMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::BlocksGainCompensator*>(instance)->getMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_BlocksGainCompensator_setMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::BlocksGainCompensator*>(instance)->setMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_detail_ChannelsCompensator_ChannelsCompensator_int(int nr_feeds) {
		try {
	...
	Result_void cv_detail_ChannelsCompensator_apply_int_Point_const__InputOutputArrayX_const__InputArrayX(void* instance, int index, cv::Point corner, void* image, void* mask) {
		try {
			reinterpret_cast<cv::detail::ChannelsCompensator*>(instance)->apply(index, corner, *reinterpret_cast<const cv::_InputOutputArray*>(image), *reinterpret_cast<const cv::_InputArray*>(mask));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_ChannelsCompensator_getMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::ChannelsCompensator*>(instance)->getMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_ChannelsCompensator_setMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::ChannelsCompensator*>(instance)->setMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_ChannelsCompensator_setNrFeeds_int(void* instance, int nr_feeds) {
		try {
			reinterpret_cast<cv::detail::ChannelsCompensator*>(instance)->setNrFeeds(nr_feeds);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<int> cv_detail_ChannelsCompensator_getNrFeeds(void* instance) {
		try {
			int ret = reinterpret_cast<cv::detail::ChannelsCompensator*>(instance)->getNrFeeds();
			return Ok<int>(ret);
		} OCVRS_CATCH(Result<int>)
	}
	
	Result<void*> cv_detail_ChannelsCompensator_gains_const(void* instance) {
		try {
			std::vector<cv::Scalar> ret = reinterpret_cast<cv::detail::ChannelsCompensator*>(instance)->gains();
			return Ok<void*>(new std::vector<cv::Scalar>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_detail_DpSeamFinder_DpSeamFinder_String(char* costFunc) {
		try {
	...
	Result_void cv_detail_DpSeamFinder_setCostFunction_String(void* instance, char* val) {
		try {
			reinterpret_cast<cv::detail::DpSeamFinder*>(instance)->setCostFunction(std::string(val));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_detail_ExposureCompensator_getMatGains_vector_Mat_X(void* instance, void* unnamed) {
		try {
			reinterpret_cast<cv::detail::ExposureCompensator*>(instance)->getMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(unnamed));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_ExposureCompensator_setMatGains_vector_Mat_X(void* instance, void* unnamed) {
		try {
			reinterpret_cast<cv::detail::ExposureCompensator*>(instance)->setMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(unnamed));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_ExposureCompensator_setUpdateGain_bool(void* instance, bool b) {
		try {
			reinterpret_cast<cv::detail::ExposureCompensator*>(instance)->setUpdateGain(b);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<bool> cv_detail_ExposureCompensator_getUpdateGain(void* instance) {
		try {
			bool ret = reinterpret_cast<cv::detail::ExposureCompensator*>(instance)->getUpdateGain();
			return Ok<bool>(ret);
		} OCVRS_CATCH(Result<bool>)
	}
	...
	Result<void*> cv_detail_GainCompensator_GainCompensator() {
		try {
	...
	Result<void*> cv_detail_GainCompensator_GainCompensator_int(int nr_feeds) {
		try {
	...
	Result_void cv_detail_GainCompensator_getMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::GainCompensator*>(instance)->getMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_GainCompensator_setMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::GainCompensator*>(instance)->setMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_GainCompensator_setNrFeeds_int(void* instance, int nr_feeds) {
		try {
			reinterpret_cast<cv::detail::GainCompensator*>(instance)->setNrFeeds(nr_feeds);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<int> cv_detail_GainCompensator_getNrFeeds(void* instance) {
		try {
			int ret = reinterpret_cast<cv::detail::GainCompensator*>(instance)->getNrFeeds();
			return Ok<int>(ret);
		} OCVRS_CATCH(Result<int>)
	}
	...
	Result<void*> cv_detail_GraphCutSeamFinder_GraphCutSeamFinder_String_float_float(char* cost_type, float terminal_cost, float bad_region_penalty) {
		try {
	...
	Result<void*> cv_detail_ImageFeatures_getKeypoints(void* instance) {
		try {
			std::vector<cv::KeyPoint> ret = reinterpret_cast<cv::detail::ImageFeatures*>(instance)->getKeypoints();
			return Ok<void*>(new std::vector<cv::KeyPoint>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_detail_MatchesInfo_getMatches(void* instance) {
		try {
			std::vector<cv::DMatch> ret = reinterpret_cast<cv::detail::MatchesInfo*>(instance)->getMatches();
			return Ok<void*>(new std::vector<cv::DMatch>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	
	Result<void*> cv_detail_MatchesInfo_getInliers(void* instance) {
		try {
			std::vector<unsigned char> ret = reinterpret_cast<cv::detail::MatchesInfo*>(instance)->getInliers();
			return Ok<void*>(new std::vector<unsigned char>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_detail_NoExposureCompensator_getMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::NoExposureCompensator*>(instance)->getMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_detail_NoExposureCompensator_setMatGains_vector_Mat_X(void* instance, void* umv) {
		try {
			reinterpret_cast<cv::detail::NoExposureCompensator*>(instance)->setMatGains(*reinterpret_cast<std::vector<cv::Mat>*>(umv));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_detail_SeamFinder_createDefault_int(int type) {
		try {
