...
extern "C" {
	...
	Result_void cv_AGAST_const__InputArrayX_vector_KeyPoint_X_int_bool_DetectorType(void* image, void* keypoints, int threshold, bool nonmaxSuppression, cv::AgastFeatureDetector::DetectorType type) {
		try {
	...
	Result_void cv_FAST_const__InputArrayX_vector_KeyPoint_X_int_bool_DetectorType(void* image, void* keypoints, int threshold, bool nonmaxSuppression, cv::FastFeatureDetector::DetectorType type) {
		try {
	...
	Result_void cv_drawKeypoints_const__InputArrayX_const_vector_KeyPoint_X_const__InputOutputArrayX_const_ScalarX_DrawMatchesFlags(void* image, void* keypoints, void* outImage, const cv::Scalar* color, cv::DrawMatchesFlags flags) {
		try {
	...
	Result<void*> cv_AKAZE_create_DescriptorType_int_int_float_int_int_DiffusivityType(cv::AKAZE::DescriptorType descriptor_type, int descriptor_size, int descriptor_channels, float threshold, int nOctaves, int nOctaveLayers, cv::KAZE::DiffusivityType diffusivity) {
		try {
	...
	Result_void cv_AKAZE_setDescriptorType_DescriptorType(void* instance, cv::AKAZE::DescriptorType dtype) {
		try {
	...
	Result<cv::AKAZE::DescriptorType> cv_AKAZE_getDescriptorType_const(void* instance) {
		try {
			cv::AKAZE::DescriptorType ret = reinterpret_cast<cv::AKAZE*>(instance)->getDescriptorType();
	...
	Result_void cv_AKAZE_setDiffusivity_DiffusivityType(void* instance, cv::KAZE::DiffusivityType diff) {
		try {
	...
	Result<cv::KAZE::DiffusivityType> cv_AKAZE_getDiffusivity_const(void* instance) {
		try {
			cv::KAZE::DiffusivityType ret = reinterpret_cast<cv::AKAZE*>(instance)->getDiffusivity();
	...
	Result<void*> cv_AgastFeatureDetector_create_int_bool_DetectorType(int threshold, bool nonmaxSuppression, cv::AgastFeatureDetector::DetectorType type) {
		try {
	...
	Result_void cv_AgastFeatureDetector_setType_DetectorType(void* instance, cv::AgastFeatureDetector::DetectorType type) {
		try {
	...
	Result<cv::AgastFeatureDetector::DetectorType> cv_AgastFeatureDetector_getType_const(void* instance) {
		try {
			cv::AgastFeatureDetector::DetectorType ret = reinterpret_cast<cv::AgastFeatureDetector*>(instance)->getType();
	...
	Result_void cv_BRISK_setThreshold_int(void* instance, int threshold) {
		try {
	...
	Result<int> cv_BRISK_getThreshold_const(void* instance) {
		try {
	...
	Result_void cv_BRISK_setOctaves_int(void* instance, int octaves) {
		try {
	...
	Result<int> cv_BRISK_getOctaves_const(void* instance) {
		try {
	...
	Result_void cv_DescriptorMatcher_write_const_const_StringX(void* instance, const char* fileName) {
		try {
			reinterpret_cast<cv::DescriptorMatcher*>(instance)->write(std::string(fileName));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_DescriptorMatcher_read_const_StringX(void* instance, const char* fileName) {
		try {
			reinterpret_cast<cv::DescriptorMatcher*>(instance)->read(std::string(fileName));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_DescriptorMatcher_create_const_MatcherTypeX(const cv::DescriptorMatcher::MatcherType* matcherType) {
		try {
	...
	Result_void cv_DescriptorMatcher_write_const_const_Ptr_FileStorage_X_const_StringX(void* instance, void* fs, const char* name) {
		try {
			reinterpret_cast<cv::DescriptorMatcher*>(instance)->write(*reinterpret_cast<const cv::Ptr<cv::FileStorage>*>(fs), std::string(name));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<void*> cv_FastFeatureDetector_create_int_bool_DetectorType(int threshold, bool nonmaxSuppression, cv::FastFeatureDetector::DetectorType type) {
		try {
	...
	Result_void cv_FastFeatureDetector_setType_DetectorType(void* instance, cv::FastFeatureDetector::DetectorType type) {
		try {
	...
	Result<cv::FastFeatureDetector::DetectorType> cv_FastFeatureDetector_getType_const(void* instance) {
		try {
			cv::FastFeatureDetector::DetectorType ret = reinterpret_cast<cv::FastFeatureDetector*>(instance)->getType();
	...
	Result_void cv_Feature2D_write_const_const_StringX(void* instance, const char* fileName) {
		try {
			reinterpret_cast<cv::Feature2D*>(instance)->write(std::string(fileName));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_Feature2D_read_const_StringX(void* instance, const char* fileName) {
		try {
			reinterpret_cast<cv::Feature2D*>(instance)->read(std::string(fileName));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_Feature2D_write_const_const_Ptr_FileStorage_X_const_StringX(void* instance, void* fs, const char* name) {
		try {
			reinterpret_cast<cv::Feature2D*>(instance)->write(*reinterpret_cast<const cv::Ptr<cv::FileStorage>*>(fs), std::string(name));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_KAZE_create_bool_bool_float_int_int_DiffusivityType(bool extended, bool upright, float threshold, int nOctaves, int nOctaveLayers, cv::KAZE::DiffusivityType diffusivity) {
		try {
	...
	Result_void cv_KAZE_setDiffusivity_DiffusivityType(void* instance, cv::KAZE::DiffusivityType diff) {
		try {
	...
	Result<cv::KAZE::DiffusivityType> cv_KAZE_getDiffusivity_const(void* instance) {
		try {
			cv::KAZE::DiffusivityType ret = reinterpret_cast<cv::KAZE*>(instance)->getDiffusivity();
			return Ok<cv::KAZE::DiffusivityType>(ret);
		} OCVRS_CATCH(Result<cv::KAZE::DiffusivityType>)
	}
	...
	Result<int> cv_ORB_kBytes_const(void* instance) {
		try {
			int ret = reinterpret_cast<cv::ORB*>(instance)->kBytes;
			return Ok<int>(ret);
		} OCVRS_CATCH(Result<int>)
	}
	
	Result<void*> cv_ORB_create_int_float_int_int_int_int_ScoreType_int_int(int nfeatures, float scaleFactor, int nlevels, int edgeThreshold, int firstLevel, int WTA_K, cv::ORB::ScoreType scoreType, int patchSize, int fastThreshold) {
		try {
	...
	Result_void cv_ORB_setScoreType_ScoreType(void* instance, cv::ORB::ScoreType scoreType) {
		try {
	...
	Result<cv::ORB::ScoreType> cv_ORB_getScoreType_const(void* instance) {
		try {
			cv::ORB::ScoreType ret = reinterpret_cast<cv::ORB*>(instance)->getScoreType();
