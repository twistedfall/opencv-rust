...
extern "C" {
	...
	Result<void*> cv_readOpticalFlow_const_StringX(const char* path) {
		try {
	...
	Result<bool> cv_writeOpticalFlow_const_StringX_const__InputArrayX(const char* path, void* flow) {
		try {
			bool ret = cv::writeOpticalFlow(std::string(path), *reinterpret_cast<const cv::_InputArray*>(flow));
			return Ok<bool>(ret);
	...
	Result<int> cv_DISOpticalFlow_getFinestScale_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setFinestScale_int(void* instance, int val) {
		try {
	...
	Result<int> cv_DISOpticalFlow_getPatchSize_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setPatchSize_int(void* instance, int val) {
		try {
	...
	Result<int> cv_DISOpticalFlow_getPatchStride_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setPatchStride_int(void* instance, int val) {
		try {
	...
	Result<int> cv_DISOpticalFlow_getGradientDescentIterations_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setGradientDescentIterations_int(void* instance, int val) {
		try {
	...
	Result<int> cv_DISOpticalFlow_getVariationalRefinementIterations_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setVariationalRefinementIterations_int(void* instance, int val) {
		try {
	...
	Result<float> cv_DISOpticalFlow_getVariationalRefinementAlpha_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setVariationalRefinementAlpha_float(void* instance, float val) {
		try {
	...
	Result<float> cv_DISOpticalFlow_getVariationalRefinementDelta_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setVariationalRefinementDelta_float(void* instance, float val) {
		try {
	...
	Result<float> cv_DISOpticalFlow_getVariationalRefinementGamma_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setVariationalRefinementGamma_float(void* instance, float val) {
		try {
	...
	Result<bool> cv_DISOpticalFlow_getUseMeanNormalization_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setUseMeanNormalization_bool(void* instance, bool val) {
		try {
	...
	Result<bool> cv_DISOpticalFlow_getUseSpatialPropagation_const(void* instance) {
		try {
	...
	Result_void cv_DISOpticalFlow_setUseSpatialPropagation_bool(void* instance, bool val) {
		try {
	...
	Result<void*> cv_DISOpticalFlow_create_int(int preset) {
		try {
			cv::Ptr<cv::DISOpticalFlow> ret = cv::DISOpticalFlow::create(preset);
			return Ok<void*>(new cv::Ptr<cv::DISOpticalFlow>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_VariationalRefinement_calcUV_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX_const__InputOutputArrayX(void* instance, void* I0, void* I1, void* flow_u, void* flow_v) {
		try {
			reinterpret_cast<cv::VariationalRefinement*>(instance)->calcUV(*reinterpret_cast<const cv::_InputArray*>(I0), *reinterpret_cast<const cv::_InputArray*>(I1), *reinterpret_cast<const cv::_InputOutputArray*>(flow_u), *reinterpret_cast<const cv::_InputOutputArray*>(flow_v));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<int> cv_VariationalRefinement_getFixedPointIterations_const(void* instance) {
		try {
	...
	Result_void cv_VariationalRefinement_setFixedPointIterations_int(void* instance, int val) {
		try {
	...
	Result<int> cv_VariationalRefinement_getSorIterations_const(void* instance) {
		try {
	...
	Result_void cv_VariationalRefinement_setSorIterations_int(void* instance, int val) {
		try {
	...
	Result<float> cv_VariationalRefinement_getOmega_const(void* instance) {
		try {
	...
	Result_void cv_VariationalRefinement_setOmega_float(void* instance, float val) {
		try {
	...
	Result<float> cv_VariationalRefinement_getAlpha_const(void* instance) {
		try {
	...
	Result_void cv_VariationalRefinement_setAlpha_float(void* instance, float val) {
		try {
	...
	Result<float> cv_VariationalRefinement_getDelta_const(void* instance) {
		try {
	...
	Result_void cv_VariationalRefinement_setDelta_float(void* instance, float val) {
		try {
	...
	Result<float> cv_VariationalRefinement_getGamma_const(void* instance) {
		try {
	...
	Result_void cv_VariationalRefinement_setGamma_float(void* instance, float val) {
		try {
	...
	Result<void*> cv_VariationalRefinement_create() {
		try {
			cv::Ptr<cv::VariationalRefinement> ret = cv::VariationalRefinement::create();
			return Ok<void*>(new cv::Ptr<cv::VariationalRefinement>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
