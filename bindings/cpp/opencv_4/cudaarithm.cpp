...
extern "C" {
	...
	Result_void cv_cuda_copyMakeBorder_const__InputArrayR_const__OutputArrayR_int_int_int_int_int_Scalar_StreamR(const cv::_InputArray* src, const cv::_OutputArray* dst, int top, int bottom, int left, int right, int borderType, const cv::Scalar* value, cv::cuda::Stream* stream) {
		try {
	...
	Result<cv::Ptr<cv::cuda::Convolution>*> cv_cuda_createConvolution_Size(const cv::Size* user_block_size) {
		try {
	...
	Result<cv::Ptr<cv::cuda::DFT>*> cv_cuda_createDFT_Size_int(const cv::Size* dft_size, int flags) {
		try {
	...
	Result_void cv_cuda_dft_const__InputArrayR_const__OutputArrayR_Size_int_StreamR(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::Size* dft_size, int flags, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_lshift_const__InputArrayR_Scalar__int__const__OutputArrayR_StreamR(const cv::_InputArray* src, const cv::Scalar_<int>* val, const cv::_OutputArray* dst, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_lshift_const__InputArrayR_Scalar_const__OutputArrayR_StreamR(const cv::_InputArray* src, const cv::Scalar* val, const cv::_OutputArray* dst, cv::cuda::Stream* stream) {
		try {
			cv::cuda::lshift(*src, *val, *dst, *stream);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_cuda_rectStdDev_const__InputArrayR_const__InputArrayR_const__OutputArrayR_Rect_StreamR(const cv::_InputArray* src, const cv::_InputArray* sqr, const cv::_OutputArray* dst, const cv::Rect* rect, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_rshift_const__InputArrayR_Scalar__int__const__OutputArrayR_StreamR(const cv::_InputArray* src, const cv::Scalar_<int>* val, const cv::_OutputArray* dst, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_rshift_const__InputArrayR_Scalar_const__OutputArrayR_StreamR(const cv::_InputArray* src, const cv::Scalar* val, const cv::_OutputArray* dst, cv::cuda::Stream* stream) {
		try {
			cv::cuda::rshift(*src, *val, *dst, *stream);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
