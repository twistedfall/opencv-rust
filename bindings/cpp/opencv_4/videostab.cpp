...
extern "C" {
	...
	Result_void cv_videostab_ImageMotionEstimatorBase_setFrameMask_const__InputArrayX(void* instance, void* mask) {
		try {
	...
	Result_void cv_videostab_KeypointBasedMotionEstimator_setFrameMask_const__InputArrayX(void* instance, void* mask) {
		try {
	...
	Result_void cv_videostab_StabilizerBase_setMaskSource_const_Ptr_IFrameSource_X(void* instance, void* val) {
		try {
			reinterpret_cast<cv::videostab::StabilizerBase*>(instance)->setMaskSource(*reinterpret_cast<const cv::Ptr<cv::videostab::IFrameSource>*>(val));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<void*> cv_videostab_StabilizerBase_maskSource_const(void* instance) {
		try {
			cv::Ptr<cv::videostab::IFrameSource> ret = reinterpret_cast<cv::videostab::StabilizerBase*>(instance)->maskSource();
			return Ok<void*>(new cv::Ptr<cv::videostab::IFrameSource>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_videostab_ToFileMotionWriter_ToFileMotionWriter_const_StringX_Ptr_ImageMotionEstimatorBase_(const char* path, void* estimator) {
		try {
			cv::videostab::ToFileMotionWriter* ret = new cv::videostab::ToFileMotionWriter(std::string(path), *reinterpret_cast<cv::Ptr<cv::videostab::ImageMotionEstimatorBase>*>(estimator));
			return Ok<void*>(ret);
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_videostab_ToFileMotionWriter_setFrameMask_const__InputArrayX(void* instance, void* mask) {
		try {
