...
extern "C" {
	...
	Result_void cv_sfm_BaseSFM_run_const_vector_String_R(cv::sfm::BaseSFM* instance, const std::vector<cv::String>* images) {
		try {
			instance->run(*images);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_sfm_SFMLibmvEuclideanReconstruction_run_const_vector_String_R(cv::sfm::SFMLibmvEuclideanReconstruction* instance, const std::vector<cv::String>* images) {
		try {
			instance->run(*images);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
