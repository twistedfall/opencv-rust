...
extern "C" {
	Result_void cv_cuda_buildWarpAffineMaps_Mat_bool_Size_GpuMatR_GpuMatR_StreamR(cv::Mat* M, bool inverse, const cv::Size* dsize, cv::cuda::GpuMat* xmap, cv::cuda::GpuMat* ymap, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_buildWarpAffineMaps_UMat_bool_Size_GpuMatR_GpuMatR_StreamR(cv::UMat* M, bool inverse, const cv::Size* dsize, cv::cuda::GpuMat* xmap, cv::cuda::GpuMat* ymap, cv::cuda::Stream* stream) {
		try {
			cv::cuda::buildWarpAffineMaps(*M, inverse, *dsize, *xmap, *ymap, *stream);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_cuda_buildWarpPerspectiveMaps_Mat_bool_Size_GpuMatR_GpuMatR_StreamR(cv::Mat* M, bool inverse, const cv::Size* dsize, cv::cuda::GpuMat* xmap, cv::cuda::GpuMat* ymap, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_buildWarpPerspectiveMaps_UMat_bool_Size_GpuMatR_GpuMatR_StreamR(cv::UMat* M, bool inverse, const cv::Size* dsize, cv::cuda::GpuMat* xmap, cv::cuda::GpuMat* ymap, cv::cuda::Stream* stream) {
		try {
			cv::cuda::buildWarpPerspectiveMaps(*M, inverse, *dsize, *xmap, *ymap, *stream);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_cuda_warpAffine_const__InputArrayR_const__OutputArrayR_Mat_Size_int_int_Scalar_StreamR(const cv::_InputArray* src, const cv::_OutputArray* dst, cv::Mat* M, const cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_warpAffine_const__InputArrayR_const__OutputArrayR_UMat_Size_int_int_Scalar_StreamR(const cv::_InputArray* src, const cv::_OutputArray* dst, cv::UMat* M, const cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue, cv::cuda::Stream* stream) {
		try {
			cv::cuda::warpAffine(*src, *dst, *M, *dsize, flags, borderMode, *borderValue, *stream);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_cuda_warpPerspective_const__InputArrayR_const__OutputArrayR_Mat_Size_int_int_Scalar_StreamR(const cv::_InputArray* src, const cv::_OutputArray* dst, cv::Mat* M, const cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue, cv::cuda::Stream* stream) {
		try {
	...
	Result_void cv_cuda_warpPerspective_const__InputArrayR_const__OutputArrayR_UMat_Size_int_int_Scalar_StreamR(const cv::_InputArray* src, const cv::_OutputArray* dst, cv::UMat* M, const cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue, cv::cuda::Stream* stream) {
		try {
			cv::cuda::warpPerspective(*src, *dst, *M, *dsize, flags, borderMode, *borderValue, *stream);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
