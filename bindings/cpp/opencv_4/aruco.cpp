...
extern "C" {
	...
	Result<int> cv_aruco_estimatePoseBoard_const__InputArrayX_const__InputArrayX_const_Ptr_Board_X_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX_const__InputOutputArrayX_bool(void* corners, void* ids, void* board, void* cameraMatrix, void* distCoeffs, void* rvec, void* tvec, bool useExtrinsicGuess) {
		try {
			int ret = cv::aruco::estimatePoseBoard(*reinterpret_cast<const cv::_InputArray*>(corners), *reinterpret_cast<const cv::_InputArray*>(ids), *reinterpret_cast<const cv::Ptr<cv::aruco::Board>*>(board), *reinterpret_cast<const cv::_InputArray*>(cameraMatrix), *reinterpret_cast<const cv::_InputArray*>(distCoeffs), *reinterpret_cast<const cv::_InputOutputArray*>(rvec), *reinterpret_cast<const cv::_InputOutputArray*>(tvec), useExtrinsicGuess);
			return Ok<int>(ret);
