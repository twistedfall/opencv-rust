...
extern "C" {
	...
	Result<void*> cv_text_createERFilterNM1_const_StringX_int_float_float_float_bool_float(const char* filename, int thresholdDelta, float minArea, float maxArea, float minProbability, bool nonMaxSuppression, float minProbabilityDiff) {
		try {
	...
	Result<void*> cv_text_createERFilterNM2_const_StringX_float(const char* filename, float minProbability) {
		try {
	...
	Result<void*> cv_text_createOCRHMMTransitionsTable_const_StringX_vector_String_X(const char* vocabulary, void* lexicon) {
		try {
			cv::Mat ret = cv::text::createOCRHMMTransitionsTable(std::string(vocabulary), *reinterpret_cast<std::vector<cv::String>*>(lexicon));
	...
	Result_void cv_text_detectRegions_const__InputArrayX_const_Ptr_ERFilter_X_const_Ptr_ERFilter_X_vector_Rect_X_int_const_StringX_float(void* image, void* er_filter1, void* er_filter2, void* groups_rects, int method, const char* filename, float minProbability) {
		try {
			cv::text::detectRegions(*reinterpret_cast<const cv::_InputArray*>(image), *reinterpret_cast<const cv::Ptr<cv::text::ERFilter>*>(er_filter1), *reinterpret_cast<const cv::Ptr<cv::text::ERFilter>*>(er_filter2), *reinterpret_cast<std::vector<cv::Rect>*>(groups_rects), method, std::string(filename), minProbability);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_text_erGrouping_const__InputArrayX_const__InputArrayX_vector_vector_Point___vector_Rect_X_int_const_StringX_float(void* image, void* channel, void* regions, void* groups_rects, int method, const char* filename, float minProbablity) {
		try {
			cv::text::erGrouping(*reinterpret_cast<const cv::_InputArray*>(image), *reinterpret_cast<const cv::_InputArray*>(channel), *reinterpret_cast<std::vector<std::vector<cv::Point>>*>(regions), *reinterpret_cast<std::vector<cv::Rect>*>(groups_rects), method, std::string(filename), minProbablity);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_text_loadOCRHMMClassifier_const_StringX_int(const char* filename, int classifier) {
		try {
	...
	Result<int> cv_text_ERFilter_getNumRejected_const(void* instance) {
		try {
	...
	Result<void*> cv_text_OCRBeamSearchDecoder_create_const_StringX_const_StringX_const__InputArrayX_const__InputArrayX_int_int(const char* filename, const char* vocabulary, void* transition_probabilities_table, void* emission_probabilities_table, int mode, int beam_size) {
		try {
			cv::Ptr<cv::text::OCRBeamSearchDecoder> ret = cv::text::OCRBeamSearchDecoder::create(std::string(filename), std::string(vocabulary), *reinterpret_cast<const cv::_InputArray*>(transition_probabilities_table), *reinterpret_cast<const cv::_InputArray*>(emission_probabilities_table), mode, beam_size);
			return Ok<void*>(new cv::Ptr<cv::text::OCRBeamSearchDecoder>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_text_OCRHMMDecoder_create_const_StringX_const_StringX_const__InputArrayX_const__InputArrayX_int_int(const char* filename, const char* vocabulary, void* transition_probabilities_table, void* emission_probabilities_table, int mode, int classifier) {
		try {
			cv::Ptr<cv::text::OCRHMMDecoder> ret = cv::text::OCRHMMDecoder::create(std::string(filename), std::string(vocabulary), *reinterpret_cast<const cv::_InputArray*>(transition_probabilities_table), *reinterpret_cast<const cv::_InputArray*>(emission_probabilities_table), mode, classifier);
			return Ok<void*>(new cv::Ptr<cv::text::OCRHMMDecoder>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_text_OCRHolisticWordRecognizer_run_MatX_stringX_vector_Rect_X_vector_string_X_vector_float_X_int(void* instance, void* image, void** output_text, void* component_rects, void* component_texts, void* component_confidences, int component_level) {
		try {
			std::string output_text_out;
			reinterpret_cast<cv::text::OCRHolisticWordRecognizer*>(instance)->run(*reinterpret_cast<cv::Mat*>(image), output_text_out, reinterpret_cast<std::vector<cv::Rect>*>(component_rects), reinterpret_cast<std::vector<std::string>*>(component_texts), reinterpret_cast<std::vector<float>*>(component_confidences), component_level);
			*output_text = ocvrs_create_string(output_text_out.c_str());
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_text_OCRHolisticWordRecognizer_run_MatX_MatX_stringX_vector_Rect_X_vector_string_X_vector_float_X_int(void* instance, void* image, void* mask, void** output_text, void* component_rects, void* component_texts, void* component_confidences, int component_level) {
		try {
			std::string output_text_out;
			reinterpret_cast<cv::text::OCRHolisticWordRecognizer*>(instance)->run(*reinterpret_cast<cv::Mat*>(image), *reinterpret_cast<cv::Mat*>(mask), output_text_out, reinterpret_cast<std::vector<cv::Rect>*>(component_rects), reinterpret_cast<std::vector<std::string>*>(component_texts), reinterpret_cast<std::vector<float>*>(component_confidences), component_level);
			*output_text = ocvrs_create_string(output_text_out.c_str());
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<void*> cv_text_OCRHolisticWordRecognizer_create_const_stringX_const_stringX_const_stringX(const char* archFilename, const char* weightsFilename, const char* wordsFilename) {
		try {
			...
			return Ok<void*>(new cv::Ptr<cv::text::OCRHolisticWordRecognizer>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_text_OCRTesseract_setWhiteList_const_StringX(void* instance, const char* char_whitelist) {
		try {
			reinterpret_cast<cv::text::OCRTesseract*>(instance)->setWhiteList(std::string(char_whitelist));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_text_TextDetector_detect_const__InputArrayX_vector_Rect_X_vector_float_X(void* instance, void* inputImage, void* Bbox, void* confidence) {
		try {
			reinterpret_cast<cv::text::TextDetector*>(instance)->detect(*reinterpret_cast<const cv::_InputArray*>(inputImage), *reinterpret_cast<std::vector<cv::Rect>*>(Bbox), *reinterpret_cast<std::vector<float>*>(confidence));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_text_TextDetectorCNN_detect_const__InputArrayX_vector_Rect_X_vector_float_X(void* instance, void* inputImage, void* Bbox, void* confidence) {
		try {
			reinterpret_cast<cv::text::TextDetectorCNN*>(instance)->detect(*reinterpret_cast<const cv::_InputArray*>(inputImage), *reinterpret_cast<std::vector<cv::Rect>*>(Bbox), *reinterpret_cast<std::vector<float>*>(confidence));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<void*> cv_text_TextDetectorCNN_create_const_StringX_const_StringX_vector_Size_(const char* modelArchFilename, const char* modelWeightsFilename, void* detectionSizes) {
		try {
			cv::Ptr<cv::text::TextDetectorCNN> ret = cv::text::TextDetectorCNN::create(std::string(modelArchFilename), std::string(modelWeightsFilename), *reinterpret_cast<std::vector<cv::Size>*>(detectionSizes));
			return Ok<void*>(new cv::Ptr<cv::text::TextDetectorCNN>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	
	Result<void*> cv_text_TextDetectorCNN_create_const_StringX_const_StringX(const char* modelArchFilename, const char* modelWeightsFilename) {
		try {
