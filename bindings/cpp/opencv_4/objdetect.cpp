...
extern "C" {
	...
	Result<void*> cv_HOGDescriptor_HOGDescriptor_Size_Size_Size_Size_int_int_double_HistogramNormType_double_bool_int_bool(cv::Size _winSize, cv::Size _blockSize, cv::Size _blockStride, cv::Size _cellSize, int _nbins, int _derivAperture, double _winSigma, cv::HOGDescriptor::HistogramNormType _histogramNormType, double _L2HysThreshold, bool _gammaCorrection, int _nlevels, bool _signedGradient) {
		try {
	...
	Result_void cv_HOGDescriptor_detect_const_const__InputArrayX_vector_Point_X_vector_double_X_double_Size_Size_const_vector_Point_X(void* instance, void* img, void* foundLocations, void* weights, double hitThreshold, cv::Size winStride, cv::Size padding, void* searchLocations) {
		try {
	...
	Result_void cv_HOGDescriptor_detect_const_const__InputArrayX_vector_Point_X_double_Size_Size_const_vector_Point_X(void* instance, void* img, void* foundLocations, double hitThreshold, cv::Size winStride, cv::Size padding, void* searchLocations) {
		try {
	...
	Result_void cv_HOGDescriptor_computeGradient_const_const__InputArrayX_const__InputOutputArrayX_const__InputOutputArrayX_Size_Size(void* instance, void* img, void* grad, void* angleOfs, cv::Size paddingTL, cv::Size paddingBR) {
		try {
	...
	Result_void cv_HOGDescriptor_detectROI_const_const__InputArrayX_const_vector_Point_X_vector_Point_X_vector_double_X_double_Size_Size(void* instance, void* img, void* locations, void* foundLocations, void* confidences, double hitThreshold, cv::Size winStride, cv::Size padding) {
		try {
