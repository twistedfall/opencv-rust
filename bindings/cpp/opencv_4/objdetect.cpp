...
extern "C" {
	...
	Result_void cv_DetectionBasedTracker_ExtObject_setPropLocation_Rect(cv::DetectionBasedTracker::ExtObject* instance, const cv::Rect* val) {
		try {
	...
	Result_void cv_HOGDescriptor_setPropWinSize_Size(cv::HOGDescriptor* instance, const cv::Size* val) {
		try {
	...
	Result_void cv_HOGDescriptor_setPropBlockSize_Size(cv::HOGDescriptor* instance, const cv::Size* val) {
		try {
	...
	Result_void cv_HOGDescriptor_setPropBlockStride_Size(cv::HOGDescriptor* instance, const cv::Size* val) {
		try {
	...
	Result_void cv_HOGDescriptor_setPropCellSize_Size(cv::HOGDescriptor* instance, const cv::Size* val) {
		try {
