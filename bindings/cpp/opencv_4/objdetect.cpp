...
extern "C" {
	...
	Result<bool> cv_BaseCascadeClassifier_load_const_StringX(void* instance, const char* filename) {
		try {
			bool ret = reinterpret_cast<cv::BaseCascadeClassifier*>(instance)->load(std::string(filename));
			return Ok<bool>(ret);
		} OCVRS_CATCH(Result<bool>)
	}
	...
	Result<bool> cv_CascadeClassifier_load_const_StringX(void* instance, const char* filename) {
		try {
			bool ret = reinterpret_cast<cv::CascadeClassifier*>(instance)->load(std::string(filename));
			return Ok<bool>(ret);
		} OCVRS_CATCH(Result<bool>)
	}
	...
	Result<cv::HOGDescriptor::HistogramNormType> cv_HOGDescriptor_histogramNormType_const(void* instance) {
		try {
			cv::HOGDescriptor::HistogramNormType ret = reinterpret_cast<cv::HOGDescriptor*>(instance)->histogramNormType;
			return Ok<cv::HOGDescriptor::HistogramNormType>(ret);
		} OCVRS_CATCH(Result<cv::HOGDescriptor::HistogramNormType>)
	}
	
	Result_void cv_HOGDescriptor_setHistogramNormType_HistogramNormType(void* instance, cv::HOGDescriptor::HistogramNormType val) {
		try {
	...
	Result<void*> cv_HOGDescriptor_HOGDescriptor_Size_Size_Size_Size_int_int_double_HistogramNormType_double_bool_int_bool(const cv::Size* _winSize, const cv::Size* _blockSize, const cv::Size* _blockStride, const cv::Size* _cellSize, int _nbins, int _derivAperture, double _winSigma, cv::HOGDescriptor::HistogramNormType _histogramNormType, double _L2HysThreshold, bool _gammaCorrection, int _nlevels, bool _signedGradient) {
		try {
	...
	Result_void cv_HOGDescriptor_setSVMDetector_const__InputArrayX(void* instance, void* svmdetector) {
		try {
	...
	Result_void cv_HOGDescriptor_write_const_FileStorageX_const_StringX(void* instance, void* fs, const char* objname) {
		try {
			reinterpret_cast<cv::HOGDescriptor*>(instance)->write(*reinterpret_cast<cv::FileStorage*>(fs), std::string(objname));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<bool> cv_HOGDescriptor_load_const_StringX_const_StringX(void* instance, const char* filename, const char* objname) {
		try {
			bool ret = reinterpret_cast<cv::HOGDescriptor*>(instance)->load(std::string(filename), std::string(objname));
			return Ok<bool>(ret);
		} OCVRS_CATCH(Result<bool>)
	}
	...
	Result_void cv_HOGDescriptor_save_const_const_StringX_const_StringX(void* instance, const char* filename, const char* objname) {
		try {
			reinterpret_cast<cv::HOGDescriptor*>(instance)->save(std::string(filename), std::string(objname));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_HOGDescriptor_detect_const_const__InputArrayX_vector_Point_X_vector_double_X_double_Size_Size_const_vector_Point_X(void* instance, void* img, void* foundLocations, void* weights, double hitThreshold, const cv::Size* winStride, const cv::Size* padding, void* searchLocations) {
		try {
			reinterpret_cast<cv::HOGDescriptor*>(instance)->detect(*reinterpret_cast<const cv::_InputArray*>(img), *reinterpret_cast<std::vector<cv::Point>*>(foundLocations), *reinterpret_cast<std::vector<double>*>(weights), hitThreshold, *winStride, *padding, *reinterpret_cast<const std::vector<cv::Point>*>(searchLocations));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_HOGDescriptor_detect_const_const__InputArrayX_vector_Point_X_double_Size_Size_const_vector_Point_X(void* instance, void* img, void* foundLocations, double hitThreshold, const cv::Size* winStride, const cv::Size* padding, void* searchLocations) {
		try {
			reinterpret_cast<cv::HOGDescriptor*>(instance)->detect(*reinterpret_cast<const cv::_InputArray*>(img), *reinterpret_cast<std::vector<cv::Point>*>(foundLocations), hitThreshold, *winStride, *padding, *reinterpret_cast<const std::vector<cv::Point>*>(searchLocations));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_HOGDescriptor_computeGradient_const_const__InputArrayX_const__InputOutputArrayX_const__InputOutputArrayX_Size_Size(void* instance, void* img, void* grad, void* angleOfs, const cv::Size* paddingTL, const cv::Size* paddingBR) {
		try {
			reinterpret_cast<cv::HOGDescriptor*>(instance)->computeGradient(*reinterpret_cast<const cv::_InputArray*>(img), *reinterpret_cast<const cv::_InputOutputArray*>(grad), *reinterpret_cast<const cv::_InputOutputArray*>(angleOfs), *paddingTL, *paddingBR);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_HOGDescriptor_detectROI_const_const__InputArrayX_const_vector_Point_X_vector_Point_X_vector_double_X_double_Size_Size(void* instance, void* img, void* locations, void* foundLocations, void* confidences, double hitThreshold, const cv::Size* winStride, const cv::Size* padding) {
		try {
			reinterpret_cast<cv::HOGDescriptor*>(instance)->detectROI(*reinterpret_cast<const cv::_InputArray*>(img), *reinterpret_cast<const std::vector<cv::Point>*>(locations), *reinterpret_cast<std::vector<cv::Point>*>(foundLocations), *reinterpret_cast<std::vector<double>*>(confidences), hitThreshold, *winStride, *padding);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_HOGDescriptor_detectMultiScaleROI_const_const__InputArrayX_vector_Rect_X_vector_DetectionROI_X_double_int(void* instance, void* img, void* foundLocations, void* locations, double hitThreshold, int groupThreshold) {
		try {
	...
	Result<void*> cv_QRCodeDetector_QRCodeDetector() {
		try {
	...
	Result_void cv_QRCodeDetector_setEpsX_double(void* instance, double epsX) {
		try {
	...
	Result_void cv_QRCodeDetector_setEpsY_double(void* instance, double epsY) {
		try {
	...
	Result<bool> cv_QRCodeDetector_detect_const_const__InputArrayX_const__OutputArrayX(void* instance, void* img, void* points) {
		try {
			bool ret = reinterpret_cast<cv::QRCodeDetector*>(instance)->detect(*reinterpret_cast<const cv::_InputArray*>(img), *reinterpret_cast<const cv::_OutputArray*>(points));
			return Ok<bool>(ret);
		} OCVRS_CATCH(Result<bool>)
	}
	
	Result<void*> cv_QRCodeDetector_decode_const__InputArrayX_const__InputArrayX_const__OutputArrayX(void* instance, void* img, void* points, void* straight_qrcode) {
		try {
			std::string ret = reinterpret_cast<cv::QRCodeDetector*>(instance)->decode(*reinterpret_cast<const cv::_InputArray*>(img), *reinterpret_cast<const cv::_InputArray*>(points), *reinterpret_cast<const cv::_OutputArray*>(straight_qrcode));
			return Ok<void*>(ocvrs_create_string(ret.c_str()));
		} OCVRS_CATCH(Result<void*>)
	}
	
	Result<void*> cv_QRCodeDetector_detectAndDecode_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(void* instance, void* img, void* points, void* straight_qrcode) {
		try {
			std::string ret = reinterpret_cast<cv::QRCodeDetector*>(instance)->detectAndDecode(*reinterpret_cast<const cv::_InputArray*>(img), *reinterpret_cast<const cv::_OutputArray*>(points), *reinterpret_cast<const cv::_OutputArray*>(straight_qrcode));
			return Ok<void*>(ocvrs_create_string(ret.c_str()));
		} OCVRS_CATCH(Result<void*>)
	}
