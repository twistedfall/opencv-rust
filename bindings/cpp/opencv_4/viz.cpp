...
extern "C" {
	...
	Result<void*> cv_viz_imshow_const_StringX_const__InputArrayX_const_SizeX(const char* window_name, void* image, const cv::Size* window_size) {
		try {
			cv::viz::Viz3d ret = cv::viz::imshow(std::string(window_name), *reinterpret_cast<const cv::_InputArray*>(image), *window_size);
			return Ok<void*>(new cv::viz::Viz3d(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_viz_readCloud_const_StringX_const__OutputArrayX_const__OutputArrayX(const char* file, void* colors, void* normals) {
		try {
			cv::Mat ret = cv::viz::readCloud(std::string(file), *reinterpret_cast<const cv::_OutputArray*>(colors), *reinterpret_cast<const cv::_OutputArray*>(normals));
	...
	Result_void cv_viz_readTrajectory_const__OutputArrayX_const_StringX_int_int_const_StringX(void* traj, const char* files_format, int start, int end, const char* tag) {
		try {
			cv::viz::readTrajectory(*reinterpret_cast<const cv::_OutputArray*>(traj), std::string(files_format), start, end, std::string(tag));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_writeCloud_const_StringX_const__InputArrayX_const__InputArrayX_const__InputArrayX_bool(const char* file, void* cloud, void* colors, void* normals, bool binary) {
		try {
			cv::viz::writeCloud(std::string(file), *reinterpret_cast<const cv::_InputArray*>(cloud), *reinterpret_cast<const cv::_InputArray*>(colors), *reinterpret_cast<const cv::_InputArray*>(normals), binary);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_writeTrajectory_const__InputArrayX_const_StringX_int_const_StringX(void* traj, const char* files_format, int start, const char* tag) {
		try {
			cv::viz::writeTrajectory(*reinterpret_cast<const cv::_InputArray*>(traj), std::string(files_format), start, std::string(tag));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_KeyboardEvent_setSymbol_String(void* instance, char* val) {
		try {
			reinterpret_cast<cv::viz::KeyboardEvent*>(instance)->symbol = std::string(val);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_Viz3d_showWidget_const_StringX_const_WidgetX_const_Affine3dX(void* instance, const char* id, void* widget, const cv::Affine3d* pose) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->showWidget(std::string(id), *reinterpret_cast<const cv::viz::Widget*>(widget), *pose);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_Viz3d_removeWidget_const_StringX(void* instance, const char* id) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->removeWidget(std::string(id));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_viz_Viz3d_getWidget_const_const_StringX(void* instance, const char* id) {
		try {
			cv::viz::Widget ret = reinterpret_cast<cv::viz::Viz3d*>(instance)->getWidget(std::string(id));
	...
	Result_void cv_viz_Viz3d_setWidgetPose_const_StringX_const_Affine3dX(void* instance, const char* id, const cv::Affine3d* pose) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->setWidgetPose(std::string(id), *pose);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_Viz3d_updateWidgetPose_const_StringX_const_Affine3dX(void* instance, const char* id, const cv::Affine3d* pose) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->updateWidgetPose(std::string(id), *pose);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<cv::Affine3d> cv_viz_Viz3d_getWidgetPose_const_const_StringX(void* instance, const char* id) {
		try {
			cv::Affine3d ret = reinterpret_cast<cv::viz::Viz3d*>(instance)->getWidgetPose(std::string(id));
			return Ok<cv::Affine3d>(ret);
		} OCVRS_CATCH(Result<cv::Affine3d>)
	}
	...
	Result<cv::Affine3d> cv_viz_Viz3d_getViewerPose_const(void* instance) {
		try {
	...
	Result_void cv_viz_Viz3d_resetCameraViewpoint_const_StringX(void* instance, const char* id) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->resetCameraViewpoint(std::string(id));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_Viz3d_saveScreenshot_const_StringX(void* instance, const char* file) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->saveScreenshot(std::string(file));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_Viz3d_addLight_const_Vec3dX_const_Vec3dX_const_ColorX_const_ColorX_const_ColorX_const_ColorX(void* instance, const cv::Vec3d* position, const cv::Vec3d* focalPoint, void* color, void* diffuseColor, void* ambientColor, void* specularColor) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->addLight(*position, *focalPoint, *reinterpret_cast<const cv::viz::Viz3d::Color*>(color), *reinterpret_cast<const cv::viz::Viz3d::Color*>(diffuseColor), *reinterpret_cast<const cv::viz::Viz3d::Color*>(ambientColor), *reinterpret_cast<const cv::viz::Viz3d::Color*>(specularColor));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_viz_Viz3d_setRenderingProperty_const_StringX_int_double(void* instance, const char* id, int property, double value) {
		try {
			reinterpret_cast<cv::viz::Viz3d*>(instance)->setRenderingProperty(std::string(id), property, value);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<double> cv_viz_Viz3d_getRenderingProperty_const_StringX_int(void* instance, const char* id, int property) {
		try {
			double ret = reinterpret_cast<cv::viz::Viz3d*>(instance)->getRenderingProperty(std::string(id), property);
	...
	Result<void*> cv_viz_WText_WText_const_StringX_const_PointX_int_const_ColorX(const char* text, const cv::Point* pos, int font_size, void* color) {
		try {
			cv::viz::WText* ret = new cv::viz::WText(std::string(text), *pos, font_size, *reinterpret_cast<const cv::viz::Color*>(color));
			return Ok<void*>(ret);
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_viz_WText_setText_const_StringX(void* instance, const char* text) {
		try {
			reinterpret_cast<cv::viz::WText*>(instance)->setText(std::string(text));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_viz_WText3D_WText3D_const_StringX_const_Point3dX_double_bool_const_ColorX(const char* text, const cv::Point3d* position, double text_scale, bool face_camera, void* color) {
		try {
			cv::viz::WText3D* ret = new cv::viz::WText3D(std::string(text), *position, text_scale, face_camera, *reinterpret_cast<const cv::viz::Color*>(color));
			return Ok<void*>(ret);
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result_void cv_viz_WText3D_setText_const_StringX(void* instance, const char* text) {
		try {
			reinterpret_cast<cv::viz::WText3D*>(instance)->setText(std::string(text));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
