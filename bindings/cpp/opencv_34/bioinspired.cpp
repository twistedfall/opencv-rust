...
extern "C" {
	...
	Result<void*> cv_bioinspired_Retina_create_Size(cv::Size inputSize) {
		try {
	...
	Result<void*> cv_bioinspired_Retina_create_Size_bool_int_bool_float_float(cv::Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrenght) {
		try {
	...
	Result<void*> cv_bioinspired_RetinaFastToneMapping_create_Size(cv::Size inputSize) {
		try {
	...
	Result<void*> cv_bioinspired_TransientAreasSegmentationModule_create_Size(cv::Size inputSize) {
		try {
