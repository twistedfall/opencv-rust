...
extern "C" {
	...
	Result_void cv_flann_Index_save_const_const_StringX(void* instance, const char* filename) {
		try {
			reinterpret_cast<cv::flann::Index*>(instance)->save(cv::String(filename));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<bool> cv_flann_Index_load_const__InputArrayX_const_StringX(void* instance, void* features, const char* filename) {
		try {
			bool ret = reinterpret_cast<cv::flann::Index*>(instance)->load(*reinterpret_cast<const cv::_InputArray*>(features), cv::String(filename));
			return Ok<bool>(ret);
	...
	Result<void*> cv_flann_IndexParams_getString_const_const_StringX_const_StringX(void* instance, const char* key, const char* defaultVal) {
		try {
			cv::String ret = reinterpret_cast<cv::flann::IndexParams*>(instance)->getString(cv::String(key), cv::String(defaultVal));
	...
	Result<int> cv_flann_IndexParams_getInt_const_const_StringX_int(void* instance, const char* key, int defaultVal) {
		try {
			int ret = reinterpret_cast<cv::flann::IndexParams*>(instance)->getInt(cv::String(key), defaultVal);
			return Ok<int>(ret);
		} OCVRS_CATCH(Result<int>)
	}
	...
	Result<double> cv_flann_IndexParams_getDouble_const_const_StringX_double(void* instance, const char* key, double defaultVal) {
		try {
			double ret = reinterpret_cast<cv::flann::IndexParams*>(instance)->getDouble(cv::String(key), defaultVal);
	...
	Result_void cv_flann_IndexParams_setString_const_StringX_const_StringX(void* instance, const char* key, const char* value) {
		try {
			reinterpret_cast<cv::flann::IndexParams*>(instance)->setString(cv::String(key), cv::String(value));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_flann_IndexParams_setInt_const_StringX_int(void* instance, const char* key, int value) {
		try {
			reinterpret_cast<cv::flann::IndexParams*>(instance)->setInt(cv::String(key), value);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_flann_IndexParams_setDouble_const_StringX_double(void* instance, const char* key, double value) {
		try {
			reinterpret_cast<cv::flann::IndexParams*>(instance)->setDouble(cv::String(key), value);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_flann_IndexParams_setFloat_const_StringX_float(void* instance, const char* key, float value) {
		try {
			reinterpret_cast<cv::flann::IndexParams*>(instance)->setFloat(cv::String(key), value);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_flann_IndexParams_setBool_const_StringX_bool(void* instance, const char* key, bool value) {
		try {
			reinterpret_cast<cv::flann::IndexParams*>(instance)->setBool(cv::String(key), value);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_flann_IndexParams_getAll_const_vector_String_X_vector_int_X_vector_String_X_vector_double_X(void* instance, void* names, void* types, void* strValues, void* numValues) {
		try {
			reinterpret_cast<cv::flann::IndexParams*>(instance)->getAll(*reinterpret_cast<std::vector<cv::String>*>(names), *reinterpret_cast<std::vector<int>*>(types), *reinterpret_cast<std::vector<cv::String>*>(strValues), *reinterpret_cast<std::vector<double>*>(numValues));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
