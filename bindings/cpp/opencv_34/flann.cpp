...
extern "C" {
	...
	Result_void cv_flann_IndexParams_getAll_const_vector_String_X_vector_int_X_vector_String_X_vector_double_X(const cv::flann::IndexParams* instance, std::vector<cv::String>* names, std::vector<int>* types, std::vector<cv::String>* strValues, std::vector<double>* numValues) {
		try {
