...
extern "C" {
	...
	Result_void cv_text_detectRegions_const__InputArrayX_const_Ptr_ERFilter_X_const_Ptr_ERFilter_X_vector_Rect_X_int_const_StringX_float(void* image, void* er_filter1, void* er_filter2, void* groups_rects, int method, const char* filename, float minProbability) {
		try {
			cv::text::detectRegions(*reinterpret_cast<const cv::_InputArray*>(image), *reinterpret_cast<const cv::Ptr<cv::text::ERFilter>*>(er_filter1), *reinterpret_cast<const cv::Ptr<cv::text::ERFilter>*>(er_filter2), *reinterpret_cast<std::vector<cv::Rect>*>(groups_rects), method, cv::String(filename), minProbability);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_text_OCRBeamSearchDecoder_create_const_StringX_const_StringX_const__InputArrayX_const__InputArrayX_int_int(const char* filename, const char* vocabulary, void* transition_probabilities_table, void* emission_probabilities_table, int mode, int beam_size) {
		try {
			cv::Ptr<cv::text::OCRBeamSearchDecoder> ret = cv::text::OCRBeamSearchDecoder::create(cv::String(filename), cv::String(vocabulary), *reinterpret_cast<const cv::_InputArray*>(transition_probabilities_table), *reinterpret_cast<const cv::_InputArray*>(emission_probabilities_table), mode, beam_size);
			return Ok<void*>(new cv::Ptr<cv::text::OCRBeamSearchDecoder>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_text_OCRHMMDecoder_create_const_StringX_const_StringX_const__InputArrayX_const__InputArrayX_int_int(const char* filename, const char* vocabulary, void* transition_probabilities_table, void* emission_probabilities_table, int mode, int classifier) {
		try {
			cv::Ptr<cv::text::OCRHMMDecoder> ret = cv::text::OCRHMMDecoder::create(cv::String(filename), cv::String(vocabulary), *reinterpret_cast<const cv::_InputArray*>(transition_probabilities_table), *reinterpret_cast<const cv::_InputArray*>(emission_probabilities_table), mode, classifier);
			return Ok<void*>(new cv::Ptr<cv::text::OCRHMMDecoder>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<void*> cv_text_TextDetectorCNN_create_const_StringX_const_StringX_vector_Size_(const char* modelArchFilename, const char* modelWeightsFilename, void* detectionSizes) {
		try {
			cv::Ptr<cv::text::TextDetectorCNN> ret = cv::text::TextDetectorCNN::create(cv::String(modelArchFilename), cv::String(modelWeightsFilename), *reinterpret_cast<std::vector<cv::Size>*>(detectionSizes));
