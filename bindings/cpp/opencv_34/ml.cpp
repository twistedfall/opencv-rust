...
extern "C" {
	...
	Result<double> cv_ml_ANN_MLP_ANNEAL_getAnnealInitialT_const(void* instance) {
		try {
	...
	Result_void cv_ml_ANN_MLP_ANNEAL_setAnnealInitialT_double(void* instance, double val) {
		try {
	...
	Result<double> cv_ml_ANN_MLP_ANNEAL_getAnnealFinalT_const(void* instance) {
		try {
	...
	Result_void cv_ml_ANN_MLP_ANNEAL_setAnnealFinalT_double(void* instance, double val) {
		try {
	...
	Result<double> cv_ml_ANN_MLP_ANNEAL_getAnnealCoolingRatio_const(void* instance) {
		try {
	...
	Result_void cv_ml_ANN_MLP_ANNEAL_setAnnealCoolingRatio_double(void* instance, double val) {
		try {
	...
	Result<int> cv_ml_ANN_MLP_ANNEAL_getAnnealItePerStep_const(void* instance) {
		try {
	...
	Result_void cv_ml_ANN_MLP_ANNEAL_setAnnealItePerStep_int(void* instance, int val) {
		try {
	...
	Result_void cv_ml_ANN_MLP_ANNEAL_setAnnealEnergyRNG_const_RNGX(void* instance, void* rng) {
		try {
			reinterpret_cast<cv::ml::ANN_MLP_ANNEAL*>(instance)->setAnnealEnergyRNG(*reinterpret_cast<const cv::RNG*>(rng));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
