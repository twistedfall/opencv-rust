...
extern "C" {
	...
	Result<bool> cv_findCirclesGrid2_const__InputArrayX_Size_const__OutputArrayX_int_const_Ptr_FeatureDetector_X_CirclesGridFinderParameters2(void* image, const cv::Size* patternSize, void* centers, int flags, void* blobDetector, const cv::CirclesGridFinderParameters2* parameters) {
		try {
	...
	Result<bool> cv_findCirclesGrid_const__InputArrayX_Size_const__OutputArrayX_int_const_Ptr_FeatureDetector_X_CirclesGridFinderParameters(void* image, const cv::Size* patternSize, void* centers, int flags, void* blobDetector, const cv::CirclesGridFinderParameters* parameters) {
		try {
