...
extern "C" {
	...
	Result<bool> cv_findCirclesGrid2_const__InputArrayX_Size_const__OutputArrayX_int_const_Ptr_FeatureDetector_X_CirclesGridFinderParameters2(const cv::_InputArray* image, const cv::Size* patternSize, const cv::_OutputArray* centers, int flags, const cv::Ptr<cv::FeatureDetector>* blobDetector, const cv::CirclesGridFinderParameters2* parameters) {
		try {
	...
	Result<bool> cv_findCirclesGrid_const__InputArrayX_Size_const__OutputArrayX_int_const_Ptr_FeatureDetector_X_CirclesGridFinderParameters(const cv::_InputArray* image, const cv::Size* patternSize, const cv::_OutputArray* centers, int flags, const cv::Ptr<cv::FeatureDetector>* blobDetector, const cv::CirclesGridFinderParameters* parameters) {
		try {
