...
extern "C" {
	...
	Result_void cv_AGAST_const__InputArrayR_vector_KeyPoint_R_int_bool_int(const cv::_InputArray* image, std::vector<cv::KeyPoint>* keypoints, int threshold, bool nonmaxSuppression, int type) {
		try {
	...
	Result_void cv_FAST_const__InputArrayR_vector_KeyPoint_R_int_bool_int(const cv::_InputArray* image, std::vector<cv::KeyPoint>* keypoints, int threshold, bool nonmaxSuppression, int type) {
		try {
	...
	Result_void cv_drawKeypoints_const__InputArrayR_const_vector_KeyPoint_R_const__InputOutputArrayR_const_ScalarR_int(const cv::_InputArray* image, const std::vector<cv::KeyPoint>* keypoints, const cv::_InputOutputArray* outImage, const cv::Scalar* color, int flags) {
		try {
