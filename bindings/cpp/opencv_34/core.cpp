...
extern "C" {
	...
	Result<cv::_InputArray*> cv__InputArray__InputArray_const_vector_vector_bool__X(const std::vector<std::vector<bool>>* unnamed) {
		try {
	...
	Result<cv::_OutputArray*> cv__OutputArray__OutputArray_vector_vector_bool__X(std::vector<std::vector<bool>>* unnamed) {
		try {
