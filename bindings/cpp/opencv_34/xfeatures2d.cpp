...
extern "C" {
	Result_void cv_xfeatures2d_FASTForPointSet_const__InputArrayX_vector_KeyPoint_X_int_bool_int(void* image, void* keypoints, int threshold, bool nonmaxSuppression, int type) {
		try {
