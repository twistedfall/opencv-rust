...
extern "C" {
	...
	Result_void cv_sqrBoxFilter_const__InputArrayR_const__OutputArrayR_int_Size_Point_bool_int(const cv::_InputArray* src, const cv::_OutputArray* dst, int ddepth, const cv::Size* ksize, const cv::Point* anchor, bool normalize, int borderType) {
		try {
	...
	Result_void cv_warpPolar_const__InputArrayR_const__OutputArrayR_Size_Point2f_double_int(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::Size* dsize, const cv::Point2f* center, double maxRadius, int flags) {
		try {
