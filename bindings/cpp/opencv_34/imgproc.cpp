...
extern "C" {
	...
	Result_void cv_undistortPoints_const__InputArrayX_const__OutputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_TermCriteria(void* src, void* dst, void* cameraMatrix, void* distCoeffs, void* R, void* P, void* criteria) {
		try {
			cv::undistortPoints(*reinterpret_cast<const cv::_InputArray*>(src), *reinterpret_cast<const cv::_OutputArray*>(dst), *reinterpret_cast<const cv::_InputArray*>(cameraMatrix), *reinterpret_cast<const cv::_InputArray*>(distCoeffs), *reinterpret_cast<const cv::_InputArray*>(R), *reinterpret_cast<const cv::_InputArray*>(P), *reinterpret_cast<cv::TermCriteria*>(criteria));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
