...
extern "C" {
	...
	Result_void cv_sfm_importReconstruction_const_StringX_const__OutputArrayX_const__OutputArrayX_const__OutputArrayX_const__OutputArrayX_int(const char* file, void* Rs, void* Ts, void* Ks, void* points3d, int file_format) {
		try {
			cv::sfm::importReconstruction(cv::String(file), *reinterpret_cast<const cv::_OutputArray*>(Rs), *reinterpret_cast<const cv::_OutputArray*>(Ts), *reinterpret_cast<const cv::_OutputArray*>(Ks), *reinterpret_cast<const cv::_OutputArray*>(points3d), file_format);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_sfm_reconstruct_vector_string__const__OutputArrayX_const__OutputArrayX_const__InputOutputArrayX_bool(void* images, void* Ps, void* points3d, void* K, bool is_projective) {
		try {
			cv::sfm::reconstruct(*reinterpret_cast<std::vector<std::string>*>(images), *reinterpret_cast<const cv::_OutputArray*>(Ps), *reinterpret_cast<const cv::_OutputArray*>(points3d), *reinterpret_cast<const cv::_InputOutputArray*>(K), is_projective);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_sfm_reconstruct_vector_string__const__OutputArrayX_const__OutputArrayX_const__InputOutputArrayX_const__OutputArrayX_bool(void* images, void* Rs, void* Ts, void* K, void* points3d, bool is_projective) {
		try {
			cv::sfm::reconstruct(*reinterpret_cast<std::vector<std::string>*>(images), *reinterpret_cast<const cv::_OutputArray*>(Rs), *reinterpret_cast<const cv::_OutputArray*>(Ts), *reinterpret_cast<const cv::_InputOutputArray*>(K), *reinterpret_cast<const cv::_OutputArray*>(points3d), is_projective);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_sfm_BaseSFM_run_const_vector_string_X(void* instance, void* images) {
		try {
			reinterpret_cast<cv::sfm::BaseSFM*>(instance)->run(*reinterpret_cast<const std::vector<std::string>*>(images));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_sfm_BaseSFM_run_const_vector_string_X_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_const__OutputArrayX(void* instance, void* images, void* K, void* Rs, void* Ts, void* points3d) {
		try {
			reinterpret_cast<cv::sfm::BaseSFM*>(instance)->run(*reinterpret_cast<const std::vector<std::string>*>(images), *reinterpret_cast<const cv::_InputOutputArray*>(K), *reinterpret_cast<const cv::_OutputArray*>(Rs), *reinterpret_cast<const cv::_OutputArray*>(Ts), *reinterpret_cast<const cv::_OutputArray*>(points3d));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_sfm_SFMLibmvEuclideanReconstruction_run_const_vector_string_X(void* instance, void* images) {
		try {
			reinterpret_cast<cv::sfm::SFMLibmvEuclideanReconstruction*>(instance)->run(*reinterpret_cast<const std::vector<std::string>*>(images));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_sfm_SFMLibmvEuclideanReconstruction_run_const_vector_string_X_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_const__OutputArrayX(void* instance, void* images, void* K, void* Rs, void* Ts, void* points3d) {
		try {
			reinterpret_cast<cv::sfm::SFMLibmvEuclideanReconstruction*>(instance)->run(*reinterpret_cast<const std::vector<std::string>*>(images), *reinterpret_cast<const cv::_InputOutputArray*>(K), *reinterpret_cast<const cv::_OutputArray*>(Rs), *reinterpret_cast<const cv::_OutputArray*>(Ts), *reinterpret_cast<const cv::_OutputArray*>(points3d));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
