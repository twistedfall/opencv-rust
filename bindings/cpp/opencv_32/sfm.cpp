...
extern "C" {
	...
	Result_void cv_sfm_reconstruct_vector_string__const__OutputArrayR_const__OutputArrayR_const__InputOutputArrayR_bool(const std::vector<std::string>* images, const cv::_OutputArray* Ps, const cv::_OutputArray* points3d, const cv::_InputOutputArray* K, bool is_projective) {
		try {
	...
	Result_void cv_sfm_reconstruct_vector_string__const__OutputArrayR_const__OutputArrayR_const__InputOutputArrayR_const__OutputArrayR_bool(const std::vector<std::string>* images, const cv::_OutputArray* Rs, const cv::_OutputArray* Ts, const cv::_InputOutputArray* K, const cv::_OutputArray* points3d, bool is_projective) {
		try {
