...
extern "C" {
	Result<cv::Ptr<cv::dnn::Importer>*> cv_dnn_createCaffeImporter_const_StringX_const_StringX(const char* prototxt, const char* caffeModel) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::Importer>*>)
	}
	...
	Result<cv::dnn::Blob*> cv_dnn_readTorchBlob_const_StringX_bool(const char* filename, bool isBinary) {
		...
		} OCVRS_CATCH(Result<cv::dnn::Blob*>)
	}
	...
	Result<int> cv_dnn_CropLayer_startAxis_const(const cv::dnn::CropLayer* instance) {
		try {
	...
	Result_void cv_dnn_CropLayer_setStartAxis_int(cv::dnn::CropLayer* instance, int val) {
		try {
	...
	Result<std::vector<int>*> cv_dnn_CropLayer_offset(cv::dnn::CropLayer* instance) {
		try {
	...
	Result_void cv_dnn_CropLayer_setOffset_vector_int_(cv::dnn::CropLayer* instance, std::vector<int>* val) {
		try {
			instance->offset = *val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<cv::Ptr<cv::dnn::CropLayer>*> cv_dnn_CropLayer_create_int_const_vector_int_X(int start_axis, const std::vector<int>* offset) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::CropLayer>*>)
	}
	...
	Result<double> cv_dnn_LRNLayer_alpha_const(const cv::dnn::LRNLayer* instance) {
		try {
	...
	Result_void cv_dnn_LRNLayer_setAlpha_double(cv::dnn::LRNLayer* instance, double val) {
		try {
			instance->alpha = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<double> cv_dnn_LRNLayer_beta_const(const cv::dnn::LRNLayer* instance) {
		try {
	...
	Result_void cv_dnn_LRNLayer_setBeta_double(cv::dnn::LRNLayer* instance, double val) {
		try {
			instance->beta = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<double> cv_dnn_LRNLayer_bias_const(const cv::dnn::LRNLayer* instance) {
		try {
	...
	Result_void cv_dnn_LRNLayer_setBias_double(cv::dnn::LRNLayer* instance, double val) {
		try {
			instance->bias = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<std::vector<cv::dnn::Blob>*> cv_dnn_Layer_blobs(cv::dnn::Layer* instance) {
		try {
			std::vector<cv::dnn::Blob> ret = instance->blobs;
			return Ok(new std::vector<cv::dnn::Blob>(ret));
		} OCVRS_CATCH(Result<std::vector<cv::dnn::Blob>*>)
	}
	
	Result_void cv_dnn_Layer_setBlobs_vector_Blob_(cv::dnn::Layer* instance, std::vector<cv::dnn::Blob>* val) {
		try {
			instance->blobs = *val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<std::vector<cv::dnn::Blob>*> cv_dnn_LayerParams_blobs(cv::dnn::LayerParams* instance) {
		try {
			std::vector<cv::dnn::Blob> ret = instance->blobs;
			return Ok(new std::vector<cv::dnn::Blob>(ret));
		} OCVRS_CATCH(Result<std::vector<cv::dnn::Blob>*>)
	...
	Result_void cv_dnn_LayerParams_setBlobs_vector_Blob_(cv::dnn::LayerParams* instance, std::vector<cv::dnn::Blob>* val) {
		try {
			instance->blobs = *val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<double> cv_dnn_MVNLayer_eps_const(const cv::dnn::MVNLayer* instance) {
		try {
	...
	Result_void cv_dnn_MVNLayer_setEps_double(cv::dnn::MVNLayer* instance, double val) {
		try {
			instance->eps = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<double> cv_dnn_PowerLayer_power_const(const cv::dnn::PowerLayer* instance) {
		try {
	...
	Result_void cv_dnn_PowerLayer_setPower_double(cv::dnn::PowerLayer* instance, double val) {
		try {
			instance->power = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<double> cv_dnn_PowerLayer_scale_const(const cv::dnn::PowerLayer* instance) {
		try {
	...
	Result_void cv_dnn_PowerLayer_setScale_double(cv::dnn::PowerLayer* instance, double val) {
		try {
			instance->scale = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<double> cv_dnn_PowerLayer_shift_const(const cv::dnn::PowerLayer* instance) {
		try {
	...
	Result_void cv_dnn_PowerLayer_setShift_double(cv::dnn::PowerLayer* instance, double val) {
		try {
			instance->shift = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	...
	Result<double> cv_dnn_ReLULayer_negativeSlope_const(const cv::dnn::ReLULayer* instance) {
		try {
	...
	Result_void cv_dnn_ReLULayer_setNegativeSlope_double(cv::dnn::ReLULayer* instance, double val) {
		try {
	...
	Result<cv::dnn::BlobShape*> cv_dnn_ReshapeLayer_newShapeDesc(cv::dnn::ReshapeLayer* instance) {
		try {
	...
	Result_void cv_dnn_ReshapeLayer_setNewShapeDesc_BlobShape(cv::dnn::ReshapeLayer* instance, cv::dnn::BlobShape* val) {
		try {
	...
	Result<std::vector<int>*> cv_dnn_SliceLayer_sliceIndices(cv::dnn::SliceLayer* instance) {
		try {
	...
	Result_void cv_dnn_SliceLayer_setSliceIndices_vector_int_(cv::dnn::SliceLayer* instance, std::vector<int>* val) {
		try {
