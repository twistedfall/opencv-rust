...
extern "C" {
	...
	Result_void cv_hdf_HDF5_dscreate_const_int_int_int_String_int_const_vector_int_R(const cv::hdf::HDF5* instance, int rows, int cols, int type, char* dslabel, int compresslevel, const std::vector<int>* dims_chunks) {
		try {
	...
	Result_void cv_hdf_HDF5_dscreate_const_const_vector_int_R_int_String_int_const_vector_int_R(const cv::hdf::HDF5* instance, const std::vector<int>* sizes, int type, char* dslabel, int compresslevel, const std::vector<int>* dims_chunks) {
		try {
	...
	Result_void cv_hdf_HDF5_kpread_const_vector_KeyPoint_R_String_int_int(const cv::hdf::HDF5* instance, std::vector<cv::KeyPoint>* keypoints, char* kplabel, int offset, int counts) {
		try {
