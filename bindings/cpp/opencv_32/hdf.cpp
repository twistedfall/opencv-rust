...
extern "C" {
	...
	Result_void cv_hdf_HDF5_kpwrite_const_vector_KeyPoint__String_int_int(const cv::hdf::HDF5* instance, std::vector<cv::KeyPoint>* keypoints, char* kplabel, int offset, int counts) {
		try {
	...
	Result_void cv_hdf_HDF5_kpinsert_const_vector_KeyPoint__String_int_int(const cv::hdf::HDF5* instance, std::vector<cv::KeyPoint>* keypoints, char* kplabel, int offset, int counts) {
		try {
