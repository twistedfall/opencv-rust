...
extern "C" {
	...
	Result_void cv_rgbd_warpFrame_const_MatX_const_MatX_const_MatX_const_MatX_const_MatX_const_MatX_MatX_MatX_MatX(const cv::Mat* image, const cv::Mat* depth, const cv::Mat* mask, const cv::Mat* Rt, const cv::Mat* cameraMatrix, const cv::Mat* distCoeff, cv::Mat* warpedImage, cv::Mat* warpedDepth, cv::Mat* warpedMask) {
		try {
	...
	Result<bool> cv_rgbd_Odometry_compute_const_Ptr_OdometryFrame_X_Ptr_OdometryFrame_X_MatX_const_MatX(const cv::rgbd::Odometry* instance, cv::Ptr<cv::rgbd::OdometryFrame>* srcFrame, cv::Ptr<cv::rgbd::OdometryFrame>* dstFrame, cv::Mat* Rt, const cv::Mat* initRt) {
		try {
