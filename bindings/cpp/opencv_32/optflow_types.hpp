...
extern "C" void cv_PtrOfDISOpticalFlow_delete(cv::Ptr<cv::optflow::DISOpticalFlow>* instance) {
	delete instance;
}

extern "C" cv::optflow::DISOpticalFlow* cv_PtrOfDISOpticalFlow_get_inner_ptr(cv::Ptr<cv::optflow::DISOpticalFlow>* instance) {
	return instance->get();
}
...
extern "C" void cv_PtrOfVariationalRefinement_delete(cv::Ptr<cv::optflow::VariationalRefinement>* instance) {
	delete instance;
}

extern "C" cv::optflow::VariationalRefinement* cv_PtrOfVariationalRefinement_get_inner_ptr(cv::Ptr<cv::optflow::VariationalRefinement>* instance) {
	return instance->get();
}
