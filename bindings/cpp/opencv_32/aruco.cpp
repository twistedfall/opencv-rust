...
extern "C" {
	...
	Result_void cv_aruco_detectMarkers_const__InputArrayX_const_Ptr_Dictionary_X_const__OutputArrayX_const__OutputArrayX_const_Ptr_DetectorParameters_X_const__OutputArrayX(void* image, void* dictionary, void* corners, void* ids, void* parameters, void* rejectedImgPoints) {
		try {
			cv::aruco::detectMarkers(*reinterpret_cast<const cv::_InputArray*>(image), *reinterpret_cast<const cv::Ptr<cv::aruco::Dictionary>*>(dictionary), *reinterpret_cast<const cv::_OutputArray*>(corners), *reinterpret_cast<const cv::_OutputArray*>(ids), *reinterpret_cast<const cv::Ptr<cv::aruco::DetectorParameters>*>(parameters), *reinterpret_cast<const cv::_OutputArray*>(rejectedImgPoints));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<int> cv_aruco_estimatePoseBoard_const__InputArrayX_const__InputArrayX_const_Ptr_Board_X_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(void* corners, void* ids, void* board, void* cameraMatrix, void* distCoeffs, void* rvec, void* tvec) {
		try {
			int ret = cv::aruco::estimatePoseBoard(*reinterpret_cast<const cv::_InputArray*>(corners), *reinterpret_cast<const cv::_InputArray*>(ids), *reinterpret_cast<const cv::Ptr<cv::aruco::Board>*>(board), *reinterpret_cast<const cv::_InputArray*>(cameraMatrix), *reinterpret_cast<const cv::_InputArray*>(distCoeffs), *reinterpret_cast<const cv::_OutputArray*>(rvec), *reinterpret_cast<const cv::_OutputArray*>(tvec));
			return Ok<int>(ret);
		} OCVRS_CATCH(Result<int>)
	}
	
	Result<bool> cv_aruco_estimatePoseCharucoBoard_const__InputArrayX_const__InputArrayX_const_Ptr_CharucoBoard_X_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(void* charucoCorners, void* charucoIds, void* board, void* cameraMatrix, void* distCoeffs, void* rvec, void* tvec) {
		try {
	...
	Result_void cv_aruco_estimatePoseSingleMarkers_const__InputArrayX_float_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(void* corners, float markerLength, void* cameraMatrix, void* distCoeffs, void* rvecs, void* tvecs) {
		try {
			cv::aruco::estimatePoseSingleMarkers(*reinterpret_cast<const cv::_InputArray*>(corners), markerLength, *reinterpret_cast<const cv::_InputArray*>(cameraMatrix), *reinterpret_cast<const cv::_InputArray*>(distCoeffs), *reinterpret_cast<const cv::_OutputArray*>(rvecs), *reinterpret_cast<const cv::_OutputArray*>(tvecs));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result<void*> cv_aruco_generateCustomDictionary_int_int(int nMarkers, int markerSize) {
		try {
	...
	Result<void*> cv_aruco_generateCustomDictionary_int_int_const_Ptr_Dictionary_X(int nMarkers, int markerSize, void* baseDictionary) {
		try {
			cv::Ptr<cv::aruco::Dictionary> ret = cv::aruco::generateCustomDictionary(nMarkers, markerSize, *reinterpret_cast<const cv::Ptr<cv::aruco::Dictionary>*>(baseDictionary));
			return Ok<void*>(new cv::Ptr<cv::aruco::Dictionary>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<bool> cv_aruco_DetectorParameters_doCornerRefinement_const(void* instance) {
		try {
			bool ret = reinterpret_cast<cv::aruco::DetectorParameters*>(instance)->doCornerRefinement;
			return Ok<bool>(ret);
		} OCVRS_CATCH(Result<bool>)
	}
	
	Result_void cv_aruco_DetectorParameters_setDoCornerRefinement_bool(void* instance, bool val) {
		try {
			reinterpret_cast<cv::aruco::DetectorParameters*>(instance)->doCornerRefinement = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_aruco_Dictionary_create_int_int(int nMarkers, int markerSize) {
		try {
	...
	Result<void*> cv_aruco_Dictionary_create_int_int_const_Ptr_Dictionary_X(int nMarkers, int markerSize, void* baseDictionary) {
		try {
			cv::Ptr<cv::aruco::Dictionary> ret = cv::aruco::Dictionary::create(nMarkers, markerSize, *reinterpret_cast<const cv::Ptr<cv::aruco::Dictionary>*>(baseDictionary));
			return Ok<void*>(new cv::Ptr<cv::aruco::Dictionary>(ret));
		} OCVRS_CATCH(Result<void*>)
	}
