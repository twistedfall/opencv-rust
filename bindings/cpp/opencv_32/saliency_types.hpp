...
extern "C" void cv_PtrOfSaliency_delete(cv::Ptr<cv::saliency::Saliency>* instance) {
	delete instance;
}

extern "C" cv::saliency::Saliency* cv_PtrOfSaliency_get_inner_ptr(cv::Ptr<cv::saliency::Saliency>* instance) {
	return instance->get();
}
