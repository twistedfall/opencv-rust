...
extern "C" {
	...
	Result<void*> cv_findFundamentalMat_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_double_double(void* points1, void* points2, void* mask, int method, double param1, double param2) {
		try {
			cv::Mat ret = cv::findFundamentalMat(*reinterpret_cast<const cv::_InputArray*>(points1), *reinterpret_cast<const cv::_InputArray*>(points2), *reinterpret_cast<const cv::_OutputArray*>(mask), method, param1, param2);
			return Ok<void*>(new cv::Mat(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	
	Result<void*> cv_findFundamentalMat_const__InputArrayX_const__InputArrayX_int_double_double_const__OutputArrayX(void* points1, void* points2, int method, double param1, double param2, void* mask) {
		try {
			cv::Mat ret = cv::findFundamentalMat(*reinterpret_cast<const cv::_InputArray*>(points1), *reinterpret_cast<const cv::_InputArray*>(points2), method, param1, param2, *reinterpret_cast<const cv::_OutputArray*>(mask));
			return Ok<void*>(new cv::Mat(ret));
		} OCVRS_CATCH(Result<void*>)
	}
