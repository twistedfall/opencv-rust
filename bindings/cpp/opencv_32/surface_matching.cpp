...
extern "C" {
	...
	Result<int> cv_ppf_match_3d_ICP_registerModelToScene_const_MatX_const_MatX_doubleX_double_X__16_(cv::ppf_match_3d::ICP* instance, const cv::Mat* srcPC, const cv::Mat* dstPC, double* residual, double(*pose)[16]) {
		try {
	...
	Result<unsigned int> cv_ppf_match_3d_Pose3D_modelIndex_const(const cv::ppf_match_3d::Pose3D* instance) {
		try {
	...
	Result_void cv_ppf_match_3d_Pose3D_setModelIndex_unsigned_int(cv::ppf_match_3d::Pose3D* instance, unsigned int val) {
		try {
	...
	Result<unsigned int> cv_ppf_match_3d_Pose3D_numVotes_const(const cv::ppf_match_3d::Pose3D* instance) {
		try {
	...
	Result_void cv_ppf_match_3d_Pose3D_setNumVotes_unsigned_int(cv::ppf_match_3d::Pose3D* instance, unsigned int val) {
		try {
	...
	Result<double(*)[16]> cv_ppf_match_3d_Pose3D_pose(cv::ppf_match_3d::Pose3D* instance) {
		try {
	...
	Result<double(*)[3]> cv_ppf_match_3d_Pose3D_t(cv::ppf_match_3d::Pose3D* instance) {
		try {
	...
	Result<double(*)[4]> cv_ppf_match_3d_Pose3D_q(cv::ppf_match_3d::Pose3D* instance) {
		try {
	...
	Result<int> cv_ppf_match_3d_PoseCluster3D_numVotes_const(const cv::ppf_match_3d::PoseCluster3D* instance) {
		try {
	...
	Result_void cv_ppf_match_3d_PoseCluster3D_setNumVotes_int(cv::ppf_match_3d::PoseCluster3D* instance, int val) {
		try {
			instance->numVotes = val;
			return Ok();
		} OCVRS_CATCH(Result_void)
