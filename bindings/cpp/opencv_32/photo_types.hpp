...
extern "C" void cv_PtrOfTonemapDurand_delete(cv::Ptr<cv::TonemapDurand>* instance) {
	delete instance;
}

extern "C" cv::TonemapDurand* cv_PtrOfTonemapDurand_get_inner_ptr(cv::Ptr<cv::TonemapDurand>* instance) {
	return instance->get();
}
