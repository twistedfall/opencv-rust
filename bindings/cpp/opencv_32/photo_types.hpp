...
template struct Result<cv::Ptr<cv::TonemapDurand>*>;
...
extern "C" {
	void cv_PtrOfTonemapDurand_delete(cv::Ptr<cv::TonemapDurand>* instance) {
		delete instance;
	}

	const cv::TonemapDurand* cv_PtrOfTonemapDurand_get_inner_ptr(const cv::Ptr<cv::TonemapDurand>* instance) {
		return instance->get();
	}

	cv::TonemapDurand* cv_PtrOfTonemapDurand_get_inner_ptr_mut(cv::Ptr<cv::TonemapDurand>* instance) {
		return instance->get();
	}
}
