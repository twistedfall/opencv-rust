...
extern "C" {
	...
	Result<double> cv_superres_SuperResolution_getLabmda_const(const cv::superres::SuperResolution* instance) {
		try {
	...
	Result_void cv_superres_SuperResolution_setLabmda_double(cv::superres::SuperResolution* instance, double val) {
		try {
