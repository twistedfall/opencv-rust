...
extern "C" {
	...
	Result_void cv_ximgproc_GradientDericheX_const__InputArrayX_const__OutputArrayX_double_double(const cv::_InputArray* _op, const cv::_OutputArray* _dst, double alphaDerive, double alphaMean) {
		try {
	...
	Result_void cv_ximgproc_GradientDericheY_const__InputArrayX_const__OutputArrayX_double_double(const cv::_InputArray* _op, const cv::_OutputArray* _dst, double alphaDerive, double alphaMean) {
		try {
	...
	Result_void cv_ximgproc_niBlackThreshold_const__InputArrayX_const__OutputArrayX_double_int_int_double(const cv::_InputArray* _src, const cv::_OutputArray* _dst, double maxValue, int type, int blockSize, double delta) {
		try {
	...
	Result_void cv_ximgproc_weightedMedianFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_double_WMFWeightType_Mat(const cv::_InputArray* joint, const cv::_InputArray* src, const cv::_OutputArray* dst, int r, double sigma, cv::ximgproc::WMFWeightType weightType, cv::Mat* mask) {
		try {
	...
	Result_void cv_ximgproc_StructuredEdgeDetection_detectEdges_const_const_MatX_MatX(const cv::ximgproc::StructuredEdgeDetection* instance, const cv::Mat* src, cv::Mat* dst) {
		try {
