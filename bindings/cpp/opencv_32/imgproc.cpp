...
extern "C" {
	...
	Result<cv::Rect> cv_boundingRect_const__InputArrayX(void* points) {
		try {
			cv::Rect ret = cv::boundingRect(*reinterpret_cast<const cv::_InputArray*>(points));
	...
	Result_void cv_demosaicing_const__InputArrayX_const__OutputArrayX_int_int(void* _src, void* _dst, int code, int dcn) {
		try {
			cv::demosaicing(*reinterpret_cast<const cv::_InputArray*>(_src), *reinterpret_cast<const cv::_OutputArray*>(_dst), code, dcn);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_drawMarker_MatX_Point_const_ScalarX_int_int_int_int(void* img, const cv::Point* position, const cv::Scalar* color, int markerType, int markerSize, int thickness, int line_type) {
		try {
			cv::drawMarker(*reinterpret_cast<cv::Mat*>(img), *position, *color, markerType, markerSize, thickness, line_type);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_findContours_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_int_int_Point(void* image, void* contours, void* hierarchy, int mode, int method, const cv::Point* offset) {
		try {
			cv::findContours(*reinterpret_cast<const cv::_InputOutputArray*>(image), *reinterpret_cast<const cv::_OutputArray*>(contours), *reinterpret_cast<const cv::_OutputArray*>(hierarchy), mode, method, *offset);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_findContours_const__InputOutputArrayX_const__OutputArrayX_int_int_Point(void* image, void* contours, int mode, int method, const cv::Point* offset) {
		try {
			cv::findContours(*reinterpret_cast<const cv::_InputOutputArray*>(image), *reinterpret_cast<const cv::_OutputArray*>(contours), mode, method, *offset);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result<void*> cv_getPerspectiveTransform_const_Point2fX_const_Point2fX(const cv::Point2f* src, const cv::Point2f* dst) {
		try {
	...
	Result<void*> cv_getPerspectiveTransform_const__InputArrayX_const__InputArrayX(void* src, void* dst) {
		try {
			cv::Mat ret = cv::getPerspectiveTransform(*reinterpret_cast<const cv::_InputArray*>(src), *reinterpret_cast<const cv::_InputArray*>(dst));
			return Ok<void*>(new cv::Mat(ret));
		} OCVRS_CATCH(Result<void*>)
	}
	...
	Result<float> cv_initWideAngleProjMap_const__InputArrayX_const__InputArrayX_Size_int_int_const__OutputArrayX_const__OutputArrayX_int_double(void* cameraMatrix, void* distCoeffs, const cv::Size* imageSize, int destImageWidth, int m1type, void* map1, void* map2, int projType, double alpha) {
		try {
	...
	Result_void cv_putText_const__InputOutputArrayX_const_StringX_Point_int_double_Scalar_int_int_bool(void* img, const char* text, const cv::Point* org, int fontFace, double fontScale, const cv::Scalar* color, int thickness, int lineType, bool bottomLeftOrigin) {
		try {
			cv::putText(*reinterpret_cast<const cv::_InputOutputArray*>(img), cv::String(text), *org, fontFace, fontScale, *color, thickness, lineType, bottomLeftOrigin);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_rectangle_MatX_Rect_const_ScalarX_int_int_int(void* img, const cv::Rect* rec, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
			cv::rectangle(*reinterpret_cast<cv::Mat*>(img), *rec, *color, thickness, lineType, shift);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_sqrBoxFilter_const__InputArrayX_const__OutputArrayX_int_Size_Point_bool_int(void* _src, void* _dst, int ddepth, const cv::Size* ksize, const cv::Point* anchor, bool normalize, int borderType) {
		try {
			cv::sqrBoxFilter(*reinterpret_cast<const cv::_InputArray*>(_src), *reinterpret_cast<const cv::_OutputArray*>(_dst), ddepth, *ksize, *anchor, normalize, borderType);
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	...
	Result_void cv_undistortPoints_const__InputArrayX_const__OutputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX(void* src, void* dst, void* cameraMatrix, void* distCoeffs, void* R, void* P) {
		try {
			cv::undistortPoints(*reinterpret_cast<const cv::_InputArray*>(src), *reinterpret_cast<const cv::_OutputArray*>(dst), *reinterpret_cast<const cv::_InputArray*>(cameraMatrix), *reinterpret_cast<const cv::_InputArray*>(distCoeffs), *reinterpret_cast<const cv::_InputArray*>(R), *reinterpret_cast<const cv::_InputArray*>(P));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
	
	Result_void cv_undistort_const__InputArrayX_const__OutputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX(void* src, void* dst, void* cameraMatrix, void* distCoeffs, void* newCameraMatrix) {
		try {
			cv::undistort(*reinterpret_cast<const cv::_InputArray*>(src), *reinterpret_cast<const cv::_OutputArray*>(dst), *reinterpret_cast<const cv::_InputArray*>(cameraMatrix), *reinterpret_cast<const cv::_InputArray*>(distCoeffs), *reinterpret_cast<const cv::_InputArray*>(newCameraMatrix));
			return Ok();
		} OCVRS_CATCH(Result_void)
	}
