...
extern "C" {
	...
	Result_void cv_drawMarker_MatR_Point_const_ScalarR_int_int_int_int(cv::Mat* img, cv::Point* position, const cv::Scalar* color, int markerType, int markerSize, int thickness, int line_type) {
		try {
	...
	Result_void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_const__OutputArrayR_int_int_Point(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, const cv::_OutputArray* hierarchy, int mode, int method, cv::Point* offset) {
		try {
	...
	Result_void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_int_int_Point(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, int mode, int method, cv::Point* offset) {
		try {
	...
	Result_void cv_rectangle_MatR_Rect_const_ScalarR_int_int_int(cv::Mat* img, cv::Rect* rec, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
	...
	Result_void cv_sqrBoxFilter_const__InputArrayR_const__OutputArrayR_int_Size_Point_bool_int(const cv::_InputArray* _src, const cv::_OutputArray* _dst, int ddepth, cv::Size* ksize, cv::Point* anchor, bool normalize, int borderType) {
		try {
