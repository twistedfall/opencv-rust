...
extern "C" {
	...
	Result_void cv_GaussianBlur_const__InputArrayR_const__OutputArrayR_Size_double_double_int(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::Size* ksize, double sigmaX, double sigmaY, int borderType) {
		try {
	...
	Result_void cv_arrowedLine_const__InputOutputArrayR_Point_Point_const_ScalarR_int_int_int_double(const cv::_InputOutputArray* img, const cv::Point* pt1, const cv::Point* pt2, const cv::Scalar* color, int thickness, int line_type, int shift, double tipLength) {
		try {
	...
	Result_void cv_blur_const__InputArrayR_const__OutputArrayR_Size_Point_int(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::Size* ksize, const cv::Point* anchor, int borderType) {
		try {
	...
	Result<cv::Rect> cv_boundingRect_const__InputArrayR(const cv::_InputArray* points) {
		try {
			cv::Rect ret = cv::boundingRect(*points);
			return Ok(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::Rect>))
	}
	
	Result_void cv_boxFilter_const__InputArrayR_const__OutputArrayR_int_Size_Point_bool_int(const cv::_InputArray* src, const cv::_OutputArray* dst, int ddepth, const cv::Size* ksize, const cv::Point* anchor, bool normalize, int borderType) {
		try {
	...
	Result_void cv_circle_const__InputOutputArrayR_Point_int_const_ScalarR_int_int_int(const cv::_InputOutputArray* img, const cv::Point* center, int radius, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
	...
	Result<bool> cv_clipLine_Rect_PointR_PointR(const cv::Rect* imgRect, cv::Point* pt1, cv::Point* pt2) {
		try {
	...
	Result<bool> cv_clipLine_Size2l_Point2lR_Point2lR(const cv::Size2l* imgSize, cv::Point2l* pt1, cv::Point2l* pt2) {
		try {
	...
	Result<bool> cv_clipLine_Size_PointR_PointR(const cv::Size* imgSize, cv::Point* pt1, cv::Point* pt2) {
		try {
			bool ret = cv::clipLine(*imgSize, *pt1, *pt2);
			return Ok(ret);
		} OCVRS_CATCH(OCVRS_TYPE(Result<bool>))
	...
	Result_void cv_cornerSubPix_const__InputArrayR_const__InputOutputArrayR_Size_Size_TermCriteria(const cv::_InputArray* image, const cv::_InputOutputArray* corners, const cv::Size* winSize, const cv::Size* zeroZone, const cv::TermCriteria* criteria) {
		try {
	...
	Result_void cv_createHanningWindow_const__OutputArrayR_Size_int(const cv::_OutputArray* dst, const cv::Size* winSize, int type) {
		try {
	...
	Result_void cv_demosaicing_const__InputArrayR_const__OutputArrayR_int_int(const cv::_InputArray* _src, const cv::_OutputArray* _dst, int code, int dcn) {
		try {
	...
	Result_void cv_dilate_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Point_int_int_const_ScalarR(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* kernel, const cv::Point* anchor, int iterations, int borderType, const cv::Scalar* borderValue) {
		try {
	...
	Result_void cv_drawMarker_MatR_Point_const_ScalarR_int_int_int_int(cv::Mat* img, const cv::Point* position, const cv::Scalar* color, int markerType, int markerSize, int thickness, int line_type) {
		try {
	...
	Result_void cv_ellipse2Poly_Point2d_Size2d_int_int_int_int_vector_Point2d_R(const cv::Point2d* center, const cv::Size2d* axes, int angle, int arcStart, int arcEnd, int delta, std::vector<cv::Point2d>* pts) {
		try {
	...
	Result_void cv_ellipse2Poly_Point_Size_int_int_int_int_vector_Point_R(const cv::Point* center, const cv::Size* axes, int angle, int arcStart, int arcEnd, int delta, std::vector<cv::Point>* pts) {
		try {
			cv::ellipse2Poly(*center, *axes, angle, arcStart, arcEnd, delta, *pts);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	...
	Result_void cv_ellipse_const__InputOutputArrayR_Point_Size_double_double_double_const_ScalarR_int_int_int(const cv::_InputOutputArray* img, const cv::Point* center, const cv::Size* axes, double angle, double startAngle, double endAngle, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
	...
	Result_void cv_erode_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Point_int_int_const_ScalarR(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* kernel, const cv::Point* anchor, int iterations, int borderType, const cv::Scalar* borderValue) {
		try {
	...
	Result_void cv_fillPoly_const__InputOutputArrayR_const__InputArrayR_const_ScalarR_int_int_Point(const cv::_InputOutputArray* img, const cv::_InputArray* pts, const cv::Scalar* color, int lineType, int shift, const cv::Point* offset) {
		try {
	...
	Result_void cv_filter2D_const__InputArrayR_const__OutputArrayR_int_const__InputArrayR_Point_double_int(const cv::_InputArray* src, const cv::_OutputArray* dst, int ddepth, const cv::_InputArray* kernel, const cv::Point* anchor, double delta, int borderType) {
		try {
	...
	Result_void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_const__OutputArrayR_int_int_Point(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, const cv::_OutputArray* hierarchy, int mode, int method, const cv::Point* offset) {
		try {
	...
	Result_void cv_findContours_const__InputOutputArrayR_const__OutputArrayR_int_int_Point(const cv::_InputOutputArray* image, const cv::_OutputArray* contours, int mode, int method, const cv::Point* offset) {
		try {
	...
	Result<int> cv_floodFill_const__InputOutputArrayR_Point_Scalar_RectX_Scalar_Scalar_int(const cv::_InputOutputArray* image, const cv::Point* seedPoint, const cv::Scalar* newVal, cv::Rect* rect, const cv::Scalar* loDiff, const cv::Scalar* upDiff, int flags) {
		try {
	...
	Result<int> cv_floodFill_const__InputOutputArrayR_const__InputOutputArrayR_Point_Scalar_RectX_Scalar_Scalar_int(const cv::_InputOutputArray* image, const cv::_InputOutputArray* mask, const cv::Point* seedPoint, const cv::Scalar* newVal, cv::Rect* rect, const cv::Scalar* loDiff, const cv::Scalar* upDiff, int flags) {
		try {
	...
	Result<cv::Mat*> cv_getDefaultNewCameraMatrix_const__InputArrayR_Size_bool(const cv::_InputArray* cameraMatrix, const cv::Size* imgsize, bool centerPrincipalPoint) {
		try {
	...
	Result<cv::Mat*> cv_getPerspectiveTransform_const_Point2fX_const_Point2fX(const cv::Point2f* src, const cv::Point2f* dst) {
		try {
	...
	Result<cv::Mat*> cv_getPerspectiveTransform_const__InputArrayR_const__InputArrayR(const cv::_InputArray* src, const cv::_InputArray* dst) {
		try {
			cv::Mat ret = cv::getPerspectiveTransform(*src, *dst);
			return Ok(new cv::Mat(ret));
		} OCVRS_CATCH(OCVRS_TYPE(Result<cv::Mat*>))
	...
	Result_void cv_getRectSubPix_const__InputArrayR_Size_Point2f_const__OutputArrayR_int(const cv::_InputArray* image, const cv::Size* patchSize, const cv::Point2f* center, const cv::_OutputArray* patch, int patchType) {
		try {
	...
	Result<cv::Size> cv_getTextSize_const_StringR_int_double_int_intX(const char* text, int fontFace, double fontScale, int thickness, int* baseLine) {
		try {
			cv::Size ret = cv::getTextSize(cv::String(text), fontFace, fontScale, thickness, baseLine);
			return Ok(ret);
	...
	Result_void cv_grabCut_const__InputArrayR_const__InputOutputArrayR_Rect_const__InputOutputArrayR_const__InputOutputArrayR_int_int(const cv::_InputArray* img, const cv::_InputOutputArray* mask, const cv::Rect* rect, const cv::_InputOutputArray* bgdModel, const cv::_InputOutputArray* fgdModel, int iterCount, int mode) {
		try {
	...
	Result<float> cv_initWideAngleProjMap_const__InputArrayR_const__InputArrayR_Size_int_int_const__OutputArrayR_const__OutputArrayR_int_double(const cv::_InputArray* cameraMatrix, const cv::_InputArray* distCoeffs, const cv::Size* imageSize, int destImageWidth, int m1type, const cv::_OutputArray* map1, const cv::_OutputArray* map2, int projType, double alpha) {
		try {
	...
	Result_void cv_line_const__InputOutputArrayR_Point_Point_const_ScalarR_int_int_int(const cv::_InputOutputArray* img, const cv::Point* pt1, const cv::Point* pt2, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
	...
	Result_void cv_linearPolar_const__InputArrayR_const__OutputArrayR_Point2f_double_int(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::Point2f* center, double maxRadius, int flags) {
		try {
	...
	Result_void cv_logPolar_const__InputArrayR_const__OutputArrayR_Point2f_double_int(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::Point2f* center, double M, int flags) {
		try {
	...
	Result_void cv_morphologyEx_const__InputArrayR_const__OutputArrayR_int_const__InputArrayR_Point_int_int_const_ScalarR(const cv::_InputArray* src, const cv::_OutputArray* dst, int op, const cv::_InputArray* kernel, const cv::Point* anchor, int iterations, int borderType, const cv::Scalar* borderValue) {
		try {
	...
	Result<double> cv_pointPolygonTest_const__InputArrayR_Point2f_bool(const cv::_InputArray* contour, const cv::Point2f* pt, bool measureDist) {
		try {
	...
	Result_void cv_putText_const__InputOutputArrayR_const_StringR_Point_int_double_Scalar_int_int_bool(const cv::_InputOutputArray* img, const char* text, const cv::Point* org, int fontFace, double fontScale, const cv::Scalar* color, int thickness, int lineType, bool bottomLeftOrigin) {
		try {
			cv::putText(*img, cv::String(text), *org, fontFace, fontScale, *color, thickness, lineType, bottomLeftOrigin);
			return Ok();
		} OCVRS_CATCH(OCVRS_TYPE(Result_void))
	}
	...
	Result_void cv_pyrMeanShiftFiltering_const__InputArrayR_const__OutputArrayR_double_double_int_TermCriteria(const cv::_InputArray* src, const cv::_OutputArray* dst, double sp, double sr, int maxLevel, const cv::TermCriteria* termcrit) {
		try {
	...
	Result_void cv_rectangle_MatR_Rect_const_ScalarR_int_int_int(cv::Mat* img, const cv::Rect* rec, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
	...
	Result_void cv_rectangle_const__InputOutputArrayR_Point_Point_const_ScalarR_int_int_int(const cv::_InputOutputArray* img, const cv::Point* pt1, const cv::Point* pt2, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
	...
	Result_void cv_resize_const__InputArrayR_const__OutputArrayR_Size_double_double_int(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::Size* dsize, double fx, double fy, int interpolation) {
		try {
	...
	Result_void cv_sepFilter2D_const__InputArrayR_const__OutputArrayR_int_const__InputArrayR_const__InputArrayR_Point_double_int(const cv::_InputArray* src, const cv::_OutputArray* dst, int ddepth, const cv::_InputArray* kernelX, const cv::_InputArray* kernelY, const cv::Point* anchor, double delta, int borderType) {
		try {
	...
	Result_void cv_sqrBoxFilter_const__InputArrayR_const__OutputArrayR_int_Size_Point_bool_int(const cv::_InputArray* _src, const cv::_OutputArray* _dst, int ddepth, const cv::Size* ksize, const cv::Point* anchor, bool normalize, int borderType) {
		try {
	...
	Result_void cv_warpAffine_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Size_int_int_const_ScalarR(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* M, const cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue) {
		try {
	...
	Result_void cv_warpPerspective_const__InputArrayR_const__OutputArrayR_const__InputArrayR_Size_int_int_const_ScalarR(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* M, const cv::Size* dsize, int flags, int borderMode, const cv::Scalar* borderValue) {
		try {
	...
	Result_void cv_GeneralizedHough_setTemplate_const__InputArrayR_Point(cv::GeneralizedHough* instance, const cv::_InputArray* templ, const cv::Point* templCenter) {
		try {
	...
	Result_void cv_GeneralizedHough_setTemplate_const__InputArrayR_const__InputArrayR_const__InputArrayR_Point(cv::GeneralizedHough* instance, const cv::_InputArray* edges, const cv::_InputArray* dx, const cv::_InputArray* dy, const cv::Point* templCenter) {
		try {
	...
	Result<cv::LineIterator*> cv_LineIterator_LineIterator_const_MatR_Point_Point_int_bool(const cv::Mat* img, const cv::Point* pt1, const cv::Point* pt2, int connectivity, bool leftToRight) {
		try {
	...
	Result<int> cv_Subdiv2D_locate_Point2f_intR_intR(cv::Subdiv2D* instance, const cv::Point2f* pt, int* edge, int* vertex) {
		try {
