...
extern "C" {
	...
	Result_void cv_drawMarker_MatX_Point_const_ScalarX_int_int_int_int(void* img, cv::Point position, const cv::Scalar* color, int markerType, int markerSize, int thickness, int line_type) {
		try {
	...
	Result_void cv_findContours_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_int_int_Point(void* image, void* contours, void* hierarchy, int mode, int method, cv::Point offset) {
		try {
	...
	Result_void cv_findContours_const__InputOutputArrayX_const__OutputArrayX_int_int_Point(void* image, void* contours, int mode, int method, cv::Point offset) {
		try {
	...
	Result<float> cv_initWideAngleProjMap_const__InputArrayX_const__InputArrayX_Size_int_int_const__OutputArrayX_const__OutputArrayX_int_double(void* cameraMatrix, void* distCoeffs, cv::Size imageSize, int destImageWidth, int m1type, void* map1, void* map2, int projType, double alpha) {
		try {
	...
	Result_void cv_rectangle_MatX_Rect_const_ScalarX_int_int_int(void* img, cv::Rect rec, const cv::Scalar* color, int thickness, int lineType, int shift) {
		try {
	...
	Result_void cv_sqrBoxFilter_const__InputArrayX_const__OutputArrayX_int_Size_Point_bool_int(void* _src, void* _dst, int ddepth, cv::Size ksize, cv::Point anchor, bool normalize, int borderType) {
		try {
