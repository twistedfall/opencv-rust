...
extern "C" {
	Result<cv::Ptr<cv::bioinspired::RetinaFastToneMapping>*> cv_bioinspired_createRetinaFastToneMapping_Size(cv::Size* inputSize) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_OCL_Size(cv::Size* inputSize) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_OCL_Size_const_bool_int_const_bool_const_float_const_float(cv::Size* inputSize, const bool colorMode, int colorSamplingMethod, const bool useRetinaLogSampling, const float reductionFactor, const float samplingStrenght) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_Size(cv::Size* inputSize) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_Size_const_bool_int_const_bool_const_float_const_float(cv::Size* inputSize, const bool colorMode, int colorSamplingMethod, const bool useRetinaLogSampling, const float reductionFactor, const float samplingStrenght) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::TransientAreasSegmentationModule>*> cv_bioinspired_createTransientAreasSegmentationModule_Size(cv::Size* inputSize) {
		try {
