...
extern "C" {
	Result<cv::Ptr<cv::bioinspired::RetinaFastToneMapping>*> cv_bioinspired_createRetinaFastToneMapping_Size(const cv::Size* inputSize) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_OCL_Size(const cv::Size* inputSize) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_OCL_Size_bool_int_bool_float_float(const cv::Size* inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrenght) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_Size(const cv::Size* inputSize) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::Retina>*> cv_bioinspired_createRetina_Size_bool_int_bool_float_float(const cv::Size* inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrenght) {
		try {
	...
	Result<cv::Ptr<cv::bioinspired::TransientAreasSegmentationModule>*> cv_bioinspired_createTransientAreasSegmentationModule_Size(const cv::Size* inputSize) {
		try {
