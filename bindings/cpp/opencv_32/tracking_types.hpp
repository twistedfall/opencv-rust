...
extern "C" void cv_PtrOfTrackerModel_delete(cv::Ptr<cv::TrackerModel>* instance) {
	delete instance;
}

extern "C" cv::TrackerModel* cv_PtrOfTrackerModel_get_inner_ptr(cv::Ptr<cv::TrackerModel>* instance) {
	return instance->get();
}
