...
extern "C" {
	...
	Result<void*> cv_structured_light_SinusoidalPattern_create_const_ParamsX(void* parameters) {
		try {
			cv::Ptr<cv::structured_light::SinusoidalPattern> ret = cv::structured_light::SinusoidalPattern::create(*reinterpret_cast<const cv::structured_light::SinusoidalPattern::Params*>(parameters));
	...
	Result<bool> cv_structured_light_StructuredLightPattern_decode_const_const__InputArrayX_const__OutputArrayX_const__InputArrayX_const__InputArrayX_int(void* instance, void* patternImages, void* disparityMap, void* blackImages, void* whiteImages, int flags) {
		try {
			bool ret = reinterpret_cast<cv::structured_light::StructuredLightPattern*>(instance)->decode(*reinterpret_cast<const cv::_InputArray*>(patternImages), *reinterpret_cast<const cv::_OutputArray*>(disparityMap), *reinterpret_cast<const cv::_InputArray*>(blackImages), *reinterpret_cast<const cv::_InputArray*>(whiteImages), flags);
			return Ok<bool>(ret);
		} OCVRS_CATCH(Result<bool>)
	}
