...
extern "C" {
	...
	Result<cv::Ptr<cv::structured_light::SinusoidalPattern>*> cv_structured_light_SinusoidalPattern_create_const_ParamsX(const cv::structured_light::SinusoidalPattern::Params* parameters) {
		try {
