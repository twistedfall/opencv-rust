...
extern "C" {
	...
	Result<cv::Mat*> cv_optflow_readOpticalFlow_const_StringX(const char* path) {
		try {
	...
	Result<bool> cv_optflow_writeOpticalFlow_const_StringX_const__InputArrayX(const char* path, const cv::_InputArray* flow) {
		try {
	...
	Result<cv::optflow::GPCTrainingParams> cv_optflow_GPCTrainingParams_GPCTrainingParams_const_GPCTrainingParamsX(const cv::optflow::GPCTrainingParams* params) {
		try {
	...
	Result_void cv_optflow_VariationalRefinement_calcUV_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX_const__InputOutputArrayX(cv::optflow::VariationalRefinement* instance, const cv::_InputArray* I0, const cv::_InputArray* I1, const cv::_InputOutputArray* flow_u, const cv::_InputOutputArray* flow_v) {
		try {
