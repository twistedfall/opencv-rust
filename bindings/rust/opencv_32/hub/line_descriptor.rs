...
impl DrawLinesMatchesFlags {
	#[inline] pub fn as_raw_DrawLinesMatchesFlags(&self) -> *const c_void { self.as_raw() }
	#[inline] pub fn as_raw_mut_DrawLinesMatchesFlags(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl KeyLine {
	#[inline] pub fn as_raw_KeyLine(&self) -> *const c_void { self.as_raw() }
	#[inline] pub fn as_raw_mut_KeyLine(&mut self) -> *mut c_void { self.as_raw_mut() }
}

unsafe impl Send for KeyLine {}

impl crate::line_descriptor::KeyLineTrait for KeyLine {
	#[inline] fn as_raw_KeyLine(&self) -> *const c_void { self.as_raw() }
	#[inline] fn as_raw_mut_KeyLine(&mut self) -> *mut c_void { self.as_raw_mut() }
}
