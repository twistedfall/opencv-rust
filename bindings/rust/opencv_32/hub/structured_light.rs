...
impl dyn SinusoidalPattern + '_ {
	...
	pub fn create(parameters: &crate::structured_light::SinusoidalPattern_Params) -> Result<core::Ptr::<dyn crate::structured_light::SinusoidalPattern>> {
		unsafe { sys::cv_structured_light_SinusoidalPattern_create_const_ParamsX(parameters.as_raw_SinusoidalPattern_Params()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::structured_light::SinusoidalPattern>::from_raw(ptr) })
	}
