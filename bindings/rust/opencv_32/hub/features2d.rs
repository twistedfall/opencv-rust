...
/// 
/// Detects corners using the FAST algorithm by [Rosten06](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Rosten06) .
/// 
/// 
...
/// Class implementing the BRISK keypoint detector and descriptor extractor, described in [LCS11](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_LCS11) .
...
/// 
/// - the grey image algorithm is taken from: [nister2008linear](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_nister2008linear) ;  the paper claims to be faster
/// than union-find method; it actually get 1.5~2m/s on my centrino L7200 1.2GHz laptop.
/// 
/// - the color image algorithm is taken from: [forssen2007maximally](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_forssen2007maximally) ; it should be much slower
