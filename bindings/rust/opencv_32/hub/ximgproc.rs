...
pub fn gradient_deriche_x(_op: &dyn core::ToInputArray, _dst: &mut dyn core::ToOutputArray, alpha_derive: f64, alpha_mean: f64) -> Result<()> {
	...
	unsafe { sys::cv_ximgproc_GradientDericheX_const__InputArrayX_const__OutputArrayX_double_double(_op.as_raw__InputArray(), _dst.as_raw__OutputArray(), alpha_derive, alpha_mean) }.into_result()
}
...
pub fn gradient_deriche_y(_op: &dyn core::ToInputArray, _dst: &mut dyn core::ToOutputArray, alpha_derive: f64, alpha_mean: f64) -> Result<()> {
	input_array_arg!(_op);
	output_array_arg!(_dst);
	unsafe { sys::cv_ximgproc_GradientDericheY_const__InputArrayX_const__OutputArrayX_double_double(_op.as_raw__InputArray(), _dst.as_raw__OutputArray(), alpha_derive, alpha_mean) }.into_result()
}
...
pub fn ni_black_threshold(_src: &dyn core::ToInputArray, _dst: &mut dyn core::ToOutputArray, max_value: f64, typ: i32, block_size: i32, delta: f64) -> Result<()> {
	...
	output_array_arg!(_dst);
	unsafe { sys::cv_ximgproc_niBlackThreshold_const__InputArrayX_const__OutputArrayX_double_int_int_double(_src.as_raw__InputArray(), _dst.as_raw__OutputArray(), max_value, typ, block_size, delta) }.into_result()
}
...
pub fn weighted_median_filter(joint: &dyn core::ToInputArray, src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, r: i32, sigma: f64, weight_type: crate::ximgproc::WMFWeightType, mut mask: core::Mat) -> Result<()> {
	...
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_ximgproc_weightedMedianFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_double_WMFWeightType_Mat(joint.as_raw__InputArray(), src.as_raw__InputArray(), dst.as_raw__OutputArray(), r, sigma, weight_type, mask.as_raw_mut_Mat()) }.into_result()
}
...
pub trait StructuredEdgeDetection: core::AlgorithmTrait {
	...
	fn detect_edges(&self, src: &core::Mat, dst: &mut core::Mat) -> Result<()> {
		unsafe { sys::cv_ximgproc_StructuredEdgeDetection_detectEdges_const_const_MatX_MatX(self.as_raw_StructuredEdgeDetection(), src.as_raw_Mat(), dst.as_raw_mut_Mat()) }.into_result()
	}
