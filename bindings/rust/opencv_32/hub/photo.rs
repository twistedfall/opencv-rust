...
pub trait TonemapDurand: crate::photo::Tonemap {
	...
	fn set_saturation(&mut self, saturation: f32) -> Result<()> {
		unsafe { sys::cv_TonemapDurand_setSaturation_float(self.as_raw_mut_TonemapDurand(), saturation) }.into_result()
	}
	...
	fn set_contrast(&mut self, contrast: f32) -> Result<()> {
		unsafe { sys::cv_TonemapDurand_setContrast_float(self.as_raw_mut_TonemapDurand(), contrast) }.into_result()
	}
	...
	fn set_sigma_space(&mut self, sigma_space: f32) -> Result<()> {
		unsafe { sys::cv_TonemapDurand_setSigmaSpace_float(self.as_raw_mut_TonemapDurand(), sigma_space) }.into_result()
	}
	...
	fn set_sigma_color(&mut self, sigma_color: f32) -> Result<()> {
		unsafe { sys::cv_TonemapDurand_setSigmaColor_float(self.as_raw_mut_TonemapDurand(), sigma_color) }.into_result()
	}
