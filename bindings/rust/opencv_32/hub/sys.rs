...
mod aruco_sys {
	...
	extern "C" {
		...
		pub fn cv_aruco_detectMarkers_const__InputArrayX_const_Ptr_Dictionary_X_const__OutputArrayX_const__OutputArrayX_const_Ptr_DetectorParameters_X_const__OutputArrayX(image: *const c_void, dictionary: *const c_void, corners: *const c_void, ids: *const c_void, parameters: *const c_void, rejected_img_points: *const c_void) -> Result_void;
		...
		pub fn cv_aruco_estimatePoseBoard_const__InputArrayX_const__InputArrayX_const_Ptr_Board_X_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(corners: *const c_void, ids: *const c_void, board: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void) -> Result<i32>;
		pub fn cv_aruco_estimatePoseCharucoBoard_const__InputArrayX_const__InputArrayX_const_Ptr_CharucoBoard_X_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(charuco_corners: *const c_void, charuco_ids: *const c_void, board: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void) -> Result<bool>;
		pub fn cv_aruco_estimatePoseSingleMarkers_const__InputArrayX_float_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(corners: *const c_void, marker_length: f32, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvecs: *const c_void, tvecs: *const c_void) -> Result_void;
		pub fn cv_aruco_generateCustomDictionary_int_int(n_markers: i32, marker_size: i32) -> Result<*mut c_void>;
		pub fn cv_aruco_generateCustomDictionary_int_int_const_Ptr_Dictionary_X(n_markers: i32, marker_size: i32, base_dictionary: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_aruco_Board_getPropIds(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_aruco_CharucoBoard_getPropChessboardCorners(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_aruco_CharucoBoard_setPropChessboardCorners_vector_Point3f_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_aruco_CharucoBoard_getPropNearestMarkerIdx(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_aruco_CharucoBoard_setPropNearestMarkerIdx_vector_vector_int__(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_aruco_CharucoBoard_getPropNearestMarkerCorners(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_aruco_DetectorParameters_getPropDoCornerRefinement_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_aruco_DetectorParameters_setPropDoCornerRefinement_bool(instance: *mut c_void, val: bool) -> Result_void;
		...
		pub fn cv_aruco_Dictionary_getPropBytesList(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_aruco_Dictionary_create_int_int(n_markers: i32, marker_size: i32) -> Result<*mut c_void>;
		pub fn cv_aruco_Dictionary_create_int_int_const_Ptr_Dictionary_X(n_markers: i32, marker_size: i32, base_dictionary: *const c_void) -> Result<*mut c_void>;
		pub fn cv_aruco_Dictionary_get_int(dict: i32) -> Result<*mut c_void>;
		pub fn cv_aruco_Dictionary_identify_const_const_MatX_intR_intR_double(instance: *const c_void, only_bits: *const c_void, idx: *mut i32, rotation: *mut i32, max_correction_rate: f64) -> Result<bool>;
...
mod bioinspired_sys {
	...
	extern "C" {
		pub fn cv_bioinspired_createRetinaFastToneMapping_Size(input_size: *const core::Size) -> Result<*mut c_void>;
		pub fn cv_bioinspired_createRetina_OCL_Size(input_size: *const core::Size) -> Result<*mut c_void>;
		pub fn cv_bioinspired_createRetina_OCL_Size_bool_int_bool_float_float(input_size: *const core::Size, color_mode: bool, color_sampling_method: i32, use_retina_log_sampling: bool, reduction_factor: f32, sampling_strenght: f32) -> Result<*mut c_void>;
		pub fn cv_bioinspired_createRetina_Size(input_size: *const core::Size) -> Result<*mut c_void>;
		pub fn cv_bioinspired_createRetina_Size_bool_int_bool_float_float(input_size: *const core::Size, color_mode: bool, color_sampling_method: i32, use_retina_log_sampling: bool, reduction_factor: f32, sampling_strenght: f32) -> Result<*mut c_void>;
		pub fn cv_bioinspired_createTransientAreasSegmentationModule_Size(input_size: *const core::Size) -> Result<*mut c_void>;
...
mod calib3d_sys {
	...
	extern "C" {
		...
		pub fn cv_findFundamentalMat_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_double_double(points1: *const c_void, points2: *const c_void, mask: *const c_void, method: i32, param1: f64, param2: f64) -> Result<*mut c_void>;
		pub fn cv_findFundamentalMat_const__InputArrayX_const__InputArrayX_int_double_double_const__OutputArrayX(points1: *const c_void, points2: *const c_void, method: i32, param1: f64, param2: f64, mask: *const c_void) -> Result<*mut c_void>;
...
mod ccalib_sys {
	...
	extern "C" {
		...
		pub fn cv_ccalib_CustomPattern_getPatternPoints_const__OutputArrayX(instance: *mut c_void, original_points: *const c_void) -> Result_void;
		...
		pub fn cv_ccalib_CustomPattern_findRt_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX_bool_int(instance: *mut c_void, object_points: *const c_void, image_points: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, flags: i32) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_findRt_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX_bool_int(instance: *mut c_void, image: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, flags: i32) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_findRtRANSAC_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX_bool_int_float_int_const__OutputArrayX_int(instance: *mut c_void, object_points: *const c_void, image_points: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, iterations_count: i32, reprojection_error: f32, min_inliers_count: i32, inliers: *const c_void, flags: i32) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_findRtRANSAC_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX_bool_int_float_int_const__OutputArrayX_int(instance: *mut c_void, image: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, iterations_count: i32, reprojection_error: f32, min_inliers_count: i32, inliers: *const c_void, flags: i32) -> Result<bool>;
		...
		pub fn cv_multicalib_MultiCameraCalibration_edge_getPropTransform(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_multicalib_MultiCameraCalibration_vertex_getPropPose(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_randpattern_RandomPatternCornerFinder_loadPattern_Mat(instance: *mut c_void, pattern_image: *mut c_void) -> Result_void;
...
mod core_sys {
	...
	extern "C" {
		...
		pub fn cv_PSNR_const__InputArrayX_const__InputArrayX(src1: *const c_void, src2: *const c_void) -> Result<f64>;
		...
		pub fn cv_completeSymm_const__InputOutputArrayX_bool(mtx: *const c_void, lower_to_upper: bool) -> Result_void;
		...
		pub fn cv_errorNoReturn_int_const_StringX_const_charX_const_charX_int(_code: i32, _err: *const c_char, _func: *const c_char, _file: *const c_char, _line: i32) -> Result_void;
		...
		pub fn cv_extractImageCOI_const_CvArrX_const__OutputArrayX_int(arr: *const c_void, coiimg: *const c_void, coi: i32) -> Result_void;
		...
		pub fn cv_insertImageCOI_const__InputArrayX_CvArrX_int(coiimg: *const c_void, arr: *mut c_void, coi: i32) -> Result_void;
		...
		pub fn cv_ipp_getIppFeatures() -> Result<i32>;
		...
		pub fn cv_read_const_FileNodeX_doubleR_double(node: *const c_void, value: *mut f64, default_value: f64) -> Result_void;
		pub fn cv_read_const_FileNodeX_floatR_float(node: *const c_void, value: *mut f32, default_value: f32) -> Result_void;
		pub fn cv_read_const_FileNodeX_intR_int(node: *const c_void, value: *mut i32, default_value: i32) -> Result_void;
		...
		pub fn cv_solveLP_const_MatX_const_MatX_MatX(func: *const c_void, constr: *const c_void, z: *mut c_void) -> Result<i32>;
		...
		pub fn cv_AutoLock_AutoLock_MutexX(m: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_FileNode_operator_cv_String_const(instance: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_FileNode_readRaw_const_const_StringX_unsigned_charX_size_t(instance: *const c_void, fmt: *const c_char, vec: *mut u8, len: size_t) -> Result_void;
		pub fn cv_FileNode_readObj_const(instance: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_FileNodeIterator_getPropReader(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_FileNodeIterator_setPropReader_SeqReader(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_FileNodeIterator_getPropRemaining_const(instance: *const c_void) -> Result<size_t>;
		pub fn cv_FileNodeIterator_setPropRemaining_size_t(instance: *mut c_void, val: size_t) -> Result_void;
		...
		pub fn cv_FileNodeIterator_readRaw_const_StringX_unsigned_charX_size_t(instance: *mut c_void, fmt: *const c_char, vec: *mut u8, max_count: size_t) -> Result<*mut c_void>;
		pub fn cv_FileNodeIterator_SeqReader_getPropHeader_size_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_FileNodeIterator_SeqReader_setPropHeader_size_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_FileNodeIterator_SeqReader_getPropSeq(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_FileNodeIterator_SeqReader_setPropSeq_voidX(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_FileNodeIterator_SeqReader_getPropBlock(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_FileNodeIterator_SeqReader_setPropBlock_voidX(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_FileNodeIterator_SeqReader_getPropPtr(instance: *mut c_void) -> Result<*mut i8>;
		pub fn cv_FileNodeIterator_SeqReader_setPropPtr_signed_charX(instance: *mut c_void, val: *mut i8) -> Result_void;
		pub fn cv_FileNodeIterator_SeqReader_getPropBlock_min(instance: *mut c_void) -> Result<*mut i8>;
		pub fn cv_FileNodeIterator_SeqReader_setPropBlock_min_signed_charX(instance: *mut c_void, val: *mut i8) -> Result_void;
		pub fn cv_FileNodeIterator_SeqReader_getPropBlock_max(instance: *mut c_void) -> Result<*mut i8>;
		pub fn cv_FileNodeIterator_SeqReader_setPropBlock_max_signed_charX(instance: *mut c_void, val: *mut i8) -> Result_void;
		pub fn cv_FileNodeIterator_SeqReader_getPropDelta_index_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_FileNodeIterator_SeqReader_setPropDelta_index_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_FileNodeIterator_SeqReader_getPropPrev_elem(instance: *mut c_void) -> Result<*mut i8>;
		pub fn cv_FileNodeIterator_SeqReader_setPropPrev_elem_signed_charX(instance: *mut c_void, val: *mut i8) -> Result_void;
		...
		pub fn cv_FileStorage_getPropStructs(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_FileStorage_setPropStructs_vector_char_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		...
		pub fn cv_FileStorage_FileStorage_const_StringX_int_const_StringX(source: *const c_char, flags: i32, encoding: *const c_char) -> Result<*mut c_void>;
		...
		pub fn cv_FileStorage_writeRaw_const_StringX_const_unsigned_charX_size_t(instance: *mut c_void, fmt: *const c_char, vec: *const u8, len: size_t) -> Result_void;
		pub fn cv_FileStorage_writeObj_const_StringX_const_voidX(instance: *mut c_void, name: *const c_char, obj: *const c_void) -> Result_void;
		...
		pub fn cv_FileStorage_write_const_StringX_const__InputArrayX(instance: *mut c_void, name: *const c_char, val: *const c_void) -> Result_void;
		...
		pub fn cv_Formatter_get_int(fmt: i32) -> Result<*mut c_void>;
		...
		pub fn cv_Mat_getUMat_const_int_UMatUsageFlags(instance: *const c_void, access_flags: i32, usage_flags: core::UMatUsageFlags) -> Result<*mut c_void>;
		...
		pub fn cv_Mutex_Mutex() -> Result<*mut c_void>;
		pub fn cv_Mutex_Mutex_const_MutexX(m: *const c_void) -> Result<*mut c_void>;
		pub fn cv_Mutex_lock(instance: *mut c_void) -> Result_void;
		pub fn cv_Mutex_trylock(instance: *mut c_void) -> Result<bool>;
		pub fn cv_Mutex_unlock(instance: *mut c_void) -> Result_void;
		...
		pub fn cv_TLSDataContainer_setPropKey__int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TLSDataContainer_getData_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TLSDataContainer_createDataInstance_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TLSDataContainer_deleteDataInstance_const_voidX(instance: *const c_void, p_data: *mut c_void) -> Result_void;
		...
		pub fn cv_UMat_getMat_const_int(instance: *const c_void, flags: i32) -> Result<*mut c_void>;
		...
		pub fn cv_UMat_handle_const_int(instance: *const c_void, access_flags: i32) -> Result<*mut c_void>;
		...
		pub fn cv_UMatData_getPropFlags_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_UMatData_setPropFlags_int(instance: *mut c_void, val: i32) -> Result_void;
		...
		pub fn cv_UMatDataAutoLock_getPropU(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_UMatDataAutoLock_setPropU_UMatDataX(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_UMatDataAutoLock_UMatDataAutoLock_UMatDataX(u: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv__InputArray_kind_const(instance: *const c_void) -> Result<i32>;
		...
		pub fn cv__InputOutputArray__InputOutputArray_vector_bool_X(vec: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv__OutputArray__OutputArray_vector_bool_X(vec: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv__OutputArray_create_const_Size_int_int_bool_int(instance: *const c_void, sz: *const core::Size, typ: i32, i: i32, allow_transposed: bool, fixed_depth_mask: i32) -> Result_void;
		pub fn cv__OutputArray_create_const_int_int_int_int_bool_int(instance: *const c_void, rows: i32, cols: i32, typ: i32, i: i32, allow_transposed: bool, fixed_depth_mask: i32) -> Result_void;
		pub fn cv__OutputArray_create_const_int_const_intX_int_int_bool_int(instance: *const c_void, dims: i32, size: *const i32, typ: i32, i: i32, allow_transposed: bool, fixed_depth_mask: i32) -> Result_void;
		...
		pub fn cv_ocl_KernelArg_Local() -> Result<*mut c_void>;
		...
		pub fn cv_ocl_Program_Program_const_StringX(buf: *const c_char) -> Result<*mut c_void>;
...
mod dnn_sys {
	...
	extern "C" {
		pub fn cv_dnn_createCaffeImporter_const_StringX_const_StringX(prototxt: *const c_char, caffe_model: *const c_char) -> Result<*mut c_void>;
		pub fn cv_dnn_createTensorflowImporter_const_StringX(model: *const c_char) -> Result<*mut c_void>;
		pub fn cv_dnn_createTorchImporter_const_StringX_bool(filename: *const c_char, is_binary: bool) -> Result<*mut c_void>;
		pub fn cv_dnn_initModule() -> Result_void;
		...
		pub fn cv_dnn_AbsLayer_create() -> Result<*mut c_void>;
		pub fn cv_dnn_BNLLLayer_create() -> Result<*mut c_void>;
		...
		pub fn cv_dnn_Blob_Blob() -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_Blob_const_BlobShapeX_int_int(shape: *const c_void, typ: i32, alloc_flags: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_Blob_const__InputArrayX(data: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_fromImages_const__InputArrayX_int(image: *const c_void, dst_cn: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_batchFromImages_const__InputArrayX_int(instance: *mut c_void, image: *const c_void, dst_cn: i32) -> Result_void;
		pub fn cv_dnn_Blob_create_const_BlobShapeX_int_int(instance: *mut c_void, shape: *const c_void, typ: i32, alloc_flags: i32) -> Result_void;
		pub fn cv_dnn_Blob_fill_const__InputArrayX(instance: *mut c_void, in_: *const c_void) -> Result_void;
		pub fn cv_dnn_Blob_fill_const_BlobShapeX_int_voidX_bool(instance: *mut c_void, shape: *const c_void, typ: i32, data: *mut c_void, deep_copy: bool) -> Result_void;
		pub fn cv_dnn_Blob_setTo_const__InputArrayX_int(instance: *mut c_void, value: *const c_void, alloc_flags: i32) -> Result_void;
		pub fn cv_dnn_Blob_matRef_bool(instance: *mut c_void, write_only: bool) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_matRefConst_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_umatRef_bool(instance: *mut c_void, write_only: bool) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_umatRefConst_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_updateMat_const_bool(instance: *const c_void, sync_data: bool) -> Result_void;
		pub fn cv_dnn_Blob_updateUMat_const_bool(instance: *const c_void, sync_data: bool) -> Result_void;
		pub fn cv_dnn_Blob_sync_const(instance: *const c_void) -> Result_void;
		pub fn cv_dnn_Blob_dims_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_Blob_size_const_int(instance: *const c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_Blob_xsize_const_int(instance: *const c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_Blob_total_const_int_int(instance: *const c_void, start_axis: i32, end_axis: i32) -> Result<size_t>;
		pub fn cv_dnn_Blob_canonicalAxis_const_int(instance: *const c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_Blob_shape_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_equalShape_const_const_BlobX(instance: *const c_void, other: *const c_void) -> Result<bool>;
		pub fn cv_dnn_Blob_getPlane_int_int(instance: *mut c_void, n: i32, cn: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_getPlanes_int(instance: *mut c_void, n: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_cols_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_Blob_rows_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_Blob_channels_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_Blob_num_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_Blob_size2_const(instance: *const c_void) -> Result<core::Size>;
		pub fn cv_dnn_Blob_shape4_const(instance: *const c_void) -> Result<core::Vec4i>;
		pub fn cv_dnn_Blob_offset_const_int_int_int_int(instance: *const c_void, n: i32, cn: i32, row: i32, col: i32) -> Result<size_t>;
		pub fn cv_dnn_Blob_ptr_int_int_int_int(instance: *mut c_void, n: i32, cn: i32, row: i32, col: i32) -> Result<*mut u8>;
		pub fn cv_dnn_Blob_ptrf_int_int_int_int(instance: *mut c_void, n: i32, cn: i32, row: i32, col: i32) -> Result<*mut f32>;
		pub fn cv_dnn_Blob_shareFrom_const_BlobX(instance: *mut c_void, blob: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_reshape_const_BlobShapeX(instance: *mut c_void, shape: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_reshaped_const_const_BlobShapeX(instance: *const c_void, new_shape: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_type_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_Blob_elemSize_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_Blob_getState_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_BlobShape_BlobShape() -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_BlobShape_int(s0: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_BlobShape_int_int(s0: i32, s1: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_BlobShape_int_int_int(s0: i32, s1: i32, s2: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_BlobShape_int_int_int_int(num: i32, cn: i32, rows: i32, cols: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_BlobShape_int_const_intX(ndims: i32, sizes: *const i32) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_BlobShape_const_vector_int_X(sizes: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_all_int_int(ndims: i32, fill: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_dims_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_BlobShape_size_int(instance: *mut c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_BlobShape_size_const_int(instance: *const c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_BlobShape_operator___const_int(instance: *const c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_BlobShape_operator___int(instance: *mut c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_BlobShape_xsize_const_int(instance: *const c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_BlobShape_canonicalAxis_const_int(instance: *const c_void, axis: i32) -> Result<i32>;
		pub fn cv_dnn_BlobShape_total_const(instance: *const c_void) -> Result<ptrdiff_t>;
		pub fn cv_dnn_BlobShape_total_const_int_int(instance: *const c_void, start_axis: i32, end_axis: i32) -> Result<ptrdiff_t>;
		pub fn cv_dnn_BlobShape_slice_const_int_int(instance: *const c_void, start_axis: i32, end_axis: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_ptr_const(instance: *const c_void) -> Result<*const i32>;
		pub fn cv_dnn_BlobShape_ptr(instance: *mut c_void) -> Result<*mut i32>;
		pub fn cv_dnn_BlobShape_equal_const_const_BlobShapeX(instance: *const c_void, other: *const c_void) -> Result<bool>;
		pub fn cv_dnn_BlobShape_operatorA_const_const_BlobShapeX(instance: *const c_void, r: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_like_const_MatX(m: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_like_const_UMatX(m: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_empty() -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_isEmpty_const(instance: *const c_void) -> Result<bool>;
		...
		pub fn cv_dnn_ConcatLayer_create_int(axis: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_ConvolutionLayer_create_Size_Size_Size_Size(kernel: *const core::Size, stride: *const core::Size, pad: *const core::Size, dilation: *const core::Size) -> Result<*mut c_void>;
		pub fn cv_dnn_CropLayer_getPropStartAxis_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dnn_CropLayer_setPropStartAxis_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_dnn_CropLayer_getPropOffset(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_CropLayer_setPropOffset_vector_int_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_dnn_CropLayer_create_int_const_vector_int_X(start_axis: i32, offset: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_DeconvolutionLayer_create_Size_Size_Size_Size(kernel: *const core::Size, stride: *const core::Size, pad: *const core::Size, dilation: *const core::Size) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_Dict_set_double_const_StringX_const_doubleR(instance: *mut c_void, key: *const c_char, value: *const f64) -> Result<f64>;
		pub fn cv_dnn_Dict_set_int64_t_const_StringX_const_int64_tR(instance: *mut c_void, key: *const c_char, value: *const i64) -> Result<i64>;
		...
		pub fn cv_dnn_EltwiseLayer_create_EltwiseOp_const_vector_int_X(op: crate::dnn::EltwiseLayer_EltwiseOp, coeffs: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Importer_populateNet_Net(instance: *mut c_void, net: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_InnerProductLayer_create_int(axis: i32) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_LRNLayer_getPropAlpha_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_LRNLayer_setPropAlpha_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_dnn_LRNLayer_getPropBeta_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_LRNLayer_setPropBeta_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_dnn_LRNLayer_getPropBias_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_LRNLayer_setPropBias_double(instance: *mut c_void, val: f64) -> Result_void;
		...
		pub fn cv_dnn_LRNLayer_create_int_int_double_double_double_bool(typ: i32, size: i32, alpha: f64, beta: f64, bias: f64, norm_by_size: bool) -> Result<*mut c_void>;
		pub fn cv_dnn_LSTMLayer_create() -> Result<*mut c_void>;
		pub fn cv_dnn_LSTMLayer_setWeights_const_BlobX_const_BlobX_const_BlobX(instance: *mut c_void, wh: *const c_void, wx: *const c_void, b: *const c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_setOutShape_const_BlobShapeX(instance: *mut c_void, out_tail_shape: *const c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_setH_const_BlobX(instance: *mut c_void, h: *const c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_getH_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_LSTMLayer_setC_const_BlobX(instance: *mut c_void, c: *const c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_getC_const(instance: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_LSTMLayer_forward_vector_BlobX_X_vector_Blob_X(instance: *mut c_void, input: *mut c_void, output: *mut c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_inputNameToIndex_String(instance: *mut c_void, input_name: *mut c_char) -> Result<i32>;
		pub fn cv_dnn_LSTMLayer_outputNameToIndex_String(instance: *mut c_void, output_name: *mut c_char) -> Result<i32>;
		pub fn cv_dnn_Layer_getPropBlobs(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Layer_setPropBlobs_vector_Blob_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_Layer_allocate_const_vector_BlobX_X_vector_Blob_X(instance: *mut c_void, input: *const c_void, output: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_forward_vector_BlobX_X_vector_Blob_X(instance: *mut c_void, input: *mut c_void, output: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_allocate_const_vector_Blob_X_vector_Blob_X(instance: *mut c_void, inputs: *const c_void, outputs: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_allocate_const_vector_Blob_X(instance: *mut c_void, inputs: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Layer_forward_const_vector_Blob_X_vector_Blob_X(instance: *mut c_void, inputs: *const c_void, outputs: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_run_const_vector_Blob_X_vector_Blob_X(instance: *mut c_void, inputs: *const c_void, outputs: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_LayerParams_setPropBlobs_vector_Blob_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_MVNLayer_getPropEps_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_MVNLayer_setPropEps_double(instance: *mut c_void, val: f64) -> Result_void;
		...
		pub fn cv_dnn_MVNLayer_create_bool_bool_double(norm_variance: bool, across_channels: bool, eps: f64) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_Net_deleteLayer_LayerId(instance: *mut c_void, layer: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_Net_setNetInputs_const_vector_String_X(instance: *mut c_void, input_blob_names: *const c_void) -> Result_void;
		pub fn cv_dnn_Net_allocate(instance: *mut c_void) -> Result_void;
		pub fn cv_dnn_Net_forward_LayerId(instance: *mut c_void, to_layer: *mut c_void) -> Result_void;
		pub fn cv_dnn_Net_forward_LayerId_LayerId(instance: *mut c_void, start_layer: *mut c_void, to_layer: *mut c_void) -> Result_void;
		pub fn cv_dnn_Net_forward_const_vector_LayerId_X_const_vector_LayerId_X(instance: *mut c_void, start_layers: *const c_void, to_layers: *const c_void) -> Result_void;
		pub fn cv_dnn_Net_forwardOpt_LayerId(instance: *mut c_void, to_layer: *mut c_void) -> Result_void;
		pub fn cv_dnn_Net_forwardOpt_const_vector_LayerId_X(instance: *mut c_void, to_layers: *const c_void) -> Result_void;
		pub fn cv_dnn_Net_setBlob_String_const_BlobX(instance: *mut c_void, output_name: *mut c_char, blob: *const c_void) -> Result_void;
		pub fn cv_dnn_Net_getBlob_String(instance: *mut c_void, output_name: *mut c_char) -> Result<*mut c_void>;
		pub fn cv_dnn_Net_setParam_LayerId_int_const_BlobX(instance: *mut c_void, layer: *mut c_void, num_param: i32, blob: *const c_void) -> Result_void;
		...
		pub fn cv_dnn_PoolingLayer_create_int_Size_Size_Size_const_StringX(typ: i32, kernel: *const core::Size, stride: *const core::Size, pad: *const core::Size, pad_mode: *const c_char) -> Result<*mut c_void>;
		pub fn cv_dnn_PoolingLayer_createGlobal_int(typ: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_PowerLayer_getPropPower_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_PowerLayer_setPropPower_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_dnn_PowerLayer_getPropScale_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_PowerLayer_setPropScale_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_dnn_PowerLayer_getPropShift_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_PowerLayer_setPropShift_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_dnn_PowerLayer_create_double_double_double(power: f64, scale: f64, shift: f64) -> Result<*mut c_void>;
		pub fn cv_dnn_RNNLayer_create() -> Result<*mut c_void>;
		pub fn cv_dnn_RNNLayer_setWeights_const_BlobX_const_BlobX_const_BlobX_const_BlobX_const_BlobX(instance: *mut c_void, wxh: *const c_void, bh: *const c_void, whh: *const c_void, who: *const c_void, bo: *const c_void) -> Result_void;
		pub fn cv_dnn_RNNLayer_setProduceHiddenOutput_bool(instance: *mut c_void, produce: bool) -> Result_void;
		pub fn cv_dnn_RNNLayer_forward_vector_BlobX_X_vector_Blob_X(instance: *mut c_void, input: *mut c_void, output: *mut c_void) -> Result_void;
		pub fn cv_dnn_ReLULayer_getPropNegativeSlope_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_dnn_ReLULayer_setPropNegativeSlope_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_dnn_ReLULayer_create_double(negative_slope: f64) -> Result<*mut c_void>;
		pub fn cv_dnn_ReshapeLayer_getPropNewShapeDesc(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_ReshapeLayer_setPropNewShapeDesc_BlobShape(instance: *mut c_void, val: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_ReshapeLayer_create_const_BlobShapeX_Range_bool(new_shape: *const c_void, applying_range: *mut c_void, enable_reordering: bool) -> Result<*mut c_void>;
		pub fn cv_dnn_SigmoidLayer_create() -> Result<*mut c_void>;
		...
		pub fn cv_dnn_SliceLayer_getPropSliceIndices(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_SliceLayer_setPropSliceIndices_vector_int_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_dnn_SliceLayer_create_int(axis: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_SliceLayer_create_int_const_vector_int_X(axis: i32, slice_indices: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_SoftmaxLayer_create_int(axis: i32) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_SplitLayer_create_int(outputs_count: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_TanHLayer_create() -> Result<*mut c_void>;
		pub fn cv_dnn__Range__Range_const_RangeX(r: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn__Range__Range_int_int(start: i32, size: i32) -> Result<*mut c_void>;
	}
}
#[cfg(feature = "contrib")]
pub use dnn_sys::*;
...
mod face_sys {
	...
	extern "C" {
		pub fn cv_face_createBIF_int_int(num_bands: i32, num_rotations: i32) -> Result<*mut c_void>;
		pub fn cv_face_createEigenFaceRecognizer_int_double(num_components: i32, threshold: f64) -> Result<*mut c_void>;
		pub fn cv_face_createFisherFaceRecognizer_int_double(num_components: i32, threshold: f64) -> Result<*mut c_void>;
		pub fn cv_face_createLBPHFaceRecognizer_int_int_int_int_double(radius: i32, neighbors: i32, grid_x: i32, grid_y: i32, threshold: f64) -> Result<*mut c_void>;
		...
		pub fn cv_face_FaceRecognizer_predict_const_const__InputArrayX_intR_doubleR(instance: *const c_void, src: *const c_void, label: *mut i32, confidence: *mut f64) -> Result_void;
		...
		pub fn cv_face_FaceRecognizer_save_const_const_StringX(instance: *const c_void, filename: *const c_char) -> Result_void;
		pub fn cv_face_FaceRecognizer_load_const_StringX(instance: *mut c_void, filename: *const c_char) -> Result_void;
		pub fn cv_face_FaceRecognizer_save_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_face_FaceRecognizer_load_const_FileStorageX(instance: *mut c_void, fs: *const c_void) -> Result_void;
...
mod features2d_sys {
	...
	extern "C" {
		...
		pub fn cv_AGAST_const__InputArrayX_vector_KeyPoint_X_int_bool_int(image: *const c_void, keypoints: *mut c_void, threshold: i32, nonmax_suppression: bool, typ: i32) -> Result_void;
		...
		pub fn cv_FAST_const__InputArrayX_vector_KeyPoint_X_int_bool_int(image: *const c_void, keypoints: *mut c_void, threshold: i32, nonmax_suppression: bool, typ: i32) -> Result_void;
		...
		pub fn cv_drawKeypoints_const__InputArrayX_const_vector_KeyPoint_X_const__InputOutputArrayX_const_ScalarX_int(image: *const c_void, keypoints: *const c_void, out_image: *const c_void, color: *const core::Scalar, flags: i32) -> Result_void;
		pub fn cv_drawMatches_const__InputArrayX_const_vector_KeyPoint_X_const__InputArrayX_const_vector_KeyPoint_X_const_vector_DMatch_X_const__InputOutputArrayX_const_ScalarX_const_ScalarX_const_vector_char_X_int(img1: *const c_void, keypoints1: *const c_void, img2: *const c_void, keypoints2: *const c_void, matches1to2: *const c_void, out_img: *const c_void, match_color: *const core::Scalar, single_point_color: *const core::Scalar, matches_mask: *const c_void, flags: i32) -> Result_void;
		pub fn cv_drawMatches_const__InputArrayX_const_vector_KeyPoint_X_const__InputArrayX_const_vector_KeyPoint_X_const_vector_vector_DMatch__X_const__InputOutputArrayX_const_ScalarX_const_ScalarX_const_vector_vector_char__X_int(img1: *const c_void, keypoints1: *const c_void, img2: *const c_void, keypoints2: *const c_void, matches1to2: *const c_void, out_img: *const c_void, match_color: *const core::Scalar, single_point_color: *const core::Scalar, matches_mask: *const c_void, flags: i32) -> Result_void;
		pub fn cv_evaluateFeatureDetector_const_MatX_const_MatX_const_MatX_vector_KeyPoint_X_vector_KeyPoint_X_floatR_intR_const_Ptr_Feature2D_X(img1: *const c_void, img2: *const c_void, h1to2: *const c_void, keypoints1: *mut c_void, keypoints2: *mut c_void, repeatability: *mut f32, corresp_count: *mut i32, fdetector: *const c_void) -> Result_void;
		...
		pub fn cv_AKAZE_create_int_int_int_float_int_int_int(descriptor_type: i32, descriptor_size: i32, descriptor_channels: i32, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: i32) -> Result<*mut c_void>;
		pub fn cv_AKAZE_setDescriptorType_int(instance: *mut c_void, dtype: i32) -> Result_void;
		pub fn cv_AKAZE_getDescriptorType_const(instance: *const c_void) -> Result<i32>;
		...
		pub fn cv_AgastFeatureDetector_setType_int(instance: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_AgastFeatureDetector_getType_const(instance: *const c_void) -> Result<i32>;
		...
		pub fn cv_DescriptorMatcher_create_int(matcher_type: i32) -> Result<*mut c_void>;
		pub fn cv_FastFeatureDetector_create_int_bool_int(threshold: i32, nonmax_suppression: bool, typ: i32) -> Result<*mut c_void>;
		...
		pub fn cv_FastFeatureDetector_setType_int(instance: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_FastFeatureDetector_getType_const(instance: *const c_void) -> Result<i32>;
		...
		pub fn cv_KAZE_create_bool_bool_float_int_int_int(extended: bool, upright: bool, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: i32) -> Result<*mut c_void>;
		...
		pub fn cv_KAZE_setDiffusivity_int(instance: *mut c_void, diff: i32) -> Result_void;
		pub fn cv_KAZE_getDiffusivity_const(instance: *const c_void) -> Result<i32>;
		...
		pub fn cv_ORB_create_int_float_int_int_int_int_int_int_int(nfeatures: i32, scale_factor: f32, nlevels: i32, edge_threshold: i32, first_level: i32, wta_k: i32, score_type: i32, patch_size: i32, fast_threshold: i32) -> Result<*mut c_void>;
		...
		pub fn cv_ORB_setScoreType_int(instance: *mut c_void, score_type: i32) -> Result_void;
		pub fn cv_ORB_getScoreType_const(instance: *const c_void) -> Result<i32>;
...
mod flann_sys {
	...
	extern "C" {
		...
		pub fn cv_flann_IndexParams_getAll_const_vector_String_X_vector_int_X_vector_String_X_vector_double_X(instance: *const c_void, names: *mut c_void, types: *mut c_void, str_values: *mut c_void, num_values: *mut c_void) -> Result_void;
...
mod fuzzy_sys {
	...
	extern "C" {
		pub fn cv_ft_FT02D_components_const__InputArrayX_const__InputArrayX_const__OutputArrayX(matrix: *const c_void, kernel: *const c_void, components: *const c_void) -> Result_void;
		...
		pub fn cv_ft_FT02D_process_const__InputArrayX_const__InputArrayX_const__OutputArrayX(matrix: *const c_void, kernel: *const c_void, output: *const c_void) -> Result_void;
...
mod hdf_sys {
	...
	extern "C" {
		pub fn cv_hdf_open_String(hdf5_filename: *mut c_char) -> Result<*mut c_void>;
		pub fn cv_hdf_HDF5_close(instance: *mut c_void) -> Result_void;
		pub fn cv_hdf_HDF5_grcreate_String(instance: *mut c_void, grlabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_hlexists_const_String(instance: *const c_void, label: *mut c_char) -> Result<bool>;
		pub fn cv_hdf_HDF5_dscreate_const_int_int_int_String(instance: *const c_void, rows: i32, cols: i32, typ: i32, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dscreate_const_int_int_int_String_int(instance: *const c_void, rows: i32, cols: i32, typ: i32, dslabel: *mut c_char, compresslevel: i32) -> Result_void;
		pub fn cv_hdf_HDF5_dscreate_const_int_int_int_String_int_const_vector_int_X(instance: *const c_void, rows: i32, cols: i32, typ: i32, dslabel: *mut c_char, compresslevel: i32, dims_chunks: *const c_void) -> Result_void;
		pub fn cv_hdf_HDF5_dscreate_const_int_int_int_String_int_const_intX(instance: *const c_void, rows: i32, cols: i32, typ: i32, dslabel: *mut c_char, compresslevel: i32, dims_chunks: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dscreate_const_int_const_intX_int_String(instance: *const c_void, n_dims: i32, sizes: *const i32, typ: i32, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dscreate_const_int_const_intX_int_String_int(instance: *const c_void, n_dims: i32, sizes: *const i32, typ: i32, dslabel: *mut c_char, compresslevel: i32) -> Result_void;
		pub fn cv_hdf_HDF5_dscreate_const_const_vector_int_X_int_String_int_const_vector_int_X(instance: *const c_void, sizes: *const c_void, typ: i32, dslabel: *mut c_char, compresslevel: i32, dims_chunks: *const c_void) -> Result_void;
		pub fn cv_hdf_HDF5_dscreate_const_int_const_intX_int_String_int_const_intX(instance: *const c_void, n_dims: i32, sizes: *const i32, typ: i32, dslabel: *mut c_char, compresslevel: i32, dims_chunks: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsgetsize_const_String_int(instance: *const c_void, dslabel: *mut c_char, dims_flag: i32) -> Result<*mut c_void>;
		pub fn cv_hdf_HDF5_dsgettype_const_String(instance: *const c_void, dslabel: *mut c_char) -> Result<i32>;
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayX_String(instance: *const c_void, array: *const c_void, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayX_String_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayX_String_const_vector_int_X_const_vector_int_X(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const c_void, dims_counts: *const c_void) -> Result_void;
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayX_String_const_intX_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32, dims_counts: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsinsert_const_const__InputArrayX_String(instance: *const c_void, array: *const c_void, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dsinsert_const_const__InputArrayX_String_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32) -> Result_void;
		...
		pub fn cv_hdf_HDF5_dsinsert_const_const__InputArrayX_String_const_intX_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32, dims_counts: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayX_String(instance: *const c_void, array: *const c_void, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayX_String_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayX_String_const_vector_int_X_const_vector_int_X(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const c_void, dims_counts: *const c_void) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayX_String_const_intX_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32, dims_counts: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_kpgetsize_const_String_int(instance: *const c_void, kplabel: *mut c_char, dims_flag: i32) -> Result<i32>;
		pub fn cv_hdf_HDF5_kpcreate_const_int_String_int_int(instance: *const c_void, size: i32, kplabel: *mut c_char, compresslevel: i32, chunks: i32) -> Result_void;
		pub fn cv_hdf_HDF5_kpwrite_const_vector_KeyPoint__String_int_int(instance: *const c_void, keypoints: *const c_void, kplabel: *mut c_char, offset: i32, counts: i32) -> Result_void;
		pub fn cv_hdf_HDF5_kpinsert_const_vector_KeyPoint__String_int_int(instance: *const c_void, keypoints: *const c_void, kplabel: *mut c_char, offset: i32, counts: i32) -> Result_void;
		pub fn cv_hdf_HDF5_kpread_const_vector_KeyPoint_X_String_int_int(instance: *const c_void, keypoints: *mut c_void, kplabel: *mut c_char, offset: i32, counts: i32) -> Result_void;
	}
}
#[cfg(feature = "contrib")]
pub use hdf_sys::*;
...
mod imgproc_sys {
	...
	extern "C" {
		...
		pub fn cv_boundingRect_const__InputArrayX(points: *const c_void) -> Result<core::Rect>;
		...
		pub fn cv_demosaicing_const__InputArrayX_const__OutputArrayX_int_int(_src: *const c_void, _dst: *const c_void, code: i32, dcn: i32) -> Result_void;
		...
		pub fn cv_drawMarker_MatX_Point_const_ScalarX_int_int_int_int(img: *mut c_void, position: *const core::Point, color: *const core::Scalar, marker_type: i32, marker_size: i32, thickness: i32, line_type: i32) -> Result_void;
		...
		pub fn cv_findContours_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_int_int_Point(image: *const c_void, contours: *const c_void, hierarchy: *const c_void, mode: i32, method: i32, offset: *const core::Point) -> Result_void;
		pub fn cv_findContours_const__InputOutputArrayX_const__OutputArrayX_int_int_Point(image: *const c_void, contours: *const c_void, mode: i32, method: i32, offset: *const core::Point) -> Result_void;
		...
		pub fn cv_getPerspectiveTransform_const_Point2fX_const_Point2fX(src: *const core::Point2f, dst: *const core::Point2f) -> Result<*mut c_void>;
		pub fn cv_getPerspectiveTransform_const__InputArrayX_const__InputArrayX(src: *const c_void, dst: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_initWideAngleProjMap_const__InputArrayX_const__InputArrayX_Size_int_int_const__OutputArrayX_const__OutputArrayX_int_double(camera_matrix: *const c_void, dist_coeffs: *const c_void, image_size: *const core::Size, dest_image_width: i32, m1type: i32, map1: *const c_void, map2: *const c_void, proj_type: i32, alpha: f64) -> Result<f32>;
		...
		pub fn cv_minEnclosingCircle_const__InputArrayX_Point2fX_floatR(points: *const c_void, center: *mut core::Point2f, radius: *mut f32) -> Result_void;
		...
		pub fn cv_rectangle_MatX_Rect_const_ScalarX_int_int_int(img: *mut c_void, rec: *const core::Rect, color: *const core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result_void;
		...
		pub fn cv_sqrBoxFilter_const__InputArrayX_const__OutputArrayX_int_Size_Point_bool_int(_src: *const c_void, _dst: *const c_void, ddepth: i32, ksize: *const core::Size, anchor: *const core::Point, normalize: bool, border_type: i32) -> Result_void;
...
mod line_descriptor_sys {
	...
	extern "C" {
		...
		pub fn cv_line_descriptor_KeyLine_getPropAngle_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropAngle_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropClass_id_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_line_descriptor_KeyLine_setPropClass_id_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropOctave_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_line_descriptor_KeyLine_setPropOctave_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropPt_const(instance: *const c_void) -> Result<core::Point2f>;
		pub fn cv_line_descriptor_KeyLine_setPropPt_Point2f(instance: *mut c_void, val: *const core::Point2f) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropResponse_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropResponse_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropSize_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropSize_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropStartPointX_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropStartPointX_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropStartPointY_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropStartPointY_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropEndPointX_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropEndPointX_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropEndPointY_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropEndPointY_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropSPointInOctaveX_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropSPointInOctaveX_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropSPointInOctaveY_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropSPointInOctaveY_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropEPointInOctaveX_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropEPointInOctaveX_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropEPointInOctaveY_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropEPointInOctaveY_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropLineLength_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_line_descriptor_KeyLine_setPropLineLength_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getPropNumOfPixels_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_line_descriptor_KeyLine_setPropNumOfPixels_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_line_descriptor_KeyLine_getStartPoint_const(instance: *const c_void) -> Result<core::Point2f>;
		pub fn cv_line_descriptor_KeyLine_getEndPoint_const(instance: *const c_void) -> Result<core::Point2f>;
		pub fn cv_line_descriptor_KeyLine_getStartPointInOctave_const(instance: *const c_void) -> Result<core::Point2f>;
		pub fn cv_line_descriptor_KeyLine_getEndPointInOctave_const(instance: *const c_void) -> Result<core::Point2f>;
		pub fn cv_line_descriptor_KeyLine_KeyLine() -> Result<*mut c_void>;
...
mod objdetect_sys {
	...
	extern "C" {
		...
		pub fn cv_HOGDescriptor_getPropHistogramNormType_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_HOGDescriptor_setPropHistogramNormType_int(instance: *mut c_void, val: i32) -> Result_void;
		...
		pub fn cv_HOGDescriptor_setSVMDetector_const__InputArrayX(instance: *mut c_void, _svmdetector: *const c_void) -> Result_void;
		...
		pub fn cv_HOGDescriptor_detect_const_const_MatX_vector_Point_X_vector_double_X_double_Size_Size_const_vector_Point_X(instance: *const c_void, img: *const c_void, found_locations: *mut c_void, weights: *mut c_void, hit_threshold: f64, win_stride: *const core::Size, padding: *const core::Size, search_locations: *const c_void) -> Result_void;
		pub fn cv_HOGDescriptor_detect_const_const_MatX_vector_Point_X_double_Size_Size_const_vector_Point_X(instance: *const c_void, img: *const c_void, found_locations: *mut c_void, hit_threshold: f64, win_stride: *const core::Size, padding: *const core::Size, search_locations: *const c_void) -> Result_void;
		...
		pub fn cv_HOGDescriptor_computeGradient_const_const_MatX_MatX_MatX_Size_Size(instance: *const c_void, img: *const c_void, grad: *mut c_void, angle_ofs: *mut c_void, padding_tl: *const core::Size, padding_br: *const core::Size) -> Result_void;
		...
		pub fn cv_HOGDescriptor_detectROI_const_const_MatX_const_vector_Point_X_vector_Point_X_vector_double_X_double_Size_Size(instance: *const c_void, img: *const c_void, locations: *const c_void, found_locations: *mut c_void, confidences: *mut c_void, hit_threshold: f64, win_stride: *const core::Size, padding: *const core::Size) -> Result_void;
		pub fn cv_HOGDescriptor_detectMultiScaleROI_const_const_MatX_vector_Rect_X_vector_DetectionROI_X_double_int(instance: *const c_void, img: *const c_void, found_locations: *mut c_void, locations: *mut c_void, hit_threshold: f64, group_threshold: i32) -> Result_void;
		pub fn cv_HOGDescriptor_readALTModel_String(instance: *mut c_void, modelfile: *mut c_char) -> Result_void;
...
mod optflow_sys {
	...
	extern "C" {
		pub fn cv_motempl_calcGlobalOrientation_const__InputArrayX_const__InputArrayX_const__InputArrayX_double_double(orientation: *const c_void, mask: *const c_void, mhi: *const c_void, timestamp: f64, duration: f64) -> Result<f64>;
		pub fn cv_motempl_calcMotionGradient_const__InputArrayX_const__OutputArrayX_const__OutputArrayX_double_double_int(mhi: *const c_void, mask: *const c_void, orientation: *const c_void, delta1: f64, delta2: f64, aperture_size: i32) -> Result_void;
		pub fn cv_motempl_segmentMotion_const__InputArrayX_const__OutputArrayX_vector_Rect_X_double_double(mhi: *const c_void, segmask: *const c_void, bounding_rects: *mut c_void, timestamp: f64, seg_thresh: f64) -> Result_void;
		pub fn cv_motempl_updateMotionHistory_const__InputArrayX_const__InputOutputArrayX_double_double(silhouette: *const c_void, mhi: *const c_void, timestamp: f64, duration: f64) -> Result_void;
		pub fn cv_optflow_calcOpticalFlowSF_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_int_int(from: *const c_void, to: *const c_void, flow: *const c_void, layers: i32, averaging_block_size: i32, max_flow: i32) -> Result_void;
		pub fn cv_optflow_calcOpticalFlowSF_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_int_int_double_double_int_double_double_double_int_double_double_double(from: *const c_void, to: *const c_void, flow: *const c_void, layers: i32, averaging_block_size: i32, max_flow: i32, sigma_dist: f64, sigma_color: f64, postprocess_window: i32, sigma_dist_fix: f64, sigma_color_fix: f64, occ_thr: f64, upscale_averaging_radius: i32, upscale_sigma_dist: f64, upscale_sigma_color: f64, speed_up_thr: f64) -> Result_void;
		pub fn cv_optflow_calcOpticalFlowSparseToDense_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_int_float_bool_float_float(from: *const c_void, to: *const c_void, flow: *const c_void, grid_step: i32, k: i32, sigma: f32, use_post_proc: bool, fgs_lambda: f32, fgs_sigma: f32) -> Result_void;
		pub fn cv_optflow_createOptFlow_DIS_int(preset: i32) -> Result<*mut c_void>;
		...
		pub fn cv_optflow_createVariationalFlowRefinement() -> Result<*mut c_void>;
		pub fn cv_optflow_readOpticalFlow_const_StringX(path: *const c_char) -> Result<*mut c_void>;
		pub fn cv_optflow_writeOpticalFlow_const_StringX_const__InputArrayX(path: *const c_char, flow: *const c_void) -> Result<bool>;
		pub fn cv_read_const_FileNodeX_NodeX_Node(fn_: *const c_void, node: *mut crate::optflow::GPCTree_Node, unnamed: *const crate::optflow::GPCTree_Node) -> Result_void;
		pub fn cv_write_FileStorageX_const_StringX_const_NodeX(fs: *mut c_void, name: *const c_char, node: *const crate::optflow::GPCTree_Node) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getFinestScale_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_optflow_DISOpticalFlow_setFinestScale_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getPatchSize_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_optflow_DISOpticalFlow_setPatchSize_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getPatchStride_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_optflow_DISOpticalFlow_setPatchStride_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getGradientDescentIterations_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_optflow_DISOpticalFlow_setGradientDescentIterations_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getVariationalRefinementIterations_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_optflow_DISOpticalFlow_setVariationalRefinementIterations_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getVariationalRefinementAlpha_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_optflow_DISOpticalFlow_setVariationalRefinementAlpha_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getVariationalRefinementDelta_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_optflow_DISOpticalFlow_setVariationalRefinementDelta_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getVariationalRefinementGamma_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_optflow_DISOpticalFlow_setVariationalRefinementGamma_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getUseMeanNormalization_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_optflow_DISOpticalFlow_setUseMeanNormalization_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_optflow_DISOpticalFlow_getUseSpatialPropagation_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_optflow_DISOpticalFlow_setUseSpatialPropagation_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_optflow_GPCDetails_getAllDescriptorsForImage_const_MatX_vector_GPCPatchDescriptor_X_const_GPCMatchingParamsX_int(img_ch: *const c_void, descr: *mut c_void, mp: *const crate::optflow::GPCMatchingParams, typ: i32) -> Result_void;
		...
		pub fn cv_optflow_GPCMatchingParams_GPCMatchingParams_const_GPCMatchingParamsX(params: *const crate::optflow::GPCMatchingParams) -> Result<crate::optflow::GPCMatchingParams>;
		...
		pub fn cv_optflow_GPCPatchDescriptor_dot_const_const_Vec_double__18_X(instance: *const c_void, coef: *const core::Vec18<f64>) -> Result<f64>;
		...
		pub fn cv_optflow_GPCPatchSample_getPropRef(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_optflow_GPCPatchSample_setPropRef_GPCPatchDescriptor(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_optflow_GPCPatchSample_getPropPos(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_optflow_GPCPatchSample_setPropPos_GPCPatchDescriptor(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_optflow_GPCPatchSample_getPropNeg(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_optflow_GPCPatchSample_setPropNeg_GPCPatchDescriptor(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_optflow_GPCPatchSample_getDirections_const_boolR_boolR_boolR_const_Vec_double__18_X_double(instance: *const c_void, refdir: *mut bool, posdir: *mut bool, negdir: *mut bool, coef: *const core::Vec18<f64>, rhs: f64) -> Result_void;
		...
		pub fn cv_optflow_GPCTrainingParams_GPCTrainingParams_const_GPCTrainingParamsX(params: *const crate::optflow::GPCTrainingParams) -> Result<crate::optflow::GPCTrainingParams>;
		pub fn cv_optflow_GPCTrainingParams_check_const(instance: *const crate::optflow::GPCTrainingParams) -> Result<bool>;
		pub fn cv_optflow_GPCTrainingSamples_create_const_vector_String_X_const_vector_String_X_const_vector_String_X_int(images_from: *const c_void, images_to: *const c_void, gt: *const c_void, descriptor_type: i32) -> Result<*mut c_void>;
		pub fn cv_optflow_GPCTrainingSamples_create_const__InputArrayX_const__InputArrayX_const__InputArrayX_int(images_from: *const c_void, images_to: *const c_void, gt: *const c_void, descriptor_type: i32) -> Result<*mut c_void>;
		...
		pub fn cv_optflow_GPCTree_train_GPCTrainingSamplesX_GPCTrainingParams(instance: *mut c_void, samples: *mut c_void, params: *const crate::optflow::GPCTrainingParams) -> Result_void;
		pub fn cv_optflow_GPCTree_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_optflow_GPCTree_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_optflow_GPCTree_findLeafForPatch_const_const_GPCPatchDescriptorX(instance: *const c_void, descr: *const c_void) -> Result<u32>;
		...
		pub fn cv_optflow_OpticalFlowPCAFlow_OpticalFlowPCAFlow_Ptr_PCAPrior__Size_float_float_float_float_float(_prior: *const c_void, _basis_size: *const core::Size, _sparse_rate: f32, _retained_corners_fraction: f32, _occlusions_threshold: f32, _damping_factor: f32, _clahe_clip: f32) -> Result<*mut c_void>;
		pub fn cv_optflow_OpticalFlowPCAFlow_calc_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX(instance: *mut c_void, i0: *const c_void, i1: *const c_void, flow: *const c_void) -> Result_void;
		...
		pub fn cv_optflow_VariationalRefinement_calcUV_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX_const__InputOutputArrayX(instance: *mut c_void, i0: *const c_void, i1: *const c_void, flow_u: *const c_void, flow_v: *const c_void) -> Result_void;
		pub fn cv_optflow_VariationalRefinement_getFixedPointIterations_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_optflow_VariationalRefinement_setFixedPointIterations_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_optflow_VariationalRefinement_getSorIterations_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_optflow_VariationalRefinement_setSorIterations_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_optflow_VariationalRefinement_getOmega_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_optflow_VariationalRefinement_setOmega_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_optflow_VariationalRefinement_getAlpha_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_optflow_VariationalRefinement_setAlpha_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_optflow_VariationalRefinement_getDelta_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_optflow_VariationalRefinement_setDelta_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_optflow_VariationalRefinement_getGamma_const(instance: *const c_void) -> Result<f32>;
...
mod phase_unwrapping_sys {
	...
	extern "C" {
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_create_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_getPropWidth_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_setPropWidth_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_getPropHeight_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_setPropHeight_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_getPropHistThresh_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_setPropHistThresh_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_getPropNbrOfSmallBins_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_setPropNbrOfSmallBins_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_getPropNbrOfLargeBins_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_Params_setPropNbrOfLargeBins_int(instance: *mut c_void, val: i32) -> Result_void;
...
mod photo_sys {
	...
	extern "C" {
		...
		pub fn cv_createTonemapDurand_float_float_float_float_float(gamma: f32, contrast: f32, saturation: f32, sigma_space: f32, sigma_color: f32) -> Result<*mut c_void>;
		...
		pub fn cv_TonemapDurand_getSaturation_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TonemapDurand_setSaturation_float(instance: *mut c_void, saturation: f32) -> Result_void;
		pub fn cv_TonemapDurand_getContrast_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TonemapDurand_setContrast_float(instance: *mut c_void, contrast: f32) -> Result_void;
		pub fn cv_TonemapDurand_getSigmaSpace_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TonemapDurand_setSigmaSpace_float(instance: *mut c_void, sigma_space: f32) -> Result_void;
		pub fn cv_TonemapDurand_getSigmaColor_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TonemapDurand_setSigmaColor_float(instance: *mut c_void, sigma_color: f32) -> Result_void;
...
mod plot_sys {
	...
	extern "C" {
		pub fn cv_plot_createPlot2d_const__InputArrayX(data: *const c_void) -> Result<*mut c_void>;
		pub fn cv_plot_createPlot2d_const__InputArrayX_const__InputArrayX(data_x: *const c_void, data_y: *const c_void) -> Result<*mut c_void>;
...
mod rgbd_sys {
	...
	extern "C" {
		...
		pub fn cv_rgbd_depthTo3dSparse_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__OutputArrayX(depth: *const c_void, in_k: *const c_void, in_points: *const c_void, points3d: *const c_void) -> Result_void;
		pub fn cv_rgbd_depthTo3d_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__InputArrayX(depth: *const c_void, k: *const c_void, points3d: *const c_void, mask: *const c_void) -> Result_void;
		...
		pub fn cv_rgbd_registerDepth_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const_SizeX_const__OutputArrayX_bool(unregistered_camera_matrix: *const c_void, registered_camera_matrix: *const c_void, registered_dist_coeffs: *const c_void, rt: *const c_void, unregistered_depth: *const c_void, output_image_plane_size: *const core::Size, registered_depth: *const c_void, depth_dilation: bool) -> Result_void;
		pub fn cv_rgbd_rescaleDepth_const__InputArrayX_int_const__OutputArrayX(in_: *const c_void, depth: i32, out: *const c_void) -> Result_void;
		pub fn cv_rgbd_warpFrame_const_MatX_const_MatX_const_MatX_const_MatX_const_MatX_const_MatX_MatX_MatX_MatX(image: *const c_void, depth: *const c_void, mask: *const c_void, rt: *const c_void, camera_matrix: *const c_void, dist_coeff: *const c_void, warped_image: *mut c_void, warped_depth: *mut c_void, warped_mask: *mut c_void) -> Result_void;
		...
		pub fn cv_linemod_ColorGradient_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_linemod_ColorGradient_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		...
		pub fn cv_linemod_DepthNormal_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_linemod_DepthNormal_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_linemod_Detector_Detector() -> Result<*mut c_void>;
		pub fn cv_linemod_Detector_Detector_const_vector_Ptr_Modality__X_const_vector_int_X(modalities: *const c_void, t_pyramid: *const c_void) -> Result<*mut c_void>;
		pub fn cv_linemod_Detector_match_const_const_vector_Mat_X_float_vector_Match_X_const_vector_String_X_const__OutputArrayX_const_vector_Mat_X(instance: *const c_void, sources: *const c_void, threshold: f32, matches: *mut c_void, class_ids: *const c_void, quantized_images: *const c_void, masks: *const c_void) -> Result_void;
		pub fn cv_linemod_Detector_addTemplate_const_vector_Mat_X_const_StringX_const_MatX_RectX(instance: *mut c_void, sources: *const c_void, class_id: *const c_char, object_mask: *const c_void, bounding_box: *mut core::Rect) -> Result<i32>;
		pub fn cv_linemod_Detector_addSyntheticTemplate_const_vector_Template_X_const_StringX(instance: *mut c_void, templates: *const c_void, class_id: *const c_char) -> Result<i32>;
		...
		pub fn cv_linemod_Detector_getTemplates_const_const_StringX_int(instance: *const c_void, class_id: *const c_char, template_id: i32) -> Result<*mut c_void>;
		pub fn cv_linemod_Detector_numTemplates_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_linemod_Detector_numTemplates_const_const_StringX(instance: *const c_void, class_id: *const c_char) -> Result<i32>;
		...
		pub fn cv_linemod_Detector_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_linemod_Detector_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_linemod_Detector_readClass_const_FileNodeX_const_StringX(instance: *mut c_void, fn_: *const c_void, class_id_override: *const c_char) -> Result<*mut c_void>;
		pub fn cv_linemod_Detector_writeClass_const_const_StringX_FileStorageX(instance: *const c_void, class_id: *const c_char, fs: *mut c_void) -> Result_void;
		pub fn cv_linemod_Detector_readClasses_const_vector_String_X_const_StringX(instance: *mut c_void, class_ids: *const c_void, format: *const c_char) -> Result_void;
		pub fn cv_linemod_Detector_writeClasses_const_const_StringX(instance: *const c_void, format: *const c_char) -> Result_void;
		pub fn cv_linemod_Feature_getPropX_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_linemod_Feature_setPropX_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_linemod_Feature_getPropY_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_linemod_Feature_setPropY_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_linemod_Feature_getPropLabel_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_linemod_Feature_setPropLabel_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_linemod_Feature_Feature() -> Result<*mut c_void>;
		pub fn cv_linemod_Feature_Feature_int_int_int(x: i32, y: i32, label: i32) -> Result<*mut c_void>;
		pub fn cv_linemod_Feature_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_linemod_Feature_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		...
		pub fn cv_linemod_Match_Match_int_int_float_const_StringX_int(x: i32, y: i32, similarity: f32, class_id: *const c_char, template_id: i32) -> Result<*mut c_void>;
		pub fn cv_linemod_Modality_process_const_const_MatX_const_MatX(instance: *const c_void, src: *const c_void, mask: *const c_void) -> Result<*mut c_void>;
		pub fn cv_linemod_Modality_name_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_linemod_Modality_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_linemod_Modality_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_linemod_Modality_create_const_StringX(modality_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_linemod_Modality_create_const_FileNodeX(fn_: *const c_void) -> Result<*mut c_void>;
		pub fn cv_linemod_QuantizedPyramid_quantize_const_MatX(instance: *const c_void, dst: *mut c_void) -> Result_void;
		pub fn cv_linemod_QuantizedPyramid_extractTemplate_const_TemplateX(instance: *const c_void, templ: *mut c_void) -> Result<bool>;
		...
		pub fn cv_linemod_Template_getPropFeatures(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_linemod_Template_setPropFeatures_vector_Feature_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_linemod_Template_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_linemod_Template_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		...
		pub fn cv_rgbd_Odometry_compute_const_const_MatX_const_MatX_const_MatX_const_MatX_const_MatX_const_MatX_MatX_const_MatX(instance: *const c_void, src_image: *const c_void, src_depth: *const c_void, src_mask: *const c_void, dst_image: *const c_void, dst_depth: *const c_void, dst_mask: *const c_void, rt: *mut c_void, init_rt: *const c_void) -> Result<bool>;
		pub fn cv_rgbd_Odometry_compute_const_Ptr_OdometryFrame_X_Ptr_OdometryFrame_X_MatX_const_MatX(instance: *const c_void, src_frame: *mut c_void, dst_frame: *mut c_void, rt: *mut c_void, init_rt: *const c_void) -> Result<bool>;
		pub fn cv_rgbd_Odometry_prepareFrameCache_const_Ptr_OdometryFrame_X_int(instance: *const c_void, frame: *mut c_void, cache_type: i32) -> Result<core::Size>;
		pub fn cv_rgbd_Odometry_create_const_StringX(odometry_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_rgbd_Odometry_getCameraMatrix_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_Odometry_setCameraMatrix_const_MatX(instance: *mut c_void, val: *const c_void) -> Result_void;
		...
		pub fn cv_rgbd_OdometryFrame_OdometryFrame_const_MatX_const_MatX_const_MatX_const_MatX_int(image: *const c_void, depth: *const c_void, mask: *const c_void, normals: *const c_void, id: i32) -> Result<*mut c_void>;
		...
		pub fn cv_rgbd_RgbdFrame_getPropImage(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdFrame_setPropImage_Mat(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_rgbd_RgbdFrame_getPropDepth(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdFrame_setPropDepth_Mat(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_rgbd_RgbdFrame_getPropMask(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdFrame_setPropMask_Mat(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_rgbd_RgbdFrame_getPropNormals(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_rgbd_RgbdFrame_RgbdFrame_const_MatX_const_MatX_const_MatX_const_MatX_int(image: *const c_void, depth: *const c_void, mask: *const c_void, normals: *const c_void, id: i32) -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdFrame_release(instance: *mut c_void) -> Result_void;
		pub fn cv_rgbd_RgbdNormals_RgbdNormals() -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdNormals_RgbdNormals_int_int_int_const__InputArrayX_int_int(rows: i32, cols: i32, depth: i32, k: *const c_void, window_size: i32, method: i32) -> Result<*mut c_void>;
		...
		pub fn cv_rgbd_RgbdNormals_setK_const_MatX(instance: *mut c_void, val: *const c_void) -> Result_void;
		...
		pub fn cv_rgbd_RgbdOdometry_RgbdOdometry_const_MatX_float_float_float_const_vector_int_X_const_vector_float_X_float_int(camera_matrix: *const c_void, min_depth: f32, max_depth: f32, max_depth_diff: f32, iter_counts: *const c_void, min_gradient_magnitudes: *const c_void, max_points_part: f32, transform_type: i32) -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdOdometry_prepareFrameCache_const_Ptr_OdometryFrame_X_int(instance: *const c_void, frame: *mut c_void, cache_type: i32) -> Result<core::Size>;
		pub fn cv_rgbd_RgbdOdometry_getCameraMatrix_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdOdometry_setCameraMatrix_const_MatX(instance: *mut c_void, val: *const c_void) -> Result_void;
		...
		pub fn cv_rgbd_RgbdOdometry_setIterationCounts_const_MatX(instance: *mut c_void, val: *const c_void) -> Result_void;
		pub fn cv_rgbd_RgbdOdometry_getMinGradientMagnitudes_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_RgbdOdometry_setMinGradientMagnitudes_const_MatX(instance: *mut c_void, val: *const c_void) -> Result_void;
		...
		pub fn cv_rgbd_RgbdPlane_RgbdPlane_RGBD_PLANE_METHOD(method: crate::rgbd::RgbdPlane_RGBD_PLANE_METHOD) -> Result<*mut c_void>;
...
mod saliency_sys {
	...
	extern "C" {
		...
		pub fn cv_saliency_MotionSaliencyBinWangApr2014_computeSaliency_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, image: *const c_void, saliency_map: *const c_void) -> Result<bool>;
		...
		pub fn cv_saliency_ObjectnessBING_computeSaliency_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, image: *const c_void, saliency_map: *const c_void) -> Result<bool>;
		...
		pub fn cv_saliency_ObjectnessBING_setTrainingPath_const_StringX(instance: *mut c_void, training_path: *const c_char) -> Result_void;
		pub fn cv_saliency_ObjectnessBING_setBBResDir_const_StringX(instance: *mut c_void, results_dir: *const c_char) -> Result_void;
		...
		pub fn cv_saliency_Saliency_create_const_StringX(saliency_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_saliency_Saliency_computeSaliency_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, image: *const c_void, saliency_map: *const c_void) -> Result<bool>;
		pub fn cv_saliency_Saliency_getClassName_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_saliency_StaticSaliency_computeBinaryMap_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, _saliency_map: *const c_void, _binary_map: *const c_void) -> Result<bool>;
		...
		pub fn cv_saliency_StaticSaliencyFineGrained_computeSaliency_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, image: *const c_void, saliency_map: *const c_void) -> Result<bool>;
		...
		pub fn cv_saliency_StaticSaliencySpectralResidual_computeSaliency_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, image: *const c_void, saliency_map: *const c_void) -> Result<bool>;
		pub fn cv_saliency_StaticSaliencySpectralResidual_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_saliency_StaticSaliencySpectralResidual_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
...
mod stereo_sys {
	...
	extern "C" {
		pub fn cv_stereo_censusTransform_const_MatX_const_MatX_int_MatX_MatX_int(image1: *const c_void, image2: *const c_void, kernel_size: i32, dist1: *mut c_void, dist2: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_stereo_censusTransform_const_MatX_int_MatX_int(image1: *const c_void, kernel_size: i32, dist1: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_stereo_modifiedCensusTransform_const_MatX_const_MatX_int_MatX_MatX_int_int_const_MatX_const_MatX(img1: *const c_void, img2: *const c_void, kernel_size: i32, dist1: *mut c_void, dist2: *mut c_void, typ: i32, t: i32, integral_image1: *const c_void, integral_image2: *const c_void) -> Result_void;
		pub fn cv_stereo_modifiedCensusTransform_const_MatX_int_MatX_int_int_const_MatX(img1: *const c_void, kernel_size: i32, dist: *mut c_void, typ: i32, t: i32, integral_image: *const c_void) -> Result_void;
		pub fn cv_stereo_starCensusTransform_const_MatX_const_MatX_int_MatX_MatX(img1: *const c_void, img2: *const c_void, kernel_size: i32, dist1: *mut c_void, dist2: *mut c_void) -> Result_void;
		pub fn cv_stereo_starCensusTransform_const_MatX_int_MatX(img1: *const c_void, kernel_size: i32, dist: *mut c_void) -> Result_void;
		pub fn cv_stereo_symetricCensusTransform_const_MatX_const_MatX_int_MatX_MatX_int(img1: *const c_void, img2: *const c_void, kernel_size: i32, dist1: *mut c_void, dist2: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_stereo_symetricCensusTransform_const_MatX_int_MatX_int(img1: *const c_void, kernel_size: i32, dist1: *mut c_void, typ: i32) -> Result_void;
	}
}
#[cfg(feature = "contrib")]
pub use stereo_sys::*;
...
mod stitching_sys {
	...
	extern "C" {
		...
		pub fn cv_Stitcher_setFeaturesFinder_Ptr_FeaturesFinder_(instance: *mut c_void, features_finder: *mut c_void) -> Result_void;
		...
		pub fn cv_Stitcher_estimateTransform_const__InputArrayX(instance: *mut c_void, images: *const c_void) -> Result<crate::stitching::Stitcher_Status>;
		pub fn cv_Stitcher_estimateTransform_const__InputArrayX_const_vector_vector_Rect__X(instance: *mut c_void, images: *const c_void, rois: *const c_void) -> Result<crate::stitching::Stitcher_Status>;
		...
		pub fn cv_Stitcher_stitch_const__InputArrayX_const_vector_vector_Rect__X_const__OutputArrayX(instance: *mut c_void, images: *const c_void, rois: *const c_void, pano: *const c_void) -> Result<crate::stitching::Stitcher_Status>;
		...
		pub fn cv_detail_AKAZEFeaturesFinder_AKAZEFeaturesFinder_int_int_int_float_int_int_int(descriptor_type: i32, descriptor_size: i32, descriptor_channels: i32, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: i32) -> Result<*mut c_void>;
		...
		pub fn cv_detail_AffineWarper_warpPoint_const_Point2fX_const__InputArrayX_const__InputArrayX(instance: *mut c_void, pt: *const core::Point2f, k: *const c_void, r: *const c_void) -> Result<core::Point2f>;
		pub fn cv_detail_AffineWarper_buildMaps_Size_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(instance: *mut c_void, src_size: *const core::Size, k: *const c_void, r: *const c_void, xmap: *const c_void, ymap: *const c_void) -> Result<core::Rect>;
		pub fn cv_detail_AffineWarper_warp_const__InputArrayX_const__InputArrayX_const__InputArrayX_int_int_const__OutputArrayX(instance: *mut c_void, src: *const c_void, k: *const c_void, r: *const c_void, interp_mode: i32, border_mode: i32, dst: *const c_void) -> Result<core::Point>;
		pub fn cv_detail_AffineWarper_warpRoi_Size_const__InputArrayX_const__InputArrayX(instance: *mut c_void, src_size: *const core::Size, k: *const c_void, r: *const c_void) -> Result<core::Rect>;
		...
		pub fn cv_detail_FeaturesFinder_collectGarbage(instance: *mut c_void) -> Result_void;
		...
		pub fn cv_detail_SphericalProjector_mapForward_float_float_floatR_floatR(instance: *mut c_void, x: f32, y: f32, u: *mut f32, v: *mut f32) -> Result_void;
		pub fn cv_detail_SphericalProjector_mapBackward_float_float_floatR_floatR(instance: *mut c_void, u: f32, v: f32, x: *mut f32, y: *mut f32) -> Result_void;
		...
		pub fn cv_detail_SurfFeaturesFinder_SurfFeaturesFinder_double_int_int_int_int(hess_thresh: f64, num_octaves: i32, num_layers: i32, num_octaves_descr: i32, num_layers_descr: i32) -> Result<*mut c_void>;
		pub fn cv_detail_SurfFeaturesFinderGpu_SurfFeaturesFinderGpu_double_int_int_int_int(hess_thresh: f64, num_octaves: i32, num_layers: i32, num_octaves_descr: i32, num_layers_descr: i32) -> Result<*mut c_void>;
		pub fn cv_detail_SurfFeaturesFinderGpu_collectGarbage(instance: *mut c_void) -> Result_void;
...
mod structured_light_sys {
	...
	extern "C" {
		...
		pub fn cv_structured_light_SinusoidalPattern_create_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_structured_light_SinusoidalPattern_Params_getPropMarkersLocation(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_structured_light_StructuredLightPattern_decode_const_const__InputArrayX_const__OutputArrayX_const__InputArrayX_const__InputArrayX_int(instance: *const c_void, pattern_images: *const c_void, disparity_map: *const c_void, black_images: *const c_void, white_images: *const c_void, flags: i32) -> Result<bool>;
	}
}
#[cfg(feature = "contrib")]
...
mod superres_sys {
	...
	extern "C" {
		...
		pub fn cv_superres_SuperResolution_getLabmda_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_superres_SuperResolution_setLabmda_double(instance: *mut c_void, val: f64) -> Result_void;
...
mod surface_matching_sys {
	...
	extern "C" {
		...
		pub fn cv_ppf_match_3d_ICP_ICP_int_float_float_int_ICP_SAMPLING_TYPE_int(iterations: i32, tolerence: f32, rejection_scale: f32, num_levels: i32, sample_type: crate::surface_matching::ICP_ICP_SAMPLING_TYPE, num_max_corr: i32) -> Result<*mut c_void>;
		pub fn cv_ppf_match_3d_ICP_registerModelToScene_const_MatX_const_MatX_doubleR_double_X__16_(instance: *mut c_void, src_pc: *const c_void, dst_pc: *const c_void, residual: *mut f64, pose: *mut [f64; 16]) -> Result<i32>;
		...
		pub fn cv_ppf_match_3d_Pose3D_getPropModelIndex_const(instance: *const c_void) -> Result<u32>;
		pub fn cv_ppf_match_3d_Pose3D_setPropModelIndex_unsigned_int(instance: *mut c_void, val: u32) -> Result_void;
		pub fn cv_ppf_match_3d_Pose3D_getPropNumVotes_const(instance: *const c_void) -> Result<u32>;
		pub fn cv_ppf_match_3d_Pose3D_setPropNumVotes_unsigned_int(instance: *mut c_void, val: u32) -> Result_void;
		pub fn cv_ppf_match_3d_Pose3D_getPropPose(instance: *mut c_void) -> Result<*mut [f64; 16]>;
		...
		pub fn cv_ppf_match_3d_Pose3D_getPropT(instance: *mut c_void) -> Result<*mut [f64; 3]>;
		pub fn cv_ppf_match_3d_Pose3D_getPropQ(instance: *mut c_void) -> Result<*mut [f64; 4]>;
		pub fn cv_ppf_match_3d_Pose3D_Pose3D() -> Result<*mut c_void>;
		pub fn cv_ppf_match_3d_Pose3D_Pose3D_double_unsigned_int_unsigned_int(alpha: f64, model_index: u32, num_votes: u32) -> Result<*mut c_void>;
		pub fn cv_ppf_match_3d_Pose3D_updatePose_double_X__16_(instance: *mut c_void, new_pose: *mut [f64; 16]) -> Result_void;
		pub fn cv_ppf_match_3d_Pose3D_updatePose_double_X__9__double_X__3_(instance: *mut c_void, new_r: *mut [f64; 9], new_t: *mut [f64; 3]) -> Result_void;
		pub fn cv_ppf_match_3d_Pose3D_updatePoseQuat_double_X__4__double_X__3_(instance: *mut c_void, q: *mut [f64; 4], new_t: *mut [f64; 3]) -> Result_void;
		pub fn cv_ppf_match_3d_Pose3D_appendPose_double_X__16_(instance: *mut c_void, incremental_pose: *mut [f64; 16]) -> Result_void;
		...
		pub fn cv_ppf_match_3d_PoseCluster3D_getPropPoseList(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_ppf_match_3d_PoseCluster3D_setPropPoseList_vector_Pose3DPtr_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_ppf_match_3d_PoseCluster3D_getPropNumVotes_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_ppf_match_3d_PoseCluster3D_setPropNumVotes_int(instance: *mut c_void, val: i32) -> Result_void;
...
mod text_sys {
	...
	extern "C" {
		...
		pub fn cv_text_ERFilter_getNumRejected(instance: *mut c_void) -> Result<i32>;
		...
		pub fn cv_text_OCRHMMDecoder_create_Ptr_ClassifierCallback__const_stringX_const__InputArrayX_const__InputArrayX_decoder_mode(classifier: *const c_void, vocabulary: *const c_char, transition_probabilities_table: *const c_void, emission_probabilities_table: *const c_void, mode: crate::text::decoder_mode) -> Result<*mut c_void>;
...
mod tracking_sys {
	...
	extern "C" {
		pub fn cv_selectROI_Mat_bool(img: *mut c_void, from_center: bool) -> Result<core::Rect2d>;
		pub fn cv_selectROI_const_StringX_Mat_bool_bool(window_name: *const c_char, img: *mut c_void, show_crossair: bool, from_center: bool) -> Result<core::Rect2d>;
		pub fn cv_selectROI_const_StringX_Mat_vector_Rect2d_X_bool(window_name: *const c_char, img: *mut c_void, bounding_box: *mut c_void, from_center: bool) -> Result_void;
		pub fn cv_tld_tld_InitDataset_int_const_charX_int(video_ind: i32, root_path: *const c_char, dataset_ind: i32) -> Result<core::Rect2d>;
		pub fn cv_tld_tld_getNextDatasetFrame() -> Result<*mut c_void>;
		pub fn cv_ClfMilBoost_ClfMilBoost() -> Result<*mut c_void>;
		pub fn cv_ClfMilBoost_init_const_ParamsX(instance: *mut c_void, parameters: *const c_void) -> Result_void;
		pub fn cv_ClfMilBoost_update_const_MatX_const_MatX(instance: *mut c_void, posx: *const c_void, negx: *const c_void) -> Result_void;
		pub fn cv_ClfMilBoost_classify_const_MatX_bool(instance: *mut c_void, x: *const c_void, log_r: bool) -> Result<*mut c_void>;
		pub fn cv_ClfMilBoost_sigmoid_float(instance: *mut c_void, x: f32) -> Result<f32>;
		pub fn cv_ClfMilBoost_Params_getProp_numSel_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_ClfMilBoost_Params_setProp_numSel_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_ClfMilBoost_Params_getProp_numFeat_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_ClfMilBoost_Params_setProp_numFeat_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_ClfMilBoost_Params_getProp_lRate_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_ClfMilBoost_Params_setProp_lRate_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_ClfMilBoost_Params_Params() -> Result<*mut c_void>;
		pub fn cv_CvFeatureParams_getPropMaxCatCount_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_CvFeatureParams_setPropMaxCatCount_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_CvFeatureParams_getPropFeatSize_const(instance: *const c_void) -> Result<i32>;
		...
		pub fn cv_CvFeatureParams_init_const_CvFeatureParamsX(instance: *mut c_void, fp: *const c_void) -> Result_void;
		pub fn cv_CvFeatureParams_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_CvFeatureParams_read_const_FileNodeX(instance: *mut c_void, node: *const c_void) -> Result<bool>;
		#[cfg(not(target_os = "windows"))]
		...
		pub fn cv_CvHaarEvaluator_setImage_const_MatX_unsigned_char_int(instance: *mut c_void, img: *const c_void, cls_label: u8, idx: i32) -> Result_void;
		pub fn cv_CvHaarEvaluator_writeFeatures_const_FileStorageX_const_MatX(instance: *const c_void, fs: *mut c_void, feature_map: *const c_void) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_CvHaarEvaluator_writeFeature_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		...
		#[cfg(not(target_os = "windows"))]
		pub fn cv_CvHaarEvaluator_FeatureHaar_eval_const_const_MatX_Rect_floatX(instance: *const c_void, image: *const c_void, roi: *const core::Rect, result: *mut f32) -> Result<bool>;
		#[cfg(not(target_os = "windows"))]
		...
		pub fn cv_MultiTracker_getPropObjects(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_MultiTracker_setPropObjects_vector_Rect2d_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_MultiTracker_MultiTracker_const_StringX(tracker_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_MultiTracker_add_const_MatX_const_Rect2dX(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect2d) -> Result<bool>;
		pub fn cv_MultiTracker_add_const_StringX_const_MatX_const_Rect2dX(instance: *mut c_void, tracker_type: *const c_char, image: *const c_void, bounding_box: *const core::Rect2d) -> Result<bool>;
		pub fn cv_MultiTracker_add_const_StringX_const_MatX_vector_Rect2d_(instance: *mut c_void, tracker_type: *const c_char, image: *const c_void, bounding_box: *mut c_void) -> Result<bool>;
		pub fn cv_MultiTracker_add_const_MatX_vector_Rect2d_(instance: *mut c_void, image: *const c_void, bounding_box: *mut c_void) -> Result<bool>;
		pub fn cv_MultiTracker_update_const_MatX(instance: *mut c_void, image: *const c_void) -> Result<bool>;
		pub fn cv_MultiTracker_update_const_MatX_vector_Rect2d_X(instance: *mut c_void, image: *const c_void, bounding_box: *mut c_void) -> Result<bool>;
		pub fn cv_MultiTrackerTLD_update_opt_const_MatX(instance: *mut c_void, image: *const c_void) -> Result<bool>;
		pub fn cv_MultiTracker_Alt_getPropTargetNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_MultiTracker_Alt_setPropTargetNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_MultiTracker_Alt_getPropTrackers(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_MultiTracker_Alt_setPropTrackers_vector_Ptr_Tracker__(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_MultiTracker_Alt_getPropBoundingBoxes(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_MultiTracker_Alt_setPropBoundingBoxes_vector_Rect2d_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_MultiTracker_Alt_getPropColors(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_MultiTracker_Alt_setPropColors_vector_Scalar_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_MultiTracker_Alt_MultiTracker_Alt() -> Result<*mut c_void>;
		pub fn cv_MultiTracker_Alt_addTarget_const_MatX_const_Rect2dX_String(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect2d, tracker_algorithm_name: *mut c_char) -> Result<bool>;
		pub fn cv_MultiTracker_Alt_update_const_MatX(instance: *mut c_void, image: *const c_void) -> Result<bool>;
		pub fn cv_Tracker_init_const_MatX_const_Rect2dX(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect2d) -> Result<bool>;
		pub fn cv_Tracker_update_const_MatX_Rect2dX(instance: *mut c_void, image: *const c_void, bounding_box: *mut core::Rect2d) -> Result<bool>;
		pub fn cv_Tracker_create_const_StringX(tracker_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_Tracker_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_Tracker_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_Tracker_getModel(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerBoosting_createTracker_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerBoosting_Params_getPropNumClassifiers_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerBoosting_Params_setPropNumClassifiers_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerBoosting_Params_getPropSamplerOverlap_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerBoosting_Params_setPropSamplerOverlap_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerBoosting_Params_getPropSamplerSearchFactor_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerBoosting_Params_setPropSamplerSearchFactor_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerBoosting_Params_getPropIterationInit_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerBoosting_Params_setPropIterationInit_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerBoosting_Params_getPropFeatureSetNumFeatures_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerBoosting_Params_setPropFeatureSetNumFeatures_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerBoosting_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerBoosting_Params_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_TrackerBoosting_Params_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_TrackerFeature_compute_const_vector_Mat_X_MatX(instance: *mut c_void, images: *const c_void, response: *mut c_void) -> Result_void;
		pub fn cv_TrackerFeature_create_const_StringX(tracker_feature_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_TrackerFeature_selection_MatX_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeature_getClassName_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureFeature2d_TrackerFeatureFeature2d_String_String(detector_type: *mut c_char, descriptor_type: *mut c_char) -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureFeature2d_selection_MatX_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureHAAR_TrackerFeatureHAAR_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureHAAR_extractSelected_vector_int__const_vector_Mat_X_MatX(instance: *mut c_void, sel_features: *const c_void, images: *const c_void, response: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerFeatureHAAR_selection_MatX_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureHAAR_swapFeature_int_int(instance: *mut c_void, source: i32, target: i32) -> Result<bool>;
		pub fn cv_TrackerFeatureHAAR_swapFeature_int_FeatureHaarX(instance: *mut c_void, id: i32, feature: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerFeatureHAAR_getFeatureAt_int(instance: *mut c_void, id: i32) -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureHAAR_Params_getPropNumFeatures_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerFeatureHAAR_Params_setPropNumFeatures_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerFeatureHAAR_Params_getPropRectSize_const(instance: *const c_void) -> Result<core::Size>;
		pub fn cv_TrackerFeatureHAAR_Params_setPropRectSize_Size(instance: *mut c_void, val: *const core::Size) -> Result_void;
		pub fn cv_TrackerFeatureHAAR_Params_getPropIsIntegral_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_TrackerFeatureHAAR_Params_setPropIsIntegral_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_TrackerFeatureHAAR_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureHOG_TrackerFeatureHOG() -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureHOG_selection_MatX_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureLBP_TrackerFeatureLBP() -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureLBP_selection_MatX_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureSet_TrackerFeatureSet() -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureSet_extraction_const_vector_Mat_X(instance: *mut c_void, images: *const c_void) -> Result_void;
		pub fn cv_TrackerFeatureSet_selection(instance: *mut c_void) -> Result_void;
		pub fn cv_TrackerFeatureSet_removeOutliers(instance: *mut c_void) -> Result_void;
		pub fn cv_TrackerFeatureSet_addTrackerFeature_String(instance: *mut c_void, tracker_feature_type: *mut c_char) -> Result<bool>;
		pub fn cv_TrackerFeatureSet_addTrackerFeature_Ptr_TrackerFeature_X(instance: *mut c_void, feature: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerFeatureSet_getResponses_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerGOTURN_createTracker_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerGOTURN_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerGOTURN_Params_read_const_FileNodeX(instance: *mut c_void, unnamed: *const c_void) -> Result_void;
		pub fn cv_TrackerGOTURN_Params_write_const_FileStorageX(instance: *const c_void, unnamed: *mut c_void) -> Result_void;
		pub fn cv_TrackerKCF_setFeatureExtractor_void__X__cv_Mat__cv_Rect__cv_Mat__bool(instance: *mut c_void, unnamed: Option<unsafe extern "C" fn(*const c_void, core::Rect, *mut c_void) -> ()>, pca_func: bool) -> Result_void;
		pub fn cv_TrackerKCF_createTracker_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerKCF_Params_getPropSigma_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_TrackerKCF_Params_setPropSigma_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropLambda_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_TrackerKCF_Params_setPropLambda_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropInterp_factor_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_TrackerKCF_Params_setPropInterp_factor_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropOutput_sigma_factor_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_TrackerKCF_Params_setPropOutput_sigma_factor_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropPca_learning_rate_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_TrackerKCF_Params_setPropPca_learning_rate_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropResize_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_TrackerKCF_Params_setPropResize_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropSplit_coeff_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_TrackerKCF_Params_setPropSplit_coeff_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropWrap_kernel_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_TrackerKCF_Params_setPropWrap_kernel_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropCompress_feature_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_TrackerKCF_Params_setPropCompress_feature_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropMax_patch_size_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerKCF_Params_setPropMax_patch_size_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropCompressed_size_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerKCF_Params_setPropCompressed_size_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropDesc_pca_const(instance: *const c_void) -> Result<u32>;
		pub fn cv_TrackerKCF_Params_setPropDesc_pca_unsigned_int(instance: *mut c_void, val: u32) -> Result_void;
		pub fn cv_TrackerKCF_Params_getPropDesc_npca_const(instance: *const c_void) -> Result<u32>;
		pub fn cv_TrackerKCF_Params_setPropDesc_npca_unsigned_int(instance: *mut c_void, val: u32) -> Result_void;
		pub fn cv_TrackerKCF_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerKCF_Params_read_const_FileNodeX(instance: *mut c_void, unnamed: *const c_void) -> Result_void;
		pub fn cv_TrackerKCF_Params_write_const_FileStorageX(instance: *const c_void, unnamed: *mut c_void) -> Result_void;
		pub fn cv_TrackerMIL_createTracker_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerMIL_Params_getPropSamplerInitInRadius_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerMIL_Params_setPropSamplerInitInRadius_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerMIL_Params_getPropSamplerInitMaxNegNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerMIL_Params_setPropSamplerInitMaxNegNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerMIL_Params_getPropSamplerSearchWinSize_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerMIL_Params_setPropSamplerSearchWinSize_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerMIL_Params_getPropSamplerTrackInRadius_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerMIL_Params_setPropSamplerTrackInRadius_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerMIL_Params_getPropSamplerTrackMaxPosNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerMIL_Params_setPropSamplerTrackMaxPosNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerMIL_Params_getPropSamplerTrackMaxNegNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerMIL_Params_setPropSamplerTrackMaxNegNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerMIL_Params_getPropFeatureSetNumFeatures_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerMIL_Params_setPropFeatureSetNumFeatures_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerMIL_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerMIL_Params_read_const_FileNodeX(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_TrackerMIL_Params_write_const_FileStorageX(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_TrackerMedianFlow_createTracker_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerMedianFlow_Params_getPropPointsInGrid_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerMedianFlow_Params_setPropPointsInGrid_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerMedianFlow_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerMedianFlow_Params_read_const_FileNodeX(instance: *mut c_void, unnamed: *const c_void) -> Result_void;
		pub fn cv_TrackerMedianFlow_Params_write_const_FileStorageX(instance: *const c_void, unnamed: *mut c_void) -> Result_void;
		pub fn cv_TrackerModel_setTrackerStateEstimator_Ptr_TrackerStateEstimator_(instance: *mut c_void, tracker_state_estimator: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerModel_modelEstimation_const_vector_Mat_X(instance: *mut c_void, responses: *const c_void) -> Result_void;
		pub fn cv_TrackerModel_modelUpdate(instance: *mut c_void) -> Result_void;
		pub fn cv_TrackerModel_runStateEstimator(instance: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerModel_setLastTargetState_const_Ptr_TrackerTargetState_X(instance: *mut c_void, last_target_state: *const c_void) -> Result_void;
		pub fn cv_TrackerModel_getLastTargetState_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerModel_getTrackerStateEstimator_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSampler_TrackerSampler() -> Result<*mut c_void>;
		pub fn cv_TrackerSampler_sampling_const_MatX_Rect(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect) -> Result_void;
		pub fn cv_TrackerSampler_getSamples_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSampler_addTrackerSamplerAlgorithm_String(instance: *mut c_void, tracker_sampler_algorithm_type: *mut c_char) -> Result<bool>;
		pub fn cv_TrackerSampler_addTrackerSamplerAlgorithm_Ptr_TrackerSamplerAlgorithm_X(instance: *mut c_void, sampler: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerSamplerAlgorithm_create_const_StringX(tracker_sampler_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerAlgorithm_sampling_const_MatX_Rect_vector_Mat_X(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect, sample: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerSamplerAlgorithm_getClassName_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerCS_TrackerSamplerCS_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerCS_setMode_int(instance: *mut c_void, sampling_mode: i32) -> Result_void;
		pub fn cv_TrackerSamplerCS_samplingImpl_const_MatX_Rect_vector_Mat_X(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect, sample: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerSamplerCS_getROI_const(instance: *const c_void) -> Result<core::Rect>;
		pub fn cv_TrackerSamplerCS_Params_getPropOverlap_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerSamplerCS_Params_setPropOverlap_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerSamplerCS_Params_getPropSearchFactor_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerSamplerCS_Params_setPropSearchFactor_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerSamplerCS_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerCSC_TrackerSamplerCSC_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerCSC_setMode_int(instance: *mut c_void, sampling_mode: i32) -> Result_void;
		pub fn cv_TrackerSamplerCSC_Params_getPropInitInRad_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerSamplerCSC_Params_setPropInitInRad_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerSamplerCSC_Params_getPropTrackInPosRad_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerSamplerCSC_Params_setPropTrackInPosRad_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerSamplerCSC_Params_getPropSearchWinSize_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_TrackerSamplerCSC_Params_setPropSearchWinSize_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_TrackerSamplerCSC_Params_getPropInitMaxNegNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerSamplerCSC_Params_setPropInitMaxNegNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerSamplerCSC_Params_getPropTrackMaxPosNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerSamplerCSC_Params_setPropTrackMaxPosNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerSamplerCSC_Params_getPropTrackMaxNegNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerSamplerCSC_Params_setPropTrackMaxNegNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerSamplerCSC_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerPF_TrackerSamplerPF_const_MatX_const_ParamsX(chosen_rect: *const c_void, parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerPF_Params_getPropIterationNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerSamplerPF_Params_setPropIterationNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerSamplerPF_Params_getPropParticlesNum_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerSamplerPF_Params_setPropParticlesNum_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_TrackerSamplerPF_Params_getPropAlpha_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_TrackerSamplerPF_Params_setPropAlpha_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_TrackerSamplerPF_Params_getPropStd(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerPF_Params_setPropStd_Mat__double_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_TrackerSamplerPF_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimator_create_const_StringX(tracke_state_estimator_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimator_getClassName_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerStateEstimatorAdaBoosting_int_int_int_Size_const_RectX(num_classifer: i32, init_iterations: i32, n_features: i32, patch_size: *const core::Size, roi: *const core::Rect) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_getSampleROI_const(instance: *const c_void) -> Result<core::Rect>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_setSampleROI_const_RectX(instance: *mut c_void, roi: *const core::Rect) -> Result_void;
		pub fn cv_TrackerStateEstimatorAdaBoosting_computeSelectedWeakClassifier(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_computeReplacedClassifier(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_computeSwappedClassifier(instance: *mut c_void) -> Result<*mut c_void>;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_TrackerAdaBoostingTargetState_const_Point2fX_int_int_bool_const_MatX(position: *const core::Point2f, width: i32, height: i32, foreground: bool, responses: *const c_void) -> Result<*mut c_void>;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_setTargetResponses_const_MatX(instance: *mut c_void, responses: *const c_void) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_setTargetFg_bool(instance: *mut c_void, foreground: bool) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_getTargetResponses_const(instance: *const c_void) -> Result<*mut c_void>;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_isTargetFg_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerStateEstimatorMILBoosting_int(n_features: i32) -> Result<*mut c_void>;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_TrackerMILTargetState_const_Point2fX_int_int_bool_const_MatX(position: *const core::Point2f, width: i32, height: i32, foreground: bool, features: *const c_void) -> Result<*mut c_void>;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_setTargetFg_bool(instance: *mut c_void, foreground: bool) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_setFeatures_const_MatX(instance: *mut c_void, features: *const c_void) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_isTargetFg_const(instance: *const c_void) -> Result<bool>;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_getFeatures_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimatorSVM_TrackerStateEstimatorSVM() -> Result<*mut c_void>;
		pub fn cv_TrackerTLD_createTracker_const_ParamsX(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerTLD_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerTLD_Params_read_const_FileNodeX(instance: *mut c_void, unnamed: *const c_void) -> Result_void;
		pub fn cv_TrackerTLD_Params_write_const_FileStorageX(instance: *const c_void, unnamed: *mut c_void) -> Result_void;
		pub fn cv_TrackerTargetState_getTargetPosition_const(instance: *const c_void) -> Result<core::Point2f>;
		pub fn cv_TrackerTargetState_setTargetPosition_const_Point2fX(instance: *mut c_void, position: *const core::Point2f) -> Result_void;
		pub fn cv_TrackerTargetState_getTargetWidth_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_TrackerTargetState_setTargetWidth_int(instance: *mut c_void, width: i32) -> Result_void;
		pub fn cv_TrackerTargetState_getTargetHeight_const(instance: *const c_void) -> Result<i32>;
...
mod video_sys {
	...
	extern "C" {
		...
		pub fn cv_createOptFlow_DualTVL1() -> Result<*mut c_void>;
		...
		pub fn cv_DualTVL1OpticalFlow_getTau_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_DualTVL1OpticalFlow_setTau_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getLambda_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_DualTVL1OpticalFlow_setLambda_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getTheta_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_DualTVL1OpticalFlow_setTheta_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getGamma_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_DualTVL1OpticalFlow_setGamma_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getScalesNumber_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_DualTVL1OpticalFlow_setScalesNumber_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getWarpingsNumber_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_DualTVL1OpticalFlow_setWarpingsNumber_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getEpsilon_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_DualTVL1OpticalFlow_setEpsilon_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getInnerIterations_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_DualTVL1OpticalFlow_setInnerIterations_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getOuterIterations_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_DualTVL1OpticalFlow_setOuterIterations_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getUseInitialFlow_const(instance: *const c_void) -> Result<bool>;
		pub fn cv_DualTVL1OpticalFlow_setUseInitialFlow_bool(instance: *mut c_void, val: bool) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getScaleStep_const(instance: *const c_void) -> Result<f64>;
		pub fn cv_DualTVL1OpticalFlow_setScaleStep_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_getMedianFiltering_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_DualTVL1OpticalFlow_setMedianFiltering_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_DualTVL1OpticalFlow_create_double_double_double_int_int_double_int_int_double_double_int_bool(tau: f64, lambda: f64, theta: f64, nscales: i32, warps: i32, epsilon: f64, innner_iterations: i32, outer_iterations: i32, scale_step: f64, gamma: f64, median_filtering: i32, use_initial_flow: bool) -> Result<*mut c_void>;
...
mod videoio_sys {
	...
	extern "C" {
		...
		pub fn cv_VideoCapture_VideoCapture_const_StringX(filename: *const c_char) -> Result<*mut c_void>;
		pub fn cv_VideoCapture_VideoCapture_const_StringX_int(filename: *const c_char, api_preference: i32) -> Result<*mut c_void>;
		pub fn cv_VideoCapture_VideoCapture_int(index: i32) -> Result<*mut c_void>;
		pub fn cv_VideoCapture_open_const_StringX(instance: *mut c_void, filename: *const c_char) -> Result<bool>;
		pub fn cv_VideoCapture_open_int(instance: *mut c_void, index: i32) -> Result<bool>;
		pub fn cv_VideoCapture_open_int_int(instance: *mut c_void, camera_num: i32, api_preference: i32) -> Result<bool>;
		...
		pub fn cv_VideoWriter_write_const_MatX(instance: *mut c_void, image: *const c_void) -> Result_void;
...
mod xfeatures2d_sys {
	...
	extern "C" {
		...
		pub fn cv_xfeatures2d_DAISY_create_float_int_int_int_int_const__InputArrayX_bool_bool(radius: f32, q_radius: i32, q_theta: i32, q_hist: i32, norm: i32, h: *const c_void, interpolation: bool, use_orientation: bool) -> Result<*mut c_void>;
		...
		pub fn cv_xfeatures2d_LATCH_create_int_bool_int(bytes: i32, rotation_invariance: bool, half_ssd_size: i32) -> Result<*mut c_void>;
		...
		pub fn cv_xfeatures2d_PCTSignatures_getWeightConstrast_const(instance: *const c_void) -> Result<f32>;
		...
		pub fn cv_xfeatures2d_VGG_compute_const__InputArrayX_vector_KeyPoint_X_const__OutputArrayX(instance: *mut c_void, image: *const c_void, keypoints: *mut c_void, descriptors: *const c_void) -> Result_void;
	}
}
#[cfg(feature = "contrib")]
...
mod ximgproc_sys {
	...
	extern "C" {
		pub fn cv_ximgproc_FastHoughTransform_const__InputArrayX_const__OutputArrayX_int_int_int_int(src: *const c_void, dst: *const c_void, dst_mat_depth: i32, angle_range: i32, op: i32, make_skew: i32) -> Result_void;
		pub fn cv_ximgproc_GradientDericheX_const__InputArrayX_const__OutputArrayX_double_double(_op: *const c_void, _dst: *const c_void, alpha_derive: f64, alpha_mean: f64) -> Result_void;
		pub fn cv_ximgproc_GradientDericheY_const__InputArrayX_const__OutputArrayX_double_double(_op: *const c_void, _dst: *const c_void, alpha_derive: f64, alpha_mean: f64) -> Result_void;
		pub fn cv_ximgproc_GradientPaillouX_const__InputArrayX_const__OutputArrayX_double_double(op: *const c_void, _dst: *const c_void, alpha: f64, omega: f64) -> Result_void;
		pub fn cv_ximgproc_GradientPaillouY_const__InputArrayX_const__OutputArrayX_double_double(op: *const c_void, _dst: *const c_void, alpha: f64, omega: f64) -> Result_void;
		pub fn cv_ximgproc_HoughPoint2Line_const_PointX_const__InputArrayX_int_int_int(hough_point: *const core::Point, src_img_info: *const c_void, angle_range: i32, make_skew: i32, rules: i32) -> Result<core::Vec4i>;
		pub fn cv_ximgproc_amFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_double_double_bool(joint: *const c_void, src: *const c_void, dst: *const c_void, sigma_s: f64, sigma_r: f64, adjust_outliers: bool) -> Result_void;
		pub fn cv_ximgproc_bilateralTextureFilter_const__InputArrayX_const__OutputArrayX_int_int_double_double(src: *const c_void, dst: *const c_void, fr: i32, num_iter: i32, sigma_alpha: f64, sigma_avg: f64) -> Result_void;
		pub fn cv_ximgproc_computeBadPixelPercent_const__InputArrayX_const__InputArrayX_Rect_int(gt: *const c_void, src: *const c_void, roi: *const core::Rect, thresh: i32) -> Result<f64>;
		pub fn cv_ximgproc_computeMSE_const__InputArrayX_const__InputArrayX_Rect(gt: *const c_void, src: *const c_void, roi: *const core::Rect) -> Result<f64>;
		pub fn cv_ximgproc_covarianceEstimation_const__InputArrayX_const__OutputArrayX_int_int(src: *const c_void, dst: *const c_void, window_rows: i32, window_cols: i32) -> Result_void;
		pub fn cv_ximgproc_createAMFilter_double_double_bool(sigma_s: f64, sigma_r: f64, adjust_outliers: bool) -> Result<*mut c_void>;
		pub fn cv_ximgproc_createDTFilter_const__InputArrayX_double_double_int_int(guide: *const c_void, sigma_spatial: f64, sigma_color: f64, mode: i32, num_iters: i32) -> Result<*mut c_void>;
		...
		pub fn cv_ximgproc_createFastGlobalSmootherFilter_const__InputArrayX_double_double_double_int(guide: *const c_void, lambda: f64, sigma_color: f64, lambda_attenuation: f64, num_iter: i32) -> Result<*mut c_void>;
		pub fn cv_ximgproc_createFastLineDetector_int_float_double_double_int_bool(_length_threshold: i32, _distance_threshold: f32, _canny_th1: f64, _canny_th2: f64, _canny_aperture_size: i32, _do_merge: bool) -> Result<*mut c_void>;
		pub fn cv_ximgproc_createGuidedFilter_const__InputArrayX_int_double(guide: *const c_void, radius: i32, eps: f64) -> Result<*mut c_void>;
		...
		pub fn cv_ximgproc_createStructuredEdgeDetection_const_StringX_Ptr_RFFeatureGetter_(model: *const c_char, how_to_get_features: *const c_void) -> Result<*mut c_void>;
		pub fn cv_ximgproc_createSuperpixelLSC_const__InputArrayX_int_float(image: *const c_void, region_size: i32, ratio: f32) -> Result<*mut c_void>;
		...
		pub fn cv_ximgproc_createSuperpixelSLIC_const__InputArrayX_int_int_float(image: *const c_void, algorithm: i32, region_size: i32, ruler: f32) -> Result<*mut c_void>;
		pub fn cv_ximgproc_dtFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_double_double_int_int(guide: *const c_void, src: *const c_void, dst: *const c_void, sigma_spatial: f64, sigma_color: f64, mode: i32, num_iters: i32) -> Result_void;
		pub fn cv_ximgproc_fastGlobalSmootherFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_double_double_double_int(guide: *const c_void, src: *const c_void, dst: *const c_void, lambda: f64, sigma_color: f64, lambda_attenuation: f64, num_iter: i32) -> Result_void;
		pub fn cv_ximgproc_getDisparityVis_const__InputArrayX_const__OutputArrayX_double(src: *const c_void, dst: *const c_void, scale: f64) -> Result_void;
		pub fn cv_ximgproc_guidedFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_double_int(guide: *const c_void, src: *const c_void, dst: *const c_void, radius: i32, eps: f64, d_depth: i32) -> Result_void;
		pub fn cv_ximgproc_jointBilateralFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_double_double_int(joint: *const c_void, src: *const c_void, dst: *const c_void, d: i32, sigma_color: f64, sigma_space: f64, border_type: i32) -> Result_void;
		pub fn cv_ximgproc_l0Smooth_const__InputArrayX_const__OutputArrayX_double_double(src: *const c_void, dst: *const c_void, lambda: f64, kappa: f64) -> Result_void;
		pub fn cv_ximgproc_niBlackThreshold_const__InputArrayX_const__OutputArrayX_double_int_int_double(_src: *const c_void, _dst: *const c_void, max_value: f64, typ: i32, block_size: i32, delta: f64) -> Result_void;
		pub fn cv_ximgproc_readGT_String_const__OutputArrayX(src_path: *mut c_char, dst: *const c_void) -> Result<i32>;
		pub fn cv_ximgproc_rollingGuidanceFilter_const__InputArrayX_const__OutputArrayX_int_double_double_int_int(src: *const c_void, dst: *const c_void, d: i32, sigma_color: f64, sigma_space: f64, num_of_iter: i32, border_type: i32) -> Result_void;
		...
		pub fn cv_ximgproc_thinning_const__InputArrayX_const__OutputArrayX_int(src: *const c_void, dst: *const c_void, thinning_type: i32) -> Result_void;
		pub fn cv_ximgproc_weightedMedianFilter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_int_double_WMFWeightType_Mat(joint: *const c_void, src: *const c_void, dst: *const c_void, r: i32, sigma: f64, weight_type: crate::ximgproc::WMFWeightType, mask: *mut c_void) -> Result_void;
		pub fn cv_ximgproc_AdaptiveManifoldFilter_filter_const__InputArrayX_const__OutputArrayX_const__InputArrayX(instance: *mut c_void, src: *const c_void, dst: *const c_void, joint: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_DTFilter_filter_const__InputArrayX_const__OutputArrayX_int(instance: *mut c_void, src: *const c_void, dst: *const c_void, d_depth: i32) -> Result_void;
		pub fn cv_ximgproc_DisparityFilter_filter_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__InputArrayX_Rect_const__InputArrayX(instance: *mut c_void, disparity_map_left: *const c_void, left_view: *const c_void, filtered_disparity_map: *const c_void, disparity_map_right: *const c_void, roi: *const core::Rect, right_view: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_FastGlobalSmootherFilter_filter_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, src: *const c_void, dst: *const c_void) -> Result_void;
		pub fn cv_ximgproc_FastLineDetector_detect_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, _image: *const c_void, _lines: *const c_void) -> Result_void;
		pub fn cv_ximgproc_FastLineDetector_drawSegments_const__InputOutputArrayX_const__InputArrayX_bool(instance: *mut c_void, _image: *const c_void, lines: *const c_void, draw_arrow: bool) -> Result_void;
		pub fn cv_ximgproc_GuidedFilter_filter_const__InputArrayX_const__OutputArrayX_int(instance: *mut c_void, src: *const c_void, dst: *const c_void, d_depth: i32) -> Result_void;
		pub fn cv_ximgproc_RFFeatureGetter_getFeatures_const_const_MatX_MatX_int_int_int_int_int(instance: *const c_void, src: *const c_void, features: *mut c_void, gnrm_rad: i32, gsmth_rad: i32, shrink: i32, out_num: i32, grad_num: i32) -> Result_void;
		pub fn cv_ximgproc_SparseMatchInterpolator_interpolate_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, from_image: *const c_void, from_points: *const c_void, to_image: *const c_void, to_points: *const c_void, dense_flow: *const c_void) -> Result_void;
		pub fn cv_ximgproc_StructuredEdgeDetection_detectEdges_const_const_MatX_MatX(instance: *const c_void, src: *const c_void, dst: *mut c_void) -> Result_void;
		...
		pub fn cv_ximgproc_SuperpixelLSC_getLabels_const_const__OutputArrayX(instance: *const c_void, labels_out: *const c_void) -> Result_void;
		pub fn cv_ximgproc_SuperpixelLSC_getLabelContourMask_const_const__OutputArrayX_bool(instance: *const c_void, image: *const c_void, thick_line: bool) -> Result_void;
		...
		pub fn cv_ximgproc_SuperpixelSEEDS_iterate_const__InputArrayX_int(instance: *mut c_void, img: *const c_void, num_iterations: i32) -> Result_void;
		pub fn cv_ximgproc_SuperpixelSEEDS_getLabels_const__OutputArrayX(instance: *mut c_void, labels_out: *const c_void) -> Result_void;
		pub fn cv_ximgproc_SuperpixelSEEDS_getLabelContourMask_const__OutputArrayX_bool(instance: *mut c_void, image: *const c_void, thick_line: bool) -> Result_void;
		...
		pub fn cv_ximgproc_SuperpixelSLIC_getLabels_const_const__OutputArrayX(instance: *const c_void, labels_out: *const c_void) -> Result_void;
		pub fn cv_ximgproc_SuperpixelSLIC_getLabelContourMask_const_const__OutputArrayX_bool(instance: *const c_void, image: *const c_void, thick_line: bool) -> Result_void;
		pub fn cv_ximgproc_SuperpixelSLIC_enforceLabelConnectivity_int(instance: *mut c_void, min_element_size: i32) -> Result_void;
		pub fn cv_ximgproc_segmentation_GraphSegmentation_processImage_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, src: *const c_void, dst: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_segmentation_SelectiveSearchSegmentation_setBaseImage_const__InputArrayX(instance: *mut c_void, img: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_segmentation_SelectiveSearchSegmentation_addImage_const__InputArrayX(instance: *mut c_void, img: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_segmentation_SelectiveSearchSegmentation_process_vector_Rect_X(instance: *mut c_void, rects: *mut c_void) -> Result_void;
		pub fn cv_ximgproc_segmentation_SelectiveSearchSegmentationStrategy_setImage_const__InputArrayX_const__InputArrayX_const__InputArrayX_int(instance: *mut c_void, img: *const c_void, regions: *const c_void, sizes: *const c_void, image_id: i32) -> Result_void;
