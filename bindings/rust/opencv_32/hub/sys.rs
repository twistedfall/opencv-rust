...
mod aruco_sys {
	...
	extern "C" {
		...
		pub fn cv_aruco_estimatePoseBoard_const__InputArrayR_const__InputArrayR_const_Ptr_Board_R_const__InputArrayR_const__InputArrayR_const__OutputArrayR_const__OutputArrayR(corners: *const c_void, ids: *const c_void, board: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void) -> Result<i32>;
		pub fn cv_aruco_estimatePoseCharucoBoard_const__InputArrayR_const__InputArrayR_const_Ptr_CharucoBoard_R_const__InputArrayR_const__InputArrayR_const__OutputArrayR_const__OutputArrayR(charuco_corners: *const c_void, charuco_ids: *const c_void, board: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void) -> Result<bool>;
		pub fn cv_aruco_estimatePoseSingleMarkers_const__InputArrayR_float_const__InputArrayR_const__InputArrayR_const__OutputArrayR_const__OutputArrayR(corners: *const c_void, marker_length: f32, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvecs: *const c_void, tvecs: *const c_void) -> Result_void;
		pub fn cv_aruco_generateCustomDictionary_int_int(n_markers: i32, marker_size: i32) -> Result<*mut c_void>;
		pub fn cv_aruco_generateCustomDictionary_int_int_const_Ptr_Dictionary_R(n_markers: i32, marker_size: i32, base_dictionary: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_aruco_Dictionary_create_int_int_const_Ptr_Dictionary_R(n_markers: i32, marker_size: i32, base_dictionary: *const c_void) -> Result<*mut c_void>;
...
mod bioinspired_sys {
	...
	extern "C" {
		...
		pub fn cv_bioinspired_Retina_setup_FileStorageR_bool(instance: *mut c_void, fs: *mut c_void, apply_default_setup_on_failure: bool) -> Result_void;
		...
		pub fn cv_bioinspired_TransientAreasSegmentationModule_setup_FileStorageR_bool(instance: *mut c_void, fs: *mut c_void, apply_default_setup_on_failure: bool) -> Result_void;
		...
		pub fn cv_bioinspired_TransientAreasSegmentationModule_run_const__InputArrayR_int(instance: *mut c_void, input_to_segment: *const c_void, channel_index: i32) -> Result_void;
...
mod calib3d_sys {
	...
	extern "C" {
		...
		pub fn cv_findFundamentalMat_const__InputArrayR_const__InputArrayR_const__OutputArrayR_int_double_double(points1: *const c_void, points2: *const c_void, mask: *const c_void, method: i32, param1: f64, param2: f64) -> Result<*mut c_void>;
		pub fn cv_findFundamentalMat_const__InputArrayR_const__InputArrayR_int_double_double_const__OutputArrayR(points1: *const c_void, points2: *const c_void, method: i32, param1: f64, param2: f64, mask: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_findHomography_const__InputArrayR_const__InputArrayR_int_double_const__OutputArrayR_int_double(src_points: *const c_void, dst_points: *const c_void, method: i32, ransac_reproj_threshold: f64, mask: *const c_void, max_iters: i32, confidence: f64) -> Result<*mut c_void>;
...
mod ccalib_sys {
	...
	extern "C" {
		...
		pub fn cv_ccalib_CustomPattern_create_const__InputArrayR_Size2f_const__OutputArrayR(instance: *mut c_void, pattern: *const c_void, board_size: *const core::Size2f, output: *const c_void) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_findPattern_const__InputArrayR_const__OutputArrayR_const__OutputArrayR_double_double_bool_const__OutputArrayR_const__OutputArrayR_const__OutputArrayR(instance: *mut c_void, image: *const c_void, matched_features: *const c_void, pattern_points: *const c_void, ratio: f64, proj_error: f64, refine_position: bool, out: *const c_void, h: *const c_void, pattern_corners: *const c_void) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_isInitialized(instance: *mut c_void) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_getPatternPoints_const__OutputArrayR(instance: *mut c_void, original_points: *const c_void) -> Result_void;
		...
		pub fn cv_ccalib_CustomPattern_findRt_const__InputArrayR_const__InputArrayR_const__InputArrayR_const__InputArrayR_const__OutputArrayR_const__OutputArrayR_bool_int(instance: *mut c_void, object_points: *const c_void, image_points: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, flags: i32) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_findRt_const__InputArrayR_const__InputArrayR_const__InputArrayR_const__OutputArrayR_const__OutputArrayR_bool_int(instance: *mut c_void, image: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, flags: i32) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_findRtRANSAC_const__InputArrayR_const__InputArrayR_const__InputArrayR_const__InputArrayR_const__OutputArrayR_const__OutputArrayR_bool_int_float_int_const__OutputArrayR_int(instance: *mut c_void, object_points: *const c_void, image_points: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, iterations_count: i32, reprojection_error: f32, min_inliers_count: i32, inliers: *const c_void, flags: i32) -> Result<bool>;
		pub fn cv_ccalib_CustomPattern_findRtRANSAC_const__InputArrayR_const__InputArrayR_const__InputArrayR_const__OutputArrayR_const__OutputArrayR_bool_int_float_int_const__OutputArrayR_int(instance: *mut c_void, image: *const c_void, camera_matrix: *const c_void, dist_coeffs: *const c_void, rvec: *const c_void, tvec: *const c_void, use_extrinsic_guess: bool, iterations_count: i32, reprojection_error: f32, min_inliers_count: i32, inliers: *const c_void, flags: i32) -> Result<bool>;
...
mod core_sys {
	...
	extern "C" {
		...
		pub fn cv_PSNR_const__InputArrayR_const__InputArrayR(src1: *const c_void, src2: *const c_void) -> Result<f64>;
		...
		pub fn cv_completeSymm_const__InputOutputArrayR_bool(mtx: *const c_void, lower_to_upper: bool) -> Result_void;
		...
		pub fn cv_errorNoReturn_int_const_StringR_const_charX_const_charX_int(_code: i32, _err: *const c_char, _func: *const c_char, _file: *const c_char, _line: i32) -> Result_void;
		...
		pub fn cv_extractImageCOI_const_CvArrX_const__OutputArrayR_int(arr: *const c_void, coiimg: *const c_void, coi: i32) -> Result_void;
		...
		pub fn cv_insertImageCOI_const__InputArrayR_CvArrX_int(coiimg: *const c_void, arr: *mut c_void, coi: i32) -> Result_void;
		...
		pub fn cv_solveLP_const_MatR_const_MatR_MatR(func: *const c_void, constr: *const c_void, z: *mut c_void) -> Result<i32>;
		...
		pub fn cv_AutoLock_AutoLock_MutexR(m: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_FileNode_readRaw_const_const_StringR_unsigned_charX_size_t(instance: *const c_void, fmt: *const c_char, vec: *mut u8, len: size_t) -> Result_void;
		...
		pub fn cv_FileNodeIterator_readRaw_const_StringR_unsigned_charX_size_t(instance: *mut c_void, fmt: *const c_char, vec: *mut u8, max_count: size_t) -> Result<*mut c_void>;
		...
		pub fn cv_FileStorage_FileStorage_const_StringR_int_const_StringR(source: *const c_char, flags: i32, encoding: *const c_char) -> Result<*mut c_void>;
		...
		pub fn cv_FileStorage_writeRaw_const_StringR_const_unsigned_charX_size_t(instance: *mut c_void, fmt: *const c_char, vec: *const u8, len: size_t) -> Result_void;
		pub fn cv_FileStorage_writeObj_const_StringR_const_voidX(instance: *mut c_void, name: *const c_char, obj: *const c_void) -> Result_void;
		...
		pub fn cv_Mutex_Mutex_const_MutexR(m: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv__InputOutputArray__InputOutputArray_vector_bool_R(vec: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv__OutputArray__OutputArray_vector_bool_R(vec: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_ocl_Program_Program_const_StringR(buf: *const c_char) -> Result<*mut c_void>;
...
mod dnn_sys {
	...
	extern "C" {
		pub fn cv_dnn_createCaffeImporter_const_StringR_const_StringR(prototxt: *const c_char, caffe_model: *const c_char) -> Result<*mut c_void>;
		pub fn cv_dnn_createTensorflowImporter_const_StringR(model: *const c_char) -> Result<*mut c_void>;
		pub fn cv_dnn_createTorchImporter_const_StringR_bool(filename: *const c_char, is_binary: bool) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_Blob_Blob_const_BlobShapeR_int_int(shape: *const c_void, typ: i32, alloc_flags: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_Blob_const__InputArrayR(data: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_fromImages_const__InputArrayR_int(image: *const c_void, dst_cn: i32) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_batchFromImages_const__InputArrayR_int(instance: *mut c_void, image: *const c_void, dst_cn: i32) -> Result_void;
		pub fn cv_dnn_Blob_create_const_BlobShapeR_int_int(instance: *mut c_void, shape: *const c_void, typ: i32, alloc_flags: i32) -> Result_void;
		pub fn cv_dnn_Blob_fill_const__InputArrayR(instance: *mut c_void, in_: *const c_void) -> Result_void;
		pub fn cv_dnn_Blob_fill_const_BlobShapeR_int_voidX_bool(instance: *mut c_void, shape: *const c_void, typ: i32, data: *mut c_void, deep_copy: bool) -> Result_void;
		pub fn cv_dnn_Blob_setTo_const__InputArrayR_int(instance: *mut c_void, value: *const c_void, alloc_flags: i32) -> Result_void;
		...
		pub fn cv_dnn_Blob_equalShape_const_const_BlobR(instance: *const c_void, other: *const c_void) -> Result<bool>;
		...
		pub fn cv_dnn_Blob_shareFrom_const_BlobR(instance: *mut c_void, blob: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_reshape_const_BlobShapeR(instance: *mut c_void, shape: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Blob_reshaped_const_const_BlobShapeR(instance: *const c_void, new_shape: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_BlobShape_BlobShape_const_vector_int_R(sizes: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_BlobShape_equal_const_const_BlobShapeR(instance: *const c_void, other: *const c_void) -> Result<bool>;
		pub fn cv_dnn_BlobShape_operatorA_const_const_BlobShapeR(instance: *const c_void, r: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_like_const_MatR(m: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_BlobShape_like_const_UMatR(m: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_CropLayer_create_int_const_vector_int_R(start_axis: i32, offset: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_EltwiseLayer_create_EltwiseOp_const_vector_int_R(op: crate::dnn::EltwiseLayer_EltwiseOp, coeffs: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_LSTMLayer_setWeights_const_BlobR_const_BlobR_const_BlobR(instance: *mut c_void, wh: *const c_void, wx: *const c_void, b: *const c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_setOutShape_const_BlobShapeR(instance: *mut c_void, out_tail_shape: *const c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_setH_const_BlobR(instance: *mut c_void, h: *const c_void) -> Result_void;
		pub fn cv_dnn_LSTMLayer_getH_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_LSTMLayer_setC_const_BlobR(instance: *mut c_void, c: *const c_void) -> Result_void;
		...
		pub fn cv_dnn_LSTMLayer_forward_vector_BlobX_R_vector_Blob_R(instance: *mut c_void, input: *mut c_void, output: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_Layer_allocate_const_vector_BlobX_R_vector_Blob_R(instance: *mut c_void, input: *const c_void, output: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_forward_vector_BlobX_R_vector_Blob_R(instance: *mut c_void, input: *mut c_void, output: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_allocate_const_vector_Blob_R_vector_Blob_R(instance: *mut c_void, inputs: *const c_void, outputs: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_allocate_const_vector_Blob_R(instance: *mut c_void, inputs: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dnn_Layer_forward_const_vector_Blob_R_vector_Blob_R(instance: *mut c_void, inputs: *const c_void, outputs: *mut c_void) -> Result_void;
		pub fn cv_dnn_Layer_run_const_vector_Blob_R_vector_Blob_R(instance: *mut c_void, inputs: *const c_void, outputs: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_LayerFactory_registerLayer_const_StringR_Constuctor(typ: *const c_char, constructor: Option<unsafe extern "C" fn(*mut c_void) -> *mut c_void>) -> Result_void;
		...
		pub fn cv_dnn_Net_setNetInputs_const_vector_String_R(instance: *mut c_void, input_blob_names: *const c_void) -> Result_void;
		...
		pub fn cv_dnn_Net_forward_const_vector_LayerId_R_const_vector_LayerId_R(instance: *mut c_void, start_layers: *const c_void, to_layers: *const c_void) -> Result_void;
		pub fn cv_dnn_Net_forwardOpt_LayerId(instance: *mut c_void, to_layer: *mut c_void) -> Result_void;
		pub fn cv_dnn_Net_forwardOpt_const_vector_LayerId_R(instance: *mut c_void, to_layers: *const c_void) -> Result_void;
		pub fn cv_dnn_Net_setBlob_String_const_BlobR(instance: *mut c_void, output_name: *mut c_char, blob: *const c_void) -> Result_void;
		pub fn cv_dnn_Net_getBlob_String(instance: *mut c_void, output_name: *mut c_char) -> Result<*mut c_void>;
		pub fn cv_dnn_Net_setParam_LayerId_int_const_BlobR(instance: *mut c_void, layer: *mut c_void, num_param: i32, blob: *const c_void) -> Result_void;
		...
		pub fn cv_dnn_PoolingLayer_create_int_Size_Size_Size_const_StringR(typ: i32, kernel: *const core::Size, stride: *const core::Size, pad: *const core::Size, pad_mode: *const c_char) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_RNNLayer_setWeights_const_BlobR_const_BlobR_const_BlobR_const_BlobR_const_BlobR(instance: *mut c_void, wxh: *const c_void, bh: *const c_void, whh: *const c_void, who: *const c_void, bo: *const c_void) -> Result_void;
		pub fn cv_dnn_RNNLayer_setProduceHiddenOutput_bool(instance: *mut c_void, produce: bool) -> Result_void;
		pub fn cv_dnn_RNNLayer_forward_vector_BlobX_R_vector_Blob_R(instance: *mut c_void, input: *mut c_void, output: *mut c_void) -> Result_void;
		...
		pub fn cv_dnn_ReshapeLayer_create_const_BlobShapeR_Range_bool(new_shape: *const c_void, applying_range: *mut c_void, enable_reordering: bool) -> Result<*mut c_void>;
		...
		pub fn cv_dnn_SliceLayer_create_int_const_vector_int_R(axis: i32, slice_indices: *const c_void) -> Result<*mut c_void>;
...
mod face_sys {
	...
	extern "C" {
		...
		pub fn cv_face_FaceRecognizer_save_const_const_StringR(instance: *const c_void, filename: *const c_char) -> Result_void;
		pub fn cv_face_FaceRecognizer_load_const_StringR(instance: *mut c_void, filename: *const c_char) -> Result_void;
		pub fn cv_face_FaceRecognizer_save_const_FileStorageR(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_face_FaceRecognizer_load_const_FileStorageR(instance: *mut c_void, fs: *const c_void) -> Result_void;
...
mod features2d_sys {
	...
	extern "C" {
		...
		pub fn cv_AGAST_const__InputArrayR_vector_KeyPoint_R_int_bool_int(image: *const c_void, keypoints: *mut c_void, threshold: i32, nonmax_suppression: bool, typ: i32) -> Result_void;
		...
		pub fn cv_FAST_const__InputArrayR_vector_KeyPoint_R_int_bool_int(image: *const c_void, keypoints: *mut c_void, threshold: i32, nonmax_suppression: bool, typ: i32) -> Result_void;
		...
		pub fn cv_drawKeypoints_const__InputArrayR_const_vector_KeyPoint_R_const__InputOutputArrayR_const_ScalarR_int(image: *const c_void, keypoints: *const c_void, out_image: *const c_void, color: *const core::Scalar, flags: i32) -> Result_void;
		pub fn cv_drawMatches_const__InputArrayR_const_vector_KeyPoint_R_const__InputArrayR_const_vector_KeyPoint_R_const_vector_DMatch_R_const__InputOutputArrayR_const_ScalarR_const_ScalarR_const_vector_char_R_int(img1: *const c_void, keypoints1: *const c_void, img2: *const c_void, keypoints2: *const c_void, matches1to2: *const c_void, out_img: *const c_void, match_color: *const core::Scalar, single_point_color: *const core::Scalar, matches_mask: *const c_void, flags: i32) -> Result_void;
		pub fn cv_drawMatches_const__InputArrayR_const_vector_KeyPoint_R_const__InputArrayR_const_vector_KeyPoint_R_const_vector_vector_DMatch__R_const__InputOutputArrayR_const_ScalarR_const_ScalarR_const_vector_vector_char__R_int(img1: *const c_void, keypoints1: *const c_void, img2: *const c_void, keypoints2: *const c_void, matches1to2: *const c_void, out_img: *const c_void, match_color: *const core::Scalar, single_point_color: *const core::Scalar, matches_mask: *const c_void, flags: i32) -> Result_void;
...
mod flann_sys {
	...
	extern "C" {
		...
		pub fn cv_flann_IndexParams_getAll_const_vector_String_R_vector_int_R_vector_String_R_vector_double_R(instance: *const c_void, names: *mut c_void, types: *mut c_void, str_values: *mut c_void, num_values: *mut c_void) -> Result_void;
...
mod fuzzy_sys {
	...
	extern "C" {
		pub fn cv_ft_FT02D_components_const__InputArrayR_const__InputArrayR_const__OutputArrayR(matrix: *const c_void, kernel: *const c_void, components: *const c_void) -> Result_void;
		...
		pub fn cv_ft_FT02D_process_const__InputArrayR_const__InputArrayR_const__OutputArrayR(matrix: *const c_void, kernel: *const c_void, output: *const c_void) -> Result_void;
		...
		pub fn cv_ft_createKernel_const__InputArrayR_const__InputArrayR_const__OutputArrayR_int(a: *const c_void, b: *const c_void, kernel: *const c_void, chn: i32) -> Result_void;
		pub fn cv_ft_createKernel_int_int_const__OutputArrayR_int(function: i32, radius: i32, kernel: *const c_void, chn: i32) -> Result_void;
...
mod hdf_sys {
	...
	extern "C" {
		...
		pub fn cv_hdf_HDF5_dscreate_const_int_int_int_String_int_const_vector_int_R(instance: *const c_void, rows: i32, cols: i32, typ: i32, dslabel: *mut c_char, compresslevel: i32, dims_chunks: *const c_void) -> Result_void;
		...
		pub fn cv_hdf_HDF5_dscreate_const_const_vector_int_R_int_String_int_const_vector_int_R(instance: *const c_void, sizes: *const c_void, typ: i32, dslabel: *mut c_char, compresslevel: i32, dims_chunks: *const c_void) -> Result_void;
		...
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayR_String(instance: *const c_void, array: *const c_void, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayR_String_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayR_String_const_vector_int_R_const_vector_int_R(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const c_void, dims_counts: *const c_void) -> Result_void;
		pub fn cv_hdf_HDF5_dswrite_const_const__InputArrayR_String_const_intX_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32, dims_counts: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsinsert_const_const__InputArrayR_String(instance: *const c_void, array: *const c_void, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dsinsert_const_const__InputArrayR_String_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsinsert_const_const__InputArrayR_String_const_vector_int_R_const_vector_int_R(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const c_void, dims_counts: *const c_void) -> Result_void;
		pub fn cv_hdf_HDF5_dsinsert_const_const__InputArrayR_String_const_intX_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32, dims_counts: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayR_String(instance: *const c_void, array: *const c_void, dslabel: *mut c_char) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayR_String_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayR_String_const_vector_int_R_const_vector_int_R(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const c_void, dims_counts: *const c_void) -> Result_void;
		pub fn cv_hdf_HDF5_dsread_const_const__OutputArrayR_String_const_intX_const_intX(instance: *const c_void, array: *const c_void, dslabel: *mut c_char, dims_offset: *const i32, dims_counts: *const i32) -> Result_void;
		...
		pub fn cv_hdf_HDF5_kpread_const_vector_KeyPoint_R_String_int_int(instance: *const c_void, keypoints: *mut c_void, kplabel: *mut c_char, offset: i32, counts: i32) -> Result_void;
	}
}
#[cfg(feature = "contrib")]
pub use hdf_sys::*;
...
mod imgproc_sys {
	...
	extern "C" {
		...
		pub fn cv_boundingRect_const__InputArrayR(points: *const c_void) -> Result<core::Rect>;
		...
		pub fn cv_demosaicing_const__InputArrayR_const__OutputArrayR_int_int(_src: *const c_void, _dst: *const c_void, code: i32, dcn: i32) -> Result_void;
		...
		pub fn cv_drawMarker_MatR_Point_const_ScalarR_int_int_int_int(img: *mut c_void, position: *const core::Point, color: *const core::Scalar, marker_type: i32, marker_size: i32, thickness: i32, line_type: i32) -> Result_void;
		...
		pub fn cv_findContours_const__InputOutputArrayR_const__OutputArrayR_const__OutputArrayR_int_int_Point(image: *const c_void, contours: *const c_void, hierarchy: *const c_void, mode: i32, method: i32, offset: *const core::Point) -> Result_void;
		pub fn cv_findContours_const__InputOutputArrayR_const__OutputArrayR_int_int_Point(image: *const c_void, contours: *const c_void, mode: i32, method: i32, offset: *const core::Point) -> Result_void;
		...
		pub fn cv_getPerspectiveTransform_const__InputArrayR_const__InputArrayR(src: *const c_void, dst: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_rectangle_MatR_Rect_const_ScalarR_int_int_int(img: *mut c_void, rec: *const core::Rect, color: *const core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result_void;
		...
		pub fn cv_sqrBoxFilter_const__InputArrayR_const__OutputArrayR_int_Size_Point_bool_int(_src: *const c_void, _dst: *const c_void, ddepth: i32, ksize: *const core::Size, anchor: *const core::Point, normalize: bool, border_type: i32) -> Result_void;
...
mod objdetect_sys {
	...
	extern "C" {
		...
		pub fn cv_HOGDescriptor_setSVMDetector_const__InputArrayR(instance: *mut c_void, _svmdetector: *const c_void) -> Result_void;
		...
		pub fn cv_HOGDescriptor_detect_const_const_MatR_vector_Point_R_vector_double_R_double_Size_Size_const_vector_Point_R(instance: *const c_void, img: *const c_void, found_locations: *mut c_void, weights: *mut c_void, hit_threshold: f64, win_stride: *const core::Size, padding: *const core::Size, search_locations: *const c_void) -> Result_void;
		pub fn cv_HOGDescriptor_detect_const_const_MatR_vector_Point_R_double_Size_Size_const_vector_Point_R(instance: *const c_void, img: *const c_void, found_locations: *mut c_void, hit_threshold: f64, win_stride: *const core::Size, padding: *const core::Size, search_locations: *const c_void) -> Result_void;
		...
		pub fn cv_HOGDescriptor_computeGradient_const_const_MatR_MatR_MatR_Size_Size(instance: *const c_void, img: *const c_void, grad: *mut c_void, angle_ofs: *mut c_void, padding_tl: *const core::Size, padding_br: *const core::Size) -> Result_void;
		...
		pub fn cv_HOGDescriptor_detectROI_const_const_MatR_const_vector_Point_R_vector_Point_R_vector_double_R_double_Size_Size(instance: *const c_void, img: *const c_void, locations: *const c_void, found_locations: *mut c_void, confidences: *mut c_void, hit_threshold: f64, win_stride: *const core::Size, padding: *const core::Size) -> Result_void;
		pub fn cv_HOGDescriptor_detectMultiScaleROI_const_const_MatR_vector_Rect_R_vector_DetectionROI_R_double_int(instance: *const c_void, img: *const c_void, found_locations: *mut c_void, locations: *mut c_void, hit_threshold: f64, group_threshold: i32) -> Result_void;
...
mod optflow_sys {
	...
	extern "C" {
		...
		pub fn cv_optflow_readOpticalFlow_const_StringR(path: *const c_char) -> Result<*mut c_void>;
		pub fn cv_optflow_writeOpticalFlow_const_StringR_const__InputArrayR(path: *const c_char, flow: *const c_void) -> Result<bool>;
		...
		pub fn cv_optflow_GPCTrainingParams_GPCTrainingParams_const_GPCTrainingParamsR(params: *const crate::optflow::GPCTrainingParams) -> Result<crate::optflow::GPCTrainingParams>;
		...
		pub fn cv_optflow_GPCTree_train_GPCTrainingSamplesR_GPCTrainingParams(instance: *mut c_void, samples: *mut c_void, params: *const crate::optflow::GPCTrainingParams) -> Result_void;
		...
		pub fn cv_optflow_VariationalRefinement_calcUV_const__InputArrayR_const__InputArrayR_const__InputOutputArrayR_const__InputOutputArrayR(instance: *mut c_void, i0: *const c_void, i1: *const c_void, flow_u: *const c_void, flow_v: *const c_void) -> Result_void;
...
mod phase_unwrapping_sys {
	...
	extern "C" {
		pub fn cv_phase_unwrapping_HistogramPhaseUnwrapping_create_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
...
mod photo_sys {
	...
	extern "C" {
		...
		pub fn cv_AlignMTB_shiftMat_const__InputArrayR_const__OutputArrayR_Point(instance: *mut c_void, src: *const c_void, dst: *const c_void, shift: *const core::Point) -> Result_void;
...
mod plot_sys {
	...
	extern "C" {
		pub fn cv_plot_createPlot2d_const__InputArrayR(data: *const c_void) -> Result<*mut c_void>;
		pub fn cv_plot_createPlot2d_const__InputArrayR_const__InputArrayR(data_x: *const c_void, data_y: *const c_void) -> Result<*mut c_void>;
...
mod rgbd_sys {
	...
	extern "C" {
		...
		pub fn cv_rgbd_rescaleDepth_const__InputArrayR_int_const__OutputArrayR(in_: *const c_void, depth: i32, out: *const c_void) -> Result_void;
		pub fn cv_rgbd_warpFrame_const_MatR_const_MatR_const_MatR_const_MatR_const_MatR_const_MatR_MatR_MatX_MatX(image: *const c_void, depth: *const c_void, mask: *const c_void, rt: *const c_void, camera_matrix: *const c_void, dist_coeff: *const c_void, warped_image: *mut c_void, warped_depth: *mut c_void, warped_mask: *mut c_void) -> Result_void;
		...
		pub fn cv_linemod_Feature_read_const_FileNodeR(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_linemod_Feature_write_const_FileStorageR(instance: *const c_void, fs: *mut c_void) -> Result_void;
		...
		pub fn cv_rgbd_Odometry_compute_const_const_MatR_const_MatR_const_MatR_const_MatR_const_MatR_const_MatR_MatR_const_MatR(instance: *const c_void, src_image: *const c_void, src_depth: *const c_void, src_mask: *const c_void, dst_image: *const c_void, dst_depth: *const c_void, dst_mask: *const c_void, rt: *mut c_void, init_rt: *const c_void) -> Result<bool>;
		pub fn cv_rgbd_Odometry_compute_const_Ptr_OdometryFrame_R_Ptr_OdometryFrame_R_MatR_const_MatR(instance: *const c_void, src_frame: *mut c_void, dst_frame: *mut c_void, rt: *mut c_void, init_rt: *const c_void) -> Result<bool>;
...
mod saliency_sys {
	...
	extern "C" {
		...
		pub fn cv_saliency_Saliency_create_const_StringR(saliency_type: *const c_char) -> Result<*mut c_void>;
...
mod sfm_sys {
	...
	extern "C" {
		...
		pub fn cv_sfm_reconstruct_vector_string__const__OutputArrayR_const__OutputArrayR_const__InputOutputArrayR_bool(images: *const c_void, ps: *const c_void, points3d: *const c_void, k: *const c_void, is_projective: bool) -> Result_void;
		pub fn cv_sfm_reconstruct_vector_string__const__OutputArrayR_const__OutputArrayR_const__InputOutputArrayR_const__OutputArrayR_bool(images: *const c_void, rs: *const c_void, ts: *const c_void, k: *const c_void, points3d: *const c_void, is_projective: bool) -> Result_void;
...
mod stereo_sys {
	...
	extern "C" {
		pub fn cv_stereo_censusTransform_const_MatR_const_MatR_int_MatR_MatR_int(image1: *const c_void, image2: *const c_void, kernel_size: i32, dist1: *mut c_void, dist2: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_stereo_censusTransform_const_MatR_int_MatR_int(image1: *const c_void, kernel_size: i32, dist1: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_stereo_modifiedCensusTransform_const_MatR_const_MatR_int_MatR_MatR_int_int_const_MatR_const_MatR(img1: *const c_void, img2: *const c_void, kernel_size: i32, dist1: *mut c_void, dist2: *mut c_void, typ: i32, t: i32, integral_image1: *const c_void, integral_image2: *const c_void) -> Result_void;
		pub fn cv_stereo_modifiedCensusTransform_const_MatR_int_MatR_int_int_const_MatR(img1: *const c_void, kernel_size: i32, dist: *mut c_void, typ: i32, t: i32, integral_image: *const c_void) -> Result_void;
		...
		pub fn cv_stereo_symetricCensusTransform_const_MatR_const_MatR_int_MatR_MatR_int(img1: *const c_void, img2: *const c_void, kernel_size: i32, dist1: *mut c_void, dist2: *mut c_void, typ: i32) -> Result_void;
		pub fn cv_stereo_symetricCensusTransform_const_MatR_int_MatR_int(img1: *const c_void, kernel_size: i32, dist1: *mut c_void, typ: i32) -> Result_void;
	}
}
#[cfg(feature = "contrib")]
pub use stereo_sys::*;
...
mod stitching_sys {
	...
	extern "C" {
		...
		pub fn cv_Stitcher_estimateTransform_const__InputArrayR(instance: *mut c_void, images: *const c_void) -> Result<crate::stitching::Stitcher_Status>;
		pub fn cv_Stitcher_estimateTransform_const__InputArrayR_const_vector_vector_Rect__R(instance: *mut c_void, images: *const c_void, rois: *const c_void) -> Result<crate::stitching::Stitcher_Status>;
		...
		pub fn cv_Stitcher_stitch_const__InputArrayR_const_vector_vector_Rect__R_const__OutputArrayR(instance: *mut c_void, images: *const c_void, rois: *const c_void, pano: *const c_void) -> Result<crate::stitching::Stitcher_Status>;
...
mod structured_light_sys {
	...
	extern "C" {
		...
		pub fn cv_structured_light_SinusoidalPattern_create_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_structured_light_StructuredLightPattern_decode_const_const__InputArrayR_const__OutputArrayR_const__InputArrayR_const__InputArrayR_int(instance: *const c_void, pattern_images: *const c_void, disparity_map: *const c_void, black_images: *const c_void, white_images: *const c_void, flags: i32) -> Result<bool>;
	}
}
#[cfg(feature = "contrib")]
...
mod surface_matching_sys {
	...
	extern "C" {
		...
		pub fn cv_ppf_match_3d_ICP_registerModelToScene_const_MatR_const_MatR_doubleR_double_X__16_(instance: *mut c_void, src_pc: *const c_void, dst_pc: *const c_void, residual: *mut f64, pose: *mut [f64; 16]) -> Result<i32>;
		...
		pub fn cv_ppf_match_3d_PPF3DDetector_match_const_MatR_vector_Pose3DPtr_R_double_double(instance: *mut c_void, scene: *const c_void, results: *mut c_void, relative_scene_sample_step: f64, relative_scene_distance: f64) -> Result_void;
		#[cfg(not(target_os = "windows"))]
...
mod text_sys {
	...
	extern "C" {
		...
		pub fn cv_text_OCRBeamSearchDecoder_create_Ptr_ClassifierCallback__const_stringR_const__InputArrayR_const__InputArrayR_decoder_mode_int(classifier: *const c_void, vocabulary: *const c_char, transition_probabilities_table: *const c_void, emission_probabilities_table: *const c_void, mode: crate::text::decoder_mode, beam_size: i32) -> Result<*mut c_void>;
		pub fn cv_text_OCRBeamSearchDecoder_create_Ptr_ClassifierCallback__const_StringR_const__InputArrayR_const__InputArrayR_int_int(classifier: *const c_void, vocabulary: *const c_char, transition_probabilities_table: *const c_void, emission_probabilities_table: *const c_void, mode: i32, beam_size: i32) -> Result<*mut c_void>;
		...
		pub fn cv_text_OCRHMMDecoder_create_Ptr_ClassifierCallback__const_stringR_const__InputArrayR_const__InputArrayR_decoder_mode(classifier: *const c_void, vocabulary: *const c_char, transition_probabilities_table: *const c_void, emission_probabilities_table: *const c_void, mode: crate::text::decoder_mode) -> Result<*mut c_void>;
		pub fn cv_text_OCRHMMDecoder_create_Ptr_ClassifierCallback__const_StringR_const__InputArrayR_const__InputArrayR_int(classifier: *const c_void, vocabulary: *const c_char, transition_probabilities_table: *const c_void, emission_probabilities_table: *const c_void, mode: i32) -> Result<*mut c_void>;
...
mod tracking_sys {
	...
	extern "C" {
		...
		pub fn cv_selectROI_const_StringR_Mat_bool_bool(window_name: *const c_char, img: *mut c_void, show_crossair: bool, from_center: bool) -> Result<core::Rect2d>;
		pub fn cv_selectROI_const_StringR_Mat_vector_Rect2d_R_bool(window_name: *const c_char, img: *mut c_void, bounding_box: *mut c_void, from_center: bool) -> Result_void;
		...
		pub fn cv_ClfMilBoost_init_const_ParamsR(instance: *mut c_void, parameters: *const c_void) -> Result_void;
		pub fn cv_ClfMilBoost_update_const_MatR_const_MatR(instance: *mut c_void, posx: *const c_void, negx: *const c_void) -> Result_void;
		pub fn cv_ClfMilBoost_classify_const_MatR_bool(instance: *mut c_void, x: *const c_void, log_r: bool) -> Result<*mut c_void>;
		...
		pub fn cv_MultiTracker_MultiTracker_const_StringR(tracker_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_MultiTracker_add_const_MatR_const_Rect2dR(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect2d) -> Result<bool>;
		pub fn cv_MultiTracker_add_const_StringR_const_MatR_const_Rect2dR(instance: *mut c_void, tracker_type: *const c_char, image: *const c_void, bounding_box: *const core::Rect2d) -> Result<bool>;
		pub fn cv_MultiTracker_add_const_StringR_const_MatR_vector_Rect2d_(instance: *mut c_void, tracker_type: *const c_char, image: *const c_void, bounding_box: *mut c_void) -> Result<bool>;
		pub fn cv_MultiTracker_add_const_MatR_vector_Rect2d_(instance: *mut c_void, image: *const c_void, bounding_box: *mut c_void) -> Result<bool>;
		pub fn cv_MultiTracker_update_const_MatR(instance: *mut c_void, image: *const c_void) -> Result<bool>;
		pub fn cv_MultiTracker_update_const_MatR_vector_Rect2d_R(instance: *mut c_void, image: *const c_void, bounding_box: *mut c_void) -> Result<bool>;
		pub fn cv_MultiTrackerTLD_update_opt_const_MatR(instance: *mut c_void, image: *const c_void) -> Result<bool>;
		...
		pub fn cv_MultiTracker_Alt_addTarget_const_MatR_const_Rect2dR_String(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect2d, tracker_algorithm_name: *mut c_char) -> Result<bool>;
		pub fn cv_MultiTracker_Alt_update_const_MatR(instance: *mut c_void, image: *const c_void) -> Result<bool>;
		pub fn cv_Tracker_init_const_MatR_const_Rect2dR(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect2d) -> Result<bool>;
		pub fn cv_Tracker_update_const_MatR_Rect2dR(instance: *mut c_void, image: *const c_void, bounding_box: *mut core::Rect2d) -> Result<bool>;
		pub fn cv_Tracker_create_const_StringR(tracker_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_Tracker_read_const_FileNodeR(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_Tracker_write_const_FileStorageR(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_Tracker_getModel(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerBoosting_createTracker_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerBoosting_Params_read_const_FileNodeR(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_TrackerBoosting_Params_write_const_FileStorageR(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_TrackerFeature_compute_const_vector_Mat_R_MatR(instance: *mut c_void, images: *const c_void, response: *mut c_void) -> Result_void;
		pub fn cv_TrackerFeature_create_const_StringR(tracker_feature_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_TrackerFeature_selection_MatR_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		...
		pub fn cv_TrackerFeatureFeature2d_selection_MatR_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureHAAR_TrackerFeatureHAAR_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureHAAR_extractSelected_vector_int__const_vector_Mat_R_MatR(instance: *mut c_void, sel_features: *const c_void, images: *const c_void, response: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerFeatureHAAR_selection_MatR_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureHAAR_swapFeature_int_int(instance: *mut c_void, source: i32, target: i32) -> Result<bool>;
		pub fn cv_TrackerFeatureHAAR_swapFeature_int_FeatureHaarR(instance: *mut c_void, id: i32, feature: *mut c_void) -> Result<bool>;
		...
		pub fn cv_TrackerFeatureHOG_selection_MatR_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureLBP_TrackerFeatureLBP() -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureLBP_selection_MatR_int(instance: *mut c_void, response: *mut c_void, npoints: i32) -> Result_void;
		pub fn cv_TrackerFeatureSet_TrackerFeatureSet() -> Result<*mut c_void>;
		pub fn cv_TrackerFeatureSet_extraction_const_vector_Mat_R(instance: *mut c_void, images: *const c_void) -> Result_void;
		...
		pub fn cv_TrackerFeatureSet_addTrackerFeature_Ptr_TrackerFeature_R(instance: *mut c_void, feature: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerFeatureSet_getResponses_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerGOTURN_createTracker_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerKCF_setFeatureExtractor_void__X__cv_Mat__cv_Rect__cv_MatR__bool(instance: *mut c_void, unnamed: Option<unsafe extern "C" fn(*const c_void, core::Rect, *mut c_void) -> ()>, pca_func: bool) -> Result_void;
		pub fn cv_TrackerKCF_createTracker_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerKCF_Params_read_const_FileNodeR(instance: *mut c_void, unnamed: *const c_void) -> Result_void;
		pub fn cv_TrackerKCF_Params_write_const_FileStorageR(instance: *const c_void, unnamed: *mut c_void) -> Result_void;
		pub fn cv_TrackerMIL_createTracker_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerMIL_Params_read_const_FileNodeR(instance: *mut c_void, fn_: *const c_void) -> Result_void;
		pub fn cv_TrackerMIL_Params_write_const_FileStorageR(instance: *const c_void, fs: *mut c_void) -> Result_void;
		pub fn cv_TrackerMedianFlow_createTracker_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerMedianFlow_Params_read_const_FileNodeR(instance: *mut c_void, unnamed: *const c_void) -> Result_void;
		pub fn cv_TrackerMedianFlow_Params_write_const_FileStorageR(instance: *const c_void, unnamed: *mut c_void) -> Result_void;
		...
		pub fn cv_TrackerModel_modelEstimation_const_vector_Mat_R(instance: *mut c_void, responses: *const c_void) -> Result_void;
		...
		pub fn cv_TrackerModel_setLastTargetState_const_Ptr_TrackerTargetState_R(instance: *mut c_void, last_target_state: *const c_void) -> Result_void;
		...
		pub fn cv_TrackerSampler_sampling_const_MatR_Rect(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect) -> Result_void;
		...
		pub fn cv_TrackerSampler_addTrackerSamplerAlgorithm_Ptr_TrackerSamplerAlgorithm_R(instance: *mut c_void, sampler: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerSamplerAlgorithm_create_const_StringR(tracker_sampler_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerAlgorithm_sampling_const_MatR_Rect_vector_Mat_R(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect, sample: *mut c_void) -> Result<bool>;
		pub fn cv_TrackerSamplerAlgorithm_getClassName_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerCS_TrackerSamplerCS_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerSamplerCS_setMode_int(instance: *mut c_void, sampling_mode: i32) -> Result_void;
		pub fn cv_TrackerSamplerCS_samplingImpl_const_MatR_Rect_vector_Mat_R(instance: *mut c_void, image: *const c_void, bounding_box: *const core::Rect, sample: *mut c_void) -> Result<bool>;
		...
		pub fn cv_TrackerSamplerCSC_TrackerSamplerCSC_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerSamplerPF_TrackerSamplerPF_const_MatR_const_ParamsR(chosen_rect: *const c_void, parameters: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerStateEstimator_create_const_StringR(tracke_state_estimator_type: *const c_char) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimator_getClassName_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerStateEstimatorAdaBoosting_int_int_int_Size_const_RectR(num_classifer: i32, init_iterations: i32, n_features: i32, patch_size: *const core::Size, roi: *const core::Rect) -> Result<*mut c_void>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_getSampleROI_const(instance: *const c_void) -> Result<core::Rect>;
		pub fn cv_TrackerStateEstimatorAdaBoosting_setSampleROI_const_RectR(instance: *mut c_void, roi: *const core::Rect) -> Result_void;
		...
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_TrackerAdaBoostingTargetState_const_Point2fR_int_int_bool_const_MatR(position: *const core::Point2f, width: i32, height: i32, foreground: bool, responses: *const c_void) -> Result<*mut c_void>;
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorAdaBoosting_TrackerAdaBoostingTargetState_setTargetResponses_const_MatR(instance: *mut c_void, responses: *const c_void) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		...
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_TrackerMILTargetState_const_Point2fR_int_int_bool_const_MatR(position: *const core::Point2f, width: i32, height: i32, foreground: bool, features: *const c_void) -> Result<*mut c_void>;
		#[cfg(not(target_os = "windows"))]
		...
		#[cfg(not(target_os = "windows"))]
		pub fn cv_TrackerStateEstimatorMILBoosting_TrackerMILTargetState_setFeatures_const_MatR(instance: *mut c_void, features: *const c_void) -> Result_void;
		#[cfg(not(target_os = "windows"))]
		...
		pub fn cv_TrackerTLD_createTracker_const_ParamsR(parameters: *const c_void) -> Result<*mut c_void>;
		pub fn cv_TrackerTLD_Params_Params() -> Result<*mut c_void>;
		pub fn cv_TrackerTLD_Params_read_const_FileNodeR(instance: *mut c_void, unnamed: *const c_void) -> Result_void;
		pub fn cv_TrackerTLD_Params_write_const_FileStorageR(instance: *const c_void, unnamed: *mut c_void) -> Result_void;
		pub fn cv_TrackerTargetState_getTargetPosition_const(instance: *const c_void) -> Result<core::Point2f>;
		pub fn cv_TrackerTargetState_setTargetPosition_const_Point2fR(instance: *mut c_void, position: *const core::Point2f) -> Result_void;
...
mod videoio_sys {
	...
	extern "C" {
		...
		pub fn cv_VideoCapture_VideoCapture_const_StringR(filename: *const c_char) -> Result<*mut c_void>;
		...
		pub fn cv_VideoCapture_open_const_StringR(instance: *mut c_void, filename: *const c_char) -> Result<bool>;
		...
		pub fn cv_VideoWriter_write_const_MatR(instance: *mut c_void, image: *const c_void) -> Result_void;
...
mod videostab_sys {
	...
	extern "C" {
		...
		pub fn cv_videostab_DeblurerBase_deblur_int_MatR(instance: *mut c_void, idx: i32, frame: *mut c_void) -> Result_void;
		...
		pub fn cv_videostab_WeightingDeblurer_deblur_int_MatR(instance: *mut c_void, idx: i32, frame: *mut c_void) -> Result_void;
...
mod xfeatures2d_sys {
	...
	extern "C" {
		...
		pub fn cv_xfeatures2d_PCTSignatures_create_const_vector_Point2f_R_int(init_sampling_points: *const c_void, init_seed_count: i32) -> Result<*mut c_void>;
		...
		pub fn cv_xfeatures2d_PCTSignatures_generateInitPoints_vector_Point2f_R_int_int(init_points: *mut c_void, count: i32, point_distribution: i32) -> Result_void;
		...
		pub fn cv_xfeatures2d_VGG_compute_const__InputArrayR_vector_KeyPoint_R_const__OutputArrayR(instance: *mut c_void, image: *const c_void, keypoints: *mut c_void, descriptors: *const c_void) -> Result_void;
	}
}
#[cfg(feature = "contrib")]
...
mod ximgproc_sys {
	...
	extern "C" {
		...
		pub fn cv_ximgproc_GradientDericheX_const__InputArrayR_const__OutputArrayR_double_double(_op: *const c_void, _dst: *const c_void, alpha_derive: f64, alpha_mean: f64) -> Result_void;
		pub fn cv_ximgproc_GradientDericheY_const__InputArrayR_const__OutputArrayR_double_double(_op: *const c_void, _dst: *const c_void, alpha_derive: f64, alpha_mean: f64) -> Result_void;
		...
		pub fn cv_ximgproc_createStructuredEdgeDetection_const_StringR_Ptr_RFFeatureGetter_(model: *const c_char, how_to_get_features: *const c_void) -> Result<*mut c_void>;
		...
		pub fn cv_ximgproc_niBlackThreshold_const__InputArrayR_const__OutputArrayR_double_int_int_double(_src: *const c_void, _dst: *const c_void, max_value: f64, typ: i32, block_size: i32, delta: f64) -> Result_void;
		...
		pub fn cv_ximgproc_weightedMedianFilter_const__InputArrayR_const__InputArrayR_const__OutputArrayR_int_double_WMFWeightType_Mat(joint: *const c_void, src: *const c_void, dst: *const c_void, r: i32, sigma: f64, weight_type: crate::ximgproc::WMFWeightType, mask: *mut c_void) -> Result_void;
		...
		pub fn cv_ximgproc_FastLineDetector_detect_const__InputArrayR_const__OutputArrayR(instance: *mut c_void, _image: *const c_void, _lines: *const c_void) -> Result_void;
		pub fn cv_ximgproc_FastLineDetector_drawSegments_const__InputOutputArrayR_const__InputArrayR_bool(instance: *mut c_void, _image: *const c_void, lines: *const c_void, draw_arrow: bool) -> Result_void;
		...
		pub fn cv_ximgproc_RFFeatureGetter_getFeatures_const_const_MatR_MatR_int_int_int_int_int(instance: *const c_void, src: *const c_void, features: *mut c_void, gnrm_rad: i32, gsmth_rad: i32, shrink: i32, out_num: i32, grad_num: i32) -> Result_void;
		...
		pub fn cv_ximgproc_StructuredEdgeDetection_detectEdges_const_const_MatR_MatR(instance: *const c_void, src: *const c_void, dst: *mut c_void) -> Result_void;
...
mod xphoto_sys {
	...
	extern "C" {
		...
		pub fn cv_xphoto_dctDenoising_const_MatR_MatR_double_int(src: *const c_void, dst: *mut c_void, sigma: f64, psize: i32) -> Result_void;
		pub fn cv_xphoto_inpaint_const_MatR_const_MatR_MatR_int(src: *const c_void, mask: *const c_void, dst: *mut c_void, algorithm_type: i32) -> Result_void;
