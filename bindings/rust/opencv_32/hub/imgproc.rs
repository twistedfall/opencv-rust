...
//! 
//! ![Delaunay triangulation (black) and Voronoi (red)](https://docs.opencv.org/3.2.0/delaunay_voronoi.png)
//! 
...
/// applies one of the flavors of the Teh-Chin chain approximation algorithm [TehChin89](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_TehChin89)
pub const CHAIN_APPROX_TC89_KCOS: i32 = 4;
/// applies one of the flavors of the Teh-Chin chain approximation algorithm [TehChin89](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_TehChin89)
pub const CHAIN_APPROX_TC89_L1: i32 = 3;
/// ![autumn](https://docs.opencv.org/3.2.0/colorscale_autumn.jpg)
pub const COLORMAP_AUTUMN: i32 = 0;
/// ![bone](https://docs.opencv.org/3.2.0/colorscale_bone.jpg)
pub const COLORMAP_BONE: i32 = 1;
/// ![cool](https://docs.opencv.org/3.2.0/colorscale_cool.jpg)
pub const COLORMAP_COOL: i32 = 8;
/// ![hot](https://docs.opencv.org/3.2.0/colorscale_hot.jpg)
pub const COLORMAP_HOT: i32 = 11;
/// ![HSV](https://docs.opencv.org/3.2.0/colorscale_hsv.jpg)
pub const COLORMAP_HSV: i32 = 9;
/// ![jet](https://docs.opencv.org/3.2.0/colorscale_jet.jpg)
pub const COLORMAP_JET: i32 = 2;
/// ![ocean](https://docs.opencv.org/3.2.0/colorscale_ocean.jpg)
pub const COLORMAP_OCEAN: i32 = 5;
/// ![parula](https://docs.opencv.org/3.2.0/colorscale_parula.jpg)
pub const COLORMAP_PARULA: i32 = 12;
/// ![pink](https://docs.opencv.org/3.2.0/colorscale_pink.jpg)
pub const COLORMAP_PINK: i32 = 10;
/// ![rainbow](https://docs.opencv.org/3.2.0/colorscale_rainbow.jpg)
pub const COLORMAP_RAINBOW: i32 = 4;
/// ![spring](https://docs.opencv.org/3.2.0/colorscale_spring.jpg)
pub const COLORMAP_SPRING: i32 = 7;
/// ![summer](https://docs.opencv.org/3.2.0/colorscale_summer.jpg)
pub const COLORMAP_SUMMER: i32 = 6;
/// ![winter](https://docs.opencv.org/3.2.0/colorscale_winter.jpg)
...
/// Edge-Aware Demosaicing
pub const COLOR_COLORCVT_MAX: i32 = 139;
...
/// This alternative formula is regularly used for texture comparison. See e.g. [Puzicha1997](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Puzicha1997)
...
/// basically *21HT*, described in [Yuen90](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Yuen90)
...
pub enum ColorConversionCodes {
	...
	/// Edge-Aware Demosaicing
	COLOR_COLORCVT_MAX = 139 as isize,
}
...
/// ![threshold types](https://docs.opencv.org/3.2.0/threshold.png)
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
/// * edges: ,threshold1,threshold2,L2gradient See cv::Canny
/// 
...
/// Finds edges in an image using the Canny algorithm [Canny86](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Canny86) .
/// 
...
/// two weighted point configurations. One of the applications described in [RubnerSept98](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_RubnerSept98),
/// [Rubner2000](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Rubner2000) is multi-dimensional histogram comparison for image retrieval. EMD is a transportation
...
pub fn gaussian_blur(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, ksize: core::Size, sigma_x: f64, sigma_y: f64, border_type: i32) -> Result<()> {
	...
	unsafe { sys::cv_GaussianBlur_const__InputArrayX_const__OutputArrayX_Size_double_double_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), &ksize, sigma_x, sigma_y, border_type) }.into_result()
}
...
/// in [Matas00](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Matas00)
/// 
...
/// 
/// ![image](https://docs.opencv.org/3.2.0/building.jpg)
/// 
/// And this is the output of the above program in case of the probabilistic Hough transform:
/// 
/// ![image](https://docs.opencv.org/3.2.0/houghp.png)
/// 
/// ## Parameters
...
/// 
/// The function calculates seven Hu invariants (introduced in [Hu62](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Hu62); see also
...
/// is equivalent to
/// 
/// ![block formula](https://latex.codecogs.com/png.latex?%5Ctexttt%7BSobel%28src%2C%20dst%2C%20ddepth%2C%20dx%2C%20dy%2C%20CV%5C%5FSCHARR%2C%20scale%2C%20delta%2C%20borderType%29%7D%20%2E)
/// 
/// ## Parameters
/// * src: input image.
...
/// * dst: %Accumulator with the same number of channels as input images, 32-bit or 64-bit
/// floating-point.
...
pub fn arrowed_line(img: &mut dyn core::ToInputOutputArray, pt1: core::Point, pt2: core::Point, color: core::Scalar, thickness: i32, line_type: i32, shift: i32, tip_length: f64) -> Result<()> {
	...
	unsafe { sys::cv_arrowedLine_const__InputOutputArrayX_Point_Point_const_ScalarX_int_int_int_double(img.as_raw__InputOutputArray(), &pt1, &pt2, &color, thickness, line_type, shift, tip_length) }.into_result()
}
...
pub fn blur(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, ksize: core::Size, anchor: core::Point, border_type: i32) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_blur_const__InputArrayX_const__OutputArrayX_Size_Point_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), &ksize, &anchor, border_type) }.into_result()
}
...
pub fn bounding_rect(points: &dyn core::ToInputArray) -> Result<core::Rect> {
	input_array_arg!(points);
	unsafe { sys::cv_boundingRect_const__InputArrayX(points.as_raw__InputArray()) }.into_result()
}
...
pub fn box_filter(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, ddepth: i32, ksize: core::Size, anchor: core::Point, normalize: bool, border_type: i32) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_boxFilter_const__InputArrayX_const__OutputArrayX_int_Size_Point_bool_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), ddepth, &ksize, &anchor, normalize, border_type) }.into_result()
}
...
pub fn box_points(box_: core::RotatedRect, points: &mut dyn core::ToOutputArray) -> Result<()> {
	output_array_arg!(points);
	unsafe { sys::cv_boxPoints_RotatedRect_const__OutputArrayX(box_.as_raw_RotatedRect(), points.as_raw__OutputArray()) }.into_result()
}
...
/// 
/// ## Overloaded parameters
pub fn calc_back_project(images: &dyn core::ToInputArray, channels: &types::VectorOfi32, hist: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, ranges: &types::VectorOff32, scale: f64) -> Result<()> {
...
/// ## C++ default parameters
/// * accumulate: false
pub fn calc_hist(images: &dyn core::ToInputArray, channels: &types::VectorOfi32, mask: &dyn core::ToInputArray, hist: &mut dyn core::ToOutputArray, hist_size: &types::VectorOfi32, ranges: &types::VectorOff32, accumulate: bool) -> Result<()> {
	input_array_arg!(images);
	input_array_arg!(mask);
...
pub fn circle(img: &mut dyn core::ToInputOutputArray, center: core::Point, radius: i32, color: core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result<()> {
	input_output_array_arg!(img);
	unsafe { sys::cv_circle_const__InputOutputArrayX_Point_int_const_ScalarX_int_int_int(img.as_raw__InputOutputArray(), &center, radius, &color, thickness, line_type, shift) }.into_result()
}
...
pub fn clip_line(img_rect: core::Rect, pt1: &mut core::Point, pt2: &mut core::Point) -> Result<bool> {
	unsafe { sys::cv_clipLine_Rect_PointX_PointX(&img_rect, pt1, pt2) }.into_result()
}
...
pub fn clip_line_size_i64(img_size: core::Size2l, pt1: &mut core::Point2l, pt2: &mut core::Point2l) -> Result<bool> {
	unsafe { sys::cv_clipLine_Size2l_Point2lX_Point2lX(&img_size, pt1, pt2) }.into_result()
}
...
pub fn clip_line_size(img_size: core::Size, pt1: &mut core::Point, pt2: &mut core::Point) -> Result<bool> {
	unsafe { sys::cv_clipLine_Size_PointX_PointX(&img_size, pt1, pt2) }.into_result()
}
...
/// 
/// The function cv::convexHull finds the convex hull of a 2D point set using the Sklansky's algorithm [Sklansky82](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Sklansky82)
...
/// 
/// ![image](https://docs.opencv.org/3.2.0/defects.png)
/// 
/// ## Parameters
...
/// 
/// ![image](https://docs.opencv.org/3.2.0/cornersubpix.png)
/// 
...
/// 
/// ![block formula](https://latex.codecogs.com/png.latex?%5Csum%20%5Fi%28DI%5F%7Bp%5Fi%7D%20%20%5Ccdot%20%7BDI%5F%7Bp%5Fi%7D%7D%5ET%29%20%2D%20%20%5Csum%20%5Fi%28DI%5F%7Bp%5Fi%7D%20%20%5Ccdot%20%7BDI%5F%7Bp%5Fi%7D%7D%5ET%20%20%5Ccdot%20p%5Fi%29)
/// 
...
/// then a ![inline formula](https://latex.codecogs.com/png.latex?5%2A2%2B1%20%5Ctimes%205%2A2%2B1%20%3D%2011%20%5Ctimes%2011) search window is used.
...
pub fn corner_sub_pix(image: &dyn core::ToInputArray, corners: &mut dyn core::ToInputOutputArray, win_size: core::Size, zero_zone: core::Size, criteria: core::TermCriteria) -> Result<()> {
	...
	unsafe { sys::cv_cornerSubPix_const__InputArrayX_const__InputOutputArrayX_Size_Size_TermCriteria(image.as_raw__InputArray(), corners.as_raw__InputOutputArray(), &win_size, &zero_zone, criteria.as_raw_TermCriteria()) }.into_result()
}
...
pub fn create_hanning_window(dst: &mut dyn core::ToOutputArray, win_size: core::Size, typ: i32) -> Result<()> {
	output_array_arg!(dst);
	unsafe { sys::cv_createHanningWindow_const__OutputArrayX_Size_int(dst.as_raw__OutputArray(), &win_size, typ) }.into_result()
}
...
/// * _log_eps: Detection threshold: -log10(NFA) \> log_eps. Used only when advancent refinement
/// is chosen.
...
/// ## C++ default parameters
/// * dcn: 0
pub fn demosaicing(_src: &dyn core::ToInputArray, _dst: &mut dyn core::ToOutputArray, code: i32, dcn: i32) -> Result<()> {
	input_array_arg!(_src);
	output_array_arg!(_dst);
	unsafe { sys::cv_demosaicing_const__InputArrayX_const__OutputArrayX_int_int(_src.as_raw__InputArray(), _dst.as_raw__OutputArray(), code, dcn) }.into_result()
}
...
pub fn dilate(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, kernel: &dyn core::ToInputArray, anchor: core::Point, iterations: i32, border_type: i32, border_value: core::Scalar) -> Result<()> {
	...
	unsafe { sys::cv_dilate_const__InputArrayX_const__OutputArrayX_const__InputArrayX_Point_int_int_const_ScalarX(src.as_raw__InputArray(), dst.as_raw__OutputArray(), kernel.as_raw__InputArray(), &anchor, iterations, border_type, &border_value) }.into_result()
}
...
/// algorithm described in [Felzenszwalb04](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Felzenszwalb04) . This algorithm is parallelized with the TBB library.
/// 
/// In other cases, the algorithm [Borgefors86](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Borgefors86) is used. This means that for a pixel the function
...
/// * maskSize: Size of the distance transform mask, see cv::DistanceTransformMasks.
...
/// single-channel image of the same size as src .
/// * distanceType: Type of distance, see cv::DistanceTypes
/// * maskSize: Size of the distance transform mask, see cv::DistanceTransformMasks. In case of the
...
pub fn draw_contours(image: &mut dyn core::ToInputOutputArray, contours: &dyn core::ToInputArray, contour_idx: i32, color: core::Scalar, thickness: i32, line_type: i32, hierarchy: &dyn core::ToInputArray, max_level: i32, offset: core::Point) -> Result<()> {
	...
	unsafe { sys::cv_drawContours_const__InputOutputArrayX_const__InputArrayX_int_const_ScalarX_int_int_const__InputArrayX_int_Point(image.as_raw__InputOutputArray(), contours.as_raw__InputArray(), contour_idx, &color, thickness, line_type, hierarchy.as_raw__InputArray(), max_level, &offset) }.into_result()
}
...
pub fn draw_marker(img: &mut core::Mat, position: core::Point, color: core::Scalar, marker_type: i32, marker_size: i32, thickness: i32, line_type: i32) -> Result<()> {
	unsafe { sys::cv_drawMarker_MatX_Point_const_ScalarX_int_int_int_int(img.as_raw_Mat(), &position, &color, marker_type, marker_size, thickness, line_type) }.into_result()
}
...
pub fn ellipse_2_poly_f64(center: core::Point2d, axes: core::Size2d, angle: i32, arc_start: i32, arc_end: i32, delta: i32, pts: &mut types::VectorOfPoint2d) -> Result<()> {
	unsafe { sys::cv_ellipse2Poly_Point2d_Size2d_int_int_int_int_vector_Point2d_X(&center, &axes, angle, arc_start, arc_end, delta, pts.as_raw_VectorOfPoint2d()) }.into_result()
}
...
pub fn ellipse_2_poly(center: core::Point, axes: core::Size, angle: i32, arc_start: i32, arc_end: i32, delta: i32, pts: &mut types::VectorOfPoint) -> Result<()> {
	unsafe { sys::cv_ellipse2Poly_Point_Size_int_int_int_int_vector_Point_X(&center, &axes, angle, arc_start, arc_end, delta, pts.as_raw_VectorOfPoint()) }.into_result()
}
...
/// 
/// ![Parameters of Elliptic Arc](https://docs.opencv.org/3.2.0/ellipse.png)
/// 
/// ## Parameters
/// * img: Image.
...
pub fn ellipse(img: &mut dyn core::ToInputOutputArray, center: core::Point, axes: core::Size, angle: f64, start_angle: f64, end_angle: f64, color: core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result<()> {
	input_output_array_arg!(img);
	unsafe { sys::cv_ellipse_const__InputOutputArrayX_Point_Size_double_double_double_const_ScalarX_int_int_int(img.as_raw__InputOutputArray(), &center, &axes, angle, start_angle, end_angle, &color, thickness, line_type, shift) }.into_result()
}
...
pub fn erode(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, kernel: &dyn core::ToInputArray, anchor: core::Point, iterations: i32, border_type: i32, border_value: core::Scalar) -> Result<()> {
	...
	output_array_arg!(dst);
	input_array_arg!(kernel);
	unsafe { sys::cv_erode_const__InputArrayX_const__OutputArrayX_const__InputArrayX_Point_int_int_const_ScalarX(src.as_raw__InputArray(), dst.as_raw__OutputArray(), kernel.as_raw__InputArray(), &anchor, iterations, border_type, &border_value) }.into_result()
}
...
pub fn fill_poly(img: &mut dyn core::ToInputOutputArray, pts: &dyn core::ToInputArray, color: core::Scalar, line_type: i32, shift: i32, offset: core::Point) -> Result<()> {
	input_output_array_arg!(img);
	input_array_arg!(pts);
	unsafe { sys::cv_fillPoly_const__InputOutputArrayX_const__InputArrayX_const_ScalarX_int_int_Point(img.as_raw__InputOutputArray(), pts.as_raw__InputArray(), &color, line_type, shift, &offset) }.into_result()
}
...
pub fn filter_2d(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, ddepth: i32, kernel: &dyn core::ToInputArray, anchor: core::Point, delta: f64, border_type: i32) -> Result<()> {
	...
	output_array_arg!(dst);
	input_array_arg!(kernel);
	unsafe { sys::cv_filter2D_const__InputArrayX_const__OutputArrayX_int_const__InputArrayX_Point_double_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), ddepth, kernel.as_raw__InputArray(), &anchor, delta, border_type) }.into_result()
}

/// Finds contours in a binary image.
/// 
/// The function retrieves contours from the binary image using the algorithm [Suzuki85](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Suzuki85) . The contours
...
pub fn find_contours_with_hierarchy(image: &mut dyn core::ToInputOutputArray, contours: &mut dyn core::ToOutputArray, hierarchy: &mut dyn core::ToOutputArray, mode: i32, method: i32, offset: core::Point) -> Result<()> {
	...
	unsafe { sys::cv_findContours_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_int_int_Point(image.as_raw__InputOutputArray(), contours.as_raw__OutputArray(), hierarchy.as_raw__OutputArray(), mode, method, &offset) }.into_result()
}
...
pub fn find_contours(image: &mut dyn core::ToInputOutputArray, contours: &mut dyn core::ToOutputArray, mode: i32, method: i32, offset: core::Point) -> Result<()> {
	input_output_array_arg!(image);
	output_array_arg!(contours);
	unsafe { sys::cv_findContours_const__InputOutputArrayX_const__OutputArrayX_int_int_Point(image.as_raw__InputOutputArray(), contours.as_raw__OutputArray(), mode, method, &offset) }.into_result()
}

/// Fits an ellipse around a set of 2D points.
/// 
/// The function calculates the ellipse that fits (in a least-squares sense) a set of 2D points best of
/// all. It returns the rotated rectangle in which the ellipse is inscribed. The first algorithm described by [Fitzgibbon95](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Fitzgibbon95)
...
pub fn fit_ellipse(points: &dyn core::ToInputArray) -> Result<core::RotatedRect> {
	input_array_arg!(points);
	unsafe { sys::cv_fitEllipse_const__InputArrayX(points.as_raw__InputArray()) }.into_result().map(|ptr| core::RotatedRect { ptr })
}
...
pub fn flood_fill(image: &mut dyn core::ToInputOutputArray, seed_point: core::Point, new_val: core::Scalar, rect: &mut core::Rect, lo_diff: core::Scalar, up_diff: core::Scalar, flags: i32) -> Result<i32> {
	input_output_array_arg!(image);
	unsafe { sys::cv_floodFill_const__InputOutputArrayX_Point_Scalar_RectX_Scalar_Scalar_int(image.as_raw__InputOutputArray(), &seed_point, &new_val, rect, &lo_diff, &up_diff, flags) }.into_result()
}
...
pub fn flood_fill_mask(image: &mut dyn core::ToInputOutputArray, mask: &mut dyn core::ToInputOutputArray, seed_point: core::Point, new_val: core::Scalar, rect: &mut core::Rect, lo_diff: core::Scalar, up_diff: core::Scalar, flags: i32) -> Result<i32> {
	...
	unsafe { sys::cv_floodFill_const__InputOutputArrayX_const__InputOutputArrayX_Point_Scalar_RectX_Scalar_Scalar_int(image.as_raw__InputOutputArray(), mask.as_raw__InputOutputArray(), &seed_point, &new_val, rect, &lo_diff, &up_diff, flags) }.into_result()
}
...
pub fn get_affine_transform_slice(src: &[core::Point2f], dst: &[core::Point2f]) -> Result<core::Mat> {
	unsafe { sys::cv_getAffineTransform_const_Point2fX_const_Point2fX(src.as_ptr(), dst.as_ptr()) }.into_result().map(|ptr| core::Mat { ptr })
}

pub fn get_affine_transform(src: &dyn core::ToInputArray, dst: &dyn core::ToInputArray) -> Result<core::Mat> {
	input_array_arg!(src);
	input_array_arg!(dst);
	unsafe { sys::cv_getAffineTransform_const__InputArrayX_const__InputArrayX(src.as_raw__InputArray(), dst.as_raw__InputArray()) }.into_result().map(|ptr| core::Mat { ptr })
}
...
pub fn get_default_new_camera_matrix(camera_matrix: &dyn core::ToInputArray, imgsize: core::Size, center_principal_point: bool) -> Result<core::Mat> {
	...
	unsafe { sys::cv_getDefaultNewCameraMatrix_const__InputArrayX_Size_bool(camera_matrix.as_raw__InputArray(), &imgsize, center_principal_point) }.into_result().map(|ptr| core::Mat { ptr })
}

/// Returns filter coefficients for computing spatial image derivatives.
/// 
/// The function computes and returns the filter coefficients for spatial image derivatives. When
/// `ksize=CV_SCHARR`, the Scharr ![inline formula](https://latex.codecogs.com/png.latex?3%20%5Ctimes%203) kernels are generated (see cv::Scharr). Otherwise, Sobel
...
pub fn get_perspective_transform_slice(src: &[core::Point2f], dst: &[core::Point2f]) -> Result<core::Mat> {
	unsafe { sys::cv_getPerspectiveTransform_const_Point2fX_const_Point2fX(src.as_ptr(), dst.as_ptr()) }.into_result().map(|ptr| core::Mat { ptr })
}
...
pub fn get_perspective_transform(src: &dyn core::ToInputArray, dst: &dyn core::ToInputArray) -> Result<core::Mat> {
	input_array_arg!(src);
	input_array_arg!(dst);
	unsafe { sys::cv_getPerspectiveTransform_const__InputArrayX_const__InputArrayX(src.as_raw__InputArray(), dst.as_raw__InputArray()) }.into_result().map(|ptr| core::Mat { ptr })
}
...
/// 
/// ![block formula](https://latex.codecogs.com/png.latex?dst%28x%2C%20y%29%20%3D%20src%28x%20%2B%20%20%5Ctexttt%7Bcenter%2Ex%7D%20%2D%20%28%20%5Ctexttt%7Bdst%2Ecols%7D%20%2D1%29%2A0%2E5%2C%20y%20%2B%20%20%5Ctexttt%7Bcenter%2Ey%7D%20%2D%20%28%20%5Ctexttt%7Bdst%2Erows%7D%20%2D1%29%2A0%2E5%29)
/// 
...
pub fn get_rect_sub_pix(image: &dyn core::ToInputArray, patch_size: core::Size, center: core::Point2f, patch: &mut dyn core::ToOutputArray, patch_type: i32) -> Result<()> {
	...
	unsafe { sys::cv_getRectSubPix_const__InputArrayX_Size_Point2f_const__OutputArrayX_int(image.as_raw__InputArray(), &patch_size, &center, patch.as_raw__OutputArray(), patch_type) }.into_result()
}
...
pub fn get_text_size(text: &str, font_face: i32, font_scale: f64, thickness: i32, base_line: &mut i32) -> Result<core::Size> {
	string_arg!(text);
	unsafe { sys::cv_getTextSize_const_StringX_int_double_int_intX(text.as_ptr(), font_face, font_scale, thickness, base_line) }.into_result()
}

/// Determines strong corners on an image.
/// 
/// The function finds the most prominent corners in the image or in the specified image region, as
/// described in [Shi94](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Shi94)
/// 
...
pub fn grab_cut(img: &dyn core::ToInputArray, mask: &mut dyn core::ToInputOutputArray, rect: core::Rect, bgd_model: &mut dyn core::ToInputOutputArray, fgd_model: &mut dyn core::ToInputOutputArray, iter_count: i32, mode: i32) -> Result<()> {
	...
	unsafe { sys::cv_grabCut_const__InputArrayX_const__InputOutputArrayX_Rect_const__InputOutputArrayX_const__InputOutputArrayX_int_int(img.as_raw__InputArray(), mask.as_raw__InputOutputArray(), &rect, bgd_model.as_raw__InputOutputArray(), fgd_model.as_raw__InputOutputArray(), iter_count, mode) }.into_result()
}
...
/// * alpha: 0
pub fn init_wide_angle_proj_map(camera_matrix: &dyn core::ToInputArray, dist_coeffs: &dyn core::ToInputArray, image_size: core::Size, dest_image_width: i32, m1type: i32, map1: &mut dyn core::ToOutputArray, map2: &mut dyn core::ToOutputArray, proj_type: i32, alpha: f64) -> Result<f32> {
	input_array_arg!(camera_matrix);
	input_array_arg!(dist_coeffs);
	output_array_arg!(map1);
	output_array_arg!(map2);
	unsafe { sys::cv_initWideAngleProjMap_const__InputArrayX_const__InputArrayX_Size_int_int_const__OutputArrayX_const__OutputArrayX_int_double(camera_matrix.as_raw__InputArray(), dist_coeffs.as_raw__InputArray(), &image_size, dest_image_width, m1type, map1.as_raw__OutputArray(), map2.as_raw__OutputArray(), proj_type, alpha) }.into_result()
}
...
/// 
/// ![integral calculation example](https://docs.opencv.org/3.2.0/integral.png)
/// 
/// ## Parameters
...
pub fn line(img: &mut dyn core::ToInputOutputArray, pt1: core::Point, pt2: core::Point, color: core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result<()> {
	input_output_array_arg!(img);
	unsafe { sys::cv_line_const__InputOutputArrayX_Point_Point_const_ScalarX_int_int_int(img.as_raw__InputOutputArray(), &pt1, &pt2, &color, thickness, line_type, shift) }.into_result()
}

/// Remaps an image to polar coordinates space.
/// 
/// @anchor polar_remaps_reference_image
/// ![Polar remaps reference](https://docs.opencv.org/3.2.0/polar_remap_doc.png)
/// 
...
/// 
/// where
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0A%20%20I%20%3D%20%28dx%2Cdy%29%20%3D%20%28x%20%2D%20center%2Ex%2Cy%20%2D%20center%2Ey%29%20%5C%5C%0A%20%20%5Crho%20%3D%20Kx%20%5Ccdot%20%5Ctexttt%7Bmagnitude%7D%20%28I%29%20%2C%5C%5C%0A%20%20%5Cphi%20%3D%20Ky%20%5Ccdot%20%5Ctexttt%7Bangle%7D%20%28I%29%5F%7B0%2E%2E360%20deg%7D%0A%5Cend%7Barray%7D)
/// 
/// and
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0A%20%20Kx%20%3D%20src%2Ecols%20%2F%20maxRadius%20%5C%5C%0A%20%20Ky%20%3D%20src%2Erows%20%2F%20360%0A%5Cend%7Barray%7D)
/// 
/// 
/// ## Parameters
/// * src: Source image
...
pub fn linear_polar(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, center: core::Point2f, max_radius: f64, flags: i32) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_linearPolar_const__InputArrayX_const__OutputArrayX_Point2f_double_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), &center, max_radius, flags) }.into_result()
}
...
/// 
/// where
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0A%20%20I%20%3D%20%28dx%2Cdy%29%20%3D%20%28x%20%2D%20center%2Ex%2Cy%20%2D%20center%2Ey%29%20%5C%5C%0A%20%20%5Crho%20%3D%20M%20%5Ccdot%20log%5Fe%28%5Ctexttt%7Bmagnitude%7D%20%28I%29%29%20%2C%5C%5C%0A%20%20%5Cphi%20%3D%20Ky%20%5Ccdot%20%5Ctexttt%7Bangle%7D%20%28I%29%5F%7B0%2E%2E360%20deg%7D%20%5C%5C%0A%5Cend%7Barray%7D)
/// 
/// and
/// ![block formula](https://latex.codecogs.com/png.latex?%5Cbegin%7Barray%7D%7Bl%7D%0A%20%20M%20%3D%20src%2Ecols%20%2F%20log%5Fe%28maxRadius%29%20%5C%5C%0A%20%20Ky%20%3D%20src%2Erows%20%2F%20360%20%5C%5C%0A%5Cend%7Barray%7D)
/// 
...
pub fn log_polar(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, center: core::Point2f, m: f64, flags: i32) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_logPolar_const__InputArrayX_const__OutputArrayX_Point2f_double_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), &center, m, flags) }.into_result()
}
...
pub fn min_area_rect(points: &dyn core::ToInputArray) -> Result<core::RotatedRect> {
	input_array_arg!(points);
	unsafe { sys::cv_minAreaRect_const__InputArrayX(points.as_raw__InputArray()) }.into_result().map(|ptr| core::RotatedRect { ptr })
}
...
pub fn min_enclosing_circle(points: &dyn core::ToInputArray, center: &mut core::Point2f, radius: &mut f32) -> Result<()> {
	input_array_arg!(points);
	unsafe { sys::cv_minEnclosingCircle_const__InputArrayX_Point2fX_floatX(points.as_raw__InputArray(), center, radius) }.into_result()
}
...
/// 
/// ![Sample output of the minimum enclosing triangle function](https://docs.opencv.org/3.2.0/minenclosingtriangle.png)
/// 
/// The implementation of the algorithm is based on O'Rourke's [ORourke86](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_ORourke86) and Klee and Laskowski's
/// [KleeLaskowski85](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_KleeLaskowski85) papers. O'Rourke provides a ![inline formula](https://latex.codecogs.com/png.latex?%5Ctheta%28n%29) algorithm for finding the minimal
...
pub fn morphology_ex(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, op: i32, kernel: &dyn core::ToInputArray, anchor: core::Point, iterations: i32, border_type: i32, border_value: core::Scalar) -> Result<()> {
	...
	output_array_arg!(dst);
	input_array_arg!(kernel);
	unsafe { sys::cv_morphologyEx_const__InputArrayX_const__OutputArrayX_int_const__InputArrayX_Point_int_int_const_ScalarX(src.as_raw__InputArray(), dst.as_raw__OutputArray(), op, kernel.as_raw__InputArray(), &anchor, iterations, border_type, &border_value) }.into_result()
}
...
/// 
/// ![sample output](https://docs.opencv.org/3.2.0/pointpolygon.png)
/// 
/// ## Parameters
/// * contour: Input contour.
...
pub fn point_polygon_test(contour: &dyn core::ToInputArray, pt: core::Point2f, measure_dist: bool) -> Result<f64> {
	input_array_arg!(contour);
	unsafe { sys::cv_pointPolygonTest_const__InputArrayX_Point2f_bool(contour.as_raw__InputArray(), &pt, measure_dist) }.into_result()
}
...
pub fn put_text(img: &mut dyn core::ToInputOutputArray, text: &str, org: core::Point, font_face: i32, font_scale: f64, color: core::Scalar, thickness: i32, line_type: i32, bottom_left_origin: bool) -> Result<()> {
	input_output_array_arg!(img);
	string_arg!(text);
	unsafe { sys::cv_putText_const__InputOutputArrayX_const_StringX_Point_int_double_Scalar_int_int_bool(img.as_raw__InputOutputArray(), text.as_ptr(), &org, font_face, font_scale, &color, thickness, line_type, bottom_left_origin) }.into_result()
}
...
pub fn pyr_mean_shift_filtering(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, sp: f64, sr: f64, max_level: i32, termcrit: core::TermCriteria) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_pyrMeanShiftFiltering_const__InputArrayX_const__OutputArrayX_double_double_int_TermCriteria(src.as_raw__InputArray(), dst.as_raw__OutputArray(), sp, sr, max_level, termcrit.as_raw_TermCriteria()) }.into_result()
}
...
pub fn rectangle(img: &mut core::Mat, rec: core::Rect, color: core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result<()> {
	unsafe { sys::cv_rectangle_MatX_Rect_const_ScalarX_int_int_int(img.as_raw_Mat(), &rec, &color, thickness, line_type, shift) }.into_result()
}
...
pub fn rectangle_points(img: &mut dyn core::ToInputOutputArray, pt1: core::Point, pt2: core::Point, color: core::Scalar, thickness: i32, line_type: i32, shift: i32) -> Result<()> {
	input_output_array_arg!(img);
	unsafe { sys::cv_rectangle_const__InputOutputArrayX_Point_Point_const_ScalarX_int_int_int(img.as_raw__InputOutputArray(), &pt1, &pt2, &color, thickness, line_type, shift) }.into_result()
}
...
/// * interpolation: Interpolation method (see cv::InterpolationFlags). The method INTER_AREA is
...
pub fn resize(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, dsize: core::Size, fx: f64, fy: f64, interpolation: i32) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_resize_const__InputArrayX_const__OutputArrayX_Size_double_double_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), &dsize, fx, fy, interpolation) }.into_result()
}
...
/// 
/// ![intersection examples](https://docs.opencv.org/3.2.0/intersection.png)
/// 
/// ## Parameters
/// * rect1: First rectangle
/// * rect2: Second rectangle
/// * intersectingRegion: The output array of the verticies of the intersecting region. It returns
...
pub fn sep_filter_2d(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, ddepth: i32, kernel_x: &dyn core::ToInputArray, kernel_y: &dyn core::ToInputArray, anchor: core::Point, delta: f64, border_type: i32) -> Result<()> {
	...
	unsafe { sys::cv_sepFilter2D_const__InputArrayX_const__OutputArrayX_int_const__InputArrayX_const__InputArrayX_Point_double_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), ddepth, kernel_x.as_raw__InputArray(), kernel_y.as_raw__InputArray(), &anchor, delta, border_type) }.into_result()
}
...
/// * normalize: true
/// * border_type: BORDER_DEFAULT
pub fn sqr_box_filter(_src: &dyn core::ToInputArray, _dst: &mut dyn core::ToOutputArray, ddepth: i32, ksize: core::Size, anchor: core::Point, normalize: bool, border_type: i32) -> Result<()> {
	input_array_arg!(_src);
	output_array_arg!(_dst);
	unsafe { sys::cv_sqrBoxFilter_const__InputArrayX_const__OutputArrayX_int_Size_Point_bool_int(_src.as_raw__InputArray(), _dst.as_raw__OutputArray(), ddepth, &ksize, &anchor, normalize, border_type) }.into_result()
}
...
/// * flags: combination of interpolation methods (see cv::InterpolationFlags) and the optional
...
pub fn warp_affine(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, m: &dyn core::ToInputArray, dsize: core::Size, flags: i32, border_mode: i32, border_value: core::Scalar) -> Result<()> {
	...
	output_array_arg!(dst);
	input_array_arg!(m);
	unsafe { sys::cv_warpAffine_const__InputArrayX_const__OutputArrayX_const__InputArrayX_Size_int_int_const_ScalarX(src.as_raw__InputArray(), dst.as_raw__OutputArray(), m.as_raw__InputArray(), &dsize, flags, border_mode, &border_value) }.into_result()
}
...
pub fn warp_perspective(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, m: &dyn core::ToInputArray, dsize: core::Size, flags: i32, border_mode: i32, border_value: core::Scalar) -> Result<()> {
	...
	output_array_arg!(dst);
	input_array_arg!(m);
	unsafe { sys::cv_warpPerspective_const__InputArrayX_const__OutputArrayX_const__InputArrayX_Size_int_int_const_ScalarX(src.as_raw__InputArray(), dst.as_raw__OutputArray(), m.as_raw__InputArray(), &dsize, flags, border_mode, &border_value) }.into_result()
}

/// Performs a marker-based image segmentation using the watershed algorithm.
/// 
/// The function implements one of the variants of watershed, non-parametric marker-based segmentation
/// algorithm, described in [Meyer92](https://docs.opencv.org/3.2.0/d0/de3/citelist.html#CITEREF_Meyer92) .
/// 
...
pub trait CLAHE: core::AlgorithmTrait {
	...
	fn apply(&mut self, src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray) -> Result<()> {
		input_array_arg!(src);
		output_array_arg!(dst);
		unsafe { sys::cv_CLAHE_apply_const__InputArrayX_const__OutputArrayX(self.as_raw_CLAHE(), src.as_raw__InputArray(), dst.as_raw__OutputArray()) }.into_result()
	}
...
pub trait GeneralizedHough: core::AlgorithmTrait {
	...
	fn set_template(&mut self, templ: &dyn core::ToInputArray, templ_center: core::Point) -> Result<()> {
		input_array_arg!(templ);
		unsafe { sys::cv_GeneralizedHough_setTemplate_const__InputArrayX_Point(self.as_raw_GeneralizedHough(), templ.as_raw__InputArray(), &templ_center) }.into_result()
	}
	...
	fn set_template_1(&mut self, edges: &dyn core::ToInputArray, dx: &dyn core::ToInputArray, dy: &dyn core::ToInputArray, templ_center: core::Point) -> Result<()> {
		...
		input_array_arg!(dx);
		input_array_arg!(dy);
		unsafe { sys::cv_GeneralizedHough_setTemplate_const__InputArrayX_const__InputArrayX_const__InputArrayX_Point(self.as_raw_GeneralizedHough(), edges.as_raw__InputArray(), dx.as_raw__InputArray(), dy.as_raw__InputArray(), &templ_center) }.into_result()
	}
	...
	fn detect(&mut self, image: &dyn core::ToInputArray, positions: &mut dyn core::ToOutputArray, votes: &mut dyn core::ToOutputArray) -> Result<()> {
		...
		unsafe { sys::cv_GeneralizedHough_detect_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_GeneralizedHough(), image.as_raw__InputArray(), positions.as_raw__OutputArray(), votes.as_raw__OutputArray()) }.into_result()
	}
	...
	fn detect_with_edges(&mut self, edges: &dyn core::ToInputArray, dx: &dyn core::ToInputArray, dy: &dyn core::ToInputArray, positions: &mut dyn core::ToOutputArray, votes: &mut dyn core::ToOutputArray) -> Result<()> {
		...
		output_array_arg!(positions);
		output_array_arg!(votes);
		unsafe { sys::cv_GeneralizedHough_detect_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(self.as_raw_GeneralizedHough(), edges.as_raw__InputArray(), dx.as_raw__InputArray(), dy.as_raw__InputArray(), positions.as_raw__OutputArray(), votes.as_raw__OutputArray()) }.into_result()
	}
...
pub trait LineIteratorTrait {
	fn as_raw_LineIterator(&self) -> *mut c_void;
	fn ptr(&mut self) -> &mut u8 {
		unsafe { sys::cv_LineIterator_ptr(self.as_raw_LineIterator()) }.into_result().and_then(|x| unsafe { x.as_mut() }.ok_or_else(|| Error::new(core::StsNullPtr, "Function returned Null pointer".to_string()))).expect("Infallible function failed: ptr")
	}
	
	fn set_ptr(&mut self, val: &mut u8) -> () {
		unsafe { sys::cv_LineIterator_setPtr_unsigned_charX(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_ptr")
	}
	
	fn ptr0(&self) -> &u8 {
		unsafe { sys::cv_LineIterator_ptr0_const(self.as_raw_LineIterator()) }.into_result().and_then(|x| unsafe { x.as_ref() }.ok_or_else(|| Error::new(core::StsNullPtr, "Function returned Null pointer".to_string()))).expect("Infallible function failed: ptr0")
	}
	
	fn step(&self) -> i32 {
		unsafe { sys::cv_LineIterator_step_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: step")
	}
	
	fn set_step(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setStep_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_step")
	}
	
	fn elem_size(&self) -> i32 {
		unsafe { sys::cv_LineIterator_elemSize_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: elem_size")
	}
	
	fn set_elem_size(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setElemSize_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_elem_size")
	}
	
	fn err(&self) -> i32 {
		unsafe { sys::cv_LineIterator_err_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: err")
	}
	
	fn set_err(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setErr_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_err")
	}
	
	fn count(&self) -> i32 {
		unsafe { sys::cv_LineIterator_count_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: count")
	}
	
	fn set_count(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setCount_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_count")
	}
	
	fn minus_delta(&self) -> i32 {
		unsafe { sys::cv_LineIterator_minusDelta_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: minus_delta")
	}
	
	fn set_minus_delta(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setMinusDelta_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_minus_delta")
	}
	
	fn plus_delta(&self) -> i32 {
		unsafe { sys::cv_LineIterator_plusDelta_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: plus_delta")
	}
	
	fn set_plus_delta(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setPlusDelta_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_plus_delta")
	}
	
	fn minus_step(&self) -> i32 {
		unsafe { sys::cv_LineIterator_minusStep_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: minus_step")
	}
	
	fn set_minus_step(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setMinusStep_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_minus_step")
	}
	
	fn plus_step(&self) -> i32 {
		unsafe { sys::cv_LineIterator_plusStep_const(self.as_raw_LineIterator()) }.into_result().expect("Infallible function failed: plus_step")
	}
	
	fn set_plus_step(&mut self, val: i32) -> () {
		unsafe { sys::cv_LineIterator_setPlusStep_int(self.as_raw_LineIterator(), val) }.into_result().expect("Infallible function failed: set_plus_step")
	}
...
impl Drop for LineIterator {
	fn drop(&mut self) {
		...
		unsafe { cv_LineIterator_delete(self.as_raw_LineIterator()) };
	}
}
...
impl crate::imgproc::LineIteratorTrait for LineIterator {
	fn as_raw_LineIterator(&self) -> *mut c_void { self.ptr }
}
...
impl LineIterator {
	...
	pub fn new(img: &core::Mat, pt1: core::Point, pt2: core::Point, connectivity: i32, left_to_right: bool) -> Result<crate::imgproc::LineIterator> {
		unsafe { sys::cv_LineIterator_LineIterator_const_MatX_Point_Point_int_bool(img.as_raw_Mat(), &pt1, &pt2, connectivity, left_to_right) }.into_result().map(|ptr| crate::imgproc::LineIterator { ptr })
	}
...
pub trait LineSegmentDetector: core::AlgorithmTrait {
	...
	/// 
	/// ![image](https://docs.opencv.org/3.2.0/building_lsd.png)
	/// 
	/// ## Parameters
	...
	fn draw_segments(&mut self, _image: &mut dyn core::ToInputOutputArray, lines: &dyn core::ToInputArray) -> Result<()> {
		...
		unsafe { sys::cv_LineSegmentDetector_drawSegments_const__InputOutputArrayX_const__InputArrayX(self.as_raw_LineSegmentDetector(), _image.as_raw__InputOutputArray(), lines.as_raw__InputArray()) }.into_result()
	}
	...
	fn compare_segments(&mut self, size: core::Size, lines1: &dyn core::ToInputArray, lines2: &dyn core::ToInputArray, _image: &mut dyn core::ToInputOutputArray) -> Result<i32> {
		...
		input_output_array_arg!(_image);
		unsafe { sys::cv_LineSegmentDetector_compareSegments_const_SizeX_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX(self.as_raw_LineSegmentDetector(), &size, lines1.as_raw__InputArray(), lines2.as_raw__InputArray(), _image.as_raw__InputOutputArray()) }.into_result()
	}
...
pub trait Subdiv2DTrait {
	...
	/// appropriately.
	fn insert_multiple(&mut self, ptvec: &types::VectorOfPoint2f) -> Result<()> {
		unsafe { sys::cv_Subdiv2D_insert_const_vector_Point2f_X(self.as_raw_Subdiv2D(), ptvec.as_raw_VectorOfPoint2f()) }.into_result()
	}
	...
	fn locate(&mut self, pt: core::Point2f, edge: &mut i32, vertex: &mut i32) -> Result<i32> {
		unsafe { sys::cv_Subdiv2D_locate_Point2f_intX_intX(self.as_raw_Subdiv2D(), &pt, edge, vertex) }.into_result()
	}
	...
	fn find_nearest(&mut self, pt: core::Point2f, nearest_pt: &mut core::Point2f) -> Result<i32> {
		unsafe { sys::cv_Subdiv2D_findNearest_Point2f_Point2fX(self.as_raw_Subdiv2D(), &pt, nearest_pt) }.into_result()
	}
	...
	fn get_edge_list(&self, edge_list: &mut types::VectorOfVec4f) -> Result<()> {
		unsafe { sys::cv_Subdiv2D_getEdgeList_const_vector_Vec4f_X(self.as_raw_Subdiv2D(), edge_list.as_raw_VectorOfVec4f()) }.into_result()
	}
	...
	fn get_leading_edge_list(&self, leading_edge_list: &mut types::VectorOfi32) -> Result<()> {
		unsafe { sys::cv_Subdiv2D_getLeadingEdgeList_const_vector_int_X(self.as_raw_Subdiv2D(), leading_edge_list.as_raw_VectorOfi32()) }.into_result()
	}
	...
	fn get_triangle_list(&self, triangle_list: &mut types::VectorOfVec6f) -> Result<()> {
		unsafe { sys::cv_Subdiv2D_getTriangleList_const_vector_Vec6f_X(self.as_raw_Subdiv2D(), triangle_list.as_raw_VectorOfVec6f()) }.into_result()
	}
	...
	fn get_voronoi_facet_list(&mut self, idx: &types::VectorOfi32, facet_list: &mut types::VectorOfVectorOfPoint2f, facet_centers: &mut types::VectorOfPoint2f) -> Result<()> {
		unsafe { sys::cv_Subdiv2D_getVoronoiFacetList_const_vector_int_X_vector_vector_Point2f__X_vector_Point2f_X(self.as_raw_Subdiv2D(), idx.as_raw_VectorOfi32(), facet_list.as_raw_VectorOfVectorOfPoint2f(), facet_centers.as_raw_VectorOfPoint2f()) }.into_result()
	}
	...
	/// 
	/// ![sample output](https://docs.opencv.org/3.2.0/quadedge.png)
	/// 
	/// ## Returns
...
impl Drop for Subdiv2D {
	fn drop(&mut self) {
		...
		unsafe { cv_Subdiv2D_delete(self.as_raw_Subdiv2D()) };
	}
}
...
impl crate::imgproc::Subdiv2DTrait for Subdiv2D {
	fn as_raw_Subdiv2D(&self) -> *mut c_void { self.ptr }
}
