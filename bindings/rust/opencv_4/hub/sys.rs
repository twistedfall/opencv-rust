...
mod dnn_sys {
	...
	extern "C" {
		...
		pub fn cv_dnn_ClassificationModel_classify_const__InputArrayX_intR_floatR(instance: *mut c_void, frame: *const c_void, class_id: *mut i32, conf: *mut f32) -> Result_void;
...
mod optflow_sys {
	...
	extern "C" {
		...
		pub fn cv_optflow_calcOpticalFlowSparseRLOF_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_Ptr_RLOFOpticalFlowParameter__float(prev_img: *const c_void, next_img: *const c_void, prev_pts: *const c_void, next_pts: *const c_void, status: *const c_void, err: *const c_void, rlof_param: *mut c_void, forward_backward_threshold: f32) -> Result_void;
...
mod quality_sys {
	...
	extern "C" {
		pub fn cv_quality_QualityBRISQUE_compute_const__InputArrayX(instance: *mut c_void, img: *const c_void) -> Result<core::Scalar>;
		pub fn cv_quality_QualityBRISQUE_create_const_StringX_const_StringX(model_file_path: *const c_char, range_file_path: *const c_char) -> Result<*mut c_void>;
		pub fn cv_quality_QualityBRISQUE_create_const_Ptr_SVM_X_const_MatX(model: *const c_void, range: *const c_void) -> Result<*mut c_void>;
		pub fn cv_quality_QualityBRISQUE_compute_const__InputArrayX_const_StringX_const_StringX(img: *const c_void, model_file_path: *const c_char, range_file_path: *const c_char) -> Result<core::Scalar>;
		pub fn cv_quality_QualityBRISQUE_computeFeatures_const__InputArrayX_const__OutputArrayX(img: *const c_void, features: *const c_void) -> Result_void;
		pub fn cv_quality_QualityBase_compute_const__InputArrayX(instance: *mut c_void, img: *const c_void) -> Result<core::Scalar>;
		pub fn cv_quality_QualityBase_getQualityMap_const_const__OutputArrayX(instance: *const c_void, dst: *const c_void) -> Result_void;
		...
		pub fn cv_quality_QualityGMSD_compute_const__InputArrayX(instance: *mut c_void, cmp: *const c_void) -> Result<core::Scalar>;
		...
		pub fn cv_quality_QualityGMSD_create_const__InputArrayX(ref_: *const c_void) -> Result<*mut c_void>;
		pub fn cv_quality_QualityGMSD_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX(ref_: *const c_void, cmp: *const c_void, quality_map: *const c_void) -> Result<core::Scalar>;
		pub fn cv_quality_QualityMSE_compute_const__InputArrayX(instance: *mut c_void, cmp_imgs: *const c_void) -> Result<core::Scalar>;
		...
		pub fn cv_quality_QualityMSE_create_const__InputArrayX(ref_: *const c_void) -> Result<*mut c_void>;
		pub fn cv_quality_QualityMSE_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX(ref_: *const c_void, cmp: *const c_void, quality_map: *const c_void) -> Result<core::Scalar>;
		pub fn cv_quality_QualityPSNR_create_const__InputArrayX_double(ref_: *const c_void, max_pixel_value: f64) -> Result<*mut c_void>;
		pub fn cv_quality_QualityPSNR_compute_const__InputArrayX(instance: *mut c_void, cmp: *const c_void) -> Result<core::Scalar>;
		...
		pub fn cv_quality_QualityPSNR_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX_double(ref_: *const c_void, cmp: *const c_void, quality_map: *const c_void, max_pixel_value: f64) -> Result<core::Scalar>;
		...
		pub fn cv_quality_QualitySSIM_compute_const__InputArrayX(instance: *mut c_void, cmp: *const c_void) -> Result<core::Scalar>;
		...
		pub fn cv_quality_QualitySSIM_create_const__InputArrayX(ref_: *const c_void) -> Result<*mut c_void>;
		pub fn cv_quality_QualitySSIM_compute_const__InputArrayX_const__InputArrayX_const__OutputArrayX(ref_: *const c_void, cmp: *const c_void, quality_map: *const c_void) -> Result<core::Scalar>;
	}
}
#[cfg(feature = "contrib")]
pub use quality_sys::*;
...
mod rgbd_sys {
	...
	extern "C" {
		...
		pub fn cv_linemod_drawFeatures_const__InputOutputArrayX_const_vector_Template_X_const_Point2iX_int(img: *const c_void, templates: *const c_void, tl: *const core::Point2i, size: i32) -> Result_void;
		...
		pub fn cv_dynafu_DynaFu_create_const_Ptr_Params_X(_params: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dynafu_DynaFu_getParams_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dynafu_DynaFu_render_const_const__OutputArrayX_const_Matx44fX(instance: *const c_void, image: *const c_void, camera_pose: *const core::Matx44f) -> Result_void;
		pub fn cv_dynafu_DynaFu_getCloud_const_const__OutputArrayX_const__OutputArrayX(instance: *const c_void, points: *const c_void, normals: *const c_void) -> Result_void;
		pub fn cv_dynafu_DynaFu_getPoints_const_const__OutputArrayX(instance: *const c_void, points: *const c_void) -> Result_void;
		pub fn cv_dynafu_DynaFu_getNormals_const_const__InputArrayX_const__OutputArrayX(instance: *const c_void, points: *const c_void, normals: *const c_void) -> Result_void;
		...
		pub fn cv_dynafu_DynaFu_update_const__InputArrayX(instance: *mut c_void, depth: *const c_void) -> Result<bool>;
		pub fn cv_dynafu_DynaFu_getNodesPos_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_dynafu_DynaFu_marchCubes_const_const__OutputArrayX_const__OutputArrayX(instance: *const c_void, vertices: *const c_void, edges: *const c_void) -> Result_void;
		pub fn cv_dynafu_DynaFu_renderSurface_const__OutputArrayX_const__OutputArrayX_const__OutputArrayX_bool(instance: *mut c_void, depth_image: *const c_void, vert_image: *const c_void, norm_image: *const c_void, warp: bool) -> Result_void;
		pub fn cv_dynafu_Params_getPropFrameSize_const(instance: *const c_void) -> Result<core::Size>;
		pub fn cv_dynafu_Params_setPropFrameSize_Size(instance: *mut c_void, val: *const core::Size) -> Result_void;
		pub fn cv_dynafu_Params_getPropIntr_const(instance: *const c_void) -> Result<core::Matx33f>;
		pub fn cv_dynafu_Params_setPropIntr_Matx33f(instance: *mut c_void, val: *const core::Matx33f) -> Result_void;
		pub fn cv_dynafu_Params_getPropDepthFactor_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropDepthFactor_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropBilateral_sigma_depth_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropBilateral_sigma_depth_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropBilateral_sigma_spatial_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropBilateral_sigma_spatial_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropBilateral_kernel_size_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dynafu_Params_setPropBilateral_kernel_size_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_dynafu_Params_getPropPyramidLevels_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dynafu_Params_setPropPyramidLevels_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_dynafu_Params_getPropVolumeDims_const(instance: *const c_void) -> Result<core::Vec3i>;
		pub fn cv_dynafu_Params_setPropVolumeDims_Vec3i(instance: *mut c_void, val: *const core::Vec3i) -> Result_void;
		pub fn cv_dynafu_Params_getPropVoxelSize_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropVoxelSize_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropTsdf_min_camera_movement_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropTsdf_min_camera_movement_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropVolumePose_const(instance: *const c_void) -> Result<core::Affine3f>;
		pub fn cv_dynafu_Params_setPropVolumePose_Affine3f(instance: *mut c_void, val: *const core::Affine3f) -> Result_void;
		pub fn cv_dynafu_Params_getPropTsdf_trunc_dist_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropTsdf_trunc_dist_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropTsdf_max_weight_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_dynafu_Params_setPropTsdf_max_weight_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_dynafu_Params_getPropRaycast_step_factor_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropRaycast_step_factor_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropLightPose_const(instance: *const c_void) -> Result<core::Vec3f>;
		pub fn cv_dynafu_Params_setPropLightPose_Vec3f(instance: *mut c_void, val: *const core::Vec3f) -> Result_void;
		pub fn cv_dynafu_Params_getPropIcpDistThresh_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropIcpDistThresh_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropIcpAngleThresh_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropIcpAngleThresh_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_getPropIcpIterations(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_dynafu_Params_setPropIcpIterations_vector_int_(instance: *mut c_void, val: *mut c_void) -> Result_void;
		pub fn cv_dynafu_Params_getPropTruncateThreshold_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_dynafu_Params_setPropTruncateThreshold_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_dynafu_Params_defaultParams() -> Result<*mut c_void>;
		pub fn cv_dynafu_Params_coarseParams() -> Result<*mut c_void>;
		pub fn cv_kinfu_KinFu_create_const_Ptr_Params_X(_params: *const c_void) -> Result<*mut c_void>;
		pub fn cv_kinfu_KinFu_getParams_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_kinfu_KinFu_render_const_const__OutputArrayX_const_Matx44fX(instance: *const c_void, image: *const c_void, camera_pose: *const core::Matx44f) -> Result_void;
		pub fn cv_kinfu_KinFu_getCloud_const_const__OutputArrayX_const__OutputArrayX(instance: *const c_void, points: *const c_void, normals: *const c_void) -> Result_void;
		pub fn cv_kinfu_KinFu_getPoints_const_const__OutputArrayX(instance: *const c_void, points: *const c_void) -> Result_void;
		pub fn cv_kinfu_KinFu_getNormals_const_const__InputArrayX_const__OutputArrayX(instance: *const c_void, points: *const c_void, normals: *const c_void) -> Result_void;
		...
		pub fn cv_kinfu_KinFu_update_const__InputArrayX(instance: *mut c_void, depth: *const c_void) -> Result<bool>;
		...
		pub fn cv_kinfu_Params_getPropIcpIterations(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_kinfu_Params_Params_Matx33f_Vec3f(volume_intial_pose_rot: *const core::Matx33f, volume_intial_pose_transl: *const core::Vec3f) -> Result<*mut c_void>;
		pub fn cv_kinfu_Params_Params_Matx44f(volume_intial_pose: *const core::Matx44f) -> Result<*mut c_void>;
		...
		pub fn cv_rgbd_FastICPOdometry_FastICPOdometry_const_MatX_float_float_float_float_int_const_vector_int_X(camera_matrix: *const c_void, max_dist_diff: f32, angle_threshold: f32, sigma_depth: f32, sigma_spatial: f32, kernel_size: i32, iter_counts: *const c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_FastICPOdometry_create_const_MatX_float_float_float_float_int_const_vector_int_X(camera_matrix: *const c_void, max_dist_diff: f32, angle_threshold: f32, sigma_depth: f32, sigma_spatial: f32, kernel_size: i32, iter_counts: *const c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_FastICPOdometry_prepareFrameCache_const_Ptr_OdometryFrame_X_int(instance: *const c_void, frame: *mut c_void, cache_type: i32) -> Result<core::Size>;
		pub fn cv_rgbd_FastICPOdometry_getCameraMatrix_const(instance: *const c_void) -> Result<*mut c_void>;
		pub fn cv_rgbd_FastICPOdometry_setCameraMatrix_const_MatX(instance: *mut c_void, val: *const c_void) -> Result_void;
		...
		pub fn cv_rgbd_FastICPOdometry_setIterationCounts_const_MatX(instance: *mut c_void, val: *const c_void) -> Result_void;
...
mod stereo_sys {
	...
	extern "C" {
		...
		pub fn cv_stereo_Match_getPropP0_const(instance: *const c_void) -> Result<core::Point2i>;
		pub fn cv_stereo_Match_setPropP0_Point2i(instance: *mut c_void, val: *const core::Point2i) -> Result_void;
		pub fn cv_stereo_Match_getPropP1_const(instance: *const c_void) -> Result<core::Point2i>;
		pub fn cv_stereo_Match_setPropP1_Point2i(instance: *mut c_void, val: *const core::Point2i) -> Result_void;
		pub fn cv_stereo_Match_getPropCorr_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_stereo_Match_setPropCorr_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropCorrWinSizeX_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropCorrWinSizeX_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropCorrWinSizeY_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropCorrWinSizeY_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropBorderX_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropBorderX_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropBorderY_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropBorderY_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropCorrelationThreshold_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_stereo_PropagationParameters_setPropCorrelationThreshold_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropTextrureThreshold_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_stereo_PropagationParameters_setPropTextrureThreshold_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropNeighborhoodSize_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropNeighborhoodSize_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropDisparityGradient_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropDisparityGradient_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropLkTemplateSize_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropLkTemplateSize_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropLkPyrLvl_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropLkPyrLvl_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropLkTermParam1_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropLkTermParam1_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropLkTermParam2_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_stereo_PropagationParameters_setPropLkTermParam2_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropGftQualityThres_const(instance: *const c_void) -> Result<f32>;
		pub fn cv_stereo_PropagationParameters_setPropGftQualityThres_float(instance: *mut c_void, val: f32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropGftMinSeperationDist_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropGftMinSeperationDist_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_PropagationParameters_getPropGftMaxNumFeatures_const(instance: *const c_void) -> Result<i32>;
		pub fn cv_stereo_PropagationParameters_setPropGftMaxNumFeatures_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_stereo_QuasiDenseStereo_getPropParam(instance: *mut c_void) -> Result<*mut c_void>;
		pub fn cv_stereo_QuasiDenseStereo_setPropParam_PropagationParameters(instance: *mut c_void, val: *mut c_void) -> Result_void;
		...
		pub fn cv_stereo_QuasiDenseStereo_getSparseMatches_vector_Match_X(instance: *mut c_void, s_matches: *mut c_void) -> Result_void;
		pub fn cv_stereo_QuasiDenseStereo_getDenseMatches_vector_Match_X(instance: *mut c_void, dense_matches: *mut c_void) -> Result_void;
		pub fn cv_stereo_QuasiDenseStereo_process_const_MatX_const_MatX(instance: *mut c_void, img_left: *const c_void, img_right: *const c_void) -> Result_void;
		pub fn cv_stereo_QuasiDenseStereo_getMatch_int_int(instance: *mut c_void, x: i32, y: i32) -> Result<core::Point2f>;
		pub fn cv_stereo_QuasiDenseStereo_getDisparity_uint8_t(instance: *mut c_void, disparity_lvls: u8) -> Result<*mut c_void>;
...
mod tracking_sys {
	...
	extern "C" {
		...
		#[cfg(not(target_os = "windows"))]
		pub fn cv_CvFeatureParams_create_FeatureType(feature_type: crate::tracking::CvFeatureParams_FeatureType) -> Result<*mut c_void>;
		...
		pub fn cv_TrackerCSRT_setInitialMask_const__InputArrayX(instance: *mut c_void, mask: *const c_void) -> Result_void;
...
mod ximgproc_sys {
	...
	extern "C" {
		...
		pub fn cv_ximgproc_colorMatchTemplate_const__InputArrayX_const__InputArrayX_const__OutputArrayX(img: *const c_void, templ: *const c_void, result: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_createQuaternionImage_const__InputArrayX_const__OutputArrayX(img: *const c_void, qimg: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_edgePreservingFilter_const__InputArrayX_const__OutputArrayX_int_double(src: *const c_void, dst: *const c_void, d: i32, threshold: f64) -> Result_void;
		...
		pub fn cv_ximgproc_qconj_const__InputArrayX_const__OutputArrayX(qimg: *const c_void, qcimg: *const c_void) -> Result_void;
		pub fn cv_ximgproc_qdft_const__InputArrayX_const__OutputArrayX_int_bool(img: *const c_void, qimg: *const c_void, flags: i32, side_left: bool) -> Result_void;
		pub fn cv_ximgproc_qmultiply_const__InputArrayX_const__InputArrayX_const__OutputArrayX(src1: *const c_void, src2: *const c_void, dst: *const c_void) -> Result_void;
		pub fn cv_ximgproc_qunitary_const__InputArrayX_const__OutputArrayX(qimg: *const c_void, qnimg: *const c_void) -> Result_void;
		pub fn cv_ximgproc_readGT_String_const__OutputArrayX(src_path: *mut c_char, dst: *const c_void) -> Result<i32>;
		pub fn cv_ximgproc_rl_createRLEImage_vector_Point3i_X_const__OutputArrayX_Size(runs: *mut c_void, res: *const c_void, size: *const core::Size) -> Result_void;
		pub fn cv_ximgproc_rl_dilate_const__InputArrayX_const__OutputArrayX_const__InputArrayX_Point(rl_src: *const c_void, rl_dest: *const c_void, rl_kernel: *const c_void, anchor: *const core::Point) -> Result_void;
		pub fn cv_ximgproc_rl_erode_const__InputArrayX_const__OutputArrayX_const__InputArrayX_bool_Point(rl_src: *const c_void, rl_dest: *const c_void, rl_kernel: *const c_void, b_boundary_on: bool, anchor: *const core::Point) -> Result_void;
		pub fn cv_ximgproc_rl_getStructuringElement_int_Size(shape: i32, ksize: *const core::Size) -> Result<*mut c_void>;
		pub fn cv_ximgproc_rl_isRLMorphologyPossible_const__InputArrayX(rl_structuring_element: *const c_void) -> Result<bool>;
		pub fn cv_ximgproc_rl_morphologyEx_const__InputArrayX_const__OutputArrayX_int_const__InputArrayX_bool_Point(rl_src: *const c_void, rl_dest: *const c_void, op: i32, rl_kernel: *const c_void, b_boundary_on_for_erosion: bool, anchor: *const core::Point) -> Result_void;
		pub fn cv_ximgproc_rl_paint_const__InputOutputArrayX_const__InputArrayX_const_ScalarX(image: *const c_void, rl_src: *const c_void, value: *const core::Scalar) -> Result_void;
		pub fn cv_ximgproc_rl_threshold_const__InputArrayX_const__OutputArrayX_double_int(src: *const c_void, rl_dest: *const c_void, thresh: f64, typ: i32) -> Result_void;
		...
		pub fn cv_ximgproc_EdgeAwareInterpolator_setCostMap_const_MatX(instance: *mut c_void, _cost_map: *const c_void) -> Result_void;
		...
		pub fn cv_ximgproc_RICInterpolator_setCostMap_const_MatX(instance: *mut c_void, cost_map: *const c_void) -> Result_void;
