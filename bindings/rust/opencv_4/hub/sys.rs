...
mod rgbd_sys {
	...
	extern "C" {
		...
		pub fn cv_large_kinfu_Params_getPropIcpIterations(instance: *mut c_void) -> Result<*mut c_void>;
		...
		pub fn cv_large_kinfu_Params_getPropVolumeParams(instance: *mut c_void) -> Result<*mut c_void>;
