...
pub trait GaussianMotionFilterTrait: crate::videostab::MotionFilterBase {
	...
	fn stabilize(&mut self, idx: i32, motions: &core::Vector::<core::Mat>, range: &core::Range) -> Result<core::Mat> {
		unsafe { sys::cv_videostab_GaussianMotionFilter_stabilize_int_const_vector_Mat_X_const_RangeX(self.as_raw_mut_GaussianMotionFilter(), idx, motions.as_raw_VectorOfMat(), range.as_raw_Range()) }.into_result().map(|r| unsafe { core::Mat::opencv_from_extern(r) } )
	}
...
pub trait MotionFilterBase: crate::videostab::IMotionStabilizer {
	...
	fn stabilize(&mut self, idx: i32, motions: &core::Vector::<core::Mat>, range: &core::Range) -> Result<core::Mat> {
		unsafe { sys::cv_videostab_MotionFilterBase_stabilize_int_const_vector_Mat_X_const_RangeX(self.as_raw_mut_MotionFilterBase(), idx, motions.as_raw_VectorOfMat(), range.as_raw_Range()) }.into_result().map(|r| unsafe { core::Mat::opencv_from_extern(r) } )
	}
