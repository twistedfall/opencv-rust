...
//! image, we first compute a non-binary descriptor as described in [LBD](https://docs.opencv.org/4.2.0/d0/de3/citelist.html#CITEREF_LBD) . Such algorithm works on
//! lines extracted using EDLine detector, as explained in [EDL](https://docs.opencv.org/4.2.0/d0/de3/citelist.html#CITEREF_EDL) . Given a line, we consider a
...
/// -------------------
/// 
/// The theory described in this section is based on [MIH](https://docs.opencv.org/4.2.0/d0/de3/citelist.html#CITEREF_MIH) . Given a dataset populated with binary
...
pub trait BinaryDescriptorMatcherTrait: core::AlgorithmTrait {
	...
	/// ## C++ default parameters
	/// * masks: std::vector<Mat>()
	fn match_query(&mut self, query_descriptors: &core::Mat, matches: &mut types::VectorOfDMatch, masks: &types::VectorOfMat) -> Result<()> {
	...
	/// * masks: std::vector<Mat>()
	/// * compact_result: false
	fn knn_match_query(&mut self, query_descriptors: &core::Mat, matches: &mut types::VectorOfVectorOfDMatch, k: i32, masks: &types::VectorOfMat, compact_result: bool) -> Result<()> {
...
impl LSDDetector {
	...
	pub fn create_lsd_detector_with_params(params: crate::line_descriptor::LSDParam) -> Result<types::PtrOfLSDDetector> {
...
/// ----------------------------
/// 
/// The lines extraction methodology described in the following is mainly based on [EDL](https://docs.opencv.org/4.2.0/d0/de3/citelist.html#CITEREF_EDL) . The
