...
/// ![image](https://docs.opencv.org/4.2.0/SVM_Comparison.png)
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
pub enum SVM_Types {
	...
	/// See [LibSVM](https://docs.opencv.org/4.2.0/d0/de3/citelist.html#CITEREF_LibSVM) for details.
	NU_SVR = 104 as isize,
}
...
/// as presented in [bottou2010large](https://docs.opencv.org/4.2.0/d0/de3/citelist.html#CITEREF_bottou2010large).
/// 
...
/// 
/// The recommended model type is ASGD (following [bottou2010large](https://docs.opencv.org/4.2.0/d0/de3/citelist.html#CITEREF_bottou2010large)).
/// 
