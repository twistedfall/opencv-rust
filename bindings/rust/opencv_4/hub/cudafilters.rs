...
pub fn create_box_filter(src_type: i32, dst_type: i32, ksize: core::Size, anchor: core::Point, border_mode: i32, border_val: core::Scalar) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	unsafe { sys::cv_cuda_createBoxFilter_int_int_Size_Point_int_Scalar(src_type, dst_type, ksize.opencv_to_extern(), anchor.opencv_to_extern(), border_mode, border_val.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_box_max_filter(src_type: i32, ksize: core::Size, anchor: core::Point, border_mode: i32, border_val: core::Scalar) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	unsafe { sys::cv_cuda_createBoxMaxFilter_int_Size_Point_int_Scalar(src_type, ksize.opencv_to_extern(), anchor.opencv_to_extern(), border_mode, border_val.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_box_min_filter(src_type: i32, ksize: core::Size, anchor: core::Point, border_mode: i32, border_val: core::Scalar) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	unsafe { sys::cv_cuda_createBoxMinFilter_int_Size_Point_int_Scalar(src_type, ksize.opencv_to_extern(), anchor.opencv_to_extern(), border_mode, border_val.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_column_sum_filter(src_type: i32, dst_type: i32, ksize: i32, anchor: i32, border_mode: i32, border_val: core::Scalar) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	unsafe { sys::cv_cuda_createColumnSumFilter_int_int_int_int_int_Scalar(src_type, dst_type, ksize, anchor, border_mode, border_val.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_gaussian_filter(src_type: i32, dst_type: i32, ksize: core::Size, sigma1: f64, sigma2: f64, row_border_mode: i32, column_border_mode: i32) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	unsafe { sys::cv_cuda_createGaussianFilter_int_int_Size_double_double_int_int(src_type, dst_type, ksize.opencv_to_extern(), sigma1, sigma2, row_border_mode, column_border_mode) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_laplacian_filter(src_type: i32, dst_type: i32, ksize: i32, scale: f64, border_mode: i32, border_val: core::Scalar) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	unsafe { sys::cv_cuda_createLaplacianFilter_int_int_int_double_int_Scalar(src_type, dst_type, ksize, scale, border_mode, border_val.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_linear_filter(src_type: i32, dst_type: i32, kernel: &dyn core::ToInputArray, anchor: core::Point, border_mode: i32, border_val: core::Scalar) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	...
	unsafe { sys::cv_cuda_createLinearFilter_int_int_const__InputArrayR_Point_int_Scalar(src_type, dst_type, kernel.as_raw__InputArray(), anchor.opencv_to_extern(), border_mode, border_val.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_morphology_filter(op: i32, src_type: i32, kernel: &dyn core::ToInputArray, anchor: core::Point, iterations: i32) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	input_array_arg!(kernel);
	unsafe { sys::cv_cuda_createMorphologyFilter_int_int_const__InputArrayR_Point_int(op, src_type, kernel.as_raw__InputArray(), anchor.opencv_to_extern(), iterations) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
...
pub fn create_row_sum_filter(src_type: i32, dst_type: i32, ksize: i32, anchor: i32, border_mode: i32, border_val: core::Scalar) -> Result<core::Ptr::<dyn crate::cudafilters::Filter>> {
	unsafe { sys::cv_cuda_createRowSumFilter_int_int_int_int_int_Scalar(src_type, dst_type, ksize, anchor, border_mode, border_val.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::cudafilters::Filter>::opencv_from_extern(r) } )
}
