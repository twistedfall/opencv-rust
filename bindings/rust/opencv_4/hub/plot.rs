...
impl dyn Plot2d + '_ {
	...
	pub fn create(data: &dyn core::ToInputArray) -> Result<types::PtrOfPlot2d> {
		...
		unsafe { sys::cv_plot_Plot2d_create_const__InputArrayX(data.as_raw__InputArray()) }.into_result().map(|ptr| types::PtrOfPlot2d { ptr })
	}
	...
	pub fn create_1(data_x: &dyn core::ToInputArray, data_y: &dyn core::ToInputArray) -> Result<types::PtrOfPlot2d> {
		...
		unsafe { sys::cv_plot_Plot2d_create_const__InputArrayX_const__InputArrayX(data_x.as_raw__InputArray(), data_y.as_raw__InputArray()) }.into_result().map(|ptr| types::PtrOfPlot2d { ptr })
	}
