...
pub trait Plot2d: core::AlgorithmTrait {
	...
	fn set_show_grid(&mut self, need_show_grid: bool) -> Result<()> {
		unsafe { sys::cv_plot_Plot2d_setShowGrid_bool(self.as_raw_mut_Plot2d(), need_show_grid) }.into_result()
	}
	
	fn set_show_text(&mut self, need_show_text: bool) -> Result<()> {
		unsafe { sys::cv_plot_Plot2d_setShowText_bool(self.as_raw_mut_Plot2d(), need_show_text) }.into_result()
	}
	
	fn set_grid_lines_number(&mut self, grid_lines_number: i32) -> Result<()> {
		unsafe { sys::cv_plot_Plot2d_setGridLinesNumber_int(self.as_raw_mut_Plot2d(), grid_lines_number) }.into_result()
	}
	
	fn set_invert_orientation(&mut self, _invert_orientation: bool) -> Result<()> {
		unsafe { sys::cv_plot_Plot2d_setInvertOrientation_bool(self.as_raw_mut_Plot2d(), _invert_orientation) }.into_result()
	}
	...
	fn set_point_idx_to_print(&mut self, point_idx: i32) -> Result<()> {
		unsafe { sys::cv_plot_Plot2d_setPointIdxToPrint_int(self.as_raw_mut_Plot2d(), point_idx) }.into_result()
	}
...
impl dyn Plot2d + '_ {
	...
	pub fn create(data: &dyn core::ToInputArray) -> Result<core::Ptr::<dyn crate::plot::Plot2d>> {
		...
		unsafe { sys::cv_plot_Plot2d_create_const__InputArrayX(data.as_raw__InputArray()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::plot::Plot2d>::from_raw(ptr) })
	}
	...
	pub fn create_1(data_x: &dyn core::ToInputArray, data_y: &dyn core::ToInputArray) -> Result<core::Ptr::<dyn crate::plot::Plot2d>> {
		...
		unsafe { sys::cv_plot_Plot2d_create_const__InputArrayX_const__InputArrayX(data_x.as_raw__InputArray(), data_y.as_raw__InputArray()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::plot::Plot2d>::from_raw(ptr) })
	}
