...
mod calib3d_types {
	...
	ptr_extern! { dyn crate::calib3d::LMSolver,
		cv_PtrOfLMSolver_delete, cv_PtrOfLMSolver_get_inner_ptr
	}
	
	impl PtrOfLMSolver {
		pub fn as_raw_PtrOfLMSolver(&self) -> *const c_void { self.as_raw() }
		pub fn as_raw_mut_PtrOfLMSolver(&mut self) -> *mut c_void { self.as_raw_mut() }
	}
	...
	impl crate::calib3d::LMSolver for PtrOfLMSolver {
		fn as_raw_LMSolver(&self) -> *const c_void { self.inner_as_raw() }
		fn as_raw_mut_LMSolver(&mut self) -> *mut c_void { self.inner_as_raw_mut() }
	}
	...
	impl PtrOfLMSolver_Callback {
		pub fn as_raw_PtrOfLMSolver_Callback(&self) -> *const c_void { self.as_raw() }
		pub fn as_raw_mut_PtrOfLMSolver_Callback(&mut self) -> *mut c_void { self.as_raw_mut() }
	}
	
	impl crate::calib3d::LMSolver_Callback for PtrOfLMSolver_Callback {
		fn as_raw_LMSolver_Callback(&self) -> *const c_void { self.inner_as_raw() }
		fn as_raw_mut_LMSolver_Callback(&mut self) -> *mut c_void { self.inner_as_raw_mut() }
	}
...
mod core_types {
	...
	vector_extern! { core::Rect2d, *const c_void, *mut c_void,
		...
		cv_VectorOfRect2d_get -> sys::Result<core::Rect2d>,
		ret_map: 
	}
	...
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Rect2d> {
		type Arg = core::Rect2d;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, val: core::Rect2d) {
			extern "C" { fn cv_VectorOfRect2d_push(instance: *mut c_void, val: *const core::Rect2d); }
			unsafe { cv_VectorOfRect2d_push(self.as_raw_mut_VectorOfRect2d(), &val) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, val: core::Rect2d) -> Result<()> {
			extern "C" { fn cv_VectorOfRect2d_insert(instance: *mut c_void, index: size_t, val: *const core::Rect2d); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfRect2d_insert(self.as_raw_mut_VectorOfRect2d(), index, &val) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, val: core::Rect2d) -> Result<()> {
			extern "C" { fn cv_VectorOfRect2d_set(instance: *mut c_void, index: size_t, val: *const core::Rect2d); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfRect2d_set(self.as_raw_mut_VectorOfRect2d(), index, &val) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, val: core::Rect2d) {
			extern "C" { fn cv_VectorOfRect2d_set(instance: *mut c_void, index: size_t, val: *const core::Rect2d); }
			cv_VectorOfRect2d_set(self.as_raw_mut_VectorOfRect2d(), index, &val)
		}
	}
	...
	vector_extern! { core::RotatedRect, *const c_void, *mut c_void,
		...
		cv_VectorOfRotatedRect_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { core::RotatedRect::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { core::RotatedRect }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::RotatedRect> {
		type Arg = core::RotatedRect;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: core::RotatedRect) {
			extern "C" { fn cv_VectorOfRotatedRect_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfRotatedRect_push(self.as_raw_mut_VectorOfRotatedRect(), val.as_raw_mut_RotatedRect()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: core::RotatedRect) -> Result<()> {
			extern "C" { fn cv_VectorOfRotatedRect_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfRotatedRect_insert(self.as_raw_mut_VectorOfRotatedRect(), index, val.as_raw_mut_RotatedRect()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: core::RotatedRect) -> Result<()> {
			extern "C" { fn cv_VectorOfRotatedRect_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfRotatedRect_set(self.as_raw_mut_VectorOfRotatedRect(), index, val.as_raw_mut_RotatedRect()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: core::RotatedRect) {
			extern "C" { fn cv_VectorOfRotatedRect_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfRotatedRect_set(self.as_raw_mut_VectorOfRotatedRect(), index, val.as_raw_mut_RotatedRect())
		}
	}
	...
	vector_extern! { core::Scalar, *const c_void, *mut c_void,
		...
		cv_VectorOfScalar_get -> sys::Result<core::Scalar>,
		ret_map: 
	}
	...
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Scalar> {
		type Arg = core::Scalar;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, val: core::Scalar) {
			extern "C" { fn cv_VectorOfScalar_push(instance: *mut c_void, val: *const core::Scalar); }
			unsafe { cv_VectorOfScalar_push(self.as_raw_mut_VectorOfScalar(), &val) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, val: core::Scalar) -> Result<()> {
			extern "C" { fn cv_VectorOfScalar_insert(instance: *mut c_void, index: size_t, val: *const core::Scalar); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfScalar_insert(self.as_raw_mut_VectorOfScalar(), index, &val) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, val: core::Scalar) -> Result<()> {
			extern "C" { fn cv_VectorOfScalar_set(instance: *mut c_void, index: size_t, val: *const core::Scalar); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfScalar_set(self.as_raw_mut_VectorOfScalar(), index, &val) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, val: core::Scalar) {
			extern "C" { fn cv_VectorOfScalar_set(instance: *mut c_void, index: size_t, val: *const core::Scalar); }
			cv_VectorOfScalar_set(self.as_raw_mut_VectorOfScalar(), index, &val)
		}
	}
	...
	vector_extern! { core::Vec3i, *const c_void, *mut c_void,
		...
		cv_VectorOfVec3i_get -> sys::Result<core::Vec3i>,
		ret_map: 
	}
	...
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Vec3i> {
		type Arg = core::Vec3i;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, val: core::Vec3i) {
			extern "C" { fn cv_VectorOfVec3i_push(instance: *mut c_void, val: *const core::Vec3i); }
			unsafe { cv_VectorOfVec3i_push(self.as_raw_mut_VectorOfVec3i(), &val) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, val: core::Vec3i) -> Result<()> {
			extern "C" { fn cv_VectorOfVec3i_insert(instance: *mut c_void, index: size_t, val: *const core::Vec3i); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfVec3i_insert(self.as_raw_mut_VectorOfVec3i(), index, &val) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, val: core::Vec3i) -> Result<()> {
			extern "C" { fn cv_VectorOfVec3i_set(instance: *mut c_void, index: size_t, val: *const core::Vec3i); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfVec3i_set(self.as_raw_mut_VectorOfVec3i(), index, &val) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, val: core::Vec3i) {
			extern "C" { fn cv_VectorOfVec3i_set(instance: *mut c_void, index: size_t, val: *const core::Vec3i); }
			cv_VectorOfVec3i_set(self.as_raw_mut_VectorOfVec3i(), index, &val)
		}
	}
	...
	vector_extern! { core::Vector::<core::Mat>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfMat_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { core::Vector::<core::Mat>::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { core::Vector::<core::Mat> }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Vector::<core::Mat>> {
		type Arg = core::Vector::<core::Mat>;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: core::Vector::<core::Mat>) {
			extern "C" { fn cv_VectorOfVectorOfMat_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfVectorOfMat_push(self.as_raw_mut_VectorOfVectorOfMat(), val.as_raw_mut_VectorOfMat()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: core::Vector::<core::Mat>) -> Result<()> {
			extern "C" { fn cv_VectorOfVectorOfMat_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfVectorOfMat_insert(self.as_raw_mut_VectorOfVectorOfMat(), index, val.as_raw_mut_VectorOfMat()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: core::Vector::<core::Mat>) -> Result<()> {
			extern "C" { fn cv_VectorOfVectorOfMat_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfVectorOfMat_set(self.as_raw_mut_VectorOfVectorOfMat(), index, val.as_raw_mut_VectorOfMat()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: core::Vector::<core::Mat>) {
			extern "C" { fn cv_VectorOfVectorOfMat_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfVectorOfMat_set(self.as_raw_mut_VectorOfVectorOfMat(), index, val.as_raw_mut_VectorOfMat())
		}
	}
	...
	vector_extern! { core::Vector::<core::Range>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfRange_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { core::Vector::<core::Range>::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { core::Vector::<core::Range> }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Vector::<core::Range>> {
		type Arg = core::Vector::<core::Range>;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: core::Vector::<core::Range>) {
			extern "C" { fn cv_VectorOfVectorOfRange_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfVectorOfRange_push(self.as_raw_mut_VectorOfVectorOfRange(), val.as_raw_mut_VectorOfRange()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: core::Vector::<core::Range>) -> Result<()> {
			extern "C" { fn cv_VectorOfVectorOfRange_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfVectorOfRange_insert(self.as_raw_mut_VectorOfVectorOfRange(), index, val.as_raw_mut_VectorOfRange()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: core::Vector::<core::Range>) -> Result<()> {
			extern "C" { fn cv_VectorOfVectorOfRange_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfVectorOfRange_set(self.as_raw_mut_VectorOfVectorOfRange(), index, val.as_raw_mut_VectorOfRange()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: core::Vector::<core::Range>) {
			extern "C" { fn cv_VectorOfVectorOfRange_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfVectorOfRange_set(self.as_raw_mut_VectorOfVectorOfRange(), index, val.as_raw_mut_VectorOfRange())
		}
	}
...
mod dnn_types {
	...
	vector_extern! { core::Ptr::<crate::dnn::BackendNode>, *const c_void, *mut c_void,
		...
		cv_VectorOfPtrOfBackendNode_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { core::Ptr::<crate::dnn::BackendNode>::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { core::Ptr::<crate::dnn::BackendNode> }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Ptr::<crate::dnn::BackendNode>> {
		type Arg = core::Ptr::<crate::dnn::BackendNode>;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: core::Ptr::<crate::dnn::BackendNode>) {
			extern "C" { fn cv_VectorOfPtrOfBackendNode_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfPtrOfBackendNode_push(self.as_raw_mut_VectorOfPtrOfBackendNode(), val.as_raw_mut_PtrOfBackendNode()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: core::Ptr::<crate::dnn::BackendNode>) -> Result<()> {
			extern "C" { fn cv_VectorOfPtrOfBackendNode_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfPtrOfBackendNode_insert(self.as_raw_mut_VectorOfPtrOfBackendNode(), index, val.as_raw_mut_PtrOfBackendNode()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: core::Ptr::<crate::dnn::BackendNode>) -> Result<()> {
			extern "C" { fn cv_VectorOfPtrOfBackendNode_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfPtrOfBackendNode_set(self.as_raw_mut_VectorOfPtrOfBackendNode(), index, val.as_raw_mut_PtrOfBackendNode()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: core::Ptr::<crate::dnn::BackendNode>) {
			extern "C" { fn cv_VectorOfPtrOfBackendNode_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfPtrOfBackendNode_set(self.as_raw_mut_VectorOfPtrOfBackendNode(), index, val.as_raw_mut_PtrOfBackendNode())
		}
	}
	...
	vector_extern! { core::Ptr::<dyn crate::dnn::BackendWrapper>, *const c_void, *mut c_void,
		...
		cv_VectorOfPtrOfBackendWrapper_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { core::Ptr::<dyn crate::dnn::BackendWrapper>::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { core::Ptr::<dyn crate::dnn::BackendWrapper> }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Ptr::<dyn crate::dnn::BackendWrapper>> {
		type Arg = core::Ptr::<dyn crate::dnn::BackendWrapper>;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: core::Ptr::<dyn crate::dnn::BackendWrapper>) {
			extern "C" { fn cv_VectorOfPtrOfBackendWrapper_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfPtrOfBackendWrapper_push(self.as_raw_mut_VectorOfPtrOfBackendWrapper(), val.as_raw_mut_PtrOfBackendWrapper()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: core::Ptr::<dyn crate::dnn::BackendWrapper>) -> Result<()> {
			extern "C" { fn cv_VectorOfPtrOfBackendWrapper_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfPtrOfBackendWrapper_insert(self.as_raw_mut_VectorOfPtrOfBackendWrapper(), index, val.as_raw_mut_PtrOfBackendWrapper()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: core::Ptr::<dyn crate::dnn::BackendWrapper>) -> Result<()> {
			extern "C" { fn cv_VectorOfPtrOfBackendWrapper_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfPtrOfBackendWrapper_set(self.as_raw_mut_VectorOfPtrOfBackendWrapper(), index, val.as_raw_mut_PtrOfBackendWrapper()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: core::Ptr::<dyn crate::dnn::BackendWrapper>) {
			extern "C" { fn cv_VectorOfPtrOfBackendWrapper_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfPtrOfBackendWrapper_set(self.as_raw_mut_VectorOfPtrOfBackendWrapper(), index, val.as_raw_mut_PtrOfBackendWrapper())
		}
	}
	...
	vector_extern! { core::Ptr::<crate::dnn::Layer>, *const c_void, *mut c_void,
		...
		cv_VectorOfPtrOfLayer_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { core::Ptr::<crate::dnn::Layer>::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { core::Ptr::<crate::dnn::Layer> }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Ptr::<crate::dnn::Layer>> {
		type Arg = core::Ptr::<crate::dnn::Layer>;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: core::Ptr::<crate::dnn::Layer>) {
			extern "C" { fn cv_VectorOfPtrOfLayer_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfPtrOfLayer_push(self.as_raw_mut_VectorOfPtrOfLayer(), val.as_raw_mut_PtrOfLayer()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: core::Ptr::<crate::dnn::Layer>) -> Result<()> {
			extern "C" { fn cv_VectorOfPtrOfLayer_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfPtrOfLayer_insert(self.as_raw_mut_VectorOfPtrOfLayer(), index, val.as_raw_mut_PtrOfLayer()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: core::Ptr::<crate::dnn::Layer>) -> Result<()> {
			extern "C" { fn cv_VectorOfPtrOfLayer_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfPtrOfLayer_set(self.as_raw_mut_VectorOfPtrOfLayer(), index, val.as_raw_mut_PtrOfLayer()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: core::Ptr::<crate::dnn::Layer>) {
			extern "C" { fn cv_VectorOfPtrOfLayer_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfPtrOfLayer_set(self.as_raw_mut_VectorOfPtrOfLayer(), index, val.as_raw_mut_PtrOfLayer())
		}
	}
	...
	vector_extern! { crate::dnn::Target, *const c_void, *mut c_void,
		...
		cv_VectorOfTarget_get -> sys::Result<crate::dnn::Target>,
		ret_map: 
	}
	...
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::dnn::Target> {
		type Arg = crate::dnn::Target;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, val: crate::dnn::Target) {
			extern "C" { fn cv_VectorOfTarget_push(instance: *mut c_void, val: crate::dnn::Target); }
			unsafe { cv_VectorOfTarget_push(self.as_raw_mut_VectorOfTarget(), val) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, val: crate::dnn::Target) -> Result<()> {
			extern "C" { fn cv_VectorOfTarget_insert(instance: *mut c_void, index: size_t, val: crate::dnn::Target); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfTarget_insert(self.as_raw_mut_VectorOfTarget(), index, val) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, val: crate::dnn::Target) -> Result<()> {
			extern "C" { fn cv_VectorOfTarget_set(instance: *mut c_void, index: size_t, val: crate::dnn::Target); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfTarget_set(self.as_raw_mut_VectorOfTarget(), index, val) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, val: crate::dnn::Target) {
			extern "C" { fn cv_VectorOfTarget_set(instance: *mut c_void, index: size_t, val: crate::dnn::Target); }
			cv_VectorOfTarget_set(self.as_raw_mut_VectorOfTarget(), index, val)
		}
	}
	...
	vector_extern! { core::Vector::<crate::dnn::MatShape>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfMatShape_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { core::Vector::<crate::dnn::MatShape>::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { core::Vector::<crate::dnn::MatShape> }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<core::Vector::<crate::dnn::MatShape>> {
		type Arg = core::Vector::<crate::dnn::MatShape>;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: core::Vector::<crate::dnn::MatShape>) {
			extern "C" { fn cv_VectorOfVectorOfMatShape_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfVectorOfMatShape_push(self.as_raw_mut_VectorOfVectorOfMatShape(), val.as_raw_mut_VectorOfMatShape()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: core::Vector::<crate::dnn::MatShape>) -> Result<()> {
			extern "C" { fn cv_VectorOfVectorOfMatShape_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfVectorOfMatShape_insert(self.as_raw_mut_VectorOfVectorOfMatShape(), index, val.as_raw_mut_VectorOfMatShape()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: core::Vector::<crate::dnn::MatShape>) -> Result<()> {
			extern "C" { fn cv_VectorOfVectorOfMatShape_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfVectorOfMatShape_set(self.as_raw_mut_VectorOfVectorOfMatShape(), index, val.as_raw_mut_VectorOfMatShape()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: core::Vector::<crate::dnn::MatShape>) {
			extern "C" { fn cv_VectorOfVectorOfMatShape_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfVectorOfMatShape_set(self.as_raw_mut_VectorOfVectorOfMatShape(), index, val.as_raw_mut_VectorOfMatShape())
		}
	}
...
mod dnn_superres_types {
	...
	impl PtrOfDnnSuperResImpl {
		pub fn as_raw_PtrOfDnnSuperResImpl(&self) -> *const c_void { self.as_raw() }
		pub fn as_raw_mut_PtrOfDnnSuperResImpl(&mut self) -> *mut c_void { self.as_raw_mut() }
	}
	
	impl crate::dnn_superres::DnnSuperResImplTrait for PtrOfDnnSuperResImpl {
		fn as_raw_DnnSuperResImpl(&self) -> *const c_void { self.inner_as_raw() }
		fn as_raw_mut_DnnSuperResImpl(&mut self) -> *mut c_void { self.inner_as_raw_mut() }
	}
...
mod face_types {
	...
	vector_extern! { crate::face::FacemarkAAM_Config, *const c_void, *mut c_void,
		...
		cv_VectorOfFacemarkAAM_Config_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { crate::face::FacemarkAAM_Config::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { crate::face::FacemarkAAM_Config }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::face::FacemarkAAM_Config> {
		type Arg = crate::face::FacemarkAAM_Config;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: crate::face::FacemarkAAM_Config) {
			extern "C" { fn cv_VectorOfFacemarkAAM_Config_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfFacemarkAAM_Config_push(self.as_raw_mut_VectorOfFacemarkAAM_Config(), val.as_raw_mut_FacemarkAAM_Config()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: crate::face::FacemarkAAM_Config) -> Result<()> {
			extern "C" { fn cv_VectorOfFacemarkAAM_Config_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfFacemarkAAM_Config_insert(self.as_raw_mut_VectorOfFacemarkAAM_Config(), index, val.as_raw_mut_FacemarkAAM_Config()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: crate::face::FacemarkAAM_Config) -> Result<()> {
			extern "C" { fn cv_VectorOfFacemarkAAM_Config_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfFacemarkAAM_Config_set(self.as_raw_mut_VectorOfFacemarkAAM_Config(), index, val.as_raw_mut_FacemarkAAM_Config()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: crate::face::FacemarkAAM_Config) {
			extern "C" { fn cv_VectorOfFacemarkAAM_Config_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfFacemarkAAM_Config_set(self.as_raw_mut_VectorOfFacemarkAAM_Config(), index, val.as_raw_mut_FacemarkAAM_Config())
		}
	}
	...
	vector_extern! { crate::face::FacemarkAAM_Model_Texture, *const c_void, *mut c_void,
		...
		cv_VectorOfFacemarkAAM_Model_Texture_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { crate::face::FacemarkAAM_Model_Texture::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { crate::face::FacemarkAAM_Model_Texture }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::face::FacemarkAAM_Model_Texture> {
		type Arg = crate::face::FacemarkAAM_Model_Texture;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: crate::face::FacemarkAAM_Model_Texture) {
			extern "C" { fn cv_VectorOfFacemarkAAM_Model_Texture_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfFacemarkAAM_Model_Texture_push(self.as_raw_mut_VectorOfFacemarkAAM_Model_Texture(), val.as_raw_mut_FacemarkAAM_Model_Texture()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: crate::face::FacemarkAAM_Model_Texture) -> Result<()> {
			extern "C" { fn cv_VectorOfFacemarkAAM_Model_Texture_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfFacemarkAAM_Model_Texture_insert(self.as_raw_mut_VectorOfFacemarkAAM_Model_Texture(), index, val.as_raw_mut_FacemarkAAM_Model_Texture()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: crate::face::FacemarkAAM_Model_Texture) -> Result<()> {
			extern "C" { fn cv_VectorOfFacemarkAAM_Model_Texture_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfFacemarkAAM_Model_Texture_set(self.as_raw_mut_VectorOfFacemarkAAM_Model_Texture(), index, val.as_raw_mut_FacemarkAAM_Model_Texture()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: crate::face::FacemarkAAM_Model_Texture) {
			extern "C" { fn cv_VectorOfFacemarkAAM_Model_Texture_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfFacemarkAAM_Model_Texture_set(self.as_raw_mut_VectorOfFacemarkAAM_Model_Texture(), index, val.as_raw_mut_FacemarkAAM_Model_Texture())
		}
	}
...
mod flann_types {
	...
	vector_extern! { crate::flann::FlannIndexType, *const c_void, *mut c_void,
		...
		cv_VectorOfFlannIndexType_get -> sys::Result<crate::flann::FlannIndexType>,
		ret_map: 
	}
	vector_copy_non_bool! { crate::flann::FlannIndexType, *const c_void,
		cv_VectorOfFlannIndexType_data
	}
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::flann::FlannIndexType> {
		type Arg = crate::flann::FlannIndexType;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, val: crate::flann::FlannIndexType) {
			extern "C" { fn cv_VectorOfFlannIndexType_push(instance: *mut c_void, val: crate::flann::FlannIndexType); }
			unsafe { cv_VectorOfFlannIndexType_push(self.as_raw_mut_VectorOfFlannIndexType(), val) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, val: crate::flann::FlannIndexType) -> Result<()> {
			extern "C" { fn cv_VectorOfFlannIndexType_insert(instance: *mut c_void, index: size_t, val: crate::flann::FlannIndexType); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfFlannIndexType_insert(self.as_raw_mut_VectorOfFlannIndexType(), index, val) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, val: crate::flann::FlannIndexType) -> Result<()> {
			extern "C" { fn cv_VectorOfFlannIndexType_set(instance: *mut c_void, index: size_t, val: crate::flann::FlannIndexType); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfFlannIndexType_set(self.as_raw_mut_VectorOfFlannIndexType(), index, val) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, val: crate::flann::FlannIndexType) {
			extern "C" { fn cv_VectorOfFlannIndexType_set(instance: *mut c_void, index: size_t, val: crate::flann::FlannIndexType); }
			cv_VectorOfFlannIndexType_set(self.as_raw_mut_VectorOfFlannIndexType(), index, val)
		}
	}
...
mod line_descriptor_types {
	...
	vector_extern! { crate::line_descriptor::KeyLine, *const c_void, *mut c_void,
		...
		cv_VectorOfKeyLine_get -> sys::Result<crate::line_descriptor::KeyLine>,
		ret_map: 
	}
	...
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::line_descriptor::KeyLine> {
		...
		#[inline]
		fn push(&mut self, val: crate::line_descriptor::KeyLine) {
			extern "C" { fn cv_VectorOfKeyLine_push(instance: *mut c_void, val: *const crate::line_descriptor::KeyLine); }
			unsafe { cv_VectorOfKeyLine_push(self.as_raw_mut_VectorOfKeyLine(), &val) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, val: crate::line_descriptor::KeyLine) -> Result<()> {
			extern "C" { fn cv_VectorOfKeyLine_insert(instance: *mut c_void, index: size_t, val: *const crate::line_descriptor::KeyLine); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfKeyLine_insert(self.as_raw_mut_VectorOfKeyLine(), index, &val) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, val: crate::line_descriptor::KeyLine) -> Result<()> {
			extern "C" { fn cv_VectorOfKeyLine_set(instance: *mut c_void, index: size_t, val: *const crate::line_descriptor::KeyLine); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfKeyLine_set(self.as_raw_mut_VectorOfKeyLine(), index, &val) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, val: crate::line_descriptor::KeyLine) {
			extern "C" { fn cv_VectorOfKeyLine_set(instance: *mut c_void, index: size_t, val: *const crate::line_descriptor::KeyLine); }
			cv_VectorOfKeyLine_set(self.as_raw_mut_VectorOfKeyLine(), index, &val)
		}
	}
...
mod stitching_types {
	...
	impl PtrOfDetail_BestOf2NearestMatcher {
		pub fn as_raw_PtrOfDetail_BestOf2NearestMatcher(&self) -> *const c_void { self.as_raw() }
		pub fn as_raw_mut_PtrOfDetail_BestOf2NearestMatcher(&mut self) -> *mut c_void { self.as_raw_mut() }
	}
	
	impl crate::stitching::Detail_BestOf2NearestMatcherTrait for PtrOfDetail_BestOf2NearestMatcher {
		fn as_raw_Detail_BestOf2NearestMatcher(&self) -> *const c_void { self.inner_as_raw() }
		fn as_raw_mut_Detail_BestOf2NearestMatcher(&mut self) -> *mut c_void { self.inner_as_raw_mut() }
	}
	...
	ptr_extern! { dyn crate::stitching::Detail_Estimator,
		cv_PtrOfDetail_Estimator_delete, cv_PtrOfDetail_Estimator_get_inner_ptr
	}
	
	impl PtrOfDetail_Estimator {
		pub fn as_raw_PtrOfDetail_Estimator(&self) -> *const c_void { self.as_raw() }
		pub fn as_raw_mut_PtrOfDetail_Estimator(&mut self) -> *mut c_void { self.as_raw_mut() }
	}
...
mod videoio_types {
	...
	vector_extern! { crate::videoio::VideoCapture, *const c_void, *mut c_void,
		...
		cv_VectorOfVideoCapture_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { crate::videoio::VideoCapture::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { crate::videoio::VideoCapture }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::videoio::VideoCapture> {
		type Arg = crate::videoio::VideoCapture;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: crate::videoio::VideoCapture) {
			extern "C" { fn cv_VectorOfVideoCapture_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfVideoCapture_push(self.as_raw_mut_VectorOfVideoCapture(), val.as_raw_mut_VideoCapture()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: crate::videoio::VideoCapture) -> Result<()> {
			extern "C" { fn cv_VectorOfVideoCapture_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfVideoCapture_insert(self.as_raw_mut_VectorOfVideoCapture(), index, val.as_raw_mut_VideoCapture()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: crate::videoio::VideoCapture) -> Result<()> {
			extern "C" { fn cv_VectorOfVideoCapture_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfVideoCapture_set(self.as_raw_mut_VectorOfVideoCapture(), index, val.as_raw_mut_VideoCapture()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: crate::videoio::VideoCapture) {
			extern "C" { fn cv_VectorOfVideoCapture_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfVideoCapture_set(self.as_raw_mut_VectorOfVideoCapture(), index, val.as_raw_mut_VideoCapture())
		}
	}
	...
	vector_extern! { crate::videoio::VideoCaptureAPIs, *const c_void, *mut c_void,
		...
		cv_VectorOfVideoCaptureAPIs_get -> sys::Result<crate::videoio::VideoCaptureAPIs>,
		ret_map: 
	}
	...
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::videoio::VideoCaptureAPIs> {
		type Arg = crate::videoio::VideoCaptureAPIs;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, val: crate::videoio::VideoCaptureAPIs) {
			extern "C" { fn cv_VectorOfVideoCaptureAPIs_push(instance: *mut c_void, val: crate::videoio::VideoCaptureAPIs); }
			unsafe { cv_VectorOfVideoCaptureAPIs_push(self.as_raw_mut_VectorOfVideoCaptureAPIs(), val) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, val: crate::videoio::VideoCaptureAPIs) -> Result<()> {
			extern "C" { fn cv_VectorOfVideoCaptureAPIs_insert(instance: *mut c_void, index: size_t, val: crate::videoio::VideoCaptureAPIs); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfVideoCaptureAPIs_insert(self.as_raw_mut_VectorOfVideoCaptureAPIs(), index, val) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, val: crate::videoio::VideoCaptureAPIs) -> Result<()> {
			extern "C" { fn cv_VectorOfVideoCaptureAPIs_set(instance: *mut c_void, index: size_t, val: crate::videoio::VideoCaptureAPIs); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfVideoCaptureAPIs_set(self.as_raw_mut_VectorOfVideoCaptureAPIs(), index, val) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, val: crate::videoio::VideoCaptureAPIs) {
			extern "C" { fn cv_VectorOfVideoCaptureAPIs_set(instance: *mut c_void, index: size_t, val: crate::videoio::VideoCaptureAPIs); }
			cv_VectorOfVideoCaptureAPIs_set(self.as_raw_mut_VectorOfVideoCaptureAPIs(), index, val)
		}
	}
...
mod xfeatures2d_types {
	...
	vector_extern! { crate::xfeatures2d::Elliptic_KeyPoint, *const c_void, *mut c_void,
		...
		cv_VectorOfElliptic_KeyPoint_get -> sys::Result<*mut c_void>,
		ret_map: .map(|ptr| { crate::xfeatures2d::Elliptic_KeyPoint::from_raw(ptr) })
	}
	vector_non_copy_or_bool! { crate::xfeatures2d::Elliptic_KeyPoint }
	
	impl<'i> core::VectorTrait<'i> for core::Vector::<crate::xfeatures2d::Elliptic_KeyPoint> {
		type Arg = crate::xfeatures2d::Elliptic_KeyPoint;
	
		fn with_capacity(capacity: size_t) -> Self { Self::with_capacity(capacity) }
	
		#[inline]
		fn push(&mut self, mut val: crate::xfeatures2d::Elliptic_KeyPoint) {
			extern "C" { fn cv_VectorOfElliptic_KeyPoint_push(instance: *mut c_void, val: *mut c_void); }
			unsafe { cv_VectorOfElliptic_KeyPoint_push(self.as_raw_mut_VectorOfElliptic_KeyPoint(), val.as_raw_mut_Elliptic_KeyPoint()) }
		}
	
		#[inline]
		fn insert(&mut self, index: size_t, mut val: crate::xfeatures2d::Elliptic_KeyPoint) -> Result<()> {
			extern "C" { fn cv_VectorOfElliptic_KeyPoint_insert(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len() + 1)?;
			unsafe { cv_VectorOfElliptic_KeyPoint_insert(self.as_raw_mut_VectorOfElliptic_KeyPoint(), index, val.as_raw_mut_Elliptic_KeyPoint()) }
			Ok(())
		}
	
		#[inline]
		fn set(&mut self, index: size_t, mut val: crate::xfeatures2d::Elliptic_KeyPoint) -> Result<()> {
			extern "C" { fn cv_VectorOfElliptic_KeyPoint_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			core::vector_index_check(index, self.len())?;
			unsafe { cv_VectorOfElliptic_KeyPoint_set(self.as_raw_mut_VectorOfElliptic_KeyPoint(), index, val.as_raw_mut_Elliptic_KeyPoint()) }
			Ok(())
		}
	
		#[inline]
		unsafe fn set_unchecked(&mut self, index: size_t, mut val: crate::xfeatures2d::Elliptic_KeyPoint) {
			extern "C" { fn cv_VectorOfElliptic_KeyPoint_set(instance: *mut c_void, index: size_t, val: *mut c_void); }
			cv_VectorOfElliptic_KeyPoint_set(self.as_raw_mut_VectorOfElliptic_KeyPoint(), index, val.as_raw_mut_Elliptic_KeyPoint())
		}
	}
