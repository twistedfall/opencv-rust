...
//! 
//! The implemented stitching pipeline is very similar to the one proposed in [BL07](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BL07) .
//! 
//! ![stitching pipeline](https://docs.opencv.org/3.4.10/StitchingPipeline.jpg)
//! 
//! Camera models
//! -------------
//! 
...
pub trait StitcherTrait {
	...
	fn features_finder(&mut self) -> Result<core::Ptr::<dyn crate::stitching::Detail_FeaturesFinder>> {
		unsafe { sys::cv_Stitcher_featuresFinder(self.as_raw_mut_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_FeaturesFinder>::from_raw(ptr) })
	}
	
	fn features_finder_1(&self) -> Result<core::Ptr::<dyn crate::stitching::Detail_FeaturesFinder>> {
		unsafe { sys::cv_Stitcher_featuresFinder_const(self.as_raw_Stitcher()) }.into_result().map(|ptr| unsafe { core::Ptr::<dyn crate::stitching::Detail_FeaturesFinder>::from_raw(ptr) })
	}
	...
	fn estimate_transform(&mut self, images: &dyn core::ToInputArray) -> Result<crate::stitching::Stitcher_Status> {
		...
		unsafe { sys::cv_Stitcher_estimateTransform_const__InputArrayX(self.as_raw_mut_Stitcher(), images.as_raw__InputArray()) }.into_result()
	}
	...
	fn estimate_transform_1(&mut self, images: &dyn core::ToInputArray, rois: &core::Vector::<core::Vector::<core::Rect>>) -> Result<crate::stitching::Stitcher_Status> {
		input_array_arg!(images);
		unsafe { sys::cv_Stitcher_estimateTransform_const__InputArrayX_const_vector_vector_Rect__X(self.as_raw_mut_Stitcher(), images.as_raw__InputArray(), rois.as_raw_VectorOfVectorOfRect()) }.into_result()
	}
	...
	fn stitch_rois(&mut self, images: &dyn core::ToInputArray, rois: &core::Vector::<core::Vector::<core::Rect>>, pano: &mut dyn core::ToOutputArray) -> Result<crate::stitching::Stitcher_Status> {
		input_array_arg!(images);
		output_array_arg!(pano);
		unsafe { sys::cv_Stitcher_stitch_const__InputArrayX_const_vector_vector_Rect__X_const__OutputArrayX(self.as_raw_mut_Stitcher(), images.as_raw__InputArray(), rois.as_raw_VectorOfVectorOfRect(), pano.as_raw__OutputArray()) }.into_result()
	}
...
impl Stitcher {
	...
	pub fn create_default(try_use_gpu: bool) -> Result<crate::stitching::Stitcher> {
		unsafe { sys::cv_Stitcher_createDefault_bool(try_use_gpu) }.into_result().map(|ptr| unsafe { crate::stitching::Stitcher::from_raw(ptr) })
	}
	...
	pub fn create(mode: crate::stitching::Stitcher_Mode, try_use_gpu: bool) -> Result<core::Ptr::<crate::stitching::Stitcher>> {
		unsafe { sys::cv_Stitcher_create_Mode_bool(mode, try_use_gpu) }.into_result().map(|ptr| unsafe { core::Ptr::<crate::stitching::Stitcher>::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_AKAZEFeaturesFinder }
...
impl Detail_AKAZEFeaturesFinder {
	pub fn as_raw_Detail_AKAZEFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_AKAZEFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_AKAZEFeaturesFinderTrait for Detail_AKAZEFeaturesFinder {
	fn as_raw_Detail_AKAZEFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_AKAZEFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl crate::stitching::Detail_FeaturesFinder for Detail_AKAZEFeaturesFinder {
	fn as_raw_Detail_FeaturesFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_FeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_AKAZEFeaturesFinder {
	...
	pub fn new(descriptor_type: i32, descriptor_size: i32, descriptor_channels: i32, threshold: f32, n_octaves: i32, n_octave_layers: i32, diffusivity: i32) -> Result<crate::stitching::Detail_AKAZEFeaturesFinder> {
		unsafe { sys::cv_detail_AKAZEFeaturesFinder_AKAZEFeaturesFinder_int_int_int_float_int_int_int(descriptor_type, descriptor_size, descriptor_channels, threshold, n_octaves, n_octave_layers, diffusivity) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_AKAZEFeaturesFinder::from_raw(ptr) })
	}
...
/// intensities, see [UES01](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_UES01) for details.
...
/// intensities, see [BL07](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BL07) and [WJ10](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_WJ10) for details.
...
/// Minimum graph cut-based seam estimator. See details in [V03](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_V03) .
...
/// Blender which uses multi-band blending algorithm (see [BA83](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BA83)).
...
boxed_ptr! { Detail_OrbFeaturesFinder }
...
impl Detail_OrbFeaturesFinder {
	pub fn as_raw_Detail_OrbFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_OrbFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_OrbFeaturesFinderTrait for Detail_OrbFeaturesFinder {
	fn as_raw_Detail_OrbFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_OrbFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_OrbFeaturesFinder {
	...
	pub fn new(_grid_size: core::Size, nfeatures: i32, scale_factor: f32, nlevels: i32) -> Result<crate::stitching::Detail_OrbFeaturesFinder> {
		unsafe { sys::cv_detail_OrbFeaturesFinder_OrbFeaturesFinder_Size_int_float_int(&_grid_size, nfeatures, scale_factor, nlevels) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_OrbFeaturesFinder::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_SiftFeaturesFinder }

impl Drop for Detail_SiftFeaturesFinder {
	fn drop(&mut self) {
		extern "C" { fn cv_Detail_SiftFeaturesFinder_delete(instance: *mut c_void); }
		unsafe { cv_Detail_SiftFeaturesFinder_delete(self.as_raw_mut_Detail_SiftFeaturesFinder()) };
	}
}

impl Detail_SiftFeaturesFinder {
	pub fn as_raw_Detail_SiftFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SiftFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SiftFeaturesFinderTrait for Detail_SiftFeaturesFinder {
	fn as_raw_Detail_SiftFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SiftFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}

impl Detail_SiftFeaturesFinder {
	pub fn default() -> Result<crate::stitching::Detail_SiftFeaturesFinder> {
		unsafe { sys::cv_detail_SiftFeaturesFinder_SiftFeaturesFinder() }.into_result().map(|ptr| unsafe { crate::stitching::Detail_SiftFeaturesFinder::from_raw(ptr) })
	}
...
pub trait Detail_SphericalProjectorTrait: crate::stitching::Detail_ProjectorBaseTrait {
	...
	fn map_forward(&mut self, x: f32, y: f32, u: &mut f32, v: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_SphericalProjector_mapForward_float_float_floatX_floatX(self.as_raw_mut_Detail_SphericalProjector(), x, y, u, v) }.into_result()
	}
	
	fn map_backward(&mut self, u: f32, v: f32, x: &mut f32, y: &mut f32) -> Result<()> {
		unsafe { sys::cv_detail_SphericalProjector_mapBackward_float_float_floatX_floatX(self.as_raw_mut_Detail_SphericalProjector(), u, v, x, y) }.into_result()
	}
...
boxed_ptr! { Detail_SphericalProjector }
...
impl Detail_SphericalProjector {
	pub fn as_raw_Detail_SphericalProjector(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SphericalProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SphericalProjectorTrait for Detail_SphericalProjector {
	fn as_raw_Detail_SphericalProjector(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SphericalProjector(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
boxed_ptr! { Detail_SurfFeaturesFinder }
...
impl Detail_SurfFeaturesFinder {
	pub fn as_raw_Detail_SurfFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SurfFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SurfFeaturesFinderTrait for Detail_SurfFeaturesFinder {
	fn as_raw_Detail_SurfFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SurfFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_SurfFeaturesFinder {
	...
	pub fn new(hess_thresh: f64, num_octaves: i32, num_layers: i32, num_octaves_descr: i32, num_layers_descr: i32) -> Result<crate::stitching::Detail_SurfFeaturesFinder> {
		unsafe { sys::cv_detail_SurfFeaturesFinder_SurfFeaturesFinder_double_int_int_int_int(hess_thresh, num_octaves, num_layers, num_octaves_descr, num_layers_descr) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_SurfFeaturesFinder::from_raw(ptr) })
	}
...
boxed_ptr! { Detail_SurfFeaturesFinderGpu }
...
impl Detail_SurfFeaturesFinderGpu {
	pub fn as_raw_Detail_SurfFeaturesFinderGpu(&self) -> *const c_void { self.as_raw() }
	pub fn as_raw_mut_Detail_SurfFeaturesFinderGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl crate::stitching::Detail_SurfFeaturesFinderGpuTrait for Detail_SurfFeaturesFinderGpu {
	fn as_raw_Detail_SurfFeaturesFinderGpu(&self) -> *const c_void { self.as_raw() }
	fn as_raw_mut_Detail_SurfFeaturesFinderGpu(&mut self) -> *mut c_void { self.as_raw_mut() }
}
...
impl Detail_SurfFeaturesFinderGpu {
	...
	pub fn new(hess_thresh: f64, num_octaves: i32, num_layers: i32, num_octaves_descr: i32, num_layers_descr: i32) -> Result<crate::stitching::Detail_SurfFeaturesFinderGpu> {
		unsafe { sys::cv_detail_SurfFeaturesFinderGpu_SurfFeaturesFinderGpu_double_int_int_int_int(hess_thresh, num_octaves, num_layers, num_octaves_descr, num_layers_descr) }.into_result().map(|ptr| unsafe { crate::stitching::Detail_SurfFeaturesFinderGpu::from_raw(ptr) })
	}
