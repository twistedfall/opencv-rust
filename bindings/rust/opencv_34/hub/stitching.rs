...
impl Detail_SiftFeaturesFinder {
	#[inline] pub fn as_raw_Detail_SiftFeaturesFinder(&self) -> *const c_void { self.as_raw() }
	#[inline] pub fn as_raw_mut_Detail_SiftFeaturesFinder(&mut self) -> *mut c_void { self.as_raw_mut() }
}
