...
/// 
/// 
/// ![Visualization of 10x10 CV_64FC2 (Hilbert matrix) using HDFView tool](https://docs.opencv.org/3.4.10/hdfview_demo.gif)
/// 
...
pub fn open(hdf5_filename: &str) -> Result<core::Ptr::<dyn crate::hdf::HDF5>> {
	...
	unsafe { sys::cv_hdf_open_const_StringX(hdf5_filename.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::hdf::HDF5>::opencv_from_extern(r) } )
}
...
pub trait HDF5 {
	...
	/// 
	///  [create_group](https://github.com/opencv/opencv_contrib/blob/3.4.10/modules/hdf/samples/create_groups.cpp#L1)
	/// 
	///  The corresponding result visualized using the HDFView tool is
	/// 
	///  ![Visualization of groups using the HDFView tool](https://docs.opencv.org/3.4.10/create_groups.png)
	/// 
	/// 
	...
	fn grcreate(&mut self, grlabel: &str) -> Result<()> {
		...
		unsafe { sys::cv_hdf_HDF5_grcreate_const_StringX(self.as_raw_mut_HDF5(), grlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn hlexists(&self, label: &str) -> Result<bool> {
		...
		unsafe { sys::cv_hdf_HDF5_hlexists_const_const_StringX(self.as_raw_HDF5(), label.opencv_to_extern()) }.into_result()
	}
	...
	fn atexists(&self, atlabel: &str) -> Result<bool> {
		...
		unsafe { sys::cv_hdf_HDF5_atexists_const_const_StringX(self.as_raw_HDF5(), atlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn atdelete(&mut self, atlabel: &str) -> Result<()> {
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atdelete_const_StringX(self.as_raw_mut_HDF5(), atlabel.opencv_to_extern()) }.into_result()
	}
	...
	/// 
	///  [snippets_write_str](https://github.com/opencv/opencv_contrib/blob/3.4.10/modules/hdf/samples/read_write_attributes.cpp#L1)
	/// 
	/// 
	...
	fn atwrite(&mut self, value: i32, atlabel: &str) -> Result<()> {
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atwrite_int_const_StringX(self.as_raw_mut_HDF5(), value, atlabel.opencv_to_extern()) }.into_result()
	}
	...
	/// 
	///  [snippets_read_str](https://github.com/opencv/opencv_contrib/blob/3.4.10/modules/hdf/samples/read_write_attributes.cpp#L1)
	/// 
	/// 
	...
	fn atread(&mut self, value: &mut i32, atlabel: &str) -> Result<()> {
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atread_intX_const_StringX(self.as_raw_mut_HDF5(), value, atlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn atwrite_1(&mut self, value: f64, atlabel: &str) -> Result<()> {
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atwrite_double_const_StringX(self.as_raw_mut_HDF5(), value, atlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn atread_1(&mut self, value: &mut f64, atlabel: &str) -> Result<()> {
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atread_doubleX_const_StringX(self.as_raw_mut_HDF5(), value, atlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn atwrite_2(&mut self, value: &str, atlabel: &str) -> Result<()> {
		...
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atwrite_const_StringX_const_StringX(self.as_raw_mut_HDF5(), value.opencv_to_extern(), atlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn atread_2(&mut self, value: &mut String, atlabel: &str) -> Result<()> {
		...
		extern_container_arg!(atlabel);
		let out = unsafe { sys::cv_hdf_HDF5_atread_StringX_const_StringX(self.as_raw_mut_HDF5(), &mut value_via, atlabel.opencv_to_extern()) }.into_result();
	...
	fn atwrite_3(&mut self, value: &dyn core::ToInputArray, atlabel: &str) -> Result<()> {
		...
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atwrite_const__InputArrayX_const_StringX(self.as_raw_mut_HDF5(), value.as_raw__InputArray(), atlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn atread_3(&mut self, value: &mut dyn core::ToOutputArray, atlabel: &str) -> Result<()> {
		...
		extern_container_arg!(atlabel);
		unsafe { sys::cv_hdf_HDF5_atread_const__OutputArrayX_const_StringX(self.as_raw_mut_HDF5(), value.as_raw__OutputArray(), atlabel.opencv_to_extern()) }.into_result()
	}
	...
	fn dscreate(&self, rows: i32, cols: i32, typ: i32, dslabel: &str) -> Result<()> {
		...
		unsafe { sys::cv_hdf_HDF5_dscreate_const_int_int_int_const_StringX(self.as_raw_HDF5(), rows, cols, typ, dslabel.opencv_to_extern()) }.into_result()
	}
	...
	fn dscreate_1(&self, rows: i32, cols: i32, typ: i32, dslabel: &str, compresslevel: i32) -> Result<()> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dscreate_const_int_int_int_const_StringX_int(self.as_raw_HDF5(), rows, cols, typ, dslabel.opencv_to_extern(), compresslevel) }.into_result()
	}
	...
	fn dscreate_2(&self, rows: i32, cols: i32, typ: i32, dslabel: &str, compresslevel: i32, dims_chunks: &core::Vector::<i32>) -> Result<()> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dscreate_const_int_int_int_const_StringX_int_const_vector_int_X(self.as_raw_HDF5(), rows, cols, typ, dslabel.opencv_to_extern(), compresslevel, dims_chunks.as_raw_VectorOfi32()) }.into_result()
	}
	...
	fn dscreate_3(&self, rows: i32, cols: i32, typ: i32, dslabel: &str, compresslevel: i32, dims_chunks: &i32) -> Result<()> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dscreate_const_int_int_int_const_StringX_int_const_intX(self.as_raw_HDF5(), rows, cols, typ, dslabel.opencv_to_extern(), compresslevel, dims_chunks) }.into_result()
	}
	
	fn dscreate_4(&self, n_dims: i32, sizes: &i32, typ: i32, dslabel: &str) -> Result<()> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dscreate_const_int_const_intX_int_const_StringX(self.as_raw_HDF5(), n_dims, sizes, typ, dslabel.opencv_to_extern()) }.into_result()
	}
	
	fn dscreate_5(&self, n_dims: i32, sizes: &i32, typ: i32, dslabel: &str, compresslevel: i32) -> Result<()> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dscreate_const_int_const_intX_int_const_StringX_int(self.as_raw_HDF5(), n_dims, sizes, typ, dslabel.opencv_to_extern(), compresslevel) }.into_result()
	}
	...
	fn dscreate_6(&self, sizes: &core::Vector::<i32>, typ: i32, dslabel: &str, compresslevel: i32, dims_chunks: &core::Vector::<i32>) -> Result<()> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dscreate_const_const_vector_int_X_int_const_StringX_int_const_vector_int_X(self.as_raw_HDF5(), sizes.as_raw_VectorOfi32(), typ, dslabel.opencv_to_extern(), compresslevel, dims_chunks.as_raw_VectorOfi32()) }.into_result()
	}
	...
	fn dscreate_7(&self, n_dims: i32, sizes: &i32, typ: i32, dslabel: &str, compresslevel: i32, dims_chunks: &i32) -> Result<()> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dscreate_const_int_const_intX_int_const_StringX_int_const_intX(self.as_raw_HDF5(), n_dims, sizes, typ, dslabel.opencv_to_extern(), compresslevel, dims_chunks) }.into_result()
	}
	...
	fn dsgetsize(&self, dslabel: &str, dims_flag: i32) -> Result<core::Vector::<i32>> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsgetsize_const_const_StringX_int(self.as_raw_HDF5(), dslabel.opencv_to_extern(), dims_flag) }.into_result().map(|r| unsafe { core::Vector::<i32>::opencv_from_extern(r) } )
	}
	...
	fn dsgettype(&self, dslabel: &str) -> Result<i32> {
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsgettype_const_const_StringX(self.as_raw_HDF5(), dslabel.opencv_to_extern()) }.into_result()
	}
	
	fn dswrite(&self, array: &dyn core::ToInputArray, dslabel: &str) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dswrite_const_const__InputArrayX_const_StringX(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern()) }.into_result()
	}
	
	fn dswrite_1(&self, array: &dyn core::ToInputArray, dslabel: &str, dims_offset: &i32) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dswrite_const_const__InputArrayX_const_StringX_const_intX(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern(), dims_offset) }.into_result()
	}
	...
	fn dswrite_2(&self, array: &dyn core::ToInputArray, dslabel: &str, dims_offset: &core::Vector::<i32>, dims_counts: &core::Vector::<i32>) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dswrite_const_const__InputArrayX_const_StringX_const_vector_int_X_const_vector_int_X(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern(), dims_offset.as_raw_VectorOfi32(), dims_counts.as_raw_VectorOfi32()) }.into_result()
	}
	...
	fn dswrite_3(&self, array: &dyn core::ToInputArray, dslabel: &str, dims_offset: &i32, dims_counts: &i32) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dswrite_const_const__InputArrayX_const_StringX_const_intX_const_intX(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern(), dims_offset, dims_counts) }.into_result()
	}
	
	fn dsinsert(&self, array: &dyn core::ToInputArray, dslabel: &str) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsinsert_const_const__InputArrayX_const_StringX(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern()) }.into_result()
	}
	
	fn dsinsert_1(&self, array: &dyn core::ToInputArray, dslabel: &str, dims_offset: &i32) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsinsert_const_const__InputArrayX_const_StringX_const_intX(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern(), dims_offset) }.into_result()
	}
	...
	fn dsinsert_2(&self, array: &dyn core::ToInputArray, dslabel: &str, dims_offset: &core::Vector::<i32>, dims_counts: &core::Vector::<i32>) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsinsert_const_const__InputArrayX_const_StringX_const_vector_int_X_const_vector_int_X(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern(), dims_offset.as_raw_VectorOfi32(), dims_counts.as_raw_VectorOfi32()) }.into_result()
	}
	...
	fn dsinsert_3(&self, array: &dyn core::ToInputArray, dslabel: &str, dims_offset: &i32, dims_counts: &i32) -> Result<()> {
		input_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsinsert_const_const__InputArrayX_const_StringX_const_intX_const_intX(self.as_raw_HDF5(), array.as_raw__InputArray(), dslabel.opencv_to_extern(), dims_offset, dims_counts) }.into_result()
	}
	
	fn dsread(&self, array: &mut dyn core::ToOutputArray, dslabel: &str) -> Result<()> {
		output_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsread_const_const__OutputArrayX_const_StringX(self.as_raw_HDF5(), array.as_raw__OutputArray(), dslabel.opencv_to_extern()) }.into_result()
	}
	
	fn dsread_1(&self, array: &mut dyn core::ToOutputArray, dslabel: &str, dims_offset: &i32) -> Result<()> {
		output_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsread_const_const__OutputArrayX_const_StringX_const_intX(self.as_raw_HDF5(), array.as_raw__OutputArray(), dslabel.opencv_to_extern(), dims_offset) }.into_result()
	}
	...
	fn dsread_2(&self, array: &mut dyn core::ToOutputArray, dslabel: &str, dims_offset: &core::Vector::<i32>, dims_counts: &core::Vector::<i32>) -> Result<()> {
		output_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsread_const_const__OutputArrayX_const_StringX_const_vector_int_X_const_vector_int_X(self.as_raw_HDF5(), array.as_raw__OutputArray(), dslabel.opencv_to_extern(), dims_offset.as_raw_VectorOfi32(), dims_counts.as_raw_VectorOfi32()) }.into_result()
	}
	...
	fn dsread_3(&self, array: &mut dyn core::ToOutputArray, dslabel: &str, dims_offset: &i32, dims_counts: &i32) -> Result<()> {
		output_array_arg!(array);
		extern_container_arg!(dslabel);
		unsafe { sys::cv_hdf_HDF5_dsread_const_const__OutputArrayX_const_StringX_const_intX_const_intX(self.as_raw_HDF5(), array.as_raw__OutputArray(), dslabel.opencv_to_extern(), dims_offset, dims_counts) }.into_result()
	}
	...
	fn kpgetsize(&self, kplabel: &str, dims_flag: i32) -> Result<i32> {
		...
		unsafe { sys::cv_hdf_HDF5_kpgetsize_const_const_StringX_int(self.as_raw_HDF5(), kplabel.opencv_to_extern(), dims_flag) }.into_result()
	}
	...
	fn kpcreate(&self, size: i32, kplabel: &str, compresslevel: i32, chunks: i32) -> Result<()> {
		extern_container_arg!(kplabel);
		unsafe { sys::cv_hdf_HDF5_kpcreate_const_int_const_StringX_int_int(self.as_raw_HDF5(), size, kplabel.opencv_to_extern(), compresslevel, chunks) }.into_result()
	}
	...
	fn kpwrite(&self, keypoints: core::Vector::<core::KeyPoint>, kplabel: &str, offset: i32, counts: i32) -> Result<()> {
		extern_container_arg!(kplabel);
		unsafe { sys::cv_hdf_HDF5_kpwrite_const_vector_KeyPoint__const_StringX_int_int(self.as_raw_HDF5(), keypoints.as_raw_VectorOfKeyPoint(), kplabel.opencv_to_extern(), offset, counts) }.into_result()
	}
	...
	fn kpinsert(&self, keypoints: core::Vector::<core::KeyPoint>, kplabel: &str, offset: i32, counts: i32) -> Result<()> {
		extern_container_arg!(kplabel);
		unsafe { sys::cv_hdf_HDF5_kpinsert_const_vector_KeyPoint__const_StringX_int_int(self.as_raw_HDF5(), keypoints.as_raw_VectorOfKeyPoint(), kplabel.opencv_to_extern(), offset, counts) }.into_result()
	}
	...
	fn kpread(&self, keypoints: &mut core::Vector::<core::KeyPoint>, kplabel: &str, offset: i32, counts: i32) -> Result<()> {
		extern_container_arg!(kplabel);
		unsafe { sys::cv_hdf_HDF5_kpread_const_vector_KeyPoint_X_const_StringX_int_int(self.as_raw_HDF5(), keypoints.as_raw_mut_VectorOfKeyPoint(), kplabel.opencv_to_extern(), offset, counts) }.into_result()
	}
