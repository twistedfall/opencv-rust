...
pub const MATERIAL_TEXTURE: i32 = 4;
pub const MATERIAL_TEXTURE0: i32 = 4;
pub const MATERIAL_TEXTURE1: i32 = 5;
pub const MATERIAL_TEXTURE2: i32 = 6;
pub const MATERIAL_TEXTURE3: i32 = 7;
...
pub enum MaterialProperty {
	...
	MATERIAL_EMISSIVE = 3,
	MATERIAL_TEXTURE0 = 4,
	// MATERIAL_TEXTURE = 4 as isize, // duplicate discriminant
	MATERIAL_TEXTURE1 = 5,
	MATERIAL_TEXTURE2 = 6,
	MATERIAL_TEXTURE3 = 7,
}
...
pub trait WindowScene {
	...
	/// 
	/// ## Overloaded parameters
	fn set_entity_property_1(&mut self, name: &str, prop: i32, value: &str) -> Result<()> {
		extern_container_arg!(name);
		extern_container_arg!(value);
		unsafe { sys::cv_ovis_WindowScene_setEntityProperty_const_StringR_int_const_StringR(self.as_raw_mut_WindowScene(), name.opencv_as_extern(), prop, value.opencv_as_extern()) }.into_result()
	}
