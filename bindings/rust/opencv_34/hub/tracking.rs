...
//! [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) and [AMVOT](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AMVOT) .
//! 
...
//! 
//! A recent benchmark between these algorithms can be found in [OOT](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_OOT)
//! 
...
//! estimates the most likely target location, see [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) table I (ME) for further information. Fill
//! "modelUpdateImpl" in order to update the model, see [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) table I (MU). In this class you can use
...
/// errors and updates it to avoid these errors in the future. The implementation is based on [TLD](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_TLD) .
/// 
...
/// drifting problem. The implementation is based on [OLB](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_OLB) .
...
/// the CSRT tracker
/// 
/// The implementation is based on [Lukezic_IJCV2018](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Lukezic_IJCV2018) Discriminative Correlation Filter with Channel and Spatial Reliability
pub trait TrackerCSRT: crate::tracking::Tracker {
	...
	fn set_initial_mask(&mut self, mask: core::Mat) -> Result<()> {
		unsafe { sys::cv_TrackerCSRT_setInitialMask_Mat(self.as_raw_mut_TrackerCSRT(), mask.as_raw_Mat()) }.into_result()
	}
...
pub trait TrackerCSRT_ParamsTrait {
	...
	fn set_window_function(&mut self, val: &str) -> () {
		...
		unsafe { sys::cv_TrackerCSRT_Params_setPropWindow_function_string(self.as_raw_mut_TrackerCSRT_Params(), val.opencv_to_extern_mut()) }.into_result().expect("Infallible function failed: set_window_function")
	}
...
/// 
/// [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) Feature Extraction and Feature Set Refinement (Feature Processing and Feature Selection).
/// See table I and section III C [AMVOT](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AMVOT) Appearance modelling -\> Visual representation (Table II,
/// section 3.1 - 3.2)
/// 
...
/// 
/// *  GOTURN ([GOTURN](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_GOTURN)) is kind of trackers based on Convolutional Neural Networks (CNN). While taking all advantages of CNN trackers,
...
/// * This tracking method is an implementation of [KCF_ECCV](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_KCF_ECCV) which is extended to KCF with color-names features ([KCF_CN](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_KCF_CN)).
...
/// based on [MIL](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_MIL) .
/// 
...
/// 
/// The implementation is based on [MOSSE](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_MOSSE) Visual Object Tracking using Adaptive Correlation Filters
/// 
...
/// 
/// Implementation of a paper [MedianFlow](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_MedianFlow) .
/// 
...
pub trait TrackerMedianFlow_ParamsTrait {
	...
	fn set_win_size(&mut self, val: core::Size) -> () {
		unsafe { sys::cv_TrackerMedianFlow_Params_setPropWinSize_Size(self.as_raw_mut_TrackerMedianFlow_Params(), val.opencv_to_extern()) }.into_result().expect("Infallible function failed: set_win_size")
	}
	...
	fn set_term_criteria(&mut self, val: core::TermCriteria) -> () {
		unsafe { sys::cv_TrackerMedianFlow_Params_setPropTermCriteria_TermCriteria(self.as_raw_mut_TrackerMedianFlow_Params(), val.opencv_to_extern()) }.into_result().expect("Infallible function failed: set_term_criteria")
	}
	...
	fn set_win_size_ncc(&mut self, val: core::Size) -> () {
		unsafe { sys::cv_TrackerMedianFlow_Params_setPropWinSizeNCC_Size(self.as_raw_mut_TrackerMedianFlow_Params(), val.opencv_to_extern()) }.into_result().expect("Infallible function failed: set_win_size_ncc")
	}
...
/// tracker
/// 
/// See [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) Ak
/// 
...
pub trait TrackerModel {
	...
	/// 
	/// [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) ME, Model Estimation table I
	/// ## Parameters
	...
	/// Update the model
	/// 
	/// [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) MU, Model Update table I
...
/// 
/// [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) Sampling e Labeling. See table I and section III B
/// 
...
pub trait TrackerSamplerTrait {
	...
	/// Return the samples from all TrackerSamplerAlgorithm, [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) Fig. 1 variable Sk
...
pub trait TrackerSamplerAlgorithm {
	...
	/// * boundingBox: The bounding box from which regions can be calculated
	/// 
	/// * sample: The computed samples [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) Fig. 1 variable Sk
...
/// 
/// See [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) State estimator
/// 
/// See [AMVOT](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AMVOT) Statistical modeling (Fig. 3), Table III (generative) - IV (discriminative) - V (hybrid)
...
impl dyn TrackerStateEstimator + '_ {
	...
	/// The modes available now:
	/// 
	/// *   "BOOSTING" -- Boosting-based discriminative appearance models. See [AMVOT](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AMVOT) section 4.4
	/// 
	/// The modes available soon:
	/// 
	/// *   "SVM" -- SVM-based discriminative appearance models. See [AMVOT](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AMVOT) section 4.5
...
/// 
/// See [AAM](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_AAM) ![inline formula](https://latex.codecogs.com/png.latex?%5Chat%7Bx%7D%5E%7Bi%7D%5F%7Bk%7D) all the states candidates.
/// 
