...
pub const HOG_DESCR_FORMAT_COL_BY_COL: i32 = 1;
pub const HOG_DESCR_FORMAT_ROW_BY_ROW: i32 = 0;
...
/// The class implements Histogram of Oriented Gradients ([Dalal2005](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Dalal2005)) object detector.
/// 
/// 
/// Note:
...
pub trait HOG: core::AlgorithmTrait {
	...
	fn set_descriptor_format(&mut self, descr_format: i32) -> Result<()> {
		unsafe { sys::cv_cuda_HOG_setDescriptorFormat_int(self.as_raw_mut_HOG(), descr_format) }.into_result()
	}
	
	fn get_descriptor_format(&self) -> Result<i32> {
