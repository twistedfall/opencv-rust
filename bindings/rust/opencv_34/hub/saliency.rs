...
//! 
//! ![Saliency diagram](https://docs.opencv.org/3.4.10/saliency.png)
//! 
...
///  *
/// 
/// the Fast Self-tuning Background Subtraction Algorithm from [BinWangApr2014](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BinWangApr2014)
...
/// the Binarized normed gradients algorithm from [BING](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BING)
...
/// the Fine Grained Saliency approach from [FGS](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_FGS)
/// 
...
/// the Spectral Residual approach from  [SR](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_SR)
/// 
