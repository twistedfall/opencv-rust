...
/// The perl script and examples of tree generation are placed in features2d/doc folder.
/// Detects corners using the AGAST algorithm by [mair2010_agast](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_mair2010_agast) .
pub fn AGAST_with_type(image: &dyn core::ToInputArray, keypoints: &mut types::VectorOfKeyPoint, threshold: i32, nonmax_suppression: bool, typ: i32) -> Result<()> {
	input_array_arg!(image);
	unsafe { sys::cv_AGAST_const__InputArrayX_vector_KeyPoint_X_int_bool_int(image.as_raw__InputArray(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression, typ) }.into_result()
}
...
/// cv2.FAST_FEATURE_DETECTOR_TYPE_7_12 and cv2.FAST_FEATURE_DETECTOR_TYPE_9_16. For corner
/// detection, use cv2.FAST.detect() method.
pub fn FAST_with_type(image: &dyn core::ToInputArray, keypoints: &mut types::VectorOfKeyPoint, threshold: i32, nonmax_suppression: bool, typ: i32) -> Result<()> {
	input_array_arg!(image);
	unsafe { sys::cv_FAST_const__InputArrayX_vector_KeyPoint_X_int_bool_int(image.as_raw__InputArray(), keypoints.as_raw_VectorOfKeyPoint(), threshold, nonmax_suppression, typ) }.into_result()
}
...
/// * flags: DrawMatchesFlags::DEFAULT
pub fn draw_matches(img1: &dyn core::ToInputArray, keypoints1: &types::VectorOfKeyPoint, img2: &dyn core::ToInputArray, keypoints2: &types::VectorOfKeyPoint, matches1to2: &types::VectorOfDMatch, out_img: &mut dyn core::ToInputOutputArray, match_color: core::Scalar, single_point_color: core::Scalar, matches_mask: &types::VectorOfi8, flags: i32) -> Result<()> {
...
/// * flags: DrawMatchesFlags::DEFAULT
pub fn draw_matches_knn(img1: &dyn core::ToInputArray, keypoints1: &types::VectorOfKeyPoint, img2: &dyn core::ToInputArray, keypoints2: &types::VectorOfKeyPoint, matches1to2: &types::VectorOfVectorOfDMatch, out_img: &mut dyn core::ToInputOutputArray, match_color: core::Scalar, single_point_color: core::Scalar, matches_mask: &types::VectorOfVectorOfi8, flags: i32) -> Result<()> {
	input_array_arg!(img1);
	input_array_arg!(img2);
	input_output_array_arg!(out_img);
...
pub trait AgastFeatureDetector: crate::features2d::Feature2DTrait {
	...
	fn set_type(&mut self, typ: i32) -> Result<()> {
		unsafe { sys::cv_AgastFeatureDetector_setType_int(self.as_raw_AgastFeatureDetector(), typ) }.into_result()
	}
...
impl dyn AgastFeatureDetector + '_ {
	...
	pub fn create(threshold: i32, nonmax_suppression: bool, typ: i32) -> Result<types::PtrOfAgastFeatureDetector> {
		unsafe { sys::cv_AgastFeatureDetector_create_int_bool_int(threshold, nonmax_suppression, typ) }.into_result().map(|ptr| types::PtrOfAgastFeatureDetector { ptr })
	}
...
impl Drop for DrawMatchesFlags {
	fn drop(&mut self) {
		...
		unsafe { cv_DrawMatchesFlags_delete(self.as_raw_DrawMatchesFlags()) };
	}
}
...
impl crate::features2d::DrawMatchesFlagsTrait for DrawMatchesFlags {
	fn as_raw_DrawMatchesFlags(&self) -> *mut c_void { self.ptr }
}
...
pub trait FastFeatureDetector: crate::features2d::Feature2DTrait {
	...
	fn set_type(&mut self, typ: i32) -> Result<()> {
		unsafe { sys::cv_FastFeatureDetector_setType_int(self.as_raw_FastFeatureDetector(), typ) }.into_result()
	}
...
impl dyn FastFeatureDetector + '_ {
	...
	pub fn create(threshold: i32, nonmax_suppression: bool, typ: i32) -> Result<types::PtrOfFastFeatureDetector> {
		unsafe { sys::cv_FastFeatureDetector_create_int_bool_int(threshold, nonmax_suppression, typ) }.into_result().map(|ptr| types::PtrOfFastFeatureDetector { ptr })
	}
