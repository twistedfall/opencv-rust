...
impl _InputArray {
	...
	pub fn new_1(unnamed: &core::Vector::<core::Vector::<bool>>) -> Result<core::_InputArray> {
		unsafe { sys::cv__InputArray__InputArray_const_vector_vector_bool__R(unnamed.as_raw_VectorOfVectorOfbool()) }.into_result().map(|r| unsafe { core::_InputArray::opencv_from_extern(r) } )
	}
	...
	pub fn new_2(buf: &core::Buffer) -> Result<core::_InputArray> {
...
impl _OutputArray {
	...
	pub fn new_3(unnamed: &mut core::Vector::<core::Vector::<bool>>) -> Result<core::_OutputArray> {
		unsafe { sys::cv__OutputArray__OutputArray_vector_vector_bool__R(unnamed.as_raw_mut_VectorOfVectorOfbool()) }.into_result().map(|r| unsafe { core::_OutputArray::opencv_from_extern(r) } )
	}
	...
	pub fn new_4(buf: &core::Buffer) -> Result<core::_OutputArray> {
