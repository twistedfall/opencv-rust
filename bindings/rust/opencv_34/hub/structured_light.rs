...
//! of the codewords are multiplexed in time [pattern](https://docs.opencv.org/3.4.9/d0/de3/citelist.html#CITEREF_pattern) .
//! 
...
pub const FTP: i32 = 0;
pub const PSP: i32 = 1;
/// Class implementing the Gray-code pattern, based on [UNDERWORLD](https://docs.opencv.org/3.4.9/d0/de3/citelist.html#CITEREF_UNDERWORLD).
/// 
