...
//! 
//! ![Performance chart](https://docs.opencv.org/3.4.9/attack_performance.JPG)
//! 
//! ### Speed comparison with PHash library (100 images from ukbench)
//! 
//! ![Hash Computation chart](https://docs.opencv.org/3.4.9/hash_computation_chart.JPG)
//! ![Hash comparison chart](https://docs.opencv.org/3.4.9/hash_comparison_chart.JPG)
//! 
