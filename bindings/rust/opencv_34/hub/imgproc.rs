...
/// ![threshold types](https://docs.opencv.org/3.4.10/threshold.png)
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
/// two weighted point configurations. One of the applications described in [RubnerSept98](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_RubnerSept98),
/// [Rubner2000](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Rubner2000) is multi-dimensional histogram comparison for image retrieval. EMD is a transportation
...
/// in [Matas00](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Matas00)
/// 
/// See the line detection example below:
/// @include snippets/imgproc_HoughLinesP.cpp
/// This is a sample picture the function parameters have been tuned for:
/// 
/// ![image](https://docs.opencv.org/3.4.10/building.jpg)
/// 
/// And this is the output of the above program in case of the probabilistic Hough transform:
/// 
/// ![image](https://docs.opencv.org/3.4.10/houghp.png)
/// 
/// ## Parameters
...
/// 
/// The function calculates seven Hu invariants (introduced in [Hu62](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Hu62); see also
...
/// 
/// The function cv::convexHull finds the convex hull of a 2D point set using the Sklansky's algorithm [Sklansky82](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Sklansky82)
...
/// 
/// ![image](https://docs.opencv.org/3.4.10/defects.png)
/// 
/// ## Parameters
...
/// algorithm described in [Felzenszwalb04](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Felzenszwalb04) . This algorithm is parallelized with the TBB library.
/// 
/// In other cases, the algorithm [Borgefors86](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Borgefors86) is used. This means that for a pixel the function
...
/// 
/// ![Parameters of Elliptic Arc](https://docs.opencv.org/3.4.10/ellipse.svg)
/// 
/// ## Parameters
/// * img: Image.
...
/// 
/// The function retrieves contours from the binary image using the algorithm [Suzuki85](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Suzuki85) . The contours
...
/// The Approximate Mean Square (AMS) proposed by [Taubin1991](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Taubin1991) is used.
/// 
...
pub fn fit_ellipse_ams(points: &dyn core::ToInputArray) -> Result<core::RotatedRect> {
	input_array_arg!(points);
	unsafe { sys::cv_fitEllipseAMS_const__InputArrayX(points.as_raw__InputArray()) }.into_result().map(|ptr| core::RotatedRect { ptr })
}
...
/// The function calculates the ellipse that fits a set of 2D points.
/// It returns the rotated rectangle in which the ellipse is inscribed.
/// The Direct least square (Direct) method by [Fitzgibbon1999](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Fitzgibbon1999) is used.
/// 
/// For an ellipse, this basis set is ![inline formula](https://latex.codecogs.com/png.latex?%20%5Cchi%3D%20%5Cleft%28x%5E2%2C%20x%20y%2C%20y%5E2%2C%20x%2C%20y%2C%201%5Cright%29%20),
/// which is a set of six free coefficients ![inline formula](https://latex.codecogs.com/png.latex?%20A%5ET%3D%5Cleft%5C%7BA%5F%7B%5Ctext%7Bxx%7D%7D%2CA%5F%7B%5Ctext%7Bxy%7D%7D%2CA%5F%7B%5Ctext%7Byy%7D%7D%2CA%5Fx%2CA%5Fy%2CA%5F0%5Cright%5C%7D%20).
/// However, to specify an ellipse, all that is needed is five numbers; the major and minor axes lengths ![inline formula](https://latex.codecogs.com/png.latex?%20%28a%2Cb%29%20),
...
pub fn fit_ellipse_direct(points: &dyn core::ToInputArray) -> Result<core::RotatedRect> {
	input_array_arg!(points);
	unsafe { sys::cv_fitEllipseDirect_const__InputArrayX(points.as_raw__InputArray()) }.into_result().map(|ptr| core::RotatedRect { ptr })
}

/// Fits an ellipse around a set of 2D points.
/// 
/// The function calculates the ellipse that fits (in a least-squares sense) a set of 2D points best of
/// all. It returns the rotated rectangle in which the ellipse is inscribed. The first algorithm described by [Fitzgibbon95](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Fitzgibbon95)
...
/// described in [Shi94](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Shi94)
/// 
...
/// 
/// ![integral calculation example](https://docs.opencv.org/3.4.10/integral.png)
/// 
/// ## Parameters
...
/// 
/// ![Sample output of the minimum enclosing triangle function](https://docs.opencv.org/3.4.10/minenclosingtriangle.png)
/// 
/// The implementation of the algorithm is based on O'Rourke's [ORourke86](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_ORourke86) and Klee and Laskowski's
/// [KleeLaskowski85](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_KleeLaskowski85) papers. O'Rourke provides a ![inline formula](https://latex.codecogs.com/png.latex?%5Ctheta%28n%29) algorithm for finding the minimal
...
/// 
/// ![sample output](https://docs.opencv.org/3.4.10/pointpolygon.png)
/// 
/// ## Parameters
/// * contour: Input contour.
...
/// 
/// ![intersection examples](https://docs.opencv.org/3.4.10/intersection.png)
/// 
/// ## Parameters
...
pub fn sqr_box_filter(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, ddepth: i32, ksize: core::Size, anchor: core::Point, normalize: bool, border_type: i32) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_sqrBoxFilter_const__InputArrayX_const__OutputArrayX_int_Size_Point_bool_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), ddepth, &ksize, &anchor, normalize, border_type) }.into_result()
}
...
/// ![Polar remaps reference](https://docs.opencv.org/3.4.10/polar_remap_doc.png)
/// 
...
pub fn warp_polar(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, dsize: core::Size, center: core::Point2f, max_radius: f64, flags: i32) -> Result<()> {
	input_array_arg!(src);
	output_array_arg!(dst);
	unsafe { sys::cv_warpPolar_const__InputArrayX_const__OutputArrayX_Size_Point2f_double_int(src.as_raw__InputArray(), dst.as_raw__OutputArray(), &dsize, &center, max_radius, flags) }.into_result()
}

/// Performs a marker-based image segmentation using the watershed algorithm.
/// 
/// The function implements one of the variants of watershed, non-parametric marker-based segmentation
/// algorithm, described in [Meyer92](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Meyer92) .
/// 
...
/// * flow: noArray()
pub fn emd_1(signature1: &dyn core::ToInputArray, signature2: &dyn core::ToInputArray, dist_type: i32, cost: &dyn core::ToInputArray, lower_bound: types::PtrOff32, flow: &mut dyn core::ToOutputArray) -> Result<f32> {
	input_array_arg!(signature1);
	input_array_arg!(signature2);
	input_array_arg!(cost);
	output_array_arg!(flow);
	unsafe { sys::cv_wrapperEMD_const__InputArrayX_const__InputArrayX_int_const__InputArrayX_Ptr_float__const__OutputArrayX(signature1.as_raw__InputArray(), signature2.as_raw__InputArray(), dist_type, cost.as_raw__InputArray(), lower_bound.as_raw_PtrOff32(), flow.as_raw__OutputArray()) }.into_result()
}
...
/// finds arbitrary template in the grayscale image using Generalized Hough Transform
/// 
/// Detects position only without translation and rotation [Ballard1981](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Ballard1981) .
...
/// finds arbitrary template in the grayscale image using Generalized Hough Transform
/// 
/// Detects position, translation and rotation [Guil1999](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Guil1999) .
...
/// 
/// following the algorithm described at [Rafael12](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Rafael12) .
/// 
/// 
/// Note: Implementation has been removed due original code license conflict
pub trait LineSegmentDetector: core::AlgorithmTrait {
	...
	/// 
	/// ![image](https://docs.opencv.org/3.4.10/building_lsd.png)
	/// 
	/// ## Parameters
...
pub trait Subdiv2DTrait {
	...
	/// 
	/// ![sample output](https://docs.opencv.org/3.4.10/quadedge.png)
	/// 
	/// ## Returns
