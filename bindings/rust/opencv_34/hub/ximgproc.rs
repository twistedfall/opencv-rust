...
/// Classic Niblack binarization. See [Niblack1985](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Niblack1985) .
pub const BINARIZATION_NIBLACK: i32 = 0;
/// NICK technique. See [Khurshid2009](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Khurshid2009) .
pub const BINARIZATION_NICK: i32 = 3;
/// Sauvola's technique. See [Sauvola1997](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Sauvola1997) .
pub const BINARIZATION_SAUVOLA: i32 = 1;
/// Wolf's technique. See [Wolf2004](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Wolf2004) .
...
pub type slic_type = crate::ximgproc::SLIC;
...
/// 
/// For more details about this implementation, please see [paillou1997detecting](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_paillou1997detecting)
/// 
/// ## Parameters
...
/// For more details about this filter see [Cho2014](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Cho2014).
/// 
/// ## Parameters
...
/// original paper.
/// 
/// For more details about Adaptive Manifold Filter parameters, see the original article [Gastal12](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Gastal12) .
/// 
/// 
/// Note: Joint images with CV_8U and CV_16U depth converted to images with CV_32F depth and [0; 1]
/// color range before processing. Hence color space sigma sigma_r must be in [0; 1] range, unlike same
...
/// 
/// For more details about Domain Transform filter parameters, see the original article [Gastal11](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Gastal11) and
...
/// 
/// For more details about the Fast Bilateral Solver parameters, see the original paper [BarronPoole2016](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BarronPoole2016).
/// 
/// ## C++ default parameters
/// * lambda: 128.0
/// * num_iter: 25
...
/// 
/// For more details about Fast Global Smoother parameters, see the original paper [Min2014](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Min2014). However, please note that
...
/// 
/// For more details about Guided Filter parameters, see the original article [Kaiming10](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Kaiming10) .
...
/// 
/// ![image](https://docs.opencv.org/3.4.10/superpixels_lsc.png)
/// 
/// ## C++ default parameters
/// * region_size: 10
/// * ratio: 0.075f
...
/// 
/// ![image](https://docs.opencv.org/3.4.10/superpixels_blocks.png)
/// 
/// ## C++ default parameters
/// * prior: 2
/// * histogram_bins: 5
...
/// 
/// ![image](https://docs.opencv.org/3.4.10/superpixels_slic.png)
/// 
/// ## C++ default parameters
/// * algorithm: SLICO
/// * region_size: 10
...
/// 
/// For more details about this implementation, please see [PersoonFu1977](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_PersoonFu1977)
/// 
/// ## Parameters
/// * src: contour type vector<Point> , vector<Point2f>  or vector<Point2d>
...
/// 
/// For more details about L0 Smoother, see the original paper [xu2011image](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_xu2011image).
/// 
/// ## C++ default parameters
/// * lambda: 0.02
/// * kappa: 2.0
...
/// 
/// For more details, please see [zhang2014rolling](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_zhang2014rolling)
/// 
/// ## Parameters
...
/// 
/// For more details about this implementation, please see [zhang2014100](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_zhang2014100)+
/// 
/// ## Parameters
...
/// 
/// For more details about this filter see [Gastal12](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Gastal12) and References_.
/// 
...
pub trait ContourFittingTrait: core::AlgorithmTrait {
	...
	/// Fit two closed curves using fourier descriptors. More details in [PersoonFu1977](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_PersoonFu1977) and [BergerRaghunathan1998](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BergerRaghunathan1998)
	/// 
	/// ## Parameters
...
/// 
/// For more details about this filter see [Gastal11](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Gastal11) .
...
/// estimator from [Revaud2015](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Revaud2015) and Fast Global Smoother as post-processing filter.
...
/// Class implementing EdgeBoxes algorithm from [ZitnickECCV14edgeBoxes](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_ZitnickECCV14edgeBoxes) :
...
/// 
/// For more details about this solver see [BarronPoole2016](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_BarronPoole2016) .
...
/// 
/// For more details about this filter see [Min2014](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Min2014) and [Farbman2008](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Farbman2008) .
...
pub trait FastLineDetector: core::AlgorithmTrait {
	...
	///       shown image.
	/// 
	///       ![image](https://docs.opencv.org/3.4.10/corridor_fld.jpg)
	/// 
	/// ## Parameters
...
/// 
/// For more details about this filter see [Kaiming10](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Kaiming10) .
...
/// Additional refinement can be done using Skeletonization and Binarization. Adapted from [segleafvein](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_segleafvein) and [M_RF](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_M_RF)
...
/// Class implementing edge detection algorithm from [Dollar2013](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Dollar2013) :
...
/// Class implementing the LSC (Linear Spectral Clustering) superpixels
/// algorithm described in [LiCVPR2015LSC](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_LiCVPR2015LSC).
/// 
...
/// algorithm described in [VBRV14](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_VBRV14) .
/// 
...
pub trait SuperpixelSEEDS: core::AlgorithmTrait {
	...
	/// can be seen below.
	/// 
	/// ![image](https://docs.opencv.org/3.4.10/superpixels_blocks2.png)
	/// 
	/// ## C++ default parameters
	/// * num_iterations: 4
	...
	/// 
	/// ![image](https://docs.opencv.org/3.4.10/superpixels_demo.png)
	/// 
	/// ## C++ default parameters
	/// * thick_line: false
...
/// algorithm described in [Achanta2012](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Achanta2012).
/// 
...
/// SLICO stands for "Zero parameter SLIC" and it is an optimization of baseline SLIC described in [Achanta2012](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Achanta2012).
/// MSLIC stands for "Manifold SLIC" and it is an optimization of baseline SLIC described in [Liu_2017_IEEE](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_Liu_2017_IEEE).
...
/// The class implements the algorithm described in [PFF2004](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_PFF2004) .
...
/// The class implements the algorithm described in [uijlings2013selective](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_uijlings2013selective).
pub trait SelectiveSearchSegmentation: core::AlgorithmTrait {
	...
	/// Initialize the class with the 'Single stragegy' parameters describled in [uijlings2013selective](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_uijlings2013selective).
	/// ## Parameters
	...
	/// Initialize the class with the 'Selective search fast' parameters describled in [uijlings2013selective](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_uijlings2013selective).
	/// ## Parameters
...
/// The class implements a generic stragery for the algorithm described in [uijlings2013selective](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_uijlings2013selective).
...
/// The class is implemented from the algorithm described in [uijlings2013selective](https://docs.opencv.org/3.4.10/d0/de3/citelist.html#CITEREF_uijlings2013selective).
