...
mod calib3d_sys {
	...
	extern "C" {
		...
		pub fn cv_findCirclesGrid2_const__InputArrayX_Size_const__OutputArrayX_int_const_Ptr_FeatureDetector_X_CirclesGridFinderParameters2(image: *mut c_void, pattern_size: *const core::Size, centers: *mut c_void, flags: i32, blob_detector: *mut c_void, parameters: *const crate::calib3d::CirclesGridFinderParameters2) -> Result<bool>;
		...
		pub fn cv_findCirclesGrid_const__InputArrayX_Size_const__OutputArrayX_int_const_Ptr_FeatureDetector_X_CirclesGridFinderParameters(image: *mut c_void, pattern_size: *const core::Size, centers: *mut c_void, flags: i32, blob_detector: *mut c_void, parameters: *const crate::calib3d::CirclesGridFinderParameters) -> Result<bool>;
		...
		pub fn cv_findFundamentalMat_const__InputArrayX_const__InputArrayX_int_double_double_int_const__OutputArrayX(points1: *mut c_void, points2: *mut c_void, method: i32, ransac_reproj_threshold: f64, confidence: f64, max_iters: i32, mask: *mut c_void) -> Result<*mut c_void>;
...
mod ccalib_sys {
	...
	extern "C" {
		...
		pub fn cv_omnidir_initUndistortRectifyMap_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const_SizeX_int_const__OutputArrayX_const__OutputArrayX_int(k: *mut c_void, d: *mut c_void, xi: *mut c_void, r: *mut c_void, p: *mut c_void, size: *const core::Size, m1type: i32, map1: *mut c_void, map2: *mut c_void, flags: i32) -> Result_void;
		pub fn cv_omnidir_projectPoints_const__InputArrayX_const__OutputArrayX_const_Affine3dX_const__InputArrayX_double_const__InputArrayX_const__OutputArrayX(object_points: *mut c_void, image_points: *mut c_void, affine: *const core::Affine3d, k: *mut c_void, xi: f64, d: *mut c_void, jacobian: *mut c_void) -> Result_void;
...
mod core_sys {
	...
	extern "C" {
		...
		pub fn cv_detail_check_failed_auto_const_stringX_const_CheckContextX(v1: *const c_char, ctx: *mut c_void) -> Result_void;
		...
		pub fn cv__InputArray__InputArray_const_vector_vector_bool__X(unnamed: *mut c_void) -> Result<*mut c_void>;
...
mod dnn_sys {
	...
	extern "C" {
		...
		pub fn cv_dnn_Net_setInputShape_const_StringX_const_MatShapeX(instance: *mut c_void, input_name: *const c_char, shape: *mut c_void) -> Result_void;
...
mod ml_sys {
	...
	extern "C" {
		...
		pub fn cv_ml_ANN_MLP_ANNEAL_getAnnealInitialT_const(instance: *mut c_void) -> Result<f64>;
		pub fn cv_ml_ANN_MLP_ANNEAL_setAnnealInitialT_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_ml_ANN_MLP_ANNEAL_getAnnealFinalT_const(instance: *mut c_void) -> Result<f64>;
		pub fn cv_ml_ANN_MLP_ANNEAL_setAnnealFinalT_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_ml_ANN_MLP_ANNEAL_getAnnealCoolingRatio_const(instance: *mut c_void) -> Result<f64>;
		pub fn cv_ml_ANN_MLP_ANNEAL_setAnnealCoolingRatio_double(instance: *mut c_void, val: f64) -> Result_void;
		pub fn cv_ml_ANN_MLP_ANNEAL_getAnnealItePerStep_const(instance: *mut c_void) -> Result<i32>;
		pub fn cv_ml_ANN_MLP_ANNEAL_setAnnealItePerStep_int(instance: *mut c_void, val: i32) -> Result_void;
		pub fn cv_ml_ANN_MLP_ANNEAL_setAnnealEnergyRNG_const_RNGX(instance: *mut c_void, rng: *mut c_void) -> Result_void;
...
mod objdetect_sys {
	...
	extern "C" {
		...
		pub fn cv_decodeQRCode_const__InputArrayX_const__InputArrayX_stringX_const__OutputArrayX(in_: *mut c_void, points: *mut c_void, decoded_info: *mut *mut c_void, straight_qrcode: *mut c_void) -> Result<bool>;
		pub fn cv_detectQRCode_const__InputArrayX_vector_Point_X_double_double(in_: *mut c_void, points: *mut c_void, eps_x: f64, eps_y: f64) -> Result<bool>;
		...
		pub fn cv_QRCodeDetector_detectMulti_const_const__InputArrayX_const__OutputArrayX(instance: *mut c_void, img: *mut c_void, points: *mut c_void) -> Result<bool>;
		pub fn cv_QRCodeDetector_decodeMulti_const_const__InputArrayX_const__InputArrayX_vector_String_X_const__OutputArrayX(instance: *mut c_void, img: *mut c_void, points: *mut c_void, decoded_info: *mut c_void, straight_qrcode: *mut c_void) -> Result<bool>;
		pub fn cv_QRCodeDetector_detectAndDecodeMulti_const_const__InputArrayX_vector_String_X_const__OutputArrayX_const__OutputArrayX(instance: *mut c_void, img: *mut c_void, decoded_info: *mut c_void, points: *mut c_void, straight_qrcode: *mut c_void) -> Result<bool>;
		pub fn cv_QRCodeDetector_decodeMulti_const_const__InputArrayX_const__InputArrayX_vector_string_X_const__OutputArrayX(instance: *mut c_void, img: *mut c_void, points: *mut c_void, decoded_info: *mut c_void, straight_qrcode: *mut c_void) -> Result<bool>;
		pub fn cv_QRCodeDetector_detectAndDecodeMulti_const_const__InputArrayX_vector_string_X_const__OutputArrayX_const__OutputArrayX(instance: *mut c_void, img: *mut c_void, decoded_info: *mut c_void, points: *mut c_void, straight_qrcode: *mut c_void) -> Result<bool>;
...
mod video_sys {
	...
	extern "C" {
		...
		pub fn cv_estimateRigidTransform_const__InputArrayX_const__InputArrayX_bool_int_double_int(src: *mut c_void, dst: *mut c_void, full_affine: bool, ransac_max_iters: i32, ransac_good_ratio: f64, ransac_size0: i32) -> Result<*mut c_void>;
...
mod xfeatures2d_sys {
	...
	extern "C" {
		pub fn cv_xfeatures2d_FASTForPointSet_const__InputArrayX_vector_KeyPoint_X_int_bool_int(image: *mut c_void, keypoints: *mut c_void, threshold: i32, nonmax_suppression: bool, typ: i32) -> Result_void;
