...
impl dyn Boost + '_ {
	...
	pub fn load(filepath: &str, node_name: &str) -> Result<core::Ptr::<dyn crate::ml::Boost>> {
		...
		unsafe { sys::cv_ml_Boost_load_const_StringX_const_StringX(filepath.opencv_to_extern(), node_name.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::Boost>::opencv_from_extern(r) } )
	}
...
impl dyn DTrees + '_ {
	...
	pub fn load(filepath: &str, node_name: &str) -> Result<core::Ptr::<dyn crate::ml::DTrees>> {
		extern_container_arg!(filepath);
		extern_container_arg!(node_name);
		unsafe { sys::cv_ml_DTrees_load_const_StringX_const_StringX(filepath.opencv_to_extern(), node_name.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::DTrees>::opencv_from_extern(r) } )
	}
...
impl dyn EM + '_ {
	...
	pub fn load(filepath: &str, node_name: &str) -> Result<core::Ptr::<dyn crate::ml::EM>> {
		extern_container_arg!(filepath);
		extern_container_arg!(node_name);
		unsafe { sys::cv_ml_EM_load_const_StringX_const_StringX(filepath.opencv_to_extern(), node_name.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::EM>::opencv_from_extern(r) } )
	}
...
impl dyn KNearest + '_ {
	...
	pub fn load(filepath: &str) -> Result<core::Ptr::<dyn crate::ml::KNearest>> {
		extern_container_arg!(filepath);
		unsafe { sys::cv_ml_KNearest_load_const_StringX(filepath.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::KNearest>::opencv_from_extern(r) } )
	}
...
impl dyn LogisticRegression + '_ {
	...
	pub fn load(filepath: &str, node_name: &str) -> Result<core::Ptr::<dyn crate::ml::LogisticRegression>> {
		extern_container_arg!(filepath);
		extern_container_arg!(node_name);
		unsafe { sys::cv_ml_LogisticRegression_load_const_StringX_const_StringX(filepath.opencv_to_extern(), node_name.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::LogisticRegression>::opencv_from_extern(r) } )
	}
...
impl dyn NormalBayesClassifier + '_ {
	...
	pub fn load(filepath: &str, node_name: &str) -> Result<core::Ptr::<dyn crate::ml::NormalBayesClassifier>> {
		extern_container_arg!(filepath);
		extern_container_arg!(node_name);
		unsafe { sys::cv_ml_NormalBayesClassifier_load_const_StringX_const_StringX(filepath.opencv_to_extern(), node_name.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::NormalBayesClassifier>::opencv_from_extern(r) } )
	}
...
impl dyn RTrees + '_ {
	...
	pub fn load(filepath: &str, node_name: &str) -> Result<core::Ptr::<dyn crate::ml::RTrees>> {
		extern_container_arg!(filepath);
		extern_container_arg!(node_name);
		unsafe { sys::cv_ml_RTrees_load_const_StringX_const_StringX(filepath.opencv_to_extern(), node_name.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::RTrees>::opencv_from_extern(r) } )
	}
...
impl dyn SVMSGD + '_ {
	...
	pub fn load(filepath: &str, node_name: &str) -> Result<core::Ptr::<dyn crate::ml::SVMSGD>> {
		extern_container_arg!(filepath);
		extern_container_arg!(node_name);
		unsafe { sys::cv_ml_SVMSGD_load_const_StringX_const_StringX(filepath.opencv_to_extern(), node_name.opencv_to_extern()) }.into_result().map(|r| unsafe { core::Ptr::<dyn crate::ml::SVMSGD>::opencv_from_extern(r) } )
	}
...
impl dyn TrainData + '_ {
	...
	pub fn get_sub_matrix(matrix: &core::Mat, idx: &core::Mat, layout: i32) -> Result<core::Mat> {
		unsafe { sys::cv_ml_TrainData_getSubMatrix_const_MatX_const_MatX_int(matrix.as_raw_Mat(), idx.as_raw_Mat(), layout) }.into_result().map(|r| unsafe { core::Mat::opencv_from_extern(r) } )
	}
