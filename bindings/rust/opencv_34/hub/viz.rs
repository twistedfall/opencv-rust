...
impl WCameraPosition {
	...
	/// 
	/// ![Camera coordinate frame](https://docs.opencv.org/3.4.9/cpw1.png)
	/// 
	/// ## C++ default parameters
	/// * scale: 1.0
	...
	/// 
	/// ![Camera viewing frustum](https://docs.opencv.org/3.4.9/cpw2.png)
	/// 
	/// ## C++ default parameters
	/// * scale: 1.0
	/// * color: Color::white()
	...
	/// the far end plane.
	/// 
	/// ![Camera viewing frustum with image](https://docs.opencv.org/3.4.9/cpw3.png)
	/// 
	/// ## C++ default parameters
	/// * scale: 1.0
	/// * color: Color::white()
...
impl WCube {
	...
	/// 
	/// ![Cube Widget](https://docs.opencv.org/3.4.9/cube_widget.png)
	/// 
	/// ## C++ default parameters
