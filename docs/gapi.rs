pub mod gapi {
	...
	///
	/// [graph_def](https://github.com/opencv/opencv_contrib/blob/4.13.0/modules/hdf/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp#L1)
	///
	/// Full pipeline can be now captured with this object declaration:
	///
	/// [graph_cap_full](https://github.com/opencv/opencv_contrib/blob/4.13.0/modules/hdf/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp#L1)
	///
	...
	/// defined like this:
	///
	/// [graph_cap_sub](https://github.com/opencv/opencv_contrib/blob/4.13.0/modules/hdf/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp#L1)
	///
	...
	impl GScalar {
		...
		///
		/// [gscalar_implicit](https://github.com/opencv/opencv_contrib/blob/4.13.0/modules/hdf/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp#L1)
		///
