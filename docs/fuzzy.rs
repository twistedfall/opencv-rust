pub mod fuzzy {
	...
	///
	/// Note:
	///    F-transform technique of first degreee is described in paper [Vlas:FT](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_Vlas:FT).
	///
	/// ## Note
	...
	///
	/// Note:
	///    The algorithms are described in paper [Perf:rec](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_Perf:rec).
	#[inline]
