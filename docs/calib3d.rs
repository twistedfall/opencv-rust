pub mod calib3d {
	...
	//! 
	//! The camera intrinsic matrix ![inline formula](https://latex.codecogs.com/png.latex?A) (notation used as in [Zhang2000](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Zhang2000) and also generally notated
	...
	//! 
	//! ![Pinhole camera model](https://docs.opencv.org/4.10.0/pinhole_camera_model.png)
	//! 
	...
	//! 
	//! ![](https://docs.opencv.org/4.10.0/distortion_examples.png)
	//! ![](https://docs.opencv.org/4.10.0/distortion_examples2.png)
	//! 
	...
	//! ![inline formula](https://latex.codecogs.com/png.latex?y%27%27). This distortion can be modeled in the following way, see e.g. [Louhichi07](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Louhichi07).
	//! 
	...
	//! 
	//!    Summary:
	//!    Generic camera model [Kannala2006](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Kannala2006) with perspective projection and without distortion correction
	...
	/// On-line Hand-Eye Calibration [Andreff99](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Andreff99)
	pub const CALIB_HAND_EYE_ANDREFF: i32 = 3;
	/// Hand-Eye Calibration Using Dual Quaternions [Daniilidis98](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Daniilidis98)
	pub const CALIB_HAND_EYE_DANIILIDIS: i32 = 4;
	/// Hand-eye Calibration [Horaud95](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Horaud95)
	pub const CALIB_HAND_EYE_HORAUD: i32 = 2;
	/// Robot Sensor Calibration: Solving AX = XB on the Euclidean Group [Park94](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Park94)
	pub const CALIB_HAND_EYE_PARK: i32 = 1;
	/// A New Technique for Fully Autonomous and Efficient 3D Robotics Hand/Eye Calibration [Tsai89](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Tsai89)
	pub const CALIB_HAND_EYE_TSAI: i32 = 0;
	pub const CALIB_NINTRINSIC: i32 = 18;
	pub const CALIB_RATIONAL_MODEL: i32 = 16384;
	/// Simultaneous robot-world and hand-eye calibration using dual-quaternions and kronecker product [Li2010SimultaneousRA](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Li2010SimultaneousRA)
	pub const CALIB_ROBOT_WORLD_HAND_EYE_LI: i32 = 1;
	/// Solving the robot-world/hand-eye calibration problem using the kronecker product [Shah2013SolvingTR](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Shah2013SolvingTR)
	...
	/// An Efficient Algebraic Solution to the Perspective-Three-Point Problem [Ke17](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Ke17)
	pub const SOLVEPNP_AP3P: i32 = 5;
	/// **Broken implementation. Using this flag will fallback to EPnP.** 
	/// 
	/// A Direct Least-Squares (DLS) Method for PnP [hesch2011direct](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_hesch2011direct)
	pub const SOLVEPNP_DLS: i32 = 3;
	/// EPnP: Efficient Perspective-n-Point Camera Pose Estimation [lepetit2009epnp](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_lepetit2009epnp)
	pub const SOLVEPNP_EPNP: i32 = 1;
	/// Infinitesimal Plane-Based Pose Estimation [Collins14](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Collins14) 
	/// 
	...
	/// Pose refinement using non-linear Levenberg-Marquardt minimization scheme [Madsen04](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Madsen04) [Eade13](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Eade13) 
	/// 
	...
	/// Complete Solution Classification for the Perspective-Three-Point Problem [gao2003complete](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_gao2003complete)
	pub const SOLVEPNP_P3P: i32 = 2;
	/// SQPnP: A Consistently Fast and Globally OptimalSolution to the Perspective-n-Point Problem [Terzakis2020SQPnP](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Terzakis2020SQPnP)
	pub const SOLVEPNP_SQPNP: i32 = 8;
	/// **Broken implementation. Using this flag will fallback to EPnP.** 
	/// 
	/// Exhaustive Linearization for Robust Camera Pose and Focal Length Estimation [penate2013exhaustive](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_penate2013exhaustive)
	...
	/// object, e.g. see [Slabaugh](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Slabaugh) . Returned three rotation matrices and corresponding three Euler angles
	...
	/// can be found in:
	///    - A Compact Formula for the Derivative of a 3-D Rotation in Exponential Coordinates, Guillermo Gallego, Anthony J. Yezzi [Gallego2014ACF](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Gallego2014ACF)
	/// 
	/// 
	/// Note: Useful information on SE(3) and Lie Groups can be found in:
	///    - A tutorial on SE(3) transformation parameterizations and on-manifold optimization, Jose-Luis Blanco [blanco2010tutorial](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_blanco2010tutorial)
	///    - Lie Groups for 2D and 3D Transformation, Ethan Eade [Eade17](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Eade17)
	///    - A micro Lie theory for state estimation in robotics, Joan Solà, Jérémie Deray, Dinesh Atchuthan [Sol2018AML](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Sol2018AML)
	/// 
	/// ## Note
	...
	/// proposed in [strobl2011iccv](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_strobl2011iccv). In many common cases with inaccurate, unmeasured, roughly planar
	...
	/// views. The algorithm is based on [Zhang2000](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Zhang2000), [BouguetMCT](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_BouguetMCT) and [strobl2011iccv](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_strobl2011iccv). See
	...
	/// 
	/// The function estimates the intrinsic camera parameters and extrinsic parameters for each of the
	/// views. The algorithm is based on [Zhang2000](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Zhang2000) and [BouguetMCT](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_BouguetMCT) . The coordinates of 3D object
	...
	/// 
	/// ![](https://docs.opencv.org/4.10.0/hand-eye_figure.png)
	/// 
	...
	/// 
	/// ![](https://docs.opencv.org/4.10.0/robot-world_hand-eye_figure.png)
	/// 
	/// The calibration procedure is the following:
	///   - a static calibration pattern is used to estimate the transformation between the target frame
	///   and the camera frame
	...
	/// 
	/// The function implements the Optimal Triangulation Method (see Multiple View Geometry [HartleyZ00](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_HartleyZ00) for details).
	...
	/// 
	/// This function decomposes the essential matrix E using svd decomposition [HartleyZ00](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_HartleyZ00). In
	...
	/// the homography matrix H is described in detail in [Malis2007](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Malis2007).
	/// 
	...
	/// principal axes that results in the same orientation of an object, e.g. see [Slabaugh](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Slabaugh) . Returned
	...
	/// information as described in [Malis2007](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Malis2007) . The summary of the method: the [decompose_homography_mat] function
	...
	/// [duda2018](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_duda2018) "Accurate Detection and Localization of Checkerboard Corners for
	...
	/// ![Checkerboard](https://docs.opencv.org/4.10.0/checkerboard_radon.png)
	/// 
	/// ## Overloaded parameters
	/// 
	/// ## C++ default parameters
	...
	/// * maxIters: The maximum number of robust method iterations.
	/// 
	/// This function estimates essential matrix based on the five-point algorithm solver in [Nister03](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Nister03) .
	/// [SteweniusCFS](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_SteweniusCFS) is also a related. The epipolar geometry is described by the following equation:
	/// 
	...
	/// 
	/// ![image](https://docs.opencv.org/4.10.0/fisheye_undistorted.jpg)
	/// 
	/// ## Note
	...
	/// triangulated 3D points should have positive depth. Some details can be found in [Nister03](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Nister03).
	/// 
	...
	/// The fundamental matrix may be calculated using the [find_fundamental_mat] function. See [HartleyZ00](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_HartleyZ00) 11.4.3 for details.
	/// ## Parameters
	...
	/// to a Levenberg-Marquardt iterative minimization [Madsen04](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Madsen04) [Eade13](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Eade13) process.
	/// 
	/// ## Note
	...
	/// virtual visual servoing (VVS) [Chaumette06](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Chaumette06) [Marchand16](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Marchand16) scheme.
	/// 
	/// ## Note
	...
	/// homography matrices H1 and H2 . The function implements the algorithm [Hartley99](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_Hartley99) .
	/// 
	/// 
	/// Note:
	...
	/// 
	/// ![image](https://docs.opencv.org/4.10.0/stereo_undistort.jpg)
	/// 
	/// ## Note
	...
	/// The class implements the modified H. Hirschmuller algorithm [HH08](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_HH08) that differs from the original
	/// one as follows:
	/// 
	...
	/// sub-pixel metric from [BT98](https://docs.opencv.org/4.10.0/d0/de3/citelist.html#CITEREF_BT98) is used. Though, the color images are supported as well.
