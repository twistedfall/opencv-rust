pub mod superres {
	...
	///
	/// This class implements Super Resolution algorithm described in the papers [Farsiu03](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_Farsiu03) and
	/// [Mitzel09](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_Mitzel09) .
	///
