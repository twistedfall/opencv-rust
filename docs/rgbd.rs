pub mod rgbd {
	...
	opencv_type_enum! { crate::rgbd::DepthCleaner_DEPTH_CLEANER_METHOD { DEPTH_CLEANER_NIL } }
	...
	opencv_type_enum! { crate::rgbd::Kinfu_VolumeType { TSDF, HASHTSDF, COLOREDTSDF } }
	...
	opencv_type_enum! { crate::rgbd::RgbdNormals_RGBD_NORMALS_METHOD { RGBD_NORMALS_METHOD_FALS, RGBD_NORMALS_METHOD_LINEMOD, RGBD_NORMALS_METHOD_SRI } }
	...
	opencv_type_enum! { crate::rgbd::RgbdPlane_RGBD_PLANE_METHOD { RGBD_PLANE_METHOD_DEFAULT } }
	...
	/// [kinectfusion](https://docs.opencv.org/4.13.0/d0/de3/citelist.html#CITEREF_kinectfusion) paper.
	///
	...
	/// which are a sort of distances to the surface (for details read the [kinectfusion](https://docs.opencv.org/4.13.0/d0/de3/citelist.html#CITEREF_kinectfusion) article about TSDF).
	...
	/// which represent the distance to the closest surface (for details read the [kinectfusion](https://docs.opencv.org/4.13.0/d0/de3/citelist.html#CITEREF_kinectfusion) article
