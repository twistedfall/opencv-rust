pub mod ximgproc {
	...
	opencv_type_enum! { crate::ximgproc::AngleRangeOption { ARO_0_45, ARO_45_90, ARO_90_135, ARO_315_0, ARO_315_45, ARO_45_135, ARO_315_135, ARO_CTR_HOR, ARO_CTR_VER } }
	...
	opencv_type_enum! { crate::ximgproc::EdgeAwareFiltersList { DTF_NC, DTF_IC, DTF_RF, GUIDED_FILTER, AM_FILTER } }
	...
	opencv_type_enum! { crate::ximgproc::EdgeDrawing_GradientOperator { PREWITT, SOBEL, SCHARR, LSD } }
	...
	opencv_type_enum! { crate::ximgproc::HoughDeskewOption { HDO_RAW, HDO_DESKEW } }
	...
	opencv_type_enum! { crate::ximgproc::HoughOp { FHT_MIN, FHT_MAX, FHT_ADD, FHT_AVE } }
	...
	opencv_type_enum! { crate::ximgproc::LocalBinarizationMethods { BINARIZATION_NIBLACK, BINARIZATION_SAUVOLA, BINARIZATION_WOLF, BINARIZATION_NICK } }
	...
	opencv_type_enum! { crate::ximgproc::RulesOption { RO_STRICT, RO_IGNORE_BORDERS } }
	...
	opencv_type_enum! { crate::ximgproc::SLICType { SLIC, SLICO, MSLIC } }
	...
	opencv_type_enum! { crate::ximgproc::ThinningTypes { THINNING_ZHANGSUEN, THINNING_GUOHALL } }
	...
	opencv_type_enum! { crate::ximgproc::WMFWeightType { WMF_EXP, WMF_IV1, WMF_IV2, WMF_COS, WMF_JAC, WMF_OFF } }
	...
	pub trait DisparityFilterTrait: core::AlgorithmTrait + crate::ximgproc::DisparityFilterTraitConst {
		...
		///
		/// * filtered_disparity_map: output disparity map, single-channel CV_16S type,
