pub mod stereo {
	...
	/// ## See also
	/// This code represents the work presented in [Stoyanov2010](https://docs.opencv.org/4.13.0/d0/de3/citelist.html#CITEREF_Stoyanov2010).
	/// If this code is useful for your work please cite [Stoyanov2010](https://docs.opencv.org/4.13.0/d0/de3/citelist.html#CITEREF_Stoyanov2010).
	///
	/// Also the original growing scheme idea is described in [Lhuillier2000](https://docs.opencv.org/4.13.0/d0/de3/citelist.html#CITEREF_Lhuillier2000)
